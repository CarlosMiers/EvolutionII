...
public class OrdenCompraReporte {
    ...
    public OrdenCompraReporte(String numero, String fecha, String socio, String nombresocio, Double importe, String plazo, Double montocuota, String giraduria, String nombregiraduria, String comercial) {
        this.numero = numero;
        this.fecha = fecha;
        this.socio = socio;
