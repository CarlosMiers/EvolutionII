 ...
 * @author Usuario
 */
public class RptLibroVentaConsolidado {
    ...
    public RptLibroVentaConsolidado(Double iva5, Double iva10, String factura, String fecha, String nombrecliente, String ruc, Double gravada5, Double gravada10, Double exenta, Double total, String nombrecomprobante, int comprobante, int timbrado) {
        this.iva5 = iva5;
        this.iva10 = iva10;
