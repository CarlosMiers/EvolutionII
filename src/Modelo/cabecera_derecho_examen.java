 ...
 * @author Pc_Server
 */
public class cabecera_derecho_examen {
    ...
    public cabecera_derecho_examen() {

    }

    public cabecera_derecho_examen(Double idcertificado, sucursal sede, periodo_lectivo periodo, semestres semestre, String codturno, carrera codcarrera, ficha_empleado codprofesor, tipo_examen tipoexamen, Date fechaexamen, int acta, materias materia, double importe) {
