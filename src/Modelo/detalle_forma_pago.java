 ...
 * @author Pc_Server
 */
public class detalle_forma_pago {
    ...
    public detalle_forma_pago(String idmovimiento, formapago forma, moneda codmoneda, banco banco, String nrocheque, Date confirmacion, Double importepago, Double conversion, Double netocobrado, Date fechaentrega, Date fechacobrocheque) {
