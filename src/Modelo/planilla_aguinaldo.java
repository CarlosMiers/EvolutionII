 ...
 * @author Pc_Server
 */
public class planilla_aguinaldo {
    ...
    Double aguinaldo;
    public planilla_aguinaldo(){
        
    }

    public planilla_aguinaldo(Double idnumero, Date fecha, int mes, int periodo, sucursal sucursal, giraduria giraduria, ficha_empleado funcionario, Double salario_bruto, Double aguinaldo) {
