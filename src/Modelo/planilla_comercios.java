 ...
 * @author Pc_Server
 */
public class planilla_comercios {
    ...
    public planilla_comercios(double numero, int sucursal, int moneda, Date fecha, casa casa, comprobante servicio, Date vencimiento, Date totales, int asiento, double comision, double monto_comision, double iva_comision, double monto_iva, double totalcomision, double saldo_a_pagar, int cierre, double pago, int pagadopor, int usuarionulo, Date fechanulo, Date usuarioalta, Date fechaalta, int usuariomodi, Date fechamodi, String creferencia) {
        this.numero = numero;
    ...
    public Date getTotales() {
        return totales;
    }

    public void setTotales(Date totales) {
        this.totales = totales;
    }
