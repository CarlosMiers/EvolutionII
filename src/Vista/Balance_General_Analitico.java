...
import DAO.GenerarBalanceGeneralAnaliticoDAO;
 ...
 * @author hp
 */
public class Balance_General_Analitico extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltrosuc, trsfiltromodelo;
    ...
    public Balance_General_Analitico() {
        initComponents();
    ...
    private void filtroBalance(String consulta, JTable jtableBuscar) {
        DefaultTableModel modelo = new DefaultTableModel();
        modelo = (DefaultTableModel) jtableBuscar.getModel();
        TableRowSorter<DefaultTableModel> tr = new TableRowSorter<>(modelo);
        jtableBuscar.setRowSorter(tr);
//        tr.setRowFilter(RowFilter.regexFilter(filtrar.getText(), 5));
    }
    ...
    private void initComponents() {
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(Balance_General_Analitico.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(Balance_General_Analitico.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(Balance_General_Analitico.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Balance General Analitico");
        ...
        labelMetric1.setText("Balance General Analítico");
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(Balance_General_Analitico.class, "libroventaconsolidado.jButton1.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(Balance_General_Analitico.class, "libroventaconsolidado.jButton1.toolTipText")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(Balance_General_Analitico.class, "libroventaconsolidado.jButton2.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(Balance_General_Analitico.class, "libroventaconsolidado.jButton2.toolTipText")); // NOI18N
    ...
    private void listarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listarActionPerformed
        ...
        for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
            ...
            } else if (Integer.valueOf(jTable1.getValueAt(nFila, 7).toString()) == 4 && Integer.valueOf(jTable1.getValueAt(nFila, 8).toString()) == 1) {
                nTotalIngresos = nTotalIngresos + Double.valueOf(csaldo);
            } else if (Integer.valueOf(jTable1.getValueAt(nFila, 7).toString()) == 5 && Integer.valueOf(jTable1.getValueAt(nFila, 8).toString()) == 1) {
                nTotalEgresos = nTotalEgresos + Double.valueOf(csaldo);
            }
            ...
            if (Integer.valueOf(jTable1.getValueAt(nFila, 5).toString()) == 1) {
        ...
        try {
            ...
            parameters.put("cNombreEmpresa", "YO");
            ...
            URL url = getClass().getClassLoader().getResource("Reports/balance_analitico.jasper");
    ...
    private class GenerarConsulta extends Thread {
        ...
        public void run() {
            ...
            GenerarBalanceGeneralAnaliticoDAO DAO = new GenerarBalanceGeneralAnaliticoDAO();
            String formato = "%1$-" + 1 + "s";
            double nSaldo = 0;
            try {
                for (plan ca : DAO.GenerarBalanceAnalitico(Suc, FechaI, FechaF)) {
...
//          filtroBalance(filtrar.getText(), jTable1);
        }
    }
