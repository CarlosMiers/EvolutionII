...
import DAO.GenerarBalanceSumaSaldoDAO;
import DAO.sucursalDAO;
import Modelo.BalanceSumasSaldos;
import Modelo.plan;
 ...
 * @author hp
 */
public class Balance_sumas_saldos extends javax.swing.JFrame {
    ...
    private void TituloPlan() {
        ...
        modeloplan.addColumn("DESCRIPCION");
        modeloplan.addColumn("DESCRIPCION");
        modeloplan.addColumn("CORTE");
        int[] anchos = {100, 300, 120, 120, 120, 1};
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {100, 300, 120, 120, 120, 1, 1, 1, 1, 1};
    ...
    private void initComponents() {
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(Balance_sumas_saldos.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(Balance_sumas_saldos.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(Balance_sumas_saldos.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        labelMetric1.setText("Balance de Sumas y Saldos");
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(Balance_sumas_saldos.class, "libroventaconsolidado.jButton1.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(Balance_sumas_saldos.class, "libroventaconsolidado.jButton1.toolTipText")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(Balance_sumas_saldos.class, "libroventaconsolidado.jButton2.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(Balance_sumas_saldos.class, "libroventaconsolidado.jButton2.toolTipText")); // NOI18N
    ...
    private void listarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listarActionPerformed
        ...
        for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
            ...
            Libro = new BalanceSumasSaldos(jTable1.getValueAt(nFila, 0).toString(),
        ...
        try {
            ...
            URL url = getClass().getClassLoader().getResource("Reports/balance_sumas_saldos.jasper");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Balance_sumas_saldos().setVisible(true);
            }
        });
    }
    ...
    private class GenerarConsulta extends Thread {
        ...
        public void run() {
            ...
            GenerarBalanceSumaSaldoDAO DAO = new GenerarBalanceSumaSaldoDAO();
            String formato = "%1$-" + 1 + "s";
            double nSaldo = 0;
            try {
                for (plan ca : DAO.GenerarBalanceSumasaldo(Suc, FechaI, FechaF)) {
                    if (ca.getNaturaleza().equals("DEUDORA")) {
                        nSaldo = ca.getCredito() - ca.getDebito();
                    } else {
                        nSaldo = ca.getDebito() - ca.getCredito();
                    }
                    String Datos[] = {ca.getCodigo(), ca.getNombre(),
                        formatea.format(ca.getCredito()),
                        formatea.format(ca.getDebito()),
                        formatea.format(nSaldo),
                        formatosinpunto.format(ca.getAsentable()),
                        ca.getNaturaleza(),
                        formatosinpunto.format(ca.getTipo_cuenta()),
                        formatosinpunto.format(ca.getNivel()),
                        ca.getCorte()};
                    modelo.addRow(Datos);
