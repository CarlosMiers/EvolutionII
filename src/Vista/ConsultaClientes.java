...
public class ConsultaClientes extends javax.swing.JFrame {
    ...
    public ConsultaClientes() {
        ...
        cargarTitulo();
        if (Config.cCodigoAsesor.equals("0")) {
            cargarTabla("SELECT codigo,nombre,ruc,direccion,telefono FROM clientes ORDER BY codigo");
        } else {
            cargarTabla("SELECT codigo,nombre,ruc,direccion,telefono FROM clientes WHERE asesor="+Config.cCodigoAsesor+" ORDER BY codigo");
        }
        Buscar.setText("");
        Buscar.requestFocus();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "RUC", "Nombre", "Código" }));
    ...
    private void cargarTabla(String sql) {
        ...
        int[] anchos = {120, 250, 100, 250, 100};
