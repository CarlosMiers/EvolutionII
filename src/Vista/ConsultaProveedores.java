...
public class ConsultaProveedores extends javax.swing.JFrame {
    ...
    public ConsultaProveedores() {
        ...
        cargarTitulo();
        cargarTabla("select codigo,nombre,ruc,direccion,telefono,vencimiento,timbrado from proveedores order by codigo");
        Buscar.setText("");
        Buscar.requestFocus();
    }
    ...
    private void jButtonElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonElegirActionPerformed
        ...
        Parametros.NUMERO_TIMBRADO= jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString();
        Parametros.VENCIMIENTO_TIMBRADO=jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString().trim() ;
        dispose();
    ...
    private void cargarTabla(String sql) {
        ...
        int[] anchos = {50, 250, 100, 100, 100, 250, 100};
        ...
        try {
            ...
            while (results.next()) {
                ...
                fila[3] = results.getString("timbrado");
