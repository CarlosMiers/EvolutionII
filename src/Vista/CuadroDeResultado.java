...
import DAO.GenerarCuadroResultadoDAO;
 ...
 * @author hp
 */
public class CuadroDeResultado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(CuadroDeResultado.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(CuadroDeResultado.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(CuadroDeResultado.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        labelMetric1.setText("Cuadro de Resultados");
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(CuadroDeResultado.class, "libroventaconsolidado.jButton1.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(CuadroDeResultado.class, "libroventaconsolidado.jButton1.toolTipText")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(CuadroDeResultado.class, "libroventaconsolidado.jButton2.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(CuadroDeResultado.class, "libroventaconsolidado.jButton2.toolTipText")); // NOI18N
    ...
    private void listarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listarActionPerformed
        ...
        double nTotalIngresos = 0;
        double nTotalEgresos = 0;
        double nTotalIngresosDos = 0;
        double nTotalEgresosDos = 0;
        ...
        for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
            ...
            String cTipoCuenta = jTable1.getValueAt(nFila, 0).toString().substring(0, 1);
            //String cTipoCuenta = jTable1.getValueAt(nFila, 8).toString();
            System.out.println("NIVEL " + cTipoCuenta);
            if (Integer.valueOf(jTable1.getValueAt(nFila, 0).toString()) == 4 && Integer.valueOf(jTable1.getValueAt(nFila, 8).toString()) == 1) {
                nTotalIngresos = Double.valueOf(csaldo);
            } else if (Integer.valueOf(jTable1.getValueAt(nFila, 0).toString()) == 5 && Integer.valueOf(jTable1.getValueAt(nFila, 8).toString()) == 1) {
                nTotalEgresos = Double.valueOf(csaldo);
            } else if (Integer.valueOf(jTable1.getValueAt(nFila, 0).toString()) == 6 && Integer.valueOf(jTable1.getValueAt(nFila, 8).toString()) == 1) {
                nTotalEgresosDos = Double.valueOf(csaldo);
            } else if (Integer.valueOf(jTable1.getValueAt(nFila, 0).toString()) == 7 && Integer.valueOf(jTable1.getValueAt(nFila, 8).toString()) == 1) {
                nTotalIngresosDos = Double.valueOf(csaldo);
            }
            Libro = new BalanceGeneral(jTable1.getValueAt(nFila, 0).toString(),
                    ...
                    Integer.valueOf(cTipoCuenta),Integer.valueOf(jTable1.getValueAt(nFila, 5).toString()));
        ...
        try {
            ...
            parameters.put("nTotalIngresos", nTotalIngresos);
            parameters.put("nTotalEgresos", nTotalEgresos);
            parameters.put("nTotalIngresosDos", nTotalIngresosDos);
            parameters.put("nTotalEgresosDos", nTotalEgresosDos);

            System.out.println("Ingresos " + nTotalIngresos);
            System.out.println("Egresos " + nTotalEgresos);
            System.out.println("Ingresos " + nTotalIngresosDos);
            System.out.println("Egresos " + nTotalEgresosDos);

            JasperReport jr = null;

            URL url = getClass().getClassLoader().getResource("Reports/cuadro_resultado.jasper");
    ...
    private class GenerarConsulta extends Thread {
        ...
        public void run() {
            ...
            GenerarCuadroResultadoDAO DAO = new GenerarCuadroResultadoDAO();
            String formato = "%1$-" + 1 + "s";
            double nSaldo = 0;
            try {
                for (plan ca : DAO.GenerarCuadro(Suc, FechaI, FechaF)) {
                    if (ca.getTipo_cuenta() == 4) {
                        nSaldo = ca.getCredito() - ca.getDebito();
                    } else {
                        nSaldo = ca.getCredito() - ca.getDebito();
                    }
                    nSaldo = ca.getCredito() - ca.getDebito();
                    String Datos[] = {ca.getCodigo(), ca.getNombre(), formatea.format(ca.getCredito()), formatea.format(ca.getDebito()), formatea.format(Math.abs(nSaldo)), formatosinpunto.format(ca.getAsentable()), ca.getNaturaleza(), formatosinpunto.format(ca.getTipo_cuenta()), formatosinpunto.format(ca.getNivel())};
                    modelo.addRow(Datos);
            ...
            for (int i = 0; i <= (totalRow); i++) {
                ...
                int nTipoCuenta = Integer.valueOf(modelo.getValueAt(nFila, 7).toString());
                jTable1.setValueAt(formatea.format(credito), nFila, 2);
                jTable1.setValueAt(formatea.format(debito), nFila, 3);

                System.out.println(nTipoCuenta);
                if (nTipoCuenta == 4 || nTipoCuenta == 7) {
                    jTable1.setValueAt(formatea.format(Math.abs(debito - credito)), nFila, 4);
                } else {
                    jTable1.setValueAt(formatea.format(Math.abs(credito - debito)), nFila, 4);
                }
