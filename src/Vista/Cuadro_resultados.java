 ...
 * @author hp
 */
public class Cuadro_resultados extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        modelolibro.addColumn("Saldo Acumulado");
        modelolibro.addColumn("");
        int[] anchos = {200, 140, 350, 150, 200, 200, 300};
    ...
    private void initComponents() {
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(Cuadro_resultados.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(Cuadro_resultados.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(Cuadro_resultados.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(Cuadro_resultados.class, "libroventaconsolidado.jButton1.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(Cuadro_resultados.class, "libroventaconsolidado.jButton1.toolTipText")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(Cuadro_resultados.class, "libroventaconsolidado.jButton2.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(Cuadro_resultados.class, "libroventaconsolidado.jButton2.toolTipText")); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(panelTranslucido2, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(19, 19, 19))))
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cuadro_resultados().setVisible(true);
            }
        });
    }
    ...
    private class GenerarConsulta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (venta ven : DAO.libroventaxsucursal(Suc, FechaI, FechaF)) {
                    String Datos[] = {formatosinpunto.format(ven.getFactura()), formatoFecha.format(ven.getFecha()), ven.getCliente().getNombre(), ven.getCliente().getRuc(), formatea.format(ven.getGravadas5()), formatea.format(ven.getGravadas10()), formatea.format(ven.getExentas()), formatea.format(ven.getTotalneto()), ven.getComprobante().getNombre(), String.valueOf(ven.getComprobante().getCodigo())};
    ...
    private class GenerarLibro extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/Libro_Iva_Sucursal.jasper");
