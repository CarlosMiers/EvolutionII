 ...
 * @author hp
 */
public class Librocompraxsucursal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(Librocompraxsucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(Librocompraxsucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(Librocompraxsucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Libro Compra Sucursal");
        ...
        labelMetric1.setText("Libro IVA Compra por Sucursal");
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(Librocompraxsucursal.class, "libroventaconsolidado.jButton1.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(Librocompraxsucursal.class, "libroventaconsolidado.jButton1.toolTipText")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(Librocompraxsucursal.class, "libroventaconsolidado.jButton2.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(Librocompraxsucursal.class, "libroventaconsolidado.jButton2.toolTipText")); // NOI18N
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        try {
            DAO.librocomprares90Excel(Suc, FechaI, FechaF);
    ...
    private class GenerarConsulta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cabecera_compra com : DAO.librocompraxsucursal(Suc, FechaIni, FechaFin)) {
        ...
        public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                compra = new RptLibroCompraConsolidado(Double.valueOf(cIva5),
                        Double.valueOf(cIva10), jTable1.getValueAt(nFila, 0).toString(),
            ...
            try {
                ...
                //URL url = getClass().getClassLoader().getResource("Reports/Libro_Iva_Compra_Sucursal.jasper");
                URL url = getClass().getClassLoader().getResource("Reports/libro_iva_compra_sucursal_2023.jasper");
