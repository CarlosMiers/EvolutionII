...
import DAO.anticipo_aguinaldosDAO;
 ...
 *
 */
public class anticipo_aguinaldos_vista extends javax.swing.JFrame {
    ...
    public anticipo_aguinaldos_vista() {
        initComponents();
        ...
        GrillaAnticipoAguinaldos GrillaCR = new GrillaAnticipoAguinaldos();
    ...
    private void initComponents() {
        ...
        detalle_anticipo_aguinaldos = new javax.swing.JDialog();
        ...
        detalle_anticipo_aguinaldos.setTitle("Actualizar");
        detalle_anticipo_aguinaldos.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                detalle_anticipo_aguinaldosFocusGained(evt);
            }
        });
        detalle_anticipo_aguinaldos.addWindowFocusListener(new java.awt.event.WindowFocusListener() {
            public void windowGainedFocus(java.awt.event.WindowEvent evt) {
                detalle_anticipo_aguinaldosWindowGainedFocus(evt);
            }
            public void windowLostFocus(java.awt.event.WindowEvent evt) {
            }
        });
        detalle_anticipo_aguinaldos.addWindowListener(new java.awt.event.WindowAdapter() {
            public void windowActivated(java.awt.event.WindowEvent evt) {
                detalle_anticipo_aguinaldosWindowActivated(evt);
            }
        });
        ...
        javax.swing.GroupLayout detalle_anticipo_aguinaldosLayout = new javax.swing.GroupLayout(detalle_anticipo_aguinaldos.getContentPane());
        detalle_anticipo_aguinaldos.getContentPane().setLayout(detalle_anticipo_aguinaldosLayout);
        detalle_anticipo_aguinaldosLayout.setHorizontalGroup(
            detalle_anticipo_aguinaldosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(detalle_anticipo_aguinaldosLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(detalle_anticipo_aguinaldosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        detalle_anticipo_aguinaldosLayout.setVerticalGroup(
            detalle_anticipo_aguinaldosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, detalle_anticipo_aguinaldosLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(detalle_anticipo_aguinaldosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Grabar)
                    .addComponent(Salir))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jTBuscarFicha.setText(org.openide.util.NbBundle.getMessage(anticipo_aguinaldos_vista.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarFuncionario.setText(org.openide.util.NbBundle.getMessage(anticipo_aguinaldos_vista.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirFuncionario.setText(org.openide.util.NbBundle.getMessage(anticipo_aguinaldos_vista.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(anticipo_aguinaldos_vista.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(anticipo_aguinaldos_vista.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(anticipo_aguinaldos_vista.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Anticipos de Aguinaldos");
        ...
        etiquetaanticipos.setText("Anticipo de Aguinaldos");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(anticipo_aguinaldos_vista.class, "libroventaconsolidado.jPanel2.border.title"))); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(anticipo_aguinaldos_vista.class, "libroventaconsolidado.jLabel1.text")); // NOI18N

        jLabel8.setText(org.openide.util.NbBundle.getMessage(anticipo_aguinaldos_vista.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
        ...
        jMenu1.setText("Opciones de Anticipos");

        jMenuItem1.setText("Emisión de Reportes");
    ...
    private void AgregarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        idControl.setText("0");
        this.limpiar();
        detalle_anticipo_aguinaldos.setModal(true);
        detalle_anticipo_aguinaldos.setSize(520, 305);
        //Establecemos un título para el jDialog
        detalle_anticipo_aguinaldos.setTitle("Agregar Nuevo Anticipo");
        detalle_anticipo_aguinaldos.setLocationRelativeTo(null);
        detalle_anticipo_aguinaldos.setVisible(true);
    ...
    private void ModificarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) < 3) {
            ...
            anticipo_aguinaldosDAO csDAO = new anticipo_aguinaldosDAO();
            anticipo_aguinaldos cs = null;
            try {
...
//Establecemos un título para el jDialog
                detalle_anticipo_aguinaldos.setTitle("Modificar Datos del Anticipo");
                detalle_anticipo_aguinaldos.setLocationRelativeTo(null);
                detalle_anticipo_aguinaldos.setVisible(true);
    ...
    private void EliminarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        if (Config.cNivelUsuario.equals("1")) {
            ...
            if (ret == 0) {
                anticipo_aguinaldosDAO csDAO = new anticipo_aguinaldosDAO();
                try {
                    anticipo_aguinaldos cs = csDAO.buscarId(Integer.valueOf(num));
                    if (cs == null) {
    ...
    private void ListarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_ListarActionPerformed
        codigogiraduria.setText("0");
        nombregiraduria.setText("");
        dFechaI.setCalendar(c2);
        dFechaF.setCalendar(c2);
        imprimir_recibos.setModal(true);
        //(Ancho,Alto)
        imprimir_recibos.setSize(510, 352);
        imprimir_recibos.setTitle("Emisión de Reportes");
        imprimir_recibos.setLocationRelativeTo(null);
        imprimir_recibos.setVisible(true);
    }//GEN-LAST:event_ListarActionPerformed

    private void SalirActionPerformed(ActionEvent evt) {//GEN-FIRST:event_SalirActionPerformed
        detalle_anticipo_aguinaldos.setVisible(false);
        // TODO add your handling code here:
    ...
    private void GrabarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (ret == 0) {
            anticipo_aguinaldosDAO grabar = new anticipo_aguinaldosDAO();
            anticipo_aguinaldos crs = new anticipo_aguinaldos();
            ...
            detalle_anticipo_aguinaldos.setVisible(false);
            this.detalle_anticipo_aguinaldos.setModal(false);
            this.refrescar.doClick();
        }
    }//GEN-LAST:event_GrabarActionPerformed

    private void detalle_anticipo_aguinaldosFocusGained(FocusEvent evt) {//GEN-FIRST:event_detalle_anticipo_aguinaldosFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_anticipo_aguinaldosFocusGained

    private void detalle_anticipo_aguinaldosWindowGainedFocus(WindowEvent evt) {//GEN-FIRST:event_detalle_anticipo_aguinaldosWindowGainedFocus
        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_anticipo_aguinaldosWindowGainedFocus

    private void detalle_anticipo_aguinaldosWindowActivated(WindowEvent evt) {//GEN-FIRST:event_detalle_anticipo_aguinaldosWindowActivated

        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_anticipo_aguinaldosWindowActivated
    ...
    private void refrescarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_refrescarActionPerformed
        GrillaAnticipoAguinaldos GrillaOC = new GrillaAnticipoAguinaldos();
...
//      imprimir_recibos.setModal(true);
        //(Ancho,Alto)
        imprimir_recibos.setSize(487, 418);
        imprimir_recibos.setTitle("Emisión de Reportes");
        imprimir_recibos.setLocationRelativeTo(null);
        imprimir_recibos.setVisible(true);
        // TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (OpcionReporte.getSelectedIndex() == 0) {
            cReporte = "Reports/anticipo_aguinaldos.jasper";
        } else {
            cReporte = "Reports/recibo_anticipo_aguinaldos.jasper";
        }
    ...
    private javax.swing.JDialog detalle_anticipo_aguinaldos;
    ...
    private class GrillaAnticipoAguinaldos extends Thread {
        ...
        public void run() {
            ...
            anticipo_aguinaldosDAO csDAO = new anticipo_aguinaldosDAO();
            try {
                for (anticipo_aguinaldos cs : csDAO.MostrarxFecha(FechaI, FechaF)) {
