 ...
 *
 */
public class anticipo_alumnos extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(observacion, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jTBuscarFicha.setText(org.openide.util.NbBundle.getMessage(anticipo_alumnos.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarFuncionario.setText(org.openide.util.NbBundle.getMessage(anticipo_alumnos.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirFuncionario.setText(org.openide.util.NbBundle.getMessage(anticipo_alumnos.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(anticipo_alumnos.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(anticipo_alumnos.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(anticipo_alumnos.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(anticipo_alumnos.class, "libroventaconsolidado.jPanel2.border.title"))); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(anticipo_alumnos.class, "libroventaconsolidado.jLabel1.text")); // NOI18N

        jLabel8.setText(org.openide.util.NbBundle.getMessage(anticipo_alumnos.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
        ...
        jLabel9.setText(org.openide.util.NbBundle.getMessage(anticipo_alumnos.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
        ...
        public void run() {
            ...
            try {
                for (anticipo_alumno cs : csDAO.MostrarxFecha(FechaI, FechaF)) {
                    String Datos[] = {formatosinpunto.format(cs.getIdcontrol()), 
                        formatoFecha.format(cs.getFecha()),
                        cs.getFuncionario().getNombre(), 
                        formatea.format(cs.getImporte()),
                        formatoFecha.format(cs.getFechagrabado()),
                        cs.getObservacion(),
                        String.valueOf(cs.getIdusuario())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException ex) {
                Exceptions.printStackTrace(ex);
