 ...
 *
 */
public class anticipos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTBuscarFicha.setText(org.openide.util.NbBundle.getMessage(anticipos.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarFuncionario.setText(org.openide.util.NbBundle.getMessage(anticipos.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirFuncionario.setText(org.openide.util.NbBundle.getMessage(anticipos.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(anticipos.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(anticipos.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(anticipos.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetaanticipos.setText("Anticipos Salariales");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(anticipos.class, "libroventaconsolidado.jPanel2.border.title"))); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(anticipos.class, "libroventaconsolidado.jLabel1.text")); // NOI18N

        jLabel8.setText(org.openide.util.NbBundle.getMessage(anticipos.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
    ...
    private void ModificarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) < 3) {
            ...
            anticiposDAO csDAO = new anticiposDAO();
            anticipo cs = null;
            try {
...
//Establecemos un título para el jDialog
    ...
    private void EliminarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        if (Config.cNivelUsuario.equals("1")) {
            ...
            if (ret == 0) {
                anticiposDAO csDAO = new anticiposDAO();
                try {
                    anticipo cs = csDAO.buscarId(Integer.valueOf(num));
                    if (cs == null) {
    ...
    private void GrabarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (ret == 0) {
            anticiposDAO grabar = new anticiposDAO();
            anticipo crs = new anticipo();
...
//      imprimir_recibos.setModal(true);
    ...
    private class GrillaAnticipo extends Thread {
        ...
        public void run() {
            ...
            anticiposDAO csDAO = new anticiposDAO();
            try {
                for (anticipo cs : csDAO.MostrarxFecha(FechaI, FechaF)) {
