 ...
 * @author hp
 */
public class anticipos_informes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTBuscarRubro.setText(org.openide.util.NbBundle.getMessage(anticipos_informes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarRubro.setText(org.openide.util.NbBundle.getMessage(anticipos_informes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirRubro.setText(org.openide.util.NbBundle.getMessage(anticipos_informes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(anticipos_informes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(anticipos_informes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(anticipos_informes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldos.setText("Informe de Anticipos");
    ...
    private void buscarSucursalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarSucursalActionPerformed
        ...
        if (sucursal.getText().equals("0")) {
            ...
            giraduriaDAO suDAO = new giraduriaDAO();
            giraduria suc = null;
            try {
    ...
    private class GrillaJornada extends Thread {
        ...
        public void run() {
            ...
            try {
                for (anticipo cs : csDAO.MostrarxFechaxSuc(FechaI, FechaF, Integer.valueOf(sucursal.getText()))) {
                    String Datos[] = {formato.format(cs.getIdcontrol()), formatoFecha.format(cs.getFecha()), cs.getFuncionario().getNombreempleado(), formato.format(cs.getImporte()), formatoFecha.format(cs.getFechagrabado()), String.valueOf(cs.getIdusuario())};
                    modelo.addRow(Datos);
                }
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/anticipos_sucursal.jasper");
