 ...
 * @author hp
 */
public class asistencia_informes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTBuscarRubro.setText(org.openide.util.NbBundle.getMessage(asistencia_informes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarRubro.setText(org.openide.util.NbBundle.getMessage(asistencia_informes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirRubro.setText(org.openide.util.NbBundle.getMessage(asistencia_informes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(asistencia_informes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(asistencia_informes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(asistencia_informes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldos.setText("Informe de Asistencias");
    ...
    private class GrillaJornada extends Thread {
        ...
        public void run() {
            ...
            try {
                for (jornalero aus : DAO.TodosxSucursal(FechaI, FechaF, Integer.valueOf(sucursal.getText()))) {
                    String Datos[] = {String.valueOf(aus.getNumero()), formatoFecha.format(aus.getFecha()), aus.getFicha_empleado().getNombreempleado(), String.valueOf(aus.getTiempo()), formato.format(aus.getImporte())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/asistencia_sucursal.jasper");
