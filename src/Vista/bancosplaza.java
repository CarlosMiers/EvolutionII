 ...
 * @author FedeXavier
 */
public class bancosplaza extends javax.swing.JFrame {
    ...
    public bancosplaza() {
        ...
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM bancos_plaza ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        labelMetric1.setText("Bancos de Plaza");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        if (Integer.valueOf(Config.cNivelUsuario) == 1) {
            ...
            BD.borrarRegistro("bancos_plaza", "codigo=" + this.jTextField1.getText().trim());
            this.cargarTabla("SELECT * FROM bancos_plaza ORDER BY codigo");
        } else {
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("bancos_plaza", "nombre", "'" + this.jTextField2.getText() + "'");
        } else {
            BD.actualizarRegistro("bancos_plaza", "nombre ='" + this.jTextField2.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM bancos_plaza ORDER BY codigo");
        this.jTextField2.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bancosplaza.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
