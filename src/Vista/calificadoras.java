 ...
 * @author FedeXavier
 */
public class calificadoras extends javax.swing.JFrame {
    ...
    public calificadoras() {
        ...
        this.tablacalificadora.setShowGrid(false);
        this.tablacalificadora.setOpaque(true);
        this.tablacalificadora.setBackground(new Color(102, 204, 255));
        this.tablacalificadora.setForeground(Color.BLACK);
        ...
        GrillaCalificadora GrillaOC = new GrillaCalificadora();
    ...
    private void initComponents() {
        ...
        detalle_calificadora = new javax.swing.JDialog();
        ...
        tablacalificadora = new javax.swing.JTable();
        panel2 = new org.edisoncor.gui.panel.Panel();
        etiquetacalificadora = new org.edisoncor.gui.label.LabelMetric();
        jComboBox1 = new javax.swing.JComboBox();
        jTextField1 = new javax.swing.JTextField();

        detalle_calificadora.setName("detalle_calificadora"); // NOI18N
        detalle_calificadora.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                detalle_calificadoraFocusGained(evt);
            }
        });
        detalle_calificadora.addWindowFocusListener(new java.awt.event.WindowFocusListener() {
            public void windowGainedFocus(java.awt.event.WindowEvent evt) {
                detalle_calificadoraWindowGainedFocus(evt);
            }
        ...
        nacimiento.setName("nacimiento"); // NOI18N
        ...
        jLabel14.setText("Fecha Constitución");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(direccion, javax.swing.GroupLayout.DEFAULT_SIZE, 349, Short.MAX_VALUE)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(telefono, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(nacimiento, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addComponent(ruc, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(estado)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(mail)
                                .addComponent(web, javax.swing.GroupLayout.PREFERRED_SIZE, 349, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        javax.swing.GroupLayout detalle_calificadoraLayout = new javax.swing.GroupLayout(detalle_calificadora.getContentPane());
        detalle_calificadora.getContentPane().setLayout(detalle_calificadoraLayout);
        detalle_calificadoraLayout.setHorizontalGroup(
            detalle_calificadoraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(panel3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addGroup(detalle_calificadoraLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
        detalle_calificadoraLayout.setVerticalGroup(
            detalle_calificadoraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(detalle_calificadoraLayout.createSequentialGroup()
        ...
        setTitle("Ingresar Datos de Asesores");
        setName("Form"); // NOI18N
        ...
        tablacalificadora.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        ...
        tablacalificadora.setModel(modelo);
        tablacalificadora.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tablacalificadora.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        tablacalificadora.setName("tablacalificadora"); // NOI18N
        tablacalificadora.setSelectionBackground(new java.awt.Color(51, 204, 255));
        tablacalificadora.setSelectionForeground(new java.awt.Color(0, 0, 255));
        tablacalificadora.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                tablacalificadoraFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                tablacalificadoraFocusLost(evt);
            }
        });
        tablacalificadora.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablacalificadoraMouseClicked(evt);
            }
        });
        tablacalificadora.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tablacalificadoraKeyPressed(evt);
            }
        });
        jScrollPane1.setViewportView(tablacalificadora);
        ...
        etiquetacalificadora.setText("Calificadoras de Riesgo");
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        ...
        trsfiltro = new TableRowSorter(tablacalificadora.getModel());
        tablacalificadora.setRowSorter(trsfiltro);
        // TODO add your handling code here:
    ...
    private void BotonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonAgregarActionPerformed
        ...
        this.limpiar();
        detalle_calificadora.setModal(true);
        detalle_calificadora.setSize(625, 460);
        //Establecemos un título para el jDialog
        detalle_calificadora.setTitle("Agregar nuevo Registro");
        detalle_calificadora.setLocationRelativeTo(null);
        detalle_calificadora.setVisible(true);

        // TODO add your handling code here:
    }//GEN-LAST:event_BotonAgregarActionPerformed

    private void tablacalificadoraKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablacalificadoraKeyPressed
        int nFila = this.tablacalificadora.getSelectedRow();
        this.jTextOpciones1.setText(this.tablacalificadora.getValueAt(nFila, 0).toString());
        // TODO add your handling code here:
    }//GEN-LAST:event_tablacalificadoraKeyPressed

    private void tablacalificadoraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablacalificadoraMouseClicked
        int nFila = this.tablacalificadora.getSelectedRow();
        this.jTextOpciones1.setText(this.tablacalificadora.getValueAt(nFila, 0).toString());

        // TODO add your handling code here:
    }//GEN-LAST:event_tablacalificadoraMouseClicked
    ...
    private void BotonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEditarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) == 1) {
            ...
            if (nFila < 0) {
                ...
                this.tablacalificadora.requestFocus();
                return;
            }

            this.codigo.setText(this.tablacalificadora.getValueAt(nFila, 0).toString());
            calificadoraDAO sucDAO = new calificadoraDAO();
            calificadora suc = null;
            try {
            ...
            if (suc != null) {
                ...
                mail.setText(suc.getMail());
                nacimiento.setDate(suc.getNacimiento());
                direccion.setText(suc.getDireccion());
                web.setText(suc.getWeb());
                if (suc.getEstado() == 0) {
                ...
                detalle_calificadora.setSize(625, 460);
                //Establecemos un título para el jDialog
                detalle_calificadora.setTitle("Modificar Datos de la Entidad");
                detalle_calificadora.setLocationRelativeTo(null);
                detalle_calificadora.setVisible(true);
            } else {
    ...
    private void tablacalificadoraFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tablacalificadoraFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_tablacalificadoraFocusGained
    ...
    private void BotonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonDeleteActionPerformed
        if (Integer.valueOf(Config.cNivelUsuario) == 1) {
            int nFila = tablacalificadora.getSelectedRow();
            String num = tablacalificadora.getValueAt(nFila, 0).toString();
            Object[] opciones = {"   Si   ", "   No   "};
            int ret = JOptionPane.showOptionDialog(null, "Desea Eliminar el Registro ? ", "Confirmación", 0, 3, null, opciones, opciones[0]);
            if (ret == 0) {
                calificadoraDAO sucDAO = new calificadoraDAO();
                try {
                    calificadora suc = sucDAO.buscarId((Integer.valueOf(num)));
                    if (suc == null) {
                        JOptionPane.showMessageDialog(null, "Registro no Existe");
                    } else {
                        sucDAO.eliminarCalificadora(Integer.valueOf(num));
    ...
    private void tablacalificadoraFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tablacalificadoraFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_tablacalificadoraFocusLost
    ...
    private void detalle_calificadoraFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_detalle_calificadoraFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_calificadoraFocusGained

    private void detalle_calificadoraWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_detalle_calificadoraWindowGainedFocus

        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_calificadoraWindowGainedFocus

    private void BotonSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonSalirActionPerformed
        this.detalle_calificadora.setVisible(false);
        // TODO add your handling code here:
    ...
    private void BotonGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonGrabarActionPerformed
        ...
        if (ret == 0) {
            ...
            calificadoraDAO grabar = new calificadoraDAO();
            calificadora suc = new calificadora();

            int nestado = 0;
            if (this.estado.isSelected()) {
                nestado = 1;
            }
            Date dFecha = ODate.de_java_a_sql(nacimiento.getDate());
            suc.setNacimiento(dFecha);
            suc.setNombre(nombre.getText());
            suc.setRuc(ruc.getText());
            suc.setDireccion(direccion.getText());
            suc.setTelefono(telefono.getText());
            suc.setWeb(this.web.getText());
            suc.setMail(this.mail.getText());
            suc.setEstado(nestado);
            try {
                if (Integer.valueOf(codigo.getText()) == 0) {
                    grabar.insertarCalificadora(suc);
                } else {
                    suc.setCodigo(Integer.valueOf(codigo.getText()));
                    grabar.actualizarCalificadora(suc);
                }
            } catch (SQLException ex) {
                Exceptions.printStackTrace(ex);
            }
            detalle_calificadora.setVisible(false);
            detalle_calificadora.setModal(false);
    ...
    private void cargarTitulo() {
        ...
        for (int i = 0; i < modelo.getColumnCount(); i++) {
            tablacalificadora.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);
        }
        ((DefaultTableCellRenderer) tablacalificadora.getTableHeader().getDefaultRenderer()).setHorizontalAlignment(JLabel.CENTER);// Este código es para centrar las cabeceras de la tabla.
        tablacalificadora.getTableHeader().setFont(new Font("Arial Black", 1, 11));

        Font font = new Font("Arial", Font.BOLD, 10);
        this.tablacalificadora.setFont(font);

        DefaultTableCellRenderer TablaRenderer = new DefaultTableCellRenderer();
        DefaultTableCellRenderer AlinearCentro = new DefaultTableCellRenderer();
        TablaRenderer.setHorizontalAlignment(SwingConstants.RIGHT); // aqui defines donde alinear 
        AlinearCentro.setHorizontalAlignment(SwingConstants.CENTER);
        this.tablacalificadora.getColumnModel().getColumn(0).setCellRenderer(TablaRenderer);
    ...
    private javax.swing.JDialog detalle_calificadora;
    ...
    private javax.swing.JTable tablacalificadora;
    ...
    private class GrillaCalificadora extends Thread {
        ...
        public void run() {
            ...
            calificadoraDAO DAO = new calificadoraDAO();
            try {
                for (calificadora suc : DAO.todos()) {
                    String Datos[] = {String.valueOf(suc.getCodigo()), suc.getNombre(), suc.getRuc(), suc.getDireccion(), suc.getTelefono(), suc.getMail()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
            ...
            tablacalificadora.setRowSorter(new TableRowSorter(modelo));
            int cantFilas = tablacalificadora.getRowCount();
            if (cantFilas > 0) {
