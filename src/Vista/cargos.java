...
public class cargos extends javax.swing.JFrame {
    ...
    public cargos() {
        ...
        GrillaCargo GrillaOC = new GrillaCargo();
    ...
    private void initComponents() {
        ...
        nombrecargo.setFont(new java.awt.Font("Corbel", 0, 14)); // NOI18N
        nombrecargo.setEnabled(false);
        nombrecargo.setSelectionColor(new java.awt.Color(0, 63, 62));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(nombrecargo, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(nombrecargo, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        this.nombrecargo.setText(this.jTable1.getValueAt(nFila, 1).toString());
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        ...
        if (ret == 0) {
            ...
            try {
                cargo car = carDAO.buscarId(Integer.valueOf(num));
                if (car == null) {
                    JOptionPane.showMessageDialog(null, "Registro no Existe");
                } else {
                    carDAO.eliminarcargo(Integer.valueOf(num));
    ...
    private void jTable1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTable1FocusGained
        ...
        this.nombrecargo.setText(this.jTable1.getValueAt(nFila - 1, 1).toString());
        // TODO add your handling code here:
    ...
    private void nombrecargoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nombrecargoKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) { //valida que el usuario enter le da enter se quede en un lugar
            if (!nombrecargo.getText().matches("")) { //if es negacion si no esta vacio este cuadro de texto pasa al siguiente condicion mantches este es el cuadro de texto en la que estamos
