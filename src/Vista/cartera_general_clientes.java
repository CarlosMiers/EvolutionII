 ...
 * @author hp
 */
public class cartera_general_clientes extends javax.swing.JFrame {
     ...
     */
    public cartera_general_clientes() {
        initComponents();
    ...
    private void cargarTituloTabla() {
        ...
        int[] anchos = {100, 100, 100, 100, 100, 100, 150, 100, 100, 100, 100, 100, 100, 100, 100};
    ...
    private void initComponents() {
        ...
        nestado = new javax.swing.JComboBox<>();
        ...
        setTitle("Cartera General de Inversiones por Cliente");

        panelTranslucido1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        etiquetasaldos.setText("Cartera General de Inversiones");
        ...
        panelTranslucido1Layout.setHorizontalGroup(
            ...
            .addGroup(panelTranslucido1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(etiquetasaldos, javax.swing.GroupLayout.PREFERRED_SIZE, 279, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        nestado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Activos", "Inactivos" }));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(nestado, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jLabel3)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(nestado, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private javax.swing.JComboBox<String> nestado;
    ...
    private class ConsultaVenceEmisor extends Thread {
        ...
        public void run() {
            ...
            int nEstado = nestado.getSelectedIndex() + 1;

            nEstado = nEstado == 1 ? 1 : 0;
            ...
            try {
                for (cartera_clientes cart : DAO.CarteraGeneral(nCliente, nMoneda, FechaI, nEstado)) {
                    cart.setFechaemision(cart.getOperacion() > 1 ? cart.getFechacierre() : cart.getFechaemision());
                    cart.setVencimiento(cart.getOperacion() > 1 ? cart.getFechacierre() : cart.getVencimiento());

                    String Datos[] = {formato.format(cart.getNumero()),
                        formatoFecha.format(cart.getFechacierre()),
                        formatoFecha.format(cart.getFechaemision()),
                        formatoFecha.format(cart.getVencimiento()),
    ...
    private class GenerarReporteCarteraCliente extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                parameters.put("cMoneda", Integer.valueOf(moneda.getText()));
                parameters.put("cCliente", Integer.valueOf(cliente.getText()));
                parameters.put("nAsesor", Integer.valueOf(Config.cCodigoAsesor));
                parameters.put("nestado", nEstado);

                JasperReport jr = null;
                URL url = getClass().getClassLoader().getResource("Reports/cartera_general.jasper");
