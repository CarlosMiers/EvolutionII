 ...
 * @author FedeXavier
 */
public class categoria_clientes extends javax.swing.JFrame {
     ...
     */
    public categoria_clientes() {
        initComponents();
        this.jTextField3.setVisible(false);
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM categoria_clientes ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        labelMetric1.setText("Categoría de Clientes");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("categoria_clientes", "codigo=" + this.jTextField1.getText().trim());
        this.cargarTabla("SELECT * FROM categoria_clientes ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("categoria_clientes", "nombre", "'" + this.jTextField2.getText() + "'");
        } else {
            BD.actualizarRegistro("categoria_clientes", "nombre ='" + this.jTextField2.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM categoria_clientes ORDER BY codigo");
        this.jTextField2.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(categoria_clientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
