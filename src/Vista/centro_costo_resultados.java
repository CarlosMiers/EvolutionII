...
import DAO.centro_costo_reporteDAO;
 ...
 * @author hp
 */
public class centro_costo_resultados extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltrosucursal, trsfiltromoneda;
    ...
    public centro_costo_resultados() {
        ...
        Thread hilosu = new Thread(grillasu);
        hilosu.start();
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {150,90, 120,120,120, 100};
        ...
        this.jTable1.getColumnModel().getColumn(5).setCellRenderer(AlinearDerecho);
    }
    ...
    private void TitSucursal() {
        ...
        this.tablasucursal.getColumnModel().getColumn(1).setCellRenderer(TablaRendererizquierdo);
    }
    ...
    private void initComponents() {
        ...
        centrocosto = new javax.swing.JTextField();
        buscarsucursal = new javax.swing.JButton();
        nombrecentrocosto = new javax.swing.JTextField();
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(centro_costo_resultados.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(centro_costo_resultados.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(centro_costo_resultados.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        BSucursal.setTitle("Buscar Centro de Costo");
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(centro_costo_resultados.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(centro_costo_resultados.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(centro_costo_resultados.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Resultados por Centros de Costo");
        ...
        etiquetasaldos.setText("Resultados por Centros de Costo");
        ...
        centrocosto.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        centrocosto.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                centrocostoFocusGained(evt);
            }
        });
        centrocosto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                centrocostoActionPerformed(evt);
            }
        });
        centrocosto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                centrocostoKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                centrocostoKeyReleased(evt);
            }
        });
        ...
        nombrecentrocosto.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        nombrecentrocosto.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        nombrecentrocosto.setEnabled(false);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(nombrecentrocosto, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(nombremoneda)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel5)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(centrocosto, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(centrocosto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(nombrecentrocosto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel4)
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void generarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generarActionPerformed
        if (this.centrocosto.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Ingrese la Sucursal");
            this.centrocosto.requestFocus();
            return;
        }
    ...
    private void centrocostoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_centrocostoFocusGained
        centrocosto.selectAll();
    }//GEN-LAST:event_centrocostoFocusGained

    private void centrocostoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_centrocostoActionPerformed
        this.buscarsucursal.doClick();
    }//GEN-LAST:event_centrocostoActionPerformed

    private void centrocostoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_centrocostoKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.jTBuscarSucursal.requestFocus();
        }
    }//GEN-LAST:event_centrocostoKeyPressed

    private void centrocostoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_centrocostoKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_centrocostoKeyReleased
    ...
    private void buscarsucursalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarsucursalActionPerformed
        if (centrocosto.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "No puede dejar en Blanco");
            centrocosto.requestFocus();
            return;
        }

        if (centrocosto.getText().equals("0")) {
            // sucursal.setText("0");
            nombrecentrocosto.setText("Consolidado");
            moneda.requestFocus();
        } else {
            centro_costoDAO suDAO = new centro_costoDAO();
            centro_costo su = null;
            try {
                su = suDAO.buscarId(Integer.valueOf(this.centrocosto.getText()));
                if (su.getCodigo() == 0) {
                    BSucursal.setModal(true);
                    BSucursal.setSize(500, 575);
                    BSucursal.setLocationRelativeTo(null);
                    BSucursal.setVisible(true);
                    BSucursal.setTitle("Sucursal");
                    BSucursal.setModal(false);
                } else {
                    nombrecentrocosto.setText(su.getNombre());
                    //Establecemos un título para el jDialog
                }
                moneda.requestFocus();
    ...
    private void AceptarSucActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarSucActionPerformed
        ...
        this.centrocosto.setText(this.tablasucursal.getValueAt(nFila, 0).toString());
        this.nombrecentrocosto.setText(this.tablasucursal.getValueAt(nFila, 1).toString());
    ...
    private javax.swing.JTextField centrocosto;
    ...
    private javax.swing.JTextField nombrecentrocosto;
    ...
    private class GenerarConsultaSucursal extends Thread {
        ...
        public void run() {
            int nCentro = Integer.valueOf(centrocosto.getText());
            ...
            centro_costo_reporteDAO DAO = new centro_costo_reporteDAO();
            try {
                for (centro_costo_reporte vta : DAO.MostrarxReferencia(FechaI, FechaF, nCentro, nMoneda)) {
                    String Datos[] = {vta.getFormatofactura(),
                    formatoFecha.format(vta.getFecha()),
                    vta.getNombrecentro(),
                    vta.getNombreproveedor(),
                    vta.getNombremoneda(),
                    formatea.format(vta.getMonto())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GrillaSucursal extends Thread {
        ...
        public void run() {
            ...
            centro_costoDAO DAOsu = new centro_costoDAO();
            try {
                for (centro_costo su : DAOsu.Todos()) {
                    String Datos[] = {String.valueOf(su.getCodigo()), su.getNombre()};
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                parameters.put("ncentro", centrocosto.getText());
                parameters.put("nmoneda", moneda.getText());
                parameters.put("FechaInicio", FechaInicio);
                parameters.put("FechaFinal", FechaFinal);

                JasperReport jr = null;
                URL url = getClass().getClassLoader().getResource("Reports/centro_costo_resultados.jasper");
