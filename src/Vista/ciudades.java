...
public class ciudades extends javax.swing.JFrame {
    ...
    public ciudades() {
        initComponents();
        this.etiquetalocalidades.setText("Localidades-Ciudades");
    ...
    private void initComponents() {
        ...
        etiquetalocalidades = new org.edisoncor.gui.label.LabelMetric();
        ...
        etiquetalocalidades.setText(org.openide.util.NbBundle.getMessage(ciudades.class, "saldosxclientes.labelMetric1.text")); // NOI18N
        ...
        panel1Layout.setHorizontalGroup(
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addComponent(etiquetalocalidades, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        panel1Layout.setVerticalGroup(
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(etiquetalocalidades, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("localidades", "nombre", "'" + this.jTextField2.getText() + "'");
        } else {
            BD.actualizarRegistro("localidades", "nombre ='" + this.jTextField2.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM localides ORDER BY codigo");
        this.jTextField2.setText("");
    ...
    private org.edisoncor.gui.label.LabelMetric etiquetalocalidades;
