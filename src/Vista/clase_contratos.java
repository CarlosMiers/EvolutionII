 ...
 * @author FedeXavier
 */
public class clase_contratos extends javax.swing.JFrame {
     ...
     */
    public clase_contratos() {
        initComponents();
        this.jTextField3.setVisible(false);
        this.etiquetafamilia.setText("Tipo de Contratos");
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM tipo_contratos ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        etiquetafamilia.setText(org.openide.util.NbBundle.getMessage(clase_contratos.class, "saldosxclientes.labelMetric1.text")); // NOI18N
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("tipo_contratos", "codigo=" + this.jTextField1.getText().trim());
        this.cargarTabla("SELECT * FROM tipo_contratos ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void GrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("tipo_contratos", "nombre", "'" + this.nombre.getText() + "'");
        } else {
            BD.actualizarRegistro("tipo_contratos", "nombre ='" + this.nombre.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM tipo_contratos ORDER BY codigo");
        this.nombre.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(clase_contratos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
