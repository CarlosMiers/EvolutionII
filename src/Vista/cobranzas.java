...
public class cobranzas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        nrofactura.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        ...
        Listar.setText(org.openide.util.NbBundle.getMessage(cobranzas.class, "ventas.Listar.text")); // NOI18N
        Listar.setToolTipText(org.openide.util.NbBundle.getMessage(cobranzas.class, "ventas.Listar.toolTipText")); // NOI18N
...
//        }
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        GenFacturaCobros GenFacCobros = new GenFacturaCobros();
        Thread GenFac = new Thread(GenFacCobros);
        GenFacCobros.start();
    ...
    private class VistaFactura extends Thread {
        ...
        public void run() {
            ...
            cSql += "SUM(mora) AS tmora,SUM(minteres) as tinteres ";
            cSql += " FROM cobranzas ";
            cSql += " INNER JOIN detalle_cobranzas ";
            cSql += " ON cobranzas.idpagos=detalle_cobranzas.iddetalle ";
            cSql += " INNER JOIN clientes ";
    ...
    private class GrabarFacturaCobros extends Thread {
        ...
        public void run() {
            ...
            cOrdinario = interesordinario.getText();
            cOrdinario = cOrdinario.replace(".", "");
            cOrdinario = cOrdinario.replace(",", ".");

            double TotalNeto = Double.valueOf(cMora) + Double.valueOf(cPunitorio) + Double.valueOf(cGastos) + Double.valueOf(cOrdinario);
            ...
            try {
                ...
                cSqlCab += "VALUES ('" + cReferencia + "','" + FechaProceso + "','" + cFactura + "','" + PrimerVence + "','" + cuenta3.getText() + "','" + "1" + "','" + cmoneda + "','" + "1" + "','";
                cSqlCab += "1" + "','" + cCotizacion + "','" + "1" + "','" + "1" + "','" + "0" + "','" + cTotalNeto + "','" + "0" + "','" + cTotalNeto + "','" + observacion.getText().toString() + "','" + Config.CodUsuario + "')";
                try {
                ...
                //Se graban los intereses ordinarios
                if (Double.valueOf(cOrdinario) > 0) {
                    montoiva = Double.valueOf(cOrdinario);
                    ...
                    cSqlDetalle2 += "VALUES ('" + cReferencia + "','" + Config.cInteresPrestamo + "','" + cCantidad + "','" + '0' + "','" + cOrdinario + "','" + cOrdinario + "','" + cImpiva + "','" + cIva + "')";
...
//                  nTotalNeto = results.getDouble("totalneto");
    ...
    private class GrillaCobranzas extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cobranza cobros : DAO.MostrarxFecha(dFechaInicio, dFechaFinal)) {
