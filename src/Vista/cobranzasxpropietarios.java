 ...
 * @author hp
 */
public class cobranzasxpropietarios extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {0, 200, 90, 180, 300, 300, 100, 100, 120, 150, 150};
    ...
    private void initComponents() {
        ...
        jTBuscarPropietario.setText(org.openide.util.NbBundle.getMessage(cobranzasxpropietarios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarPro.setText(org.openide.util.NbBundle.getMessage(cobranzasxpropietarios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirPro.setText(org.openide.util.NbBundle.getMessage(cobranzasxpropietarios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Cobranzas por Propietarios");
        ...
        etiquetasaldos.setText("Cobranzas por Propietarios");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(124, 149, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private class GenerarConsultaCobranza extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cobranza cob : DAO.Cobranzasxpropietarios(FechaI, FechaF, nPropietario, nProp)) {
                    String Datos[] = {cob.getIdpagos(), cob.getFormatofactura(), formatoFecha.format(cob.getFecha()), String.valueOf(cob.getCliente().getRuc()), String.valueOf(cob.getCliente().getNombre()), String.valueOf(cob.getInmueble().getNomedif()), formato.format(cob.getDetalle_cobranza().getAlquiler()), formato.format(cob.getDetalle_cobranza().getGarage()), formato.format(cob.getDetalle_cobranza().getExpensa()), formato.format(cob.getDetalle_cobranza().getComision()), formato.format(cob.getDetalle_cobranza().getMulta())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
        ...
        public void run() {
            ...
            try {
                for (propietario pr : proDAO.todos()) {
                    String Datos[] = {String.valueOf(pr.getCodpro()), pr.getNombreprop()};
 ...
 private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/cobranzaxpropietario.jasper");
