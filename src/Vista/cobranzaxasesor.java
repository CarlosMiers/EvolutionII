 ...
 * @author hp
 */
public class cobranzaxasesor extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {90, 100, 100, 100, 100, 100, 200};
    ...
    private void initComponents() {
        ...
        setTitle(org.openide.util.NbBundle.getMessage(cobranzaxasesor.class, "cobranzaxasesor.title")); // NOI18N
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(cobranzaxasesor.class, "cobranzaxasesor.generar.text")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(cobranzaxasesor.class, "cobranzaxasesor.listar.text")); // NOI18N
        ...
        jButton3.setText(org.openide.util.NbBundle.getMessage(cobranzaxasesor.class, "cobranzaxasesor.jButton3.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(cobranzaxasesor.class, "cobranzaxasesor.jLabel1.text")); // NOI18N

        jLabel2.setText(org.openide.util.NbBundle.getMessage(cobranzaxasesor.class, "cobranzaxasesor.jLabel2.text")); // NOI18N

        jLabel6.setText(org.openide.util.NbBundle.getMessage(cobranzaxasesor.class, "cobranzaxasesor.jLabel6.text")); // NOI18N
        ...
        BuscarMoneda.setText(org.openide.util.NbBundle.getMessage(cobranzaxasesor.class, "cobranzaxasesor.BuscarMoneda.text")); // NOI18N
        ...
        getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(cobranzaxasesor.class, "cobranzaxasesor.AccessibleContext.accessibleName")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cobranzaxasesor().setVisible(true);
            }
        });
    }
    ...
    private class generarconsulta extends Thread {
        ...
        public void run() {
            ...
            cSql = "SELECT clientes.asesor,vendedores.nombre as nombrevendedor,'BOCA' AS origen,SUM(cuenta_clientes.amortiza) AS tamortiza,";
            cSql += "SUM(cuenta_clientes.minteres) AS tinteres,SUM(pagoexpress.gastos) AS tgastos,";
            cSql += "SUM(pagoexpress.mora) AS tmora,SUM(pagoexpress.monto) AS tmonto,";
            cSql += "cuenta_clientes.comprobante,";
            cSql += "comprobantes.nombre AS nombreprestamo ";
            cSql += "FROM pagoexpress ";
            cSql += "INNER JOIN clientes ";
            cSql += "ON clientes.codigo=pagoexpress.cliente ";
            cSql += "INNER JOIN vendedores ";
            cSql += "ON vendedores.codigo=clientes.asesor ";
            ...
            cSql += " GROUP BY asesor,origen,comprobante ";
            cSql += "UNION ";
            cSql += "SELECT clientes.asesor,vendedores.nombre as nombrevendedor,'CAJA' AS origen,SUM(detalle_cobranzas.amortiza) AS tamortiza,";
            cSql += "SUM(detalle_cobranzas.minteres) AS tinteres,";
            cSql += "SUM(detalle_cobranzas.gastos_cobranzas) AS tgastos,";
            cSql += "SUM(detalle_cobranzas.mora) AS tmora,";
            cSql += "SUM(detalle_cobranzas.pago) AS tmonto,";
            cSql += "detalle_cobranzas.comprobante,";
            cSql += "comprobantes.nombre AS nombreprestamo ";
            cSql += "FROM cobranzas ";
            cSql += "INNER JOIN clientes ";
            ...
            cSql += "WHERE fecha BETWEEN " + "'" + dFechaInicio + "'" + " AND " + "'" + dFechaFinal + "'";
            cSql += " AND comprobante IN (8,9,10) AND cobranzas.moneda =" + moneda.getText();
            cSql += " GROUP BY asesor,origen,comprobante ";
            cSql += "ORDER BY asesor,origen,comprobante ";
            ...
            try {
                ...
                while (results.next()) {
                    ...
                    Object[] fila = new Object[7]; // Cantidad de columnas en la tabla
                    fila[0] = results.getString("origen");
                    fila[1] = formatea.format(results.getDouble("tamortiza"));
                    fila[2] = formatea.format(results.getDouble("tinteres"));
                    fila[3] = formatea.format(results.getDouble("tmora"));
                    fila[4] = formatea.format(results.getDouble("tgastos"));
                    fila[5] = formatea.format(results.getDouble("tmonto"));
                    fila[6] = results.getString("nombreprestamo");
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/resumen_cobroxasesor.jasper");
