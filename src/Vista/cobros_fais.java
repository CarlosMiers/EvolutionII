 ...
 *
 */
public class cobros_fais extends javax.swing.JFrame {
    ...
    private void GrabarCobro() {
        ...
        ///INGRESAMOS LOS DETALLES DE FACTURAS COBRADOS
        String detalleitem = "[";
        int iditem = tablaitem.getRowCount();
        iditem -= 1;

        for (int i = 0; i <= iditem; i++) {
            supago = tablaitem.getValueAt(i, 6).toString();
            supago = supago.replace(".", "").replace(",", ".");
            String linea = "{idpagos : '" + idControl.getText() + "',"
                    + "iditem: " + tablaitem.getValueAt(i, 0).toString() + ","
                    + "pago : " + supago + "},";
            detalleitem += linea;
        }
        if (!detalleitem.equals("[")) {
            detalleitem = detalleitem.substring(0, detalleitem.length() - 1);
        }
        detalleitem += "]";

        System.out.println(detalleitem);
        ...
        if (tipoOp.getText().equals("0")) {
            ...
            try {
                ...
                cobroitemDAO itemDAO = new cobroitemDAO();
                itemDAO.guardarItem(idControl.getText(), detalleitem);
            } catch (SQLException ex) {
                Exceptions.printStackTrace(ex);
        ...
        if (contable.getCobranzas() == 1) {
            genDAO.generarCobranzasItemFais(idControl.getText());
        }
        this.refrescar.doClick();
...
//        this.editaritem.setEnabled(false);
    ...
    private void initComponents() {
        ...
        saldoservicio = new javax.swing.JFormattedTextField();
        pagoservicio = new javax.swing.JFormattedTextField();
        ...
        seleccionpago = new javax.swing.JDialog();
        ...
        itemfactura = new javax.swing.JTextField();
        ...
        NewItem.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.NewItem.text")); // NOI18N
        ...
        Upditem.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.Upditem.text")); // NOI18N
        ...
        DelItem.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.DelItem.text")); // NOI18N
        ...
        jLabel47.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel45.text")); // NOI18N
        ...
        jLabel11.setText("[F1] Seleccionar Cuentas");

        jLabel18.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel18.setText("[F3] Cancelar Cobro");
        ...
        PagoParcial.setTitle("Pago Parcial de Cuentas");
        ...
        nombreservicio.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        nombreservicio.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        ...
        saldoservicio.setEditable(false);
        saldoservicio.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0.00"))));
        saldoservicio.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        saldoservicio.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N

        pagoservicio.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0.00"))));
        pagoservicio.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        pagoservicio.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        pagoservicio.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                pagoservicioFocusGained(evt);
            }
        });
        pagoservicio.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                pagoservicioKeyPressed(evt);
            }
        });
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addGap(21, 21, 21)
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(nombreservicio, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(servicio, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addGap(43, 43, 43)
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(pagoservicio, javax.swing.GroupLayout.DEFAULT_SIZE, 106, Short.MAX_VALUE)
                            .addComponent(saldoservicio))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(saldoservicio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel24))
                .addGap(18, 18, 18)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(pagoservicio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel25))
        ...
        jTBuscarCobrador.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCobrador.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCobrador.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        GrabarRetencion.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.GrabarRetencion.text")); // NOI18N
        ...
        SalirRetencion.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.SalirRetencion.text")); // NOI18N
        ...
        jLabel37.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel33.text")); // NOI18N

        jLabel38.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel34.text")); // NOI18N

        nroretencion.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        nroretencion.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.nroretencion.text")); // NOI18N
        ...
        jLabel39.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel35.text")); // NOI18N

        nrofactura.setEditable(false);
        nrofactura.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        nrofactura.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.sucursalret.text")); // NOI18N

        jLabel40.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel36.text")); // NOI18N

        sucursalret.setEditable(false);
        sucursalret.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        sucursalret.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.sucursalret.text")); // NOI18N

        nombresucursalret.setEditable(false);
        nombresucursalret.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.sucursalret.text")); // NOI18N

        jLabel41.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel37.text")); // NOI18N

        monedaret.setEditable(false);
        monedaret.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        monedaret.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.sucursalret.text")); // NOI18N

        nombremonedaret.setEditable(false);
        nombremonedaret.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.sucursalret.text")); // NOI18N

        jLabel42.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel38.text")); // NOI18N
        ...
        importe_sin_iva.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.importe_sin_iva.text")); // NOI18N

        jLabel43.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel39.text")); // NOI18N
        ...
        importe_iva.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.importe_sin_iva.text")); // NOI18N

        jLabel44.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel40.text")); // NOI18N
        ...
        importe_gravado_total.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.importe_sin_iva.text")); // NOI18N

        jLabel45.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel41.text")); // NOI18N
        ...
        porcentaje_retencion.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.importe_sin_iva.text")); // NOI18N
        ...
        jLabel52.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel52.text")); // NOI18N
        ...
        valor_retencion.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.importe_sin_iva.text")); // NOI18N

        enviarcta.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.enviarcta.text")); // NOI18N

        creferenciaret.setEditable(false);
        creferenciaret.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        creferenciaret.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.creferenciaret.text")); // NOI18N

        jLabel53.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel53.text")); // NOI18N

        clienteret.setEditable(false);
        clienteret.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.clienteret.text")); // NOI18N

        nombreclienteret.setEditable(false);
        nombreclienteret.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.nombreclienteret.text")); // NOI18N
        ...
        jLabel48.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel46.text")); // NOI18N

        jLabel49.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel47.text")); // NOI18N
        ...
        jLabel50.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel48.text")); // NOI18N
        ...
        jLabel51.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel49.text")); // NOI18N

        jLabel54.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jLabel50.text")); // NOI18N
        ...
        grabarPago.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.grabarPago.text")); // NOI18N
        ...
        salirPago.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.salirPago.text")); // NOI18N
        ...
        jTBuscarForma.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarGir1.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirGir1.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarbanco.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCasa.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCasa.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        seleccionpago.setTitle("Cuentas a Cobrar");

        jPanel9.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));

        tablaitem.setModel(modeloitem);
        tablaitem.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tablaitemKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tablaitemKeyReleased(evt);
            }
        });
        jScrollPane8.setViewportView(tablaitem);
        ...
        totalitem.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        totalitem.setEnabled(false);
        totalitem.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N

        jLabel28.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel28.setText("[F1] Seleccionar Cuenta");

        jLabel29.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel29.setText("[F2] Ingresar Pago Parcial");

        jLabel30.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel30.setText("[F3] Seleccionar todas las cuentas");

        jLabel31.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel31.setText("[F4] Cancelar");
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addComponent(totalitem, javax.swing.GroupLayout.PREFERRED_SIZE, 206, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel7)
                            .addComponent(totalitem, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel28)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        itemfactura.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        itemfactura.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        itemfactura.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        itemfactura.setEnabled(false);

        jLabel27.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel27.setText("Seleccione las cuentas a cobrar");
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(itemfactura, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel26)
                    .addComponent(itemfactura, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel27))
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                .addGap(181, 181, 181)
                .addComponent(GrabarItem, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(31, 31, 31)
                .addComponent(SalirItem, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        javax.swing.GroupLayout seleccionpagoLayout = new javax.swing.GroupLayout(seleccionpago.getContentPane());
        seleccionpago.getContentPane().setLayout(seleccionpagoLayout);
        seleccionpagoLayout.setHorizontalGroup(
            seleccionpagoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(seleccionpagoLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(seleccionpagoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel10, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jPanel9, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jPanel12, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        seleccionpagoLayout.setVerticalGroup(
            seleccionpagoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(seleccionpagoLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        Listar.setText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.Listar.text")); // NOI18N
        Listar.setToolTipText(org.openide.util.NbBundle.getMessage(cobros_fais.class, "ventas.Listar.toolTipText")); // NOI18N
        ...
        if (Config.cNivelUsuario.equals("1")) {
            if (!this.idcontrol.getText().isEmpty()) {
                ...
                if (ret == 0) {
                    ...
                    BD.BorrarDetalles("cobrositem", "idpagos='" + this.idcontrol.getText().trim() + "'");
    ...
    private void pagoservicioFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_pagoservicioFocusGained
        this.saldoservicio.selectAll();
        // TODO add your handling code here:
    }//GEN-LAST:event_pagoservicioFocusGained

    private void pagoservicioKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pagoservicioKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.GrabarPagoParcial.requestFocus();
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_pagoservicioKeyPressed
    ...
    private void GrabarPagoParcialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarPagoParcialActionPerformed
        String cImportePago = this.pagoservicio.getText();
        ...
        if (cImportePago.isEmpty() || cImportePago.equals("0")) {
            ...
            this.pagoservicio.requestFocus();
            return;
        }
        this.tablaitem.setValueAt(formatea.format(Double.valueOf(cImportePago)), nFila, 6);
        PagoParcial.dispose();
        this.sumaritem();
        // TODO add your handling code here:
    ...
    private void MostrarItem(String Referencia) {
        int cantidadRegistro = modeloitem.getRowCount();
        for (int i = 1; i <= cantidadRegistro; i++) {
            modeloitem.removeRow(0);
        }

        detalle_ventaDAO itemDAO = new detalle_ventaDAO();
        try {
            for (detalle_venta de : itemDAO.MostrarDetalleCobro(Referencia)) {
                String Datos[] = {formatosinpunto.format(de.getItem()), de.getCodprod().getCodigo(), de.getCodprod().getNombre(), de.getCtadebe().getCodigo(), de.getCtadebe().getNombre(), formatea.format(de.getSaldo()), formatea.format(de.getSupago())};
        ...
        tablaitem.setRowSorter(new TableRowSorter(modeloitem));
        int cantFilas = tablaitem.getRowCount();
    ...
    private void tablacobranzaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablacobranzaKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_F1) {
            ...
            nFilaCobro = this.tablacobranza.getSelectedRow();
            String cRef = (this.tablacobranza.getValueAt(this.tablacobranza.getSelectedRow(), 12).toString());
            this.itemfactura.setText(this.tablacobranza.getValueAt(this.tablacobranza.getSelectedRow(), 1).toString());
            this.MostrarItem(cRef);
            totalitem.setText("0");
            seleccionpago.setSize(709, 503);
            seleccionpago.setLocationRelativeTo(null);
            seleccionpago.setModal(true);
...
//            this.sumarcobros();
    ...
    private void ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) < 3) {
            ...
            if (cob != null) {
                ...
                cantidadRegistro = modeloitem.getRowCount();
                for (int i = 1; i <= cantidadRegistro; i++) {
                    modeloitem.removeRow(0);
                }
                ...
                detalle_ventaDAO itemDAO = new detalle_ventaDAO();
                try {
                    for (detalle_venta de : itemDAO.MostrarDetalleCobroUpdate(idcontrol.getText())) {
                        String Datos[] = {formatosinpunto.format(de.getItem()), de.getCodprod().getCodigo(), de.getCodprod().getNombre(), de.getCtadebe().getCodigo(), de.getCtadebe().getNombre(), formatea.format(de.getSaldo()), formatea.format(de.getSupago())};
                        modeloitem.addRow(Datos);
                    }
                } catch (SQLException ex) {
    ...
    private void SalirItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SalirItemActionPerformed
        String cImportePago = this.totalitem.getText();
        cImportePago = cImportePago.replace(".", "").replace(",", ".");
        this.tablacobranza.setValueAt(formatea.format(Double.valueOf(cImportePago)), nFilaCobro, 7);
        this.sumarcobros();
        seleccionpago.setVisible(false);
        // TODO add your handling code here:
    ...
    public void sumaritem() {
        ...
        double sumpago = 0.00;
        String csupago = "";
        int totalRow = modeloitem.getRowCount();
        totalRow -= 1;
        for (int i = 0; i <= (totalRow); i++) {
            //SUMA EL TOTAL DE CUOTAS COBRADAS
            csupago = String.valueOf(modeloitem.getValueAt(i, 6));
            csupago = csupago.replace(".", "").replace(",", ".");
            supago = Double.parseDouble(String.valueOf(csupago));
            sumpago += supago;
        }
        this.totalitem.setText(formatea.format(sumpago));
        //formato.format(sumatoria1);
    }


    private void tablaitemKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablaitemKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_F1) {
            //SE REEMPLAZA LA CELDA DE PAGO CON EL VALOR A PAGAR
            this.tablaitem.setValueAt(this.tablaitem.getValueAt(this.tablaitem.getSelectedRow(), 5), this.tablaitem.getSelectedRow(), 6);
            this.sumaritem();
        }
        //PAGOPARCIAL
        if (evt.getKeyCode() == KeyEvent.VK_F2) {
            nFila = this.tablaitem.getSelectedRow();
            this.servicio.setText(this.tablaitem.getValueAt(this.tablaitem.getSelectedRow(), 1).toString());
            this.nombreservicio.setText(this.tablaitem.getValueAt(this.tablaitem.getSelectedRow(), 2).toString());
            this.saldoservicio.setText(this.tablaitem.getValueAt(this.tablaitem.getSelectedRow(), 5).toString());
            this.pagoservicio.setText(this.tablaitem.getValueAt(this.tablaitem.getSelectedRow(), 6).toString());
            PagoParcial.setSize(466, 300);
        ...
        if (evt.getKeyCode() == KeyEvent.VK_F3) {
            ...
            this.tablaitem.setValueAt("0", this.tablaitem.getSelectedRow(), 6);
            this.sumaritem();
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_tablaitemKeyPressed

    private void tablaitemKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablaitemKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_tablaitemKeyReleased
    ...
    public void CargarTituloDetalle() {
        ...
        modelodetalle.addColumn("cReferencia");

        int[] anchos = {0, 90, 90, 90, 100, 90, 100, 100, 1, 1, 1, 1, 1};
    ...
    public void CargarTituloItem() {
        modeloitem.addColumn("Id.");
        modeloitem.addColumn("Código");
        modeloitem.addColumn("Nombre Servicio");
        modeloitem.addColumn("Cuenta");
        modeloitem.addColumn("Nombre Cuenta");
        modeloitem.addColumn("Saldo");
        modeloitem.addColumn("Su Pago");

        int[] anchos = {0, 80, 120, 80, 120, 100, 100};
        for (int i = 0; i < modeloitem.getColumnCount(); i++) {
            this.tablaitem.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);
        }
        ((DefaultTableCellRenderer) tablaitem.getTableHeader().getDefaultRenderer()).setHorizontalAlignment(JLabel.CENTER);// Este código es para centrar las cabeceras de la tabla.
        tablaitem.getTableHeader().setFont(new Font("Arial Black", 1, 9));
        ...
        this.tablaitem.getColumnModel().getColumn(0).setCellRenderer(TablaRenderer);
        this.tablaitem.getColumnModel().getColumn(5).setCellRenderer(TablaRenderer);
        this.tablaitem.getColumnModel().getColumn(6).setCellRenderer(TablaRenderer);
        this.tablaitem.getColumnModel().getColumn(0).setMaxWidth(0);
        this.tablaitem.getColumnModel().getColumn(0).setMinWidth(0);
        this.tablaitem.getTableHeader().getColumnModel().getColumn(0).setMaxWidth(0);
        this.tablaitem.getTableHeader().getColumnModel().getColumn(0).setMinWidth(0);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cobros_fais().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField itemfactura;
    ...
    private javax.swing.JFormattedTextField pagoservicio;
    ...
    private javax.swing.JFormattedTextField saldoservicio;
    private javax.swing.JButton salirPago;
    private javax.swing.JDialog seleccionpago;
        ...
        public void run() {
            ...
            try {
                for (cobranza orden : DAO.MostrarxDiaCobro(dFechaInicio, dFechaFinal, 0)) {
                    String Datos[] = {orden.getIdpagos(), formatosinpunto.format(orden.getNumero()), formatoFecha.format(orden.getFecha()), String.valueOf(orden.getCliente().getCodigo()), orden.getCliente().getNombre(), orden.getMoneda().getEtiqueta(), orden.getSucursal().getNombre(), formatea.format(orden.getCotizacionmoneda()), formatea.format(orden.getTotalpago()), formatosinpunto.format(orden.getAsiento()), orden.getCobrador().getNombre(), orden.getCodusuario().getLast_name()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GrillaCuenta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cuenta_clientes co : COBCAJA.MostrarxClienteMonedaRuc(Integer.valueOf(cliente.getText()), Integer.valueOf(moneda.getText()), ruc.getText())) {
                    String Datos[] = {co.getIddocumento(), co.getDocumento(), formatoFecha.format(co.getFecha()), formatoFecha.format(co.getVencimiento()), co.getComprobante().getNombre(), String.valueOf(co.getCuota()) + "/" + String.valueOf(co.getNumerocuota()), formatea.format(co.getSaldo()), formatea.format(nPago), String.valueOf(co.getComprobante().getCodigo()), String.valueOf(co.getNumerocuota()), String.valueOf(co.getCuota()), moneda.getText(), co.getCreferencia()};
