 ...
 * @author hp
 */
public class creditos_salarios_informes extends javax.swing.JFrame {
     ...
     */
    public creditos_salarios_informes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarRubro.setText(org.openide.util.NbBundle.getMessage(creditos_salarios_informes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarRubro.setText(org.openide.util.NbBundle.getMessage(creditos_salarios_informes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirRubro.setText(org.openide.util.NbBundle.getMessage(creditos_salarios_informes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(creditos_salarios_informes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(creditos_salarios_informes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(creditos_salarios_informes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldos.setText("Informe de Créditos al Empleado");
    ...
    private void generarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generarActionPerformed
        ...
        GrillaJornada consulta1 = new GrillaJornada();
    ...
    private class GrillaJornada extends Thread {
        ...
        public void run() {
            ...
            try {
                for (credito_salario cs : csDAO.MostrarxFechaxSuc(FechaI, FechaF, Integer.valueOf(sucursal.getText()))) {
                    String Datos[] = {formato.format(cs.getIdcontrol()), formatoFecha.format(cs.getFecha()), cs.getFuncionario().getNombreempleado(), cs.getConcepto().getNombre(), formato.format(cs.getImporte()), formatoFecha.format(cs.getFechagrabado()), String.valueOf(cs.getIdusuario())};
                    modelo.addRow(Datos);
                }
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            //    parameters.put("cNombreEmpresa", "HORA");
                parameters.put("cSucursal", sucursal.getText());
                parameters.put("FechaI", FechaI);
                parameters.put("FechaF", FechaF);
                JasperReport jr = null;
                URL url = getClass().getClassLoader().getResource("Reports/credito_salarios2.jasper");
