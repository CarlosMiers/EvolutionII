 ...
 *
 */
public class debitosxsalarios extends javax.swing.JFrame {
    ...
    public debitosxsalarios() {
        ...
        GrillaDebito GrillaDB = new GrillaDebito();
        Thread HiloGrilla = new Thread(GrillaDB);
        HiloGrilla.start();
    ...
    private void initComponents() {
        ...
        detalle_debitos = new javax.swing.JDialog();
        ...
        detalle_debitos.setTitle("Actualizar Contrato");
        detalle_debitos.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                detalle_debitosFocusGained(evt);
            }
        });
        detalle_debitos.addWindowFocusListener(new java.awt.event.WindowFocusListener() {
            public void windowGainedFocus(java.awt.event.WindowEvent evt) {
                detalle_debitosWindowGainedFocus(evt);
            }
            public void windowLostFocus(java.awt.event.WindowEvent evt) {
            }
        });
        detalle_debitos.addWindowListener(new java.awt.event.WindowAdapter() {
            public void windowActivated(java.awt.event.WindowEvent evt) {
                detalle_debitosWindowActivated(evt);
            }
        });
        ...
        javax.swing.GroupLayout detalle_debitosLayout = new javax.swing.GroupLayout(detalle_debitos.getContentPane());
        detalle_debitos.getContentPane().setLayout(detalle_debitosLayout);
        detalle_debitosLayout.setHorizontalGroup(
            detalle_debitosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(detalle_debitosLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(detalle_debitosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        detalle_debitosLayout.setVerticalGroup(
            detalle_debitosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, detalle_debitosLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(detalle_debitosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Grabar)
                    .addComponent(Salir)))
        );
        ...
        jTBuscarConcepto.setText(org.openide.util.NbBundle.getMessage(debitosxsalarios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarConcepto.setText(org.openide.util.NbBundle.getMessage(debitosxsalarios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirConcepto.setText(org.openide.util.NbBundle.getMessage(debitosxsalarios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarFicha.setText(org.openide.util.NbBundle.getMessage(debitosxsalarios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarFuncionario.setText(org.openide.util.NbBundle.getMessage(debitosxsalarios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirFuncionario.setText(org.openide.util.NbBundle.getMessage(debitosxsalarios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetacredito.setText("Descuentos Salariales");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(debitosxsalarios.class, "libroventaconsolidado.jPanel2.border.title"))); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(debitosxsalarios.class, "libroventaconsolidado.jLabel1.text")); // NOI18N

        jLabel8.setText(org.openide.util.NbBundle.getMessage(debitosxsalarios.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
    ...
    private void AgregarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        idControl.setText("0");
        this.limpiar();
        detalle_debitos.setModal(true);
        detalle_debitos.setSize(450, 393);
        //Establecemos un título para el jDialog
        detalle_debitos.setTitle("Agregar Nuevo Débito Salarial");
        detalle_debitos.setLocationRelativeTo(null);
        detalle_debitos.setVisible(true);
    ...
    private void ModificarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) < 3) {
            ...
            debito_salarioDAO dsDAO = new debito_salarioDAO();
            debito_salario ds = null;
            try {
                ds = dsDAO.buscarId(Integer.valueOf(this.idcontrol.getText()));
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR:" + e.getMessage());
            }
            if (ds != null) {
                idcontrol.setText(sinformato.format(ds.getIdcontrol()));
                funcionario.setText(String.valueOf(ds.getFuncionario().getCodigo()));
                nombrefuncionario.setText(String.valueOf(ds.getFuncionario().getNombreempleado()));
                direccionfuncionario.setText(String.valueOf(ds.getFuncionario().getDireccion()));
                fechaemision.setDate(ds.getFecha());
                concepto.setText(String.valueOf(ds.getConcepto().getCodigo()));
                nombreconcepto.setText(String.valueOf(ds.getConcepto().getNombre()));
                tipoconcepto.setText(String.valueOf(ds.getConcepto().getTipo()));
                importe.setText(formatea.format(ds.getImporte()));
                observacion.setText(ds.getObservacion());

                detalle_debitos.setModal(true);
                //(Ancho,Alto)
                detalle_debitos.setSize(450, 393);
                //Establecemos un título para el jDialog
                detalle_debitos.setTitle("Modificar Datos de Débitos Salarios");
                detalle_debitos.setLocationRelativeTo(null);
                detalle_debitos.setVisible(true);
    ...
    private void EliminarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        if (Config.cNivelUsuario.equals("1")) {
            ...
            if (ret == 0) {
                ...
                try {
                    debito_salario db = dbDAO.buscarId(Integer.valueOf(num));
                    if (db == null) {
                        JOptionPane.showMessageDialog(null, "Registro no Existe");
                    } else {
                        dbDAO.EliminarDebito(db.getIdcontrol());
    ...
    private void GrabarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (ret == 0) {
            debito_salarioDAO grabar = new debito_salarioDAO();
            debito_salario db = new debito_salario();
            ...
            if (Integer.valueOf(idcontrol.getText()) > 0) {
                db.setIdcontrol(Integer.valueOf(idcontrol.getText()));
            ...
            db.setFecha(dFecha);
            db.setFechagrabado(dFechaGrabado);
            db.setObservacion(observacion.getText());
            db.setFuncionario(fi);
            db.setGiraduria(fi.getGiraduria().getCodigo());
            db.setConcepto(cs);
            ...
            db.setImporte(impor);
            db.setIdusuario(Integer.valueOf(Config.CodUsuario));

            if (Integer.valueOf(this.idcontrol.getText()) == 0) {
                try {
                    grabar.InsertarDebito(db);
            ...
            GrillaDebito GrillaGB = new GrillaDebito();
        ...
        if (ret == 0) {
            ...
            GrillaDebito GrillaOC = new GrillaDebito();
            Thread HiloGrilla = new Thread(GrillaOC);
            HiloGrilla.start();
        }*/
    }//GEN-LAST:event_GrabarActionPerformed

    private void detalle_debitosFocusGained(FocusEvent evt) {//GEN-FIRST:event_detalle_debitosFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_debitosFocusGained

    private void detalle_debitosWindowGainedFocus(WindowEvent evt) {//GEN-FIRST:event_detalle_debitosWindowGainedFocus
        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_debitosWindowGainedFocus

    private void detalle_debitosWindowActivated(WindowEvent evt) {//GEN-FIRST:event_detalle_debitosWindowActivated

        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_debitosWindowActivated
    ...
    private void BuscarConceptoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarConceptoActionPerformed
        ...
        concepto_salario cs = null;
        try {
            cs = csDAO.buscarIdxTipo(Integer.valueOf(this.concepto.getText()), "EGRESOS");
            if (cs.getCodigo() == 0) {
    ...
    private javax.swing.JDialog detalle_debitos;
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/descuentos_salarios.jasper");
    ...
    private class GrillaDebito extends Thread {
        ...
        public void run() {
            ...
            debito_salarioDAO dbDAO = new debito_salarioDAO();
            try {
                for (debito_salario db : dbDAO.MostrarxFecha(FechaI, FechaF)) {
                    String Datos[] = {sinformato.format(db.getIdcontrol()), formatoFecha.format(db.getFecha()), db.getFuncionario().getNombreempleado(), db.getConcepto().getNombre(), formatea.format(db.getImporte()), formatoFecha.format(db.getFechagrabado()), String.valueOf(db.getIdusuario())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException ex) {
                Exceptions.printStackTrace(ex);
    ...
    private class GenerarConsultaDebito extends Thread {
        ...
        public void run() {
            ...
            try {
                for (debito_salario db : dbDAO.MostrarxFecha(FechaI, FechaF)) {
                    String Datos[] = {sinformato.format(db.getIdcontrol()), formatoFecha.format(db.getFecha()), db.getFuncionario().getNombres(), db.getConcepto().getNombre(), formatea.format(db.getImporte()), formatoFecha.format(db.getFechagrabado()), String.valueOf(db.getIdusuario())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GrillaConcepto extends Thread {
        ...
        public void run() {
            ...
            try {
                for (concepto_salario cs : DAOCS.TodoxTipo("EGRESOS")) {
