 ...
 * @author One
 */
public class deducciones_dd extends javax.swing.JFrame {
     ...
     */
    public deducciones_dd(String cCliente, String cMoneda, String cNumeroControl) {
        initComponents();
    ...
    private void jButtonElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonElegirActionPerformed
        ...
        try {
            ...
            try {
                stm.executeUpdate("DELETE FROM deducciones_descuentos WHERE ndescuento=" + this.cNumeroControl.getText());
                ...
                for (int i = 0; i < Items; i++) {
                    ...
                    if (cPago.length() > 1) {
                        String cSqlDet = "INSERT INTO deducciones_descuentos(ndescuento,idfactura,documento,emision,concepto,cuota,numerocuota,vencimiento,supago,amortiza,minteres,saldo,capital,mora,gastos_cobranzas,acreedor)";
                        ...
                        cSqlDet += cMora + "','" + cGastos + "','" + cAcreedor + "')";
...
//             setText(String.valueOf(jTable1.getValueAt(fila, 8)));
    ...
    private void cargarTabla(String sql) {
        ...
        stm = con.conectar();
        ResultSet results = null;
        int[] anchos = {5, 80, 80, 80, 60, 60, 80, 80, 80, 80, 80, 80, 80, 80, 80, 50, 50};
        ...
        try {
            ...
            while (results.next()) {
                ...
                Object[] fila = new Object[17]; // Hay 8 columnas en la tabla
