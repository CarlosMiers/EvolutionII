...
public class departamentos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelMetric1.setText("Departamentos");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("departamento_laboral", "nombre", "'" + this.jTextField2.getText() + "'");
        } else {
            BD.actualizarRegistro("departamento_laboral", "nombre ='" + this.jTextField2.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM departamento_laboral ORDER BY codigo");
        this.jTextField2.setText("");
