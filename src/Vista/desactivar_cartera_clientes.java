 ...
 * @author hp
 */
public class desactivar_cartera_clientes extends javax.swing.JFrame {
     ...
     */
    public desactivar_cartera_clientes() {
        initComponents();
    ...
    private void cargarTituloTabla() {
        ...
        int[] anchos = {100, 100, 100, 100, 100, 100, 150, 100, 100, 100, 100, 100, 100, 100, 100, 100, 150, 100};
    ...
    private void initComponents() {
        ...
        setTitle("Inactivar Cartera de Cliente");
        ...
        etiquetasaldos.setText("Inactivar Cartera de Clientes");
        ...
        btnEliminar.setToolTipText("Vista Previa");
        ...
        btndesactivar.setToolTipText("Vista Previa");
        ...
        panelTranslucido2Layout.setHorizontalGroup(
            ...
            .addGroup(panelTranslucido2Layout.createSequentialGroup()
                ...
                .addGroup(panelTranslucido2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(btndesactivar, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        int nFila = cartera.getSelectedRow();
        String cReferencia = cartera.getValueAt(nFila, 17).toString();
        System.out.println("REFERENCIA "+cReferencia);
        if (nFila < 0) {
            JOptionPane.showMessageDialog(null, "Debe Seleccionar un Registro");
            this.cartera.requestFocus();
            return;
        }

        Object[] opciones = {"   Si   ", "   No   "};
        int ret = JOptionPane.showOptionDialog(null, "Desea Eliminar esta Cartera ? ", "Confirmación", 0, 3, null, opciones, opciones[0]);
        if (ret == 0) {
            String cTipo = cartera.getValueAt(nFila, 15).toString();
            cartera_clientesDAO caDAO = new cartera_clientesDAO();
            cuponesDAO cuDAO = new cuponesDAO();
            try {
                if (cTipo.equals("CP")) {
                    System.out.println("ENTRE EN CUPONES");
                    cuDAO.EliminarCupones(cReferencia);
                } else {
                    System.out.println("ENTRE EN TITULOS");
                    caDAO.EliminarCartera(cReferencia);
                }
    ...
    private void btndesactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndesactivarActionPerformed
        ...
        System.out.println("REFERENCIA "+cReferencia);
        Object[] opciones = {"   Si   ", "   No   "};
        int ret = JOptionPane.showOptionDialog(null, "Desea Desactivar esta Cartera ? ", "Confirmación", 0, 3, null, opciones, opciones[0]);
        if (ret == 0) {
            String cTipo = cartera.getValueAt(nFila, 15).toString();
            cartera_clientesDAO caDAO = new cartera_clientesDAO();
            cuponesDAO cuDAO = new cuponesDAO();
            try {
                if (cTipo.equals("CP")) {
                    System.out.println("ENTRE EN CUPONES");
                    cuDAO.ActualizarEstadoCupones(cReferencia);
                } else {
                    System.out.println("ENTRE EN TITULOS");
                    caDAO.ActualizarEstadoCartera(0,cReferencia);
                }
            } catch (SQLException ex) {
                Exceptions.printStackTrace(ex);
            }
    ...
    private class ConsultaVenceEmisor extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cartera_clientes cart : DAO.MostrarxVencimientoClientePrincipalCuponesTodos(nCliente, nMoneda, FechaI, FechaF)) {
                    String Datos[] = {formatosinpunto.format(cart.getNumero()),
