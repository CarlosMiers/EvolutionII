 ...
 * @author hp
 */
public class descuentos_informes extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        modelo.addColumn("Motivo del Descuento");
    ...
    private void initComponents() {
        ...
        jTBuscarRubro.setText(org.openide.util.NbBundle.getMessage(descuentos_informes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarRubro.setText(org.openide.util.NbBundle.getMessage(descuentos_informes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirRubro.setText(org.openide.util.NbBundle.getMessage(descuentos_informes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(descuentos_informes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(descuentos_informes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(descuentos_informes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldos.setText("Informe de Descuentos Salariales");
    ...
    private class GrillaDescuento extends Thread {
        ...
        public void run() {
            ...
            debito_salarioDAO dbDAO = new debito_salarioDAO();
            try {
                for (debito_salario db : dbDAO.MostrarxFechaxSuc(FechaI, FechaF,Integer.valueOf(sucursal.getText()))) {
                    String Datos[] = {formato.format(db.getIdcontrol()), formatoFecha.format(db.getFecha()), db.getFuncionario().getNombres(), db.getConcepto().getNombre(), formato.format(db.getImporte()), formatoFecha.format(db.getFechagrabado()), String.valueOf(db.getIdusuario())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/debitos_sucursal.jasper");
