 ...
 * @author MEC
 */
public class detalle_clientes extends javax.swing.JFrame {
    ...
    Tablas modelolaboral = new Tablas();
    ...
    public detalle_clientes(String Opcion) throws ParseException {
        initComponents();
    ...
    private void initComponents() {
        ...
        programa = new javax.swing.JCheckBox();
        ...
        jLabel11.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel11.text")); // NOI18N
        ...
        jLabel7.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jLabel7.text")); // NOI18N

        jPanel1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel1.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jLabel1.text")); // NOI18N

        codigo.setEditable(false);
        codigo.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jTextCodigo.text")); // NOI18N
        ...
        jTextnombre.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jTextnombre.text")); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jLabel2.text")); // NOI18N
        ...
        jLabel25.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel25.text")); // NOI18N

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 0, 0));
        jLabel3.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jLabel3.text")); // NOI18N

        ruc.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jTextcedula.text")); // NOI18N
        ...
        jTextControl.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jTextControl.text")); // NOI18N
        ...
        jLabel4.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jLabel4.text")); // NOI18N

        jLabel44.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel44.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel44.text_1")); // NOI18N

        cedula.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.cedula.text")); // NOI18N
        ...
        jTextConyugue.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jTextConyugue.text")); // NOI18N
        ...
        jLabel5.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel5.text")); // NOI18N
        ...
        jLabel6.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel6.text")); // NOI18N

        jLabel24.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel24.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel24.text")); // NOI18N
        ...
        jLabel42.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel42.text")); // NOI18N
        ...
        mail.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jTextmail.text")); // NOI18N
        ...
        jLabel45.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel45.text_1")); // NOI18N

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 0, 0));
        jLabel8.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jLabel8.text")); // NOI18N

        jTextDireccion.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jTextDireccion.text")); // NOI18N
        ...
        jLabel9.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jLabel9.text")); // NOI18N

        jTextFono.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jTextFono.text")); // NOI18N
        ...
        jLabel10.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jLabel10.text")); // NOI18N

        jTextCelular.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jTextCelular.text")); // NOI18N
        ...
        jLabel12.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jLabel12.text")); // NOI18N
        ...
        jLabel30.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel30.text")); // NOI18N

        jLabel32.setForeground(new java.awt.Color(0, 51, 255));
        jLabel32.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel32.text")); // NOI18N
        ...
        jLabel35.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel35.text")); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addComponent(estadocivil, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(jLabel35)
                                    .addGap(18, 18, 18)
                                    .addComponent(sexo, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(92, 92, 92))))))
                .addGap(321, 321, 321))
        );
        ...
        Panel1Clientes.addTab(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jPanel1.TabConstraints.tabTitle"), DatosGenerales); // NOI18N

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jPanel4.border.title"))); // NOI18N

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 0, 0));
        jLabel13.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel13.text")); // NOI18N

        jTextProfesion.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jTextProfesion.text")); // NOI18N
        ...
        jLabel14.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel14.text")); // NOI18N

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 0, 0));
        jLabel15.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel15.text")); // NOI18N

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel16.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel16.text")); // NOI18N

        jLabel17.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 0, 0));
        jLabel17.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel17.text")); // NOI18N

        jLabel18.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(255, 0, 0));
        jLabel18.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel18.text")); // NOI18N

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel19.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel19.text")); // NOI18N

        jLabel20.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel20.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel20.text")); // NOI18N

        jLabel21.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel21.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel21.text")); // NOI18N

        jLabel22.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel22.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel22.text")); // NOI18N

        jLabel23.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel23.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel23.text")); // NOI18N

        jTextLugarTrabajo.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jTextLugarTrabajo.text")); // NOI18N
        ...
        jTextCargoqueOcupa.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jTextCargoqueOcupa.text")); // NOI18N
        ...
        jTextDireccionLaboral.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jTextDireccionLaboral.text")); // NOI18N
        ...
        jTextTelefonoLaboral.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jTextTelefonoLaboral.text")); // NOI18N
        ...
        jTextFaxLaboral.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jTextFaxLaboral.text")); // NOI18N
        ...
        jTextMailLaboral.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jTextMailLaboral.text")); // NOI18N
        ...
        Salario.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.Salario.text")); // NOI18N
        ...
        SalarioConyugue.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.SalarioConyugue.text")); // NOI18N
        SalarioConyugue.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter()));

        otrosIngresos.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.otrosIngresos.text")); // NOI18N
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jPanel5.border.title"))); // NOI18N
        ...
        jLabel26.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel26.text")); // NOI18N

        LimiteCredito.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.LimiteCredito.text")); // NOI18N
        ...
        jLabel27.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel27.text")); // NOI18N
        ...
        jLabel28.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel28.text")); // NOI18N

        jLabel29.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel29.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel29.text")); // NOI18N
        ...
        jLabel31.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel31.text")); // NOI18N
        ...
        jLabel33.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel33.text")); // NOI18N

        jLabel34.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel34.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel34.text")); // NOI18N

        plazocredito.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        plazocredito.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.plazocredito.text")); // NOI18N
        ...
        programa.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.programa.text")); // NOI18N
        ...
        jPanel4.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jPanel4.AccessibleContext.accessibleName")); // NOI18N

        Panel1Clientes.addTab(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jPanel2.TabConstraints.tabTitle"), DatosLaborales); // NOI18N

        Referencias.setToolTipText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.Referencias.toolTipText")); // NOI18N

        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jPanel6.border.title"))); // NOI18N

        tablalaboral.setModel(modelolaboral);
        tablalaboral.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tablalaboralMousePressed(evt);
            }
        });
        tablalaboral.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tablalaboralKeyReleased(evt);
            }
        });
        ...
        referencialugartrabajo.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.referencialugartrabajo.text")); // NOI18N
        ...
        referenciafonolaboral.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.referenciafonolaboral.text")); // NOI18N

        etiqueta1.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.etiqueta1.text")); // NOI18N

        etiqueta2.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.etiqueta2.text")); // NOI18N

        GrabarRefLaboral.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.GrabarRefLaboral.text")); // NOI18N
        ...
        DelRefLaboral.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.DelRefLaboral.text")); // NOI18N
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jPanel7.border.title"))); // NOI18N
        ...
        referenciacomercio.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.referenciacomercio.text")); // NOI18N
        ...
        referenciafonocomercial.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.referenciafonocomercial.text")); // NOI18N

        GrabarRefComercial.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.GrabarRefComercial.text")); // NOI18N
        ...
        BorrarRefComercial.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.BorrarRefComercial.text")); // NOI18N
        ...
        jLabel46.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel46.text")); // NOI18N

        jLabel47.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jLabel47.text")); // NOI18N
        ...
        Panel1Clientes.addTab(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.Referencias.TabConstraints.tabTitle"), Referencias); // NOI18N

        jPanel10.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));

        BotonAbriArchivo.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.BotonAbriArchivo.text")); // NOI18N
        ...
        etiqueta.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.etiqueta.text")); // NOI18N

        GuardarArchivo.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.GuardarArchivo.text")); // NOI18N
        ...
        jButton3.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jButton3.text")); // NOI18N
        ...
        jButton4.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.jButton4.text")); // NOI18N
        ...
        Panel1Clientes.addTab(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_clientes.PanelImagenes.TabConstraints.tabTitle"), PanelImagenes); // NOI18N
        ...
        jButton1.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jButton1.text")); // NOI18N
        ...
        jButton2.setText(org.openide.util.NbBundle.getMessage(detalle_clientes.class, "detalle_asesores.jButton2.text")); // NOI18N
    ...
    private void CargarReferenciaLaboral() {
        modelolaboral.addColumn("Id");
        modelolaboral.addColumn("Lugar de Trabajo");
        modelolaboral.addColumn("Fono");
        int[] anchos = {70, 200, 100};
        for (int i = 0; i < modelolaboral.getColumnCount(); i++) {
    ...
    public void consultarTabla(String campoclave) {
        ...
        if (cl != null) {
            ...
            this.estadocivil.setSelectedItem(cl.getEstadocivil());
            ...
            this.sexo.setSelectedIndex(cl.getSexo()-1);
            if (cl.getPrograma() == 1) {
                programa.setSelected(true);
            } else {
                programa.setSelected(false);
            }
...
// TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int nprograma = 0;
        if (programa.isSelected()) {
            nprograma = 1;
        }
        int nsexo=this.sexo.getSelectedIndex()+1;
        String cParametro = this.jTextControl.getText();
        String cLetra = "new";
        if (cParametro.equals(cLetra)) {
            if (this.codigo.getText().trim().length() <= 1) {
                BD.insertarRegistro("clientes", "nombre,cedula,ruc,fechanacimiento,estadocivil,conyugue,direccion,telefono,celular,mail,estado,categoria,localidad,salario,salarioconyugue,otrosingresos,profesion,lugartrabajo,cargolaboral,direccionlaboral,fechaingreso,telefonolaboral,faxlaboral,maillaboral,limitecredito,casapropia,autopropio,informconf,asesor,notas,barrio,plazocredito,programa,sexo", "'" + this.jTextnombre.getText() + "','" + this.cedula.getText() + "','" + this.ruc.getText() + "','" + FechaNac + "','" + this.estadocivil.getSelectedItem() + "','" + this.jTextConyugue.getText() + "','" + this.jTextDireccion.getText() + "','" + this.jTextFono.getText() + "','" + this.jTextCelular.getText() + "','" + this.mail.getText() + "','" + this.jComboEstado.getSelectedIndex() + "','" + Categoria + "','" + Localidad + "','" + salario + "','" + salarioconyugue + "','" + otrosingresos + "','" + this.jTextProfesion.getText() + "','" + this.jTextLugarTrabajo.getText() + "','" + this.jTextCargoqueOcupa.getText() + "','" + this.jTextDireccionLaboral.getText() + "','" + dFechaIngreso + "','" + this.jTextTelefonoLaboral.getText() + "','" + this.jTextFaxLaboral.getText() + "','" + this.jTextMailLaboral.getText() + "','" + limitecredito + "','" + this.jComboCasaPropia.getSelectedIndex() + "','" + this.jComboAuto.getSelectedIndex() + "','" + this.jComboInfor.getSelectedIndex() + "','" + asesor + "','" + this.observaciones.getText().trim() + "','" + barrio + "','" + this.plazocredito.getText()+ "','" + nprograma+"','"+nsexo  + "'");
            } else {
                BD.insertarRegistro("clientes", "codigo,nombre,ruc,fechanacimiento,estadocivil,conyugue,direccion,telefono,celular,mail,estado,categoria,localidad,salario,salarioconyugue,otrosingresos,profesion,lugartrabajo,cargolaboral,direccionlaboral,fechaingreso,telefonolaboral,faxlaboral,maillaboral,limitecredito,casapropia,autopropio,informconf,asesor,notas,barrio,plazocredito,programa,sexo", "'" + this.codigo.getText() + "','" + this.jTextnombre.getText() + "','" + this.ruc.getText() + "','" + FechaNac + "','" + this.estadocivil.getSelectedItem() + "','" + this.jTextConyugue.getText() + "','" + this.jTextDireccion.getText() + "','" + this.jTextFono.getText() + "','" + this.jTextCelular.getText() + "','" + this.mail.getText() + "','" + this.jComboEstado.getSelectedIndex() + "','" + Categoria + "','" + Localidad + "','" + salario + "','" + salarioconyugue + "','" + otrosingresos + "','" + this.jTextProfesion.getText() + "','" + this.jTextLugarTrabajo.getText() + "','" + this.jTextCargoqueOcupa.getText() + "','" + this.jTextDireccionLaboral.getText() + "','" + dFechaIngreso + "','" + this.jTextTelefonoLaboral.getText() + "','" + this.jTextFaxLaboral.getText() + "','" + this.jTextMailLaboral.getText() + "','" + limitecredito + "','" + this.jComboCasaPropia.getSelectedIndex() + "','" + this.jComboAuto.getSelectedIndex() + "','" + this.jComboInfor.getSelectedIndex() + "','" + asesor + "','" + this.observaciones.getText().trim() + "','" + barrio + "','" + this.plazocredito.getText()+ "','" + nprograma+"','"+nsexo  + "'");
            }
        } else {
            BD.actualizarRegistro("clientes", " nombre='" + this.jTextnombre.getText() + "',cedula='" + this.cedula.getText() + "',plazocredito='" + plazocredito.getText() + "',ruc='" + this.ruc.getText() + "',fechanacimiento='" + FechaNac + "',estadocivil='" + this.estadocivil.getSelectedItem() + "',conyugue='" + this.jTextConyugue.getText() + "',direccion='" + this.jTextDireccion.getText().trim() + "',telefono='" + this.jTextFono.getText().trim() + "',celular='" + this.jTextCelular.getText() + "',mail='" + this.mail.getText() + "',estado ='" + this.jComboEstado.getSelectedIndex() + "',localidad ='" + Localidad + "',categoria ='" + Categoria + "',salario ='" + salario + "',salarioconyugue ='" + salarioconyugue + "',otrosingresos ='" + otrosingresos + "',profesion= '" + this.jTextProfesion.getText() + "',lugartrabajo='" + this.jTextLugarTrabajo.getText() + "',cargolaboral='" + this.jTextCargoqueOcupa.getText() + "',direccionlaboral='" + this.jTextDireccionLaboral.getText() + "',fechaingreso='" + dFechaIngreso + "',telefonolaboral='" + this.jTextTelefonoLaboral.getText() + "',faxlaboral= '" + this.jTextFaxLaboral.getText() + "',maillaboral='" + this.jTextMailLaboral.getText() + "',limitecredito='" + limitecredito + "',casapropia='" + this.jComboCasaPropia.getSelectedIndex() + "',autopropio='" + this.jComboAuto.getSelectedIndex() + "',informconf='" + this.jComboInfor.getSelectedIndex() + "',asesor='" + asesor + "',barrio='" + barrio + "',programa='" + nprograma + "',notas ='" + this.observaciones.getText().trim()+ "',sexo='"+nsexo + "'", "codigo= " + this.codigo.getText());
        }
        this.dispose();
    ...
    private void tablalaboralKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablalaboralKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_tablalaboralKeyReleased

    private void tablalaboralMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalaboralMousePressed
    }//GEN-LAST:event_tablalaboralMousePressed
    ...
    private void sexoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sexoKeyReleased
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.jTextConyugue.requestFocus();
        }
        if (evt.getKeyCode() == KeyEvent.VK_UP) {
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_sexoKeyReleased
    ...
    private javax.swing.JCheckBox programa;
        ...
        public void run() {
            ...
            try {
                for (referencia_laboral l : LabDAO.muestrarefxcliente(Integer.valueOf(codigo.getText()))) {
                    ...
                    modelolaboral.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
            }

            tablalaboral.setRowSorter(new TableRowSorter(modelolaboral));
