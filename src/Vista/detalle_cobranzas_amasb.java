 ...
 * @author hp
 */
public class detalle_cobranzas_amasb extends javax.swing.JFrame {
    ...
    public detalle_cobranzas_amasb(String cOpcion) {
        initComponents();
    ...
    EmitirRecibo EmitirRecibo = new EmitirRecibo();
    ...
    private void Titulo() {
        ...
        int[] anchos = {1, 60, 120, 120, 40, 40, 80, 80, 80, 80, 80, 80, 80, 80, 80, 90, 30, 50, 80, 80};
    ...
    private void initComponents() {
        ...
        jTBuscarCobrador.setText(org.openide.util.NbBundle.getMessage(detalle_cobranzas_amasb.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCobrador.setText(org.openide.util.NbBundle.getMessage(detalle_cobranzas_amasb.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCobrador.setText(org.openide.util.NbBundle.getMessage(detalle_cobranzas_amasb.class, "ventas.SalirCliente.text")); // NOI18N
...
//                new detalle_cobranzas().setVisible(true);
    ...
    public class GuardarCobranza extends Thread {
        ...
        public void run() {
            ...
            cob.setObservacion("Cobranzas s/Recibo " + nrorecibo.getText().trim());
    ...
    public class CargarSaldos extends Thread {
        ...
        public void run() {
            ...
            cSql = cSql + "cuenta_clientes.capital,cuenta_clientes.minteres,cuenta_clientes.amortiza,cuenta_clientes.vencimiento,cuenta_clientes.giraduria,cuenta_clientes.comprobante,cuenta_clientes.fecha_pago,";
            cSql = cSql + "cuenta_clientes.importe,cuenta_clientes.cliente,cuenta_clientes.saldo,cuenta_clientes.tasaoperativa,cuenta_clientes.inversionista,";
            cSql = cSql + "cuenta_clientes.importe_iva,cuenta_clientes.autorizacion,cuenta_clientes.nrocuenta,cuenta_clientes.cuota,cuenta_clientes.numerocuota,";
            cSql = cSql + "clientes.categoria,clientes.asesor,clientes.nombre as nombrecliente,DATEDIFF('" + FechaProceso + "',cuenta_clientes.vencimiento) AS atraso,";
            cSql = cSql + "clientes.celular, clientes.direccion, clientes.mail,comprobantes.nombre as nombrecomprobante,comprobantes.nomalias,DATEDIFF('" + FechaProceso + "',cuenta_clientes.fecha_pago) AS di,";
            ...
            try {
                ...
                while (results.next()) {
                    ...
                    fila[14] = formatosinpunto.format(results.getDouble("inversionista"));
    ...
    private class EmitirRecibo extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                //en el reporte
                System.out.println("id " + idControl.getText());
