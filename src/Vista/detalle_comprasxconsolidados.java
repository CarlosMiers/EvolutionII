...
import Modelo.Detallecomprasxconsolidado;
 ...
 * @author hp
 */
public class detalle_comprasxconsolidados extends javax.swing.JFrame {
     ...
     */
    public detalle_comprasxconsolidados() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {120, 160, 300, 120, 100, 100, 220, 100, 120, 300};
    ...
    private void initComponents() {
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxconsolidados.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxconsolidados.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxconsolidados.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxconsolidados.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxconsolidados.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxconsolidados.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Detalles de Compras Consolidado ");
        ...
        etiquetasaldos.setText("Detalles de Compras Consolidado");
    ...
    private class GenerarConsultaVenta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cabecera_compra com : DAO.DetalleCompraxSucursal(FechaI, FechaF, nSucursal, nSucursal, nMoneda)) {
                    String Datos[] = {formatosinpunto.format(com.getNrofactura()),com.getCodprodcompra(), com.getNombreproductocompra(), formato.format(com.getCantidadcompra()), formato.format(com.getPreciocompra()), formato.format(com.getTotalneto()),com.getNombreproveedor(), formatoFecha.format(com.getFecha()), String.valueOf(com.getSucursal().getCodigo()), com.getSucursal().getNombre()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            Detallecomprasxconsolidado tipo;
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                tipo = new Detallecomprasxconsolidado(jTable1.getValueAt(nFila, 0).toString(),jTable1.getValueAt(nFila, 7).toString(), jTable1.getValueAt(nFila, 1).toString(), jTable1.getValueAt(nFila, 2).toString(), Double.valueOf(cCantidad), Double.valueOf(cPrecio), Double.valueOf(cTotal), Integer.valueOf(jTable1.getValueAt(nFila, 8).toString()), jTable1.getValueAt(nFila, 9).toString(),jTable1.getValueAt(nFila, 6).toString());
                Resultados.add(tipo);
                ...
                System.out.println(tipo.getNombreproveedor());
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/detalle_comprasconsolidado.jasper");
