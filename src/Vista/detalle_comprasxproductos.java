...
import Modelo.Detallecomprasxproductos;
 ...
 * @author hp
 */
public class detalle_comprasxproductos extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltroproducto, trsfiltromoneda;
     ...
     */
    public detalle_comprasxproductos() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        modelo.addColumn("Descripción");
        int[] anchos = {120, 140, 300, 120, 100, 100, 100, 220, 100, 150, 250, 150, 250};
    ...
    private void TitProducto() {
        ...
        tablaproducto.getTableHeader().setFont(new Font("Arial Black", 1, 10));
        ...
        DefaultTableCellRenderer TablaRenderer = new DefaultTableCellRenderer();
        TablaRenderer.setHorizontalAlignment(SwingConstants.RIGHT); // aqui defines donde alinear 
        this.tablaproducto.getColumnModel().getColumn(0).setCellRenderer(TablaRenderer);
    }
    ...
    private void Inicializar() {
        ...
        this.producto.setText("");
        this.nombreproducto.setText("Todos los productos");
        this.moneda.setText("0");
        this.nombremoneda.setText("");
    }
    ...
    private void initComponents() {
        ...
        jTBuscarproducto.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxproductos.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarProducto.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxproductos.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirProducto.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxproductos.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxproductos.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxproductos.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxproductos.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Detalles de Compras por Productos");
        ...
        etiquetasaldos.setText("Detalles de Compras por Productos ");
        ...
        nombreproducto.setDisabledTextColor(new java.awt.Color(0, 0, 0));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(producto, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(buscarProducto, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(64, 64, 64))
    ...
    private void productoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_productoKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.jTBuscarproducto.requestFocus();
        }
        // TODO add your handling code here:
    ...
    private void buscarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarProductoActionPerformed
        if (producto.getText().equals("")) {
            producto.setText("");
            nombreproducto.setText("Todos los productos");
            moneda.requestFocus();
        } else {
            ...
            try {
                ...
                if (pro.getCodigo() == null) {
                    GrillaProducto grillapro = new GrillaProducto();
                    ...
                    BProducto.setTitle("Buscar Productos");
    ...
    private class GenerarConsultaCompra extends Thread {
        ...
        public void run() {
            String nProducto = String.valueOf(producto.getText());
            ...
            try {
                for (cabecera_compra com : DAO.DetalleCompraxProducto(FechaI, FechaF, nProducto, nMoneda)) {
                    String Datos[] = {formatosinpunto.format(com.getNrofactura()), com.getCodprodcompra(), com.getNombreproductocompra(), formato.format(com.getCantidadcompra()), formato.format(com.getPreciocompra()), formato.format(com.getTotalneto()), String.valueOf(com.getCodrubrocompra()), com.getNombrerubrocompra(), formatoFecha.format(com.getFecha()), String.valueOf(com.getProveedor().getCodigo()), com.getProveedor().getNombre(), String.valueOf(com.getCodmarca()), com.getNombremarca()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GrillaProducto extends Thread {
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                tipo = new Detallecomprasxproductos(jTable1.getValueAt(nFila, 0).toString(), jTable1.getValueAt(nFila, 8).toString(), jTable1.getValueAt(nFila, 1).toString(),jTable1.getValueAt(nFila, 2).toString(), Double.valueOf(cCantidad), Double.valueOf(cPrecio), Double.valueOf(cTotal), jTable1.getValueAt(nFila, 10).toString(), Integer.valueOf(jTable1.getValueAt(nFila, 11).toString()), jTable1.getValueAt(nFila, 12).toString());
                Resultados.add(tipo);
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/detalle_comprasxproducto.jasper");
