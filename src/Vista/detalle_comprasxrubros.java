...
import DAO.rubroDAO;
import Modelo.Detallecomprasxrubro;
 ...
 * @author hp
 */
public class detalle_comprasxrubros extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltrorubro, trsfiltromoneda;
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {120, 130, 300, 120, 80, 100,100, 220, 100, 220};
    ...
    private void initComponents() {
        ...
        jTBuscarRubro.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxrubros.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarRubro.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxrubros.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirVendedor.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxrubros.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxrubros.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxrubros.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_comprasxrubros.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Detalles de Compras por Rubros");
        ...
        etiquetasaldos.setText("Detalles de Compras por Rubros");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(nombrerubro, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(27, 27, 27))
        );
    ...
    private void jTBuscarRubroKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTBuscarRubroKeyPressed
        this.jTBuscarRubro.addKeyListener(new KeyAdapter() {
            public void keyReleased(final KeyEvent e) {
                ...
                repaint();
                filtrosrubro(indiceColumnaTabla);
            }
        });
    ...
    private void buscarRubroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarRubroActionPerformed
        if (rubro.getText().isEmpty()) {
            ...
            try {
                ...
                if (ru.getCodigo() == 0) {
                    GrillaVendedor grillaru = new GrillaVendedor();
    ...
    public void filtrosrubro(int nNumeroColumna) {
    ...
    private class GenerarConsultaCompras extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cabecera_compra com : DAO.DetalleCompraxRubro(FechaI, FechaF, nRubro, nRubro, nMoneda)) {
                    String Datos[] = {formatosinpunto.format(com.getNrofactura()),com.getCodprodcompra(), com.getNombreproductocompra(), formato.format(com.getCantidadcompra()), formato.format(com.getPreciocompra()), formato.format(com.getTotalneto()), formatoFecha.format(com.getFecha()), com.getNombreproveedor(),String.valueOf(com.getCodrubrocompra()),com.getNombrerubrocompra()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                tipo = new Detallecomprasxrubro(jTable1.getValueAt(nFila, 0).toString(),jTable1.getValueAt(nFila, 6).toString(), jTable1.getValueAt(nFila, 1).toString(),jTable1.getValueAt(nFila, 2).toString(), Double.valueOf(cCantidad), Double.valueOf(cPrecio), Double.valueOf(cTotal),jTable1.getValueAt(nFila, 7).toString(), Integer.valueOf(jTable1.getValueAt(nFila, 8).toString()), jTable1.getValueAt(nFila, 9).toString());
                Resultados.add(tipo);
                ...
                System.out.println(tipo.getNombrerubro());
            ...
            try {
                ...
                parameters.put("cSucursal",nombrerubro.getText());
                parameters.put("cMoneda",nombremoneda.getText());
          
                JasperReport jr = null;

                URL url = getClass().getClassLoader().getResource("Reports/detalle_comprasxrubro.jasper");
