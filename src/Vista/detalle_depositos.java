 ...
 * @author hp
 */
public class detalle_depositos extends javax.swing.JFrame {
     ...
     */
    public detalle_depositos(String Opcion) throws ParseException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarPlan.setText(org.openide.util.NbBundle.getMessage(detalle_depositos.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(detalle_depositos.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(detalle_depositos.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        BBancos.setTitle(org.openide.util.NbBundle.getMessage(detalle_depositos.class, "detalle_extracciones.BBancos.title")); // NOI18N
        ...
        jTBuscarbanco.setText(org.openide.util.NbBundle.getMessage(detalle_depositos.class, "detalle_extracciones.jTBuscarbanco.text")); // NOI18N
        ...
        Aceptar.setText(org.openide.util.NbBundle.getMessage(detalle_depositos.class, "detalle_extracciones.Aceptar.text")); // NOI18N
        ...
        SalirBanco.setText(org.openide.util.NbBundle.getMessage(detalle_depositos.class, "detalle_extracciones.SalirBanco.text")); // NOI18N
        ...
        jLabel1.setText("N° Boleta de Depósito");
        ...
        jPanel2.add(moneda, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 90, 120, -1));
        ...
        jPanel2.add(cotizacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 90, 90, -1));

        jLabel9.setText("Cotización");
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 70, -1, -1));

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "Observaciones"));
        ...
        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, -1, 160));

        idControl.setEditable(false);
        idControl.setEnabled(false);
        jPanel2.add(idControl, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 40, 60, -1));
        ...
        jPanel2.add(documento, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 40, 100, -1));
        ...
        jPanel2.add(importe, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 90, -1));
        ...
        jPanel2.add(idcta, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 80, -1));
        ...
        jPanel2.add(BuscarCta, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 150, 20, 20));

        nombrecuenta.setEditable(false);
        jPanel2.add(nombrecuenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 150, 200, -1));

        jLabel5.setText(org.openide.util.NbBundle.getMessage(detalle_depositos.class, "detalle_extracciones.jLabel5.text")); // NOI18N
        ...
        codbanco.setText(org.openide.util.NbBundle.getMessage(detalle_depositos.class, "detalle_extracciones.banco.text")); // NOI18N
        ...
        jPanel2.add(codbanco, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 80, -1));
        ...
        jPanel2.add(BuscarBanco, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 90, 20, 20));

        nombrebanco.setText(org.openide.util.NbBundle.getMessage(detalle_depositos.class, "detalle_extracciones.nombrebanco.text")); // NOI18N
        nombrebanco.setEnabled(false);
        jPanel2.add(nombrebanco, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 90, 140, -1));

        creferencia.setEditable(false);
        creferencia.setEnabled(false);
        jPanel2.add(creferencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 10, 60, -1));
        ...
        jLabel6.setText("Registro y Actualización de Depósitos en Cuenta");
    ...
    public void consultarTabla() throws ParseException {
        ...
        try {
            String query = null;
            query = "SELECT extracciones.idcontrol,extracciones.documento,extracciones.fecha,"
                    + "extracciones.sucursal,extracciones.banco,extracciones.idmovimiento,"
                    + "extracciones.moneda,extracciones.cotizacion,extracciones.importe,"
                    + "extracciones.observaciones,extracciones.idcta,plan.nombre as nombrecuenta,"
                    + "bancos.nombre as nombrebanco "
                    + " from extracciones "
                    + " left join plan "
                    + " on plan.codigo=extracciones.idcta "
                    + " left join bancos "
                    + " on bancos.codigo=extracciones.banco "
                    + " WHERE extracciones.idcontrol =" + this.idControl.getText();

            results = stm.executeQuery(query);
            if (results.next()) {

                nSucursal = results.getInt("sucursal");
                nBanco = results.getInt("banco");
                ...
                this.codbanco.setText(results.getString("banco"));
    ...
    private void GrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (Operacion.isEmpty()) {
            ...
            BD.insertarRegistro("extracciones", "idmovimiento,documento,sucursal,fecha,vencimiento,banco,importe,moneda,cotizacion,observaciones,tipo,idcta", "'" + idunico + "','" + cFactura.trim() + "','" + Sucursal + "','" + dEmision + "','" + dEmision + "','" + codbanco.getText() + "','" + cExentas + "','" + Moneda + "','" + cCotizacion + "','" + observacion.getText().trim() + "','" + "C" + "','" + idcta.getText().toString() + "'");
        } else {
            BD.actualizarRegistro("extracciones", " documento='" + cFactura.trim() + "',idcta='" + idcta.getText().toString() + "',sucursal='" + Sucursal + "',fecha='" + dEmision + "',vencimiento='" + dEmision + "',importe='" + cExentas + "',moneda='" + Moneda + "',cotizacion='" + cCotizacion + "',observaciones ='" + this.observacion.getText().trim() + "',banco='" + codbanco.getText() + "'", "idcontrol= '" + this.idControl.getText() + "'");
        }
        ...
        if (contable.getDepositos() == 1) {
            try {
                genDAO.generarDepositosItem(creferencia.getText());
            } catch (SQLException ex) {
...
//        ControlGrabado.REGISTRO_GRABADO = "";
    ...
    private void codbancoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_codbancoActionPerformed
        ...
        banco bco = null;
        try {
            bco = bDAO.buscarId(Integer.valueOf(codbanco.getText()));
            if (bco.getCodigo() == 0) {
                BuscarBanco.doClick();
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detalle_depositos.class
