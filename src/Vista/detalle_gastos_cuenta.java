 ...
 * @author hp
 */
public class detalle_gastos_cuenta extends javax.swing.JFrame {
     ...
     */
    public detalle_gastos_cuenta(String Opcion) throws ParseException {
        initComponents();
    ...
    private void initComponents() {
        ...
        BCuenta.setTitle(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.BCuenta.title")); // NOI18N
        ...
        jTBuscarPlan.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jTBuscarPlan.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.AceptarGir.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.SalirGir.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel1.text")); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel2.text")); // NOI18N
        ...
        jLabel3.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel3.text")); // NOI18N
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 20, -1, -1));

        jLabel4.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel4.text")); // NOI18N
        ...
        jLabel5.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel5.text")); // NOI18N
        ...
        jLabel8.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel8.text")); // NOI18N
        ...
        jLabel9.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel9.text")); // NOI18N
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 70, -1, -1));

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jPanel1.border.title"))); // NOI18N
        ...
        exentas.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.exentas.text")); // NOI18N
        ...
        gravadas10.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.gravadas10.text")); // NOI18N
        ...
        iva10.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.iva10.text")); // NOI18N
        ...
        gravadas5.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.gravadas5.text")); // NOI18N
        ...
        jLabel10.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel10.text")); // NOI18N

        jLabel11.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel11.text")); // NOI18N

        jLabel12.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel12.text")); // NOI18N

        jLabel13.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel13.text")); // NOI18N

        jLabel14.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel14.text")); // NOI18N
        ...
        Totalneto.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.Totalneto.text")); // NOI18N
        ...
        jLabel18.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel18.text")); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jPanel4.border.title"))); // NOI18N
        ...
        proveedor.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.proveedor.text")); // NOI18N
        ...
        nombreproveedor.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.nombreproveedor.text")); // NOI18N
        ...
        timbrado.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.timbrado.text")); // NOI18N
        ...
        jLabel15.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel15.text")); // NOI18N
        jPanel2.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 130, -1, -1));

        jLabel16.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel16.text")); // NOI18N
        jPanel2.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, -1, -1));

        jLabel17.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel17.text")); // NOI18N
        ...
        jButton1.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jButton1.text")); // NOI18N
        ...
        jButton2.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jButton2.text")); // NOI18N
        ...
        idControl.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.idControl.text")); // NOI18N
        idControl.setEnabled(false);
        jPanel2.add(idControl, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 50, -1));

        BuscarProveedor.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.BuscarProveedor.text")); // NOI18N
        ...
        Sumatoria.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.Sumatoria.text")); // NOI18N
        Sumatoria.setEnabled(false);
        jPanel2.add(Sumatoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 150, 50, -1));

        jLabel19.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel19.text")); // NOI18N
        ...
        factura.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.factura.text")); // NOI18N
        ...
        jLabel6.setText(org.openide.util.NbBundle.getMessage(detalle_gastos_cuenta.class, "detalle_gastos_cuenta.jLabel6.text")); // NOI18N
    ...
    public void consultarTabla() throws ParseException {
        ...
        try {
            String query = null;
            query = "SELECT formatofactura,proveedor,comprobante,primer_vence,gastos_compras.moneda,concepto,creferencia,"
                    + "sucursal,nrofactura,gastos_compras.observacion,gastos_compras.fecha,"
                    + "comprobantes.nombre AS nombrecomprobante,proveedores.nombre AS nombreproveedor,"
                    + "exentas,gastos_compras.idcta,plan.nombre as nombrecuenta,"
                    + " gravadas10,gravadas5,iva10,iva5,totalneto,monedas.nombre AS nombremoneda,"
                    + "cotizacion,gastos_compras.timbrado,vencetimbrado "
                    + " FROM gastos_compras "
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (Operacion.isEmpty()) {
            ...
            BD.insertarRegistro("gastos_compras", "creferencia,nrofactura,formatofactura,sucursal,fecha,proveedor,exentas,gravadas10,gravadas5,iva10,iva5,totalneto,timbrado,vencetimbrado,moneda,cotizacion,primer_vence,comprobante,idcta,observacion", "'" + idunico + "','" + cFactura + "','" + factura.getText() + "','" + Sucursal + "','" + dEmision + "','" + proveedor.getText() + "','" + cExentas + "','" + cGravadas10 + "','" + cGravadas5 + "','" + cIva10 + "','" + cIva5 + "','" + cTotal + "','" + timbrado.getText() + "','" + dVenceTimbrado + "','" + Moneda + "','" + cCotizacion + "','" + dVence + "','" + Comprobante + "','" + idcta.getText() + "','" + observacion.getText() + "'");
            ...
            BD.actualizarRegistro("gastos_compras", " nrofactura='" + cFactura + "',formatofactura='" + factura.getText() + "',sucursal='" + Sucursal + "',fecha='" + dEmision + "',proveedor='" + proveedor.getText() + "',exentas='" + cExentas + "',gravadas10='" + cGravadas10 + "',gravadas5='" + cGravadas5 + "',iva10='" + cIva10 + "',iva5 ='" + cIva5 + "',totalneto ='" + cTotal + "',timbrado ='" + timbrado.getText() + "',vencetimbrado='" + dVenceTimbrado + "',moneda='" + Moneda + "',cotizacion='" + cCotizacion + "',primer_vence='" + dVence + "',comprobante='" + Comprobante + "',idcta='" + idcta.getText() + "',observacion='" + observacion.getText() + "'", "creferencia= '" + this.idControl.getText() + "'");
...
//        ControlGrabado.REGISTRO_GRABADO = "";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detalle_gastos_cuenta.class
