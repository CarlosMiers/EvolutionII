 ...
 * @author hp
 */
public class detalle_notacredito extends javax.swing.JFrame {
    ...
    public detalle_notacredito(String Opcion) throws ParseException {
        initComponents();
    ...
    private void initComponents() {
        ...
        codprod.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.codprod.text")); // NOI18N
        ...
        jLabel14.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel14.text")); // NOI18N

        BuscarProducto.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.BuscarProducto.text")); // NOI18N
        ...
        nombreproducto.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.nombreproducto.text")); // NOI18N

        jLabel15.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel15.text")); // NOI18N

        cantidad.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter()));
        cantidad.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.cantidad.text")); // NOI18N
        ...
        jLabel16.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel16.text")); // NOI18N
        ...
        preciounitario.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.preciounitario.text")); // NOI18N
        ...
        jLabel17.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel17.text")); // NOI18N
        ...
        totalitem.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.totalitem.text")); // NOI18N

        jLabel19.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel19.text")); // NOI18N

        cModo.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.cModo.text")); // NOI18N

        item_iva.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.item_iva.text")); // NOI18N
        ...
        NuevoItem.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.NuevoItem.text")); // NOI18N
        ...
        SalirItem.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.SalirItem.text")); // NOI18N
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(NuevoItem, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
        ...
        setTitle(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.title")); // NOI18N
        setResizable(false);
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel1.text")); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel2.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel3.text")); // NOI18N
        ...
        jLabel4.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel4.text")); // NOI18N

        Cliente.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.Cliente.text")); // NOI18N
        ...
        NombreCliente.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.NombreCliente.text")); // NOI18N
        NombreCliente.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        NombreCliente.setEnabled(false);

        Direccion.setBackground(new java.awt.Color(204, 204, 255));
        Direccion.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.Direccion.text")); // NOI18N
        Direccion.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        Direccion.setEnabled(false);

        jLabel5.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel5.text")); // NOI18N
        ...
        BuscarCliente.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.BuscarCliente.text")); // NOI18N
        ...
        nrofactura.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.nrofactura.text")); // NOI18N
        ...
        Modo.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.Modo.text")); // NOI18N
        ...
        creferencia.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.creferencia.text")); // NOI18N

        jLabel6.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel6.text")); // NOI18N
        ...
        jLabel8.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel8.text")); // NOI18N

        cotizacion.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.cotizacion.text")); // NOI18N
        ...
        jLabel10.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel10.text")); // NOI18N
        ...
        jLabel12.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel12.text")); // NOI18N

        cuotas.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.cuotas.text")); // NOI18N
        ...
        jLabel13.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel13.text")); // NOI18N

        observacion.setColumns(20);
        observacion.setRows(5);
        jScrollPane1.setViewportView(observacion);

        AgregarItem.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.AgregarItem.text")); // NOI18N
        AgregarItem.setToolTipText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.AgregarItem.toolTipText")); // NOI18N
        ...
        UpdateItem.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.UpdateItem.text")); // NOI18N
        UpdateItem.setToolTipText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.UpdateItem.toolTipText")); // NOI18N
        ...
        DeleteItem.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.DeleteItem.text")); // NOI18N
        DeleteItem.setToolTipText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.DeleteItem.toolTipText")); // NOI18N
        ...
        jLabel18.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel18.text")); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(12, 12, 12)
                        .addComponent(sucursal, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(217, 217, 217)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(codmoneda, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(comprobante, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(AgregarItem, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(DeleteItem, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        );
        ...
        Exentas.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.Exentas.text")); // NOI18N

        jLabel7.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel7.text")); // NOI18N

        jLabel9.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel9.text")); // NOI18N

        jLabel11.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jLabel11.text")); // NOI18N
        ...
        gravadas10.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.gravadas10.text")); // NOI18N
        ...
        iva10.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.iva10.text")); // NOI18N
        ...
        gravadas5.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.gravadas5.text")); // NOI18N
        ...
        idfila.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.idfila.text")); // NOI18N
        ...
        jButton1.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jButton1.text")); // NOI18N
        ...
        jButton2.setText(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jButton2.text")); // NOI18N
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(detalle_notacredito.class, "detalle_notacredito.jPanel5.border.title"))); // NOI18N
...
//                this.autorizado.requestFocus();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (ret == 0) {
            ...
            if (this.cuotas.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Ingrese Cantidad de Cuotas");
                this.cotizacion.requestFocus();
                return;
            }
            ...
            if (Operacion.equals("new")) {
                ...
                InsertarRegistroDetalle("cuenta_clientes", "creferencia,iddocumento,sucursal,fecha,vencimiento,documento,cliente,importe,saldo,moneda,numerocuota,cuota,comprobante", "'" + this.creferencia.getText() +"','"+this.creferencia.getText()+ "','"+ Sucursal+"','"+ dProceso +"','"+dProceso+"','"+   this.nrofactura.getText() + "','" + this.Cliente.getText() + "','" + cTotal + "','"+cTotal+"','" + Moneda +  "','" + this.cuotas.getText() + "','" + this.cuotas.getText() + "','" + Comprobante + "'");
                try {
                    GuardarDetalle();
                } catch (SQLException ex) {
                    Exceptions.printStackTrace(ex);
    ...
    private void preciounitarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_preciounitarioActionPerformed
        ...
        double nCantidad = Double.parseDouble(cCantidad)*-1;//CANTIDAD
        this.cantidad.setText(String.valueOf(nCantidad));
        double nPrecio = Double.parseDouble(cPrecio);//PRECIO
        double ntotal = nCantidad * nPrecio;
        double nIva = Math.round(ntotal / 11);
...
// TODO add your handling code here:
    ...
    public void GuardarDetalle() throws SQLException, ParseException {
        ...
        for (int i = 0; i < Items; i++) {
          ...
          //    InsertarRegistroDetalle("cuenta_clientes", "iddocumento,creferencia,documento,fecha,vencimiento,cliente,sucursal,moneda,comprobante,importe,numerocuota,cuota,saldo,inversionista,tasaoperativa", "'" + creferencia.getText() + "','" + this.creferencia.getText() + "','" + cNrodocumento + "','" + dEmision + "','" + dVence + "','" + this.Cliente.getText() + "','" + Sucursal + "','" + Moneda + "','" + cComprobante + "','" + cMonto + "','" + cCuota + "','" + cCuota + "','" + cMonto + "','" + cAcreedor + "','" + cTasa + "'");
        }
    }
...
//                new detalle_descuento_cheques().setVisible(true);
    ...
    private class GenFactura extends Thread {
        ...
        public void run() {
            con = new Conexion();
            stm = con.conectar();
            cSql = "SELECT notacredito+1  AS nRegistro FROM sucursales";
            try {
