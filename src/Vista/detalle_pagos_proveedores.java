 ...
 * @author hp
 */
public class detalle_pagos_proveedores extends javax.swing.JFrame {
     ...
     */
    public detalle_pagos_proveedores() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {50, 50, 80, 120, 100, 50, 120};
    ...
    private void TitSucursal() {
        ...
        this.tablaproveedor.getColumnModel().getColumn(1).setCellRenderer(TablaRendererizquierdo);
    }
    ...
    private void initComponents() {
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_pagos_proveedores.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_pagos_proveedores.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_pagos_proveedores.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarProveedor.setText(org.openide.util.NbBundle.getMessage(detalle_pagos_proveedores.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarPro.setText(org.openide.util.NbBundle.getMessage(detalle_pagos_proveedores.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirPro.setText(org.openide.util.NbBundle.getMessage(detalle_pagos_proveedores.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Detalle de Pagos por Proveedor");
        ...
        etiquetasaldos.setText("Detalle de Pagos por Proveedor");
    ...
    private class GenerarConsultaProveedor extends Thread {
        ...
        public void run() {
            ...
            try {
                for (pago pa : DAO.Detallepagoxproveedor(FechaI, FechaF, nProveedor, nProveedor, nMoneda)) {
  ...
  private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                parameters.put("cNombreSucursal", nombreproveedor.getText());
                parameters.put("nProveedor", proveedor.getText());
                parameters.put("nMoneda", moneda.getText());

                JasperReport jr = null;
                URL url = getClass().getClassLoader().getResource("Reports/detalle_pago_proveedor.jasper");
