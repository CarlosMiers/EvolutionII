 ...
 * @author hp
 */
public class detalle_pagos_sucursal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_pagos_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_pagos_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_pagos_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(detalle_pagos_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(detalle_pagos_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(detalle_pagos_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Detalle de Pagos por Sucursales");
        ...
        etiquetasaldos.setText("Detalle de Pagos por Sucursales");
    ...
    private class GenerarConsultaSucursal extends Thread {
        ...
        public void run() {
            ...
            try {
                for (pago pa : DAO.Detallepagoxsucursal(FechaI, FechaF, nSucursal, nSucursal, nMoneda)) {
                    String Datos[] = {String.valueOf(pa.getNumero()), pa.getRecibo(), formatoFecha.format(pa.getFecha()), pa.getProveedor().getNombre(), formatea.format(pa.getDetallepago().getPago()), pa.getMoneda().getNombre(), pa.getSucursal().getNombre()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
  ...
  private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/detalle_pago_sucursal.jasper");
