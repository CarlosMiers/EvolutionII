 ...
 * @author hp
 */
public class detalle_prestamos extends javax.swing.JFrame {
    ...
    public detalle_prestamos(String Opcion) throws ParseException {
        initComponents();
    ...
    private void generarcuotas() {
        ...
        for (int i = 1; i <= nCantidad; i++) {
            ...
            if (i != nCantidad) {
                ...
                fila[7] = formato.format(nAmortiza + nInteres + nImporteIva);
            } else {
                ...
                fila[5] = formato.format(nInteres);
                fila[6] = formato.format(nImporteIva);
                fila[7] = formato.format(nMontoCuota + nImporteIva);
            }
            ...
            if (Integer.parseInt(cMoneda) == 1) {
                ...
                System.out.println("Entro el Iva PYG " + nTotalIva);
            } else {
                nTotalIva = nTotalInteres * Config.porcentajeiva / 100;
                System.out.println("Entro el Iva USD " + nTotalIva);
            }
            System.out.println("nTotalIva " + nTotalIva);
            ...
            if (Integer.parseInt(this.incluiriva.getText()) == 0) {
                this.neto_a_entregar.setText(formato.format(nMontoCapital - (nTotalIva + nGastos + ndescuento)));
            } else {
    ...
    public void consultarTabla() throws ParseException {
        ...
        query = query + "prestamos.porcentaje_acreedor,prestamos.comision_acreedor,";
        ...
        try {
            ...
            if (results.next()) {
                ...
                this.porcentaje_deudor.setText(formato.format(results.getDouble("porcentaje_deudor")));
                this.comision_deudor.setText(formato.format(results.getDouble("comision_deudor")));
                this.porcentaje_acreedor.setText(formato.format(results.getDouble("porcentaje_acreedor")));
                this.comision_acreedor.setText(formato.format(results.getDouble("comision_acreedor")));
                this.gastos_escritura.setText(formato.format(results.getDouble("gastos_escritura")));
    ...
    private void initComponents() {
        ...
        comisiones = new javax.swing.JDialog();
        jPanel18 = new javax.swing.JPanel();
        jLabel44 = new javax.swing.JLabel();
        porcentaje_deudor = new javax.swing.JFormattedTextField();
        jLabel45 = new javax.swing.JLabel();
        comision_deudor = new javax.swing.JFormattedTextField();
        jLabel46 = new javax.swing.JLabel();
        porcentaje_acreedor = new javax.swing.JFormattedTextField();
        ...
        GrabrarComision = new javax.swing.JButton();
        SalirComision = new javax.swing.JButton();
        ...
        CtaTitular.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.CtaTitular.text")); // NOI18N
        ...
        NombreTitular.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.NombreTitular.text")); // NOI18N
        NombreTitular.setBorder(null);

        NroPrestamo.setEditable(false);
        NroPrestamo.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.NroPrestamo.text")); // NOI18N
        NroPrestamo.setBorder(null);

        jLabel25.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel25.text")); // NOI18N

        jLabel26.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel26.text")); // NOI18N

        jLabel27.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel27.text")); // NOI18N

        AdItemGarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.AdItemGarante.text")); // NOI18N
        ...
        DelItemGarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.DelItemGarante.text")); // NOI18N
        ...
        codgarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.codgarante.text")); // NOI18N
        ...
        BuscarGarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.BuscarGarante.text")); // NOI18N
        ...
        nombregarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.nombregarante.text")); // NOI18N
        ...
        Cuenta.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.Cuenta.text")); // NOI18N

        ctaclientedesembolso.setEditable(false);
        ctaclientedesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.ctaclientedesembolso.text")); // NOI18N

        nombrecliente.setEditable(false);
        nombrecliente.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.nombrecliente.text")); // NOI18N

        nprestamodesembolso.setEditable(false);
        nprestamodesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.nprestamodesembolso.text")); // NOI18N

        jLabel29.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel29.text")); // NOI18N

        jLabel30.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel30.text")); // NOI18N

        formadesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.formadesembolso.text")); // NOI18N
        ...
        nombreformadesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.nombreformadesembolso.text")); // NOI18N

        bancodesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.bancodesembolso.text")); // NOI18N
        ...
        banconombredesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.banconombredesembolso.text")); // NOI18N

        jLabel31.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel31.text")); // NOI18N

        jLabel28.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel28.text")); // NOI18N

        nrocheque.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.nrocheque.text")); // NOI18N
        ...
        GrabarDesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.GrabarDesembolso.text")); // NOI18N
        ...
        jButton2.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jButton2.text")); // NOI18N
        ...
        jLabel32.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel32.text")); // NOI18N
        ...
        netodesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.netodesembolso.text")); // NOI18N

        jLabel33.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel33.text")); // NOI18N

        buscarfdesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.buscarfdesembolso.text")); // NOI18N
        ...
        buscarbdesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.buscarbdesembolso.text")); // NOI18N
        ...
        jLabel36.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel36.text")); // NOI18N

        rfpnroprestamo.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.rfpnroprestamo.text")); // NOI18N

        jLabel37.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel37.text")); // NOI18N

        rfpcuenta.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.rfpcuenta.text")); // NOI18N

        rfpnombrecuenta.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.rfpnombrecuenta.text")); // NOI18N
        ...
        jButton1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jButton1.text")); // NOI18N

        jButton9.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jButton9.text")); // NOI18N

        jLabel38.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel38.text")); // NOI18N

        jLabel39.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel39.text")); // NOI18N

        jTextField1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jTextField1.text")); // NOI18N

        jTextField2.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jTextField2.text")); // NOI18N

        jLabel40.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel40.text")); // NOI18N

        jTextField3.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jTextField3.text")); // NOI18N

        jLabel41.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel41.text")); // NOI18N

        jTextField4.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jTextField4.text")); // NOI18N

        jTextField5.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jTextField5.text")); // NOI18N

        jLabel42.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel42.text")); // NOI18N

        jLabel43.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel43.text")); // NOI18N

        jTextField6.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jTextField6.text")); // NOI18N
        ...
        jLabel44.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel44.text")); // NOI18N

        porcentaje_deudor.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0.00"))));
        porcentaje_deudor.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        porcentaje_deudor.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                porcentaje_deudorFocusLost(evt);
            }
        });
        porcentaje_deudor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                porcentaje_deudorActionPerformed(evt);
            }
        });
        porcentaje_deudor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                porcentaje_deudorKeyPressed(evt);
            }
        });

        jLabel45.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel45.text")); // NOI18N
        ...
        comision_deudor.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        comision_deudor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                comision_deudorKeyPressed(evt);
            }
        });

        jLabel46.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel46.text")); // NOI18N

        porcentaje_acreedor.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0.00"))));
        porcentaje_acreedor.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        porcentaje_acreedor.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                porcentaje_acreedorFocusLost(evt);
            }
        });
        porcentaje_acreedor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                porcentaje_acreedorKeyPressed(evt);
            }
        });

        jLabel47.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel47.text")); // NOI18N

        comision_acreedor.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0.00"))));
        comision_acreedor.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        comision_acreedor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                comision_acreedorKeyPressed(evt);
            }
        });

        jLabel48.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel48.text")); // NOI18N

        gastos_escritura.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0.00"))));
            ...
            .addGroup(jPanel18Layout.createSequentialGroup()
                ...
                .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(comision_acreedor, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE)
                        .addComponent(porcentaje_deudor, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(porcentaje_acreedor, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(comision_deudor))
                    .addComponent(gastos_escritura, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel18Layout.setVerticalGroup(
            ...
            .addGroup(jPanel18Layout.createSequentialGroup()
                ...
                .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(porcentaje_deudor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(porcentaje_acreedor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        GrabrarComision.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.GrabrarComision.text")); // NOI18N
        GrabrarComision.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                GrabrarComisionActionPerformed(evt);
            }
        });

        SalirComision.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.SalirComision.text")); // NOI18N
        SalirComision.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SalirComisionActionPerformed(evt);
            }
        });
        ...
        jPanel19Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel19Layout.createSequentialGroup()
                .addGap(91, 91, 91)
                .addComponent(GrabrarComision, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 43, Short.MAX_VALUE)
                .addComponent(SalirComision, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(93, 93, 93))
        );
        jPanel19Layout.setVerticalGroup(
            ...
            .addGroup(jPanel19Layout.createSequentialGroup()
                ...
                .addGroup(jPanel19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(GrabrarComision)
                    .addComponent(SalirComision))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        javax.swing.GroupLayout comisionesLayout = new javax.swing.GroupLayout(comisiones.getContentPane());
        comisiones.getContentPane().setLayout(comisionesLayout);
        comisionesLayout.setHorizontalGroup(
            comisionesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel18, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(jPanel19, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        comisionesLayout.setVerticalGroup(
            comisionesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(comisionesLayout.createSequentialGroup()
        ...
        setTitle(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.title")); // NOI18N
        setResizable(false);
        ...
        agregarpago.setBackground(new java.awt.Color(153, 153, 153));
        agregarpago.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.agregarpago.text")); // NOI18N
        ...
        eliminarpago.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.eliminarpago.text")); // NOI18N
        eliminarpago.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        GuardarOperacion.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.GuardarOperacion.text")); // NOI18N
        ...
        Salir.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.Salir.text")); // NOI18N
        ...
        jButton3.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jButton3.text")); // NOI18N
        ...
        jButton6.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jButton6.text")); // NOI18N
        ...
        jButton7.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jButton7.text")); // NOI18N
        ...
        jLabel20.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel20.text")); // NOI18N

        nombreacreedor.setBackground(new java.awt.Color(204, 204, 204));
        nombreacreedor.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.nombreacreedor.text")); // NOI18N
        ...
        BuscarAcreedor.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.BuscarAcreedor.text")); // NOI18N
        ...
        acreedor.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.acreedor.text")); // NOI18N
        ...
        jLabel34.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel34.text")); // NOI18N
        ...
        importecapital.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.importecapital.text")); // NOI18N
        importecapital.setToolTipText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.importecapital.toolTipText")); // NOI18N
        ...
        jLabel12.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel12.text")); // NOI18N

        jLabel14.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel14.text")); // NOI18N

        jLabel15.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel15.text")); // NOI18N

        jLabel16.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel16.text")); // NOI18N

        tasa.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.tasa.text")); // NOI18N
        ...
        jLabel17.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel17.text")); // NOI18N

        jLabel18.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel18.text")); // NOI18N
        ...
        importecuota.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.importecuota.text")); // NOI18N
        ...
        jLabel19.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel19.text")); // NOI18N
        ...
        Modo.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.Modo.text")); // NOI18N

        jLabel21.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel21.text")); // NOI18N
        ...
        plazo.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.plazo.text")); // NOI18N
        plazo.setToolTipText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.plazo.toolTipText")); // NOI18N
        ...
        jLabel22.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel22.text")); // NOI18N

        creferencia.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.creferencia.text")); // NOI18N
        ...
        incluiriva.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.incluiriva.text")); // NOI18N

        entregarneto.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.entregarneto.text")); // NOI18N
        ...
        jLabel4.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel4.text")); // NOI18N

        Cliente.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.Cliente.text")); // NOI18N
        ...
        Direccion.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.Direccion.text")); // NOI18N
        ...
        BuscarCliente.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.BuscarCliente.text")); // NOI18N
        ...
        jLabel35.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel35.text")); // NOI18N
        ...
        jLabel11.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel11.text")); // NOI18N
        ...
        jLabel10.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel10.text")); // NOI18N
        ...
        jLabel9.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel9.text")); // NOI18N
        ...
        gastos_administrativos.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.gastos_administrativos.text")); // NOI18N
        ...
        jLabel7.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel7.text")); // NOI18N
        ...
        descuentos.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.descuentos.text")); // NOI18N
        ...
        jLabel8.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel8.text")); // NOI18N
        ...
        montoiva.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.montoiva.text")); // NOI18N
        ...
        jLabel6.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel6.text")); // NOI18N
        ...
        idfila.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.idfila.text")); // NOI18N
        ...
        jLabel23.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel23.text")); // NOI18N
        ...
        jLabel24.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel24.text")); // NOI18N
        ...
        calcularneto.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.calcularneto.text")); // NOI18N
        ...
        auxiliar.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.auxiliar.text")); // NOI18N

        estado.setEditable(false);
        estado.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        estado.setForeground(new java.awt.Color(255, 0, 0));
        estado.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.estado.text")); // NOI18N

        GenerarCuotas.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.GenerarCuotas.text")); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel2.text")); // NOI18N

        jLabel13.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel13.text")); // NOI18N

        idControl.setEditable(false);
        idControl.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.idControl.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel3.text")); // NOI18N
        ...
        jLabel5.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel5.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jLabel1.text")); // NOI18N
        ...
        jMenu1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jMenu1.text")); // NOI18N

        jMenuItem1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jMenuItem1.text")); // NOI18N
        ...
        jMenuItem2.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jMenuItem2.text")); // NOI18N
        jMenu1.add(jMenuItem2);
        jMenu1.add(jSeparator2);

        jMenuItem3.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jMenuItem3.text")); // NOI18N
        ...
        jMenuItem4.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jMenuItem4.text")); // NOI18N
        ...
        jMenuItem5.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jMenuItem5.text")); // NOI18N
        ...
        jMenuItem6.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jMenuItem6.text")); // NOI18N
        jMenu1.add(jMenuItem6);
        jMenu1.add(jSeparator6);

        jMenuItem7.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jMenuItem7.text")); // NOI18N
        jMenu1.add(jMenuItem7);
        jMenu1.add(jSeparator7);

        jMenuItem8.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jMenuItem8.text")); // NOI18N
        jMenu1.add(jMenuItem8);
        jMenu1.add(jSeparator8);

        jMenuItem9.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos.class, "detalle_prestamos.jMenuItem9.text")); // NOI18N
    ...
    private void GuardarOperacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarOperacionActionPerformed
        ...
        String cPorcentajeDeudor = porcentaje_deudor.getText();
        cPorcentajeDeudor = cPorcentajeDeudor.replace(".", "").replace(",", ".");
        String cComisionDeudor = comision_deudor.getText();
        cComisionDeudor = cComisionDeudor.replace(".", "").replace(",", ".");
        if(Double.valueOf(cComisionDeudor)>0){
            cGastos=cComisionDeudor;
        }
        String cPorcentajeAcreedor = porcentaje_acreedor.getText();
        cPorcentajeAcreedor = cPorcentajeAcreedor.replace(".", "").replace(",", ".");
        String cComisionAcreedor = comision_acreedor.getText();
        cComisionAcreedor = cComisionAcreedor.replace(".", "").replace(",", ".");
        String cGastosEscritura = gastos_escritura.getText();
        cGastosEscritura = cGastosEscritura.replace(".", "").replace(",", ".");
        //m.monto_entregar=m.importe-(m.deducciones+m.comision_deudor+m.gastos_escritura)+(m.interesnocobrado)
        double nNetoEntregar=Double.valueOf(cCapital)-(Double.valueOf(cDescuentos)+Double.valueOf(cGastos)+Double.valueOf(cGastosEscritura));
        cNetoEntregar=String.valueOf(nNetoEntregar);
        ...
        if (ret == 0) {
            try {
                ...
                try {
                    ...
                    cSqlCab += "',porcentaje_deudor='" + cPorcentajeDeudor + "',porcentaje_acreedor='" + cPorcentajeAcreedor;
                    cSqlCab += "',comision_acreedor='" + cComisionAcreedor + "',gastos_escritura='" + cGastosEscritura;
                    ...
                    for (int i = 0; i < Items; i++) {
                        ...
                        cSqlCuentas += cCuota + "','" + cCuota + "','" + cTotal + "','" + cCapital + "','" + cInteres + "','" + cAmortiza + "','" + this.acreedor.getText() + "','" + cTasa + "')";
...
// TODO add your handling code here:
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        if (Integer.parseInt(this.idControl.getText()) == 0) {
            ...
            comisiones.setSize(447, 278);
            comisiones.setModal(true);
            comisiones.setTitle("Comisiones a Cobrar");
            comisiones.setLocationRelativeTo(null);
            comisiones.setVisible(true);
        }        // TODO add your handling code here:
    }//GEN-LAST:event_jButton7ActionPerformed

    private void porcentaje_deudorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_porcentaje_deudorActionPerformed
    }//GEN-LAST:event_porcentaje_deudorActionPerformed

    private void porcentaje_deudorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_porcentaje_deudorKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.comision_deudor.requestFocus();
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_porcentaje_deudorKeyPressed

    private void comision_deudorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_comision_deudorKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.porcentaje_acreedor.requestFocus();
        }
        if (evt.getKeyCode() == KeyEvent.VK_UP) {
            this.porcentaje_deudor.requestFocus();
        }        // TODO add your handling code here:
    }//GEN-LAST:event_comision_deudorKeyPressed

    private void comision_acreedorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_comision_acreedorKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
    ...
    }//GEN-LAST:event_comision_acreedorKeyPressed

    private void porcentaje_acreedorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_porcentaje_acreedorKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
    ...
    private void SalirComisionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SalirComisionActionPerformed
        comisiones.setModal(false);
        comisiones.setVisible(false);
        // TODO add your handling code here:
    }//GEN-LAST:event_SalirComisionActionPerformed

    private void GrabrarComisionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabrarComisionActionPerformed
        SalirComision.doClick();
        // TODO add your handling code here:
    }//GEN-LAST:event_GrabrarComisionActionPerformed

    private void porcentaje_deudorFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_porcentaje_deudorFocusLost
        String cImporteTotal = this.importecapital.getText();
        cImporteTotal = cImporteTotal.replace(".", "").replace(",", ".");
        String cPorcentaje = this.porcentaje_deudor.getText();
        cPorcentaje = cPorcentaje.replace(".", "").replace(",", ".");
        if (Double.valueOf(cPorcentaje) > 0) {
            comision_deudor.setText(formato.format(Double.valueOf(cImporteTotal) * Double.valueOf(cPorcentaje) / 100));
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_porcentaje_deudorFocusLost

    private void porcentaje_acreedorFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_porcentaje_acreedorFocusLost
        String cImporteTotal = this.importecapital.getText();
        cImporteTotal = cImporteTotal.replace(".", "").replace(",", ".");
        String cPorcentaje = this.porcentaje_acreedor.getText();
        cPorcentaje = cPorcentaje.replace(".", "").replace(",", ".");
        if (Double.valueOf(cPorcentaje) > 0) {
            comision_acreedor.setText(formato.format(Double.valueOf(cImporteTotal) * Double.valueOf(cPorcentaje) / 100));
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_porcentaje_acreedorFocusLost
...
//                new detalle_descuento_cheques().setVisible(true);
    ...
    private javax.swing.JButton GrabrarComision;
    ...
    private javax.swing.JButton SalirComision;
    ...
    private javax.swing.JDialog comisiones;
    ...
    private javax.swing.JFormattedTextField porcentaje_acreedor;
    private javax.swing.JFormattedTextField porcentaje_deudor;
    ...
    private class calculardiferencia extends Thread {
        ...
        public void run() {
            ...
            while (nNetoActual <= nNetoEntregar) {
                ...
                int Plazos = Integer.valueOf(cPlazo);
                double tasa = Double.parseDouble(String.valueOf(cTasa));
                double taza = tasa / 12 / 100;
    ...
    private class calculargastos extends Thread {
        ...
        public void run() {
            ...
            cImporteCapital = cImporteCapital.replace(".", "").replace(",", ".");

            String cPlazo = plazo.getText();
            cPlazo = cPlazo.replace(".", "").replace(",", ".");
            int nPlazoP = Integer.valueOf(cPlazo);
            ...
            try {
                ...
                while (results.next()) {
                    ...
                    if (results.last()) {
                        if (nPlazoP <= 12) {
                            gastos_administrativos.setText(formato.format(results.getDouble("importegastos")));
                        } else if (nPlazoP > 12 && nPlazoP <= 18) {
                            gastos_administrativos.setText(formato.format(results.getDouble("18meses")));
                        } else if (nPlazoP > 18 && nPlazoP <= 24) {
                            gastos_administrativos.setText(formato.format(results.getDouble("24meses")));
                        } else if (nPlazoP > 24 && nPlazoP <= 30) {
                            gastos_administrativos.setText(formato.format(results.getDouble("30meses")));
                        } else if (nPlazoP > 35) {
                            gastos_administrativos.setText(formato.format(results.getDouble("36meses")));
                        }
                    }
                }
                stm.close();
    ...
    private class grabarcabecera extends Thread {
        ...
        public void run() {
            ...
            //     String cImporte = this.importe.getText();
            String cNetoEntregar = neto_a_entregar.getText();
            cNetoEntregar = cNetoEntregar.replace(".", "").replace(",", ".");
            ...
            String cMontoIva = montoiva.getText();
            if (cMontoIva.trim().length() > 0) {
                cMontoIva = cMontoIva.replace(".", "").replace(",", ".");
            } else {
                cMontoIva = "0";
            }
            ...
            // COMISIONES EN PRESTAMOS HIPOTECARIOS
            String cPorcentajeDeudor = porcentaje_deudor.getText();
            cPorcentajeDeudor = cPorcentajeDeudor.replace(".", "").replace(",", ".");
            String cComisionDeudor = comision_deudor.getText();
            cComisionDeudor = cComisionDeudor.replace(".", "").replace(",", ".");
            ...
            try {
                ...
                cSqlCab += "totalamortizacion,totalprestamo,asesor,codusuario,porcentaje_deudor,porcentaje_acreedor,comision_acreedor,gastos_escritura)";
                ...
                cSqlCab += cMontoIva + "','" + cCapital + "','" + cTotal + "','" + Asesor + "','" + Config.CodUsuario + "','" + cPorcentajeDeudor + "','" + cPorcentajeAcreedor + "','" + cComisionAcreedor + "','" + cGastosEscritura + "')";
