 ...
 * @author hp
 */
public class detalle_prestamos_asociaciones extends javax.swing.JFrame {
    ...
    int cCuota = 1;
    private TableRowSorter trsfiltrocomprobante;

    ImageIcon iconobuscar = new ImageIcon("src/Iconos/buscar.png");

    public detalle_prestamos_asociaciones(String Opcion) throws ParseException {
        initComponents();
        ...
        this.limpiarCombos();
        this.BuscarAcreedor.setVisible(true);
    ...
    public void consultarTabla() throws ParseException {
        ...
        query = query + "clientes.nombre AS nombrecliente,clientes.direccion,montoaprobado,prestamos.observaciones,comprobantes.nombre as nombreprestamo ";
        query = query + "FROM prestamos ";
        query = query + "INNER JOIN clientes ";
        query = query + "ON clientes.codigo=prestamos.socio ";
        query = query + " LEFT JOIN comprobantes ";
        query = query + "ON comprobantes.codigo=prestamos.tipo ";
        ...
        try {
            ...
            if (rs.next()) {
                ...
                switch (rs.getInt("plazo")) {
                    case 2:
                        this.plazo.setSelectedIndex(0);
                        break;//
                    case 3:
                        this.plazo.setSelectedIndex(1);
                        break;//
                    case 4:
                        this.plazo.setSelectedIndex(2);
                        break;//
                    case 5:
                        this.plazo.setSelectedIndex(3);
                        break;//
                    case 6:
                        this.plazo.setSelectedIndex(4);
                        break;//
                    case 8:
                        this.plazo.setSelectedIndex(5);
                        break;//
                    case 10:
                        this.plazo.setSelectedIndex(6);
                        break;//
                    case 12:
                        this.plazo.setSelectedIndex(7);
                        break;//
                }
                ...
                this.tipoprestamo.setText(rs.getString("tipo"));
                this.nombreprestamo.setText(rs.getString("nombreprestamo"));
            }
            stm.close();
            ...
            String cComprobante = this.tipoprestamo.getText();
        } catch (SQLException ex) {
    ...
    private void initComponents() {
        ...
        jLabel25.setText("N° Préstamo");

        jLabel26.setText("Cuenta");

        jLabel27.setText("Nombre Cliente");

        AdItemGarante.setText("Agregar");
        ...
        jLabel29.setText("N° Préstamo");

        jLabel30.setText("Forma Desembolso");
        ...
        jLabel31.setText("Banco Desembolso");

        jLabel28.setText("N° Cheque");
        ...
        jLabel32.setText("Fecha Desembolso");
        ...
        jLabel33.setText("Importe Desembolsado");
        ...
        jLabel38.setText("Nombre del Refente");

        jLabel39.setText("N° Cédula");

        jLabel40.setText("Línea Baja");

        jLabel41.setText("Celular");

        jLabel42.setText("Dirección");

        jLabel43.setText("Tipo Relación");
        ...
        setTitle("Detalle Gestión de Préstamos");
        setResizable(false);
        ...
        nombreacreedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nombreacreedorActionPerformed(evt);
            }
        });

        BuscarAcreedor.setText("Refrescar");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(BuscarAcreedor, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(nombreacreedor, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(31, 31, 31)
                        .addComponent(acreedor, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jLabel12.setText("Tipo Préstamo");

        jLabel14.setText("Destino del Préstamo");

        jLabel15.setText("Tipo Garantía");
        ...
        jLabel19.setText("Importe Cuota");
        ...
        entregarneto.setText("Más IVA");
        entregarneto.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        plazo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Dos", "Tres", "Cuatro", "Cinco", "Seis", "Ocho", "Diez", "Doce" }));
        plazo.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        plazo.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                plazoItemStateChanged(evt);
            }
        });
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addComponent(cuotaoriginal, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(0, 0, Short.MAX_VALUE)))))
                        .addGap(44, 44, 44))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(tipoprestamo, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(buscarprestamo, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(nombreprestamo, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(tasa, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(31, 31, 31))))
        );
        ...
        jLabel11.setText("Neto a Entregar");
        ...
        gastos_administrativos.setEditable(false);
        ...
        GenerarCuotas.setText("Generar Cuotas");
        ...
        montoiva.setEditable(false);
        montoiva.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        montoiva.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0"))));
        ...
        jLabel13.setText("N° de Operación");
        ...
        jLabel5.setText("Asesor Comercial");
        ...
        GuardarOperacion.setText("Grabar");
        ...
        jMenuItem5.setText("Deducciones");
        ...
        jMenuItem6.setText("Comisiones");
        jMenu1.add(jMenuItem6);
        jMenu1.add(jSeparator6);

        jMenuItem7.setText("Referencias Laborales");
        jMenu1.add(jMenuItem7);
        jMenu1.add(jSeparator7);

        jMenuItem8.setText("Referencias Personales");
        jMenu1.add(jMenuItem8);
        jMenu1.add(jSeparator8);

        jMenuItem9.setText("Observaciones");
    ...
    private void GuardarOperacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarOperacionActionPerformed
        ...
        if (this.Modo.getText() != "new" || estado.getText().equals("EN PROCESO")) {
        ...
        if (ret == 0) {
            try {
                ...
                try {
                    ...
                    cSqlCab += "',socio='" + this.Cliente.getText() + "',monto_entregar='" + cNetoEntregar + "',plazo='" + String.valueOf(nplazo);
                    cSqlCab += "',deducciones='" + cDescuentos + "',importe='" + cCapital + "',monto_cuota='" + cCuota;
                    cSqlCab += "',primer_vence='" + PrimerVence + "',tipo='" + tipoprestamo.getText() + "',tasa='" + cTasa + "',interes='" + cInteres;
                    ...
                    for (int i = 0; i < Items; i++) {
                        ...
                        if (this.estado.getText().equals("DESEMBOLSADO")) {
                            ...
                            cSqlCuentas += nplazo + "','" + cNrocuota + "','" + this.Cliente.getText() + "','" + Sucursal + "','" + Moneda + "','" + tipoprestamo.getText() + "','";
                            ...
                            if (Integer.parseInt(Config.cPagoExpress) == 1) {
                                ...
                                cSqlPagoExpress += "VALUES ('" + this.Cliente.getText() + "','" + this.NombreCliente.getText() + "','" + this.idControl.getText() + "','" + this.nombreprestamo.getText() + "','";
                                cSqlPagoExpress += this.idControl.getText() + "','" + cNrocuota + "','" + cEtiquetaMoneda + "','" + cCuota + "','";
                                cSqlPagoExpress += dVence + "','" + cEstado + "','" + iddocumento + "','" + tipoprestamo.getText() + "','" + this.creferencia.getText() + "')";
                            ...
                            if (Integer.parseInt(Config.cComanda) == 1) {
                                ...
                                cSqlPagoComanda += "VALUES ('" + this.Cliente.getText() + "','" + this.NombreCliente.getText() + "','" + this.idControl.getText() + "','" + this.nombreprestamo.getText() + "','";
                                cSqlPagoComanda += this.idControl.getText() + "','" + cNrocuota + "','" + cEtiquetaMoneda + "','" + cCuota + "','";
                                cSqlPagoComanda += dVence + "','" + cEstado + "','" + iddocumento + "','" + tipoprestamo.getText() + "','" + this.creferencia.getText() + "')";
    ...
    private void importecuotaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_importecuotaFocusGained
        ...
        int Plazos = plazo.getSelectedIndex() + 1;
...
//        this.descuentos.setText(formato.format(Descuentos.totaldescuentos));
        ...
        try {
            ...
            if (d.getNprestamo() != 0) {
                ...
                cneto = this.importecapital.getText();
                cneto = cneto.replace(".", "").replace(",", ".");

                
                nneto = Double.parseDouble(cneto);
                this.neto_a_entregar.setText(formato.format(nneto -(ndescuento + Double.valueOf(cGastos))));
            }
...
// TODO add your handling code here:
    ...
    private void importecapitalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_importecapitalActionPerformed
        ...
        String cGastosPorcentaje = this.porcentaje.getText();
        cGastosPorcentaje = cGastosPorcentaje.replace(",", ".");
        this.gastos_administrativos.setText(formato.format(Math.round(nAuxiliar * Double.valueOf(cGastosPorcentaje) / 100)));
        String cGastos = this.gastos_administrativos.getText();
        cGastos = cGastos.replace(".", "").replace(",", ".");
        nAuxiliar = nAuxiliar - Double.valueOf(cGastos);
...
// TODO add your handling code here:
    ...
    private void TituloComprobante() {
        ...
        modelocomprobante.addColumn("%Gastos");
        ...
        this.tablacomprobante.getColumnModel().getColumn(3).setCellRenderer(TablaRenderer);
    ...
    private void AceptarComprobanteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarComprobanteActionPerformed
        ...
        tasa.setText(this.tablacomprobante.getValueAt(nFila, 2).toString());
        porcentaje.setText(this.tablacomprobante.getValueAt(nFila, 3).toString());
    ...
    private void buscarprestamoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarprestamoActionPerformed
        ...
        try {
            ...
            if (cm.getCodigo() == 0) {
                ...
                tasa.setText(formato.format(cm.getTasainteres()));
                porcentaje.setText(formato.format(cm.getTasainteresmora()));
                //Establecemos un título para el jDialog
            }
            destinoprestamo.requestFocus();
    ...
    private void nombreacreedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nombreacreedorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_nombreacreedorActionPerformed
    ...
    private void plazoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_plazoItemStateChanged

        // TODO add your handling code here:
    }//GEN-LAST:event_plazoItemStateChanged
    ...
    private void plazoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_plazoActionPerformed
        ...
        calculartasa vertasa = new calculartasa();
        Thread hilotasa = new Thread(vertasa);
        hilotasa.start();
...
//                new detalle_descuento_cheques().setVisible(true);
    ...
    private class grabarcabecera extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                cSqlCab += Asesor + "','" + Cliente.getText() + "','" + cNetoEntregar + "','" + String.valueOf(nCantidad) + "','" + cDescuentos + "','" + cGastos + "','";
                cSqlCab += cCapital + "','" + cCuota + "','" + PrimerVence + "','" + tipoprestamo.getText() + "','" + cTasa + "','" + cTinteres + "','";
        ...
        public void run() {
            ...
            try {
                for (comprobante com : DAOcm.todosxtipo(3)) {
                    String Datos[] = {String.valueOf(com.getCodigo()), com.getNombre(), formato.format(com.getTasainteres()), formato.format(com.getTasainteresmora())};
    ...
    private class calculartasa extends Thread {
        ...
        public void run() {
            ...
            String cPlazo = String.valueOf(plazo.getSelectedIndex() + 1);
            cPlazo = cPlazo.replace(".", "").replace(",", ".");
            String cImportePrestamo = importecapital.getText();
            cImportePrestamo = cImportePrestamo.replace(".", "").replace(",", ".");
            ...
            try {
                Connection conn = stm.getConnection();
                results = stm.executeQuery("SELECT * FROM cuoterocredito WHERE importe= " + Double.valueOf(cImportePrestamo));
                while (results.next()) {

                    switch (plazo.getSelectedIndex()) {
                        case 0:
                            tasa.setText(formato.format(results.getDouble("tasa2")));
                            importecuota.setText(formato.format(results.getDouble("cuota2")));
                            break;//por factura
                        case 1:
                            tasa.setText(formato.format(results.getDouble("tasa3")));
                            importecuota.setText(formato.format(results.getDouble("cuota3")));
                            break;//por sucursal
                        case 2:
                            tasa.setText(formato.format(results.getDouble("tasa4")));
                            importecuota.setText(formato.format(results.getDouble("cuota4")));
                            break;//por nombre del cliente
                        case 3:
                            tasa.setText(formato.format(results.getDouble("tasa5")));
                            importecuota.setText(formato.format(results.getDouble("cuota5")));
                            break;//por nombre del cliente
                        case 4:
                            tasa.setText(formato.format(results.getDouble("tasa6")));
                            importecuota.setText(formato.format(results.getDouble("cuota6")));
                            break;//por nombre del cliente
                        case 5:
                            tasa.setText(formato.format(results.getDouble("tasa8")));
                            importecuota.setText(formato.format(results.getDouble("cuota8")));
                            break;//por nombre del cliente
                        case 6:
                            tasa.setText(formato.format(results.getDouble("tasa10")));
                            importecuota.setText(formato.format(results.getDouble("cuota10")));
                            break;//por nombre del cliente
                        case 7:
                            tasa.setText(formato.format(results.getDouble("tasa12")));
                            importecuota.setText(formato.format(results.getDouble("cuota12")));
                            break;//por nombre del cliente
