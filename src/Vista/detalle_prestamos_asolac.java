 ...
 * @author hp
 */
public class detalle_prestamos_asolac extends javax.swing.JFrame {
    ...
    public detalle_prestamos_asolac(String Opcion) throws ParseException {
        initComponents();
    ...
    private void generarcuotas() {
        ...
        for (int i = 1; i <= nCantidad; i++) {
            ...
            if (i == 1) {
                ...
                nInteres = nInteres;
                fila[6] = formato.format(Double.valueOf(cGastos));
                nMontoCuota = nAmortiza + nInteres + Double.valueOf(cGastos);
                //   nMontoCuota = nMontoCuota + Double.valueOf(cGastos);
            } else {
                nMontoCuota = nCuotaAnterior;
                nInteres = Math.round((nMonto * (nTasa / 100)) / 360 * 30);
                nAmortiza = Math.round(nMontoCuota - nInteres);
                fila[6] = formato.format(0);
            }
            ...
            nImporteIva = Math.round(nTotalInteres * (Config.porcentajeiva / 100));
            this.interes.setText(formato.format(nTotalInteres));
            this.totalprestamo.setText(formato.format(nTotalPrestamo));
            this.montoiva.setText(formato.format(nImporteIva));
            this.neto_a_entregar.setText(formato.format(Double.valueOf(cMonto)-nImporteIva));
        }
    ...
    private void BuscarAcreedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarAcreedorActionPerformed
        ...
        try {
            ...
            if (d.getNprestamo() != 0) {
                ...
                String civadescuento = this.montoiva.getText();
                civadescuento = civadescuento.replace(".", "").replace(",", ".");
                this.neto_a_entregar.setText(formato.format(nneto - (ndescuento+Double.valueOf(civadescuento))));
            }
