 ...
 * @author hp
 */
public class detalle_prestamos_carlyle2 extends javax.swing.JFrame {
    ...
    public detalle_prestamos_carlyle2(String Opcion) throws ParseException {
        initComponents();
    ...
    public void consultarTabla() throws ParseException {
        ...
        query = query + "clientes.nombre AS nombrecliente,clientes.direccion,montoaprobado,prestamos.observaciones,comprobantes.nombre as nombreprestamo,prestamos.frecuenciapago  ";
        ...
        try {
            ...
            if (rs.next()) {
                ...
                this.fechaproceso.setDate(rs.getDate("fecha"));
                ...
                this.frecuenciapago.setSelectedIndex(rs.getInt("frecuenciapago"));
            }
            ...
            String cMoneda = selectCombo(this.codmoneda, "select codigo,nombre from monedas where codigo=" + nMoneda );
            String cDestino = selectCombo(this.destinoprestamo, "select codigo,nombre from destino where codigo=" + nDestino);
            String cGarantia = selectCombo(this.tipogarantia, "select codigo,nombre from garantias where codigo=" + nGarantia );
            System.out.println("Nombre Moneda "+cMoneda);
            System.out.println("Moneda "+nMoneda);
            codmoneda.setSelectedItem(nMoneda);
    ...
    private void initComponents() {
        ...
        plazo.setToolTipText("\"Pulse ENTER para Salir\"");
        ...
        jLabel44.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_carlyle2.class, "detalle_prestamos_carlyle.jLabel34.text")); // NOI18N
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(cuotaoriginal, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(tipogarantia, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(importeaprobado, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(destinoprestamo, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(creferencia, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(importecuota, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addComponent(frecuenciapago, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(48, 48, 48)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(codmoneda, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(sucursal, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        if (ret == 0) {
            try {
                ...
                try {
                    ...
                    cSqlCab += "',sucursal='" + Sucursal + "',acreedor='" + this.acreedor.getText() + "',oficial='" + Asesor+ "',frecuenciapago='" + frecuenciapago.getSelectedIndex();
                    ...
                    for (int i = 0; i < Items; i++) {
                        ...
                        if (this.estado.getText().equals("DESEMBOLSADO")) {
                            ...
                            cSqlCuentas += this.plazo.getText() + "','" + cNrocuota + "','" + this.Cliente.getText() + "','" + Sucursal + "','" + Moneda + "','" + tipoprestamo.getText() + "','";
    ...
    private void plazoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_plazoKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.frecuenciapago.requestFocus();
        }
        if (evt.getKeyCode() == KeyEvent.VK_UP) {
            this.importecapital.requestFocus();
        }
...
// TODO add your handling code here:
    ...
    private void importecapitalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_importecapitalActionPerformed
        ...
        String cGastos = this.porcentaje.getText();
        cGastos = cGastos.replace(",", ".");
        this.gastos_administrativos.setText(formato.format(Math.round(nAuxiliar * Double.valueOf(cGastos) / 100)));
...
//                new detalle_descuento_cheques().setVisible(true);
    ...
    private class grabarcabecera extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                cSqlCab += cMontoIva + "','" + cCapital + "','" + cTotal + "','" + Asesor + "','" + Config.CodUsuario +"','"+ frecuenciapago.getSelectedIndex()+ "')";
    ...
    private class calculartasa extends Thread {
        ...
        public void run() {
            ...
            try {
                Connection conn = stm.getConnection();
                results = stm.executeQuery("SELECT plazof,porcentaje FROM config_premios WHERE comprobante=" + tipoprestamo.getText() + " and moneda=" + cMoneda);
                while (results.next()) {
