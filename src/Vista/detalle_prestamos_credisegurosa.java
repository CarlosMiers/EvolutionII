 ...
 * @author hp
 */
public class detalle_prestamos_credisegurosa extends javax.swing.JFrame {
    ...
    public detalle_prestamos_credisegurosa(String Opcion) throws ParseException {
        initComponents();
...
//                nInteres = InteresAdicional;
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(tipogarantia, 0, 131, Short.MAX_VALUE)
                            .addComponent(destinoprestamo, 0, 131, Short.MAX_VALUE)
                            .addComponent(tipoprestamo, 0, 131, Short.MAX_VALUE)
                            .addComponent(plazo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(importecapital, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(importeaprobado, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(40, 40, 40))
        );
        ...
        jLabel7.setText("Comisiones Varias");
...
// TODO add your handling code here:
    ...
    private void gastos_administrativosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gastos_administrativosActionPerformed
        ...
        if(this.gastos_administrativos.getText()!="0" ){
            cGastos=this.gastos_administrativos.getText();
            cGastos=cGastos.replace(".", "").replace(",", ".");
        }
        this.totalprestamo.setText(formato.format(nAuxiliar + Double.valueOf(cGastos)));
...
//                new detalle_descuento_cheques().setVisible(true);
    ...
    private class calculargastos extends Thread {
        ...
        public void run() {
            ...
            ResultSet results = null;
            try {
                results = stm.executeQuery("SELECT * from cuoterocredito WHERE comprobante=" + cTipo + " and moneda=" + cMoneda + " and importe<=" + nImporteCapital +" ORDER BY importe");
