 ...
 * @author hp
 */
public class detalle_prestamos_pb extends javax.swing.JFrame {
    ...
    public detalle_prestamos_pb(String Opcion) throws ParseException {
        initComponents();
    ...
    public void consultarTabla() throws ParseException {
        ...
        query = query + "prestamos.comision_asesor,prestamos.codusuario,prestamos.generariva,prestamos.asesor,segurovida,gastos_escritura,";
        query = query + "prestamos.acreedor,prestamos.interesnocobrado,prestamos.oficial,prestamos.destino,prestamos.garantia,";
        query = query + "clientes.nombre AS nombrecliente,clientes.direccion,montoaprobado,prestamos.observaciones ";
        ...
        try {
            ...
            if (rs.next()) {
                nSucursal = rs.getInt("sucursal");
                nAsesor = rs.getInt("asesor");
                nMoneda = rs.getInt("moneda");
                nComprobante = rs.getInt("tipo");
                nDestino = rs.getInt("destino");
                nGarantia = rs.getInt("garantia");
                this.creferencia.setText(rs.getString("idprestamos"));
                // this.fechaproceso.setDate(results.getDate("fecha"));
                this.primer_vencimiento.setDate(rs.getDate("primer_vence"));
                this.Cliente.setText(rs.getString("socio"));
                this.NombreCliente.setText(rs.getString("nombrecliente"));
                this.Direccion.setText(rs.getString("direccion"));
                this.importecapital.setText(formato.format(rs.getDouble("importe")));
                this.tasa.setText(formato.format(rs.getDouble("tasa")));
                this.plazo.setText(formato.format(rs.getInt("plazo")));
                this.importecuota.setText(formato.format(rs.getDouble("monto_cuota")));
                this.montoiva.setText(formato.format(rs.getInt("ivainteres")));
                this.gastos_administrativos.setText(formato.format(rs.getDouble("comision_deudor")));
                this.descuentos.setText(formato.format(rs.getDouble("deducciones")));
                this.interes.setText(formato.format(rs.getDouble("interes")));
                this.totalprestamo.setText(formato.format(rs.getDouble("totalprestamo")));
                this.neto_a_entregar.setText(formato.format(rs.getDouble("monto_entregar")));
                this.segurovida.setText(formato.format(rs.getDouble("segurovida")));
                this.comision.setText(formato.format(rs.getDouble("gastos_escritura")));
                this.acreedor.setText(rs.getString("acreedor"));
                this.importeaprobado.setText(formato.format(rs.getDouble("montoaprobado")));
                this.estado.setText(rs.getString("estado"));
                this.observaciones2.setText(rs.getString("observaciones"));
            }
            stm.close();
    ...
    private void initComponents() {
        ...
        CtaTitular.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.CtaTitular.text")); // NOI18N
        ...
        NombreTitular.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.NombreTitular.text")); // NOI18N
        NombreTitular.setBorder(null);

        NroPrestamo.setEditable(false);
        NroPrestamo.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.NroPrestamo.text")); // NOI18N
        NroPrestamo.setBorder(null);

        jLabel25.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel25.text")); // NOI18N

        jLabel26.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel26.text")); // NOI18N

        jLabel27.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel27.text")); // NOI18N

        AdItemGarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.AdItemGarante.text")); // NOI18N
        ...
        DelItemGarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.DelItemGarante.text")); // NOI18N
        ...
        codgarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.codgarante.text")); // NOI18N
        ...
        BuscarGarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.BuscarGarante.text")); // NOI18N
        ...
        nombregarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.nombregarante.text")); // NOI18N
        ...
        Cuenta.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.Cuenta.text")); // NOI18N

        ctaclientedesembolso.setEditable(false);
        ctaclientedesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.ctaclientedesembolso.text")); // NOI18N

        nombrecliente.setEditable(false);
        nombrecliente.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.nombrecliente.text")); // NOI18N

        nprestamodesembolso.setEditable(false);
        nprestamodesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.nprestamodesembolso.text")); // NOI18N

        jLabel29.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel29.text")); // NOI18N

        jLabel30.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel30.text")); // NOI18N

        formadesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.formadesembolso.text")); // NOI18N
        ...
        nombreformadesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.nombreformadesembolso.text")); // NOI18N

        bancodesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.bancodesembolso.text")); // NOI18N
        ...
        banconombredesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.banconombredesembolso.text")); // NOI18N

        jLabel31.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel31.text")); // NOI18N

        jLabel28.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel28.text")); // NOI18N

        nrocheque.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.nrocheque.text")); // NOI18N
        ...
        GrabarDesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.GrabarDesembolso.text")); // NOI18N
        ...
        jButton2.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jButton2.text")); // NOI18N
        ...
        jLabel32.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel32.text")); // NOI18N
        ...
        netodesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.netodesembolso.text")); // NOI18N

        jLabel33.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel33.text")); // NOI18N

        buscarfdesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.buscarfdesembolso.text")); // NOI18N
        ...
        buscarbdesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.buscarbdesembolso.text")); // NOI18N
        ...
        jLabel36.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel36.text")); // NOI18N

        rfpnroprestamo.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.rfpnroprestamo.text")); // NOI18N

        jLabel37.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel37.text")); // NOI18N

        rfpcuenta.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.rfpcuenta.text")); // NOI18N

        rfpnombrecuenta.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.rfpnombrecuenta.text")); // NOI18N
        ...
        jButton1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jButton1.text")); // NOI18N

        jButton9.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jButton9.text")); // NOI18N

        jLabel38.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel38.text")); // NOI18N

        jLabel39.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel39.text")); // NOI18N

        jTextField1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jTextField1.text")); // NOI18N

        jTextField2.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jTextField2.text")); // NOI18N

        jLabel40.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel40.text")); // NOI18N

        jTextField3.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jTextField3.text")); // NOI18N

        jLabel41.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel41.text")); // NOI18N

        jTextField4.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jTextField4.text")); // NOI18N

        jTextField5.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jTextField5.text")); // NOI18N

        jLabel42.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel42.text")); // NOI18N

        jLabel43.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel43.text")); // NOI18N

        jTextField6.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jTextField6.text")); // NOI18N
        ...
        setTitle(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.title")); // NOI18N
        setResizable(false);
        ...
        jButton3.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jButton3.text")); // NOI18N
        ...
        jButton6.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jButton6.text")); // NOI18N
        ...
        nombreacreedor.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.nombreacreedor.text")); // NOI18N
        ...
        BuscarAcreedor.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.BuscarAcreedor.text")); // NOI18N
        ...
        acreedor.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.acreedor.text")); // NOI18N
        ...
        jLabel34.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel34.text")); // NOI18N
        ...
        importecapital.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.importecapital.text")); // NOI18N
        importecapital.setToolTipText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.importecapital.toolTipText")); // NOI18N
        ...
        jLabel12.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel12.text")); // NOI18N

        jLabel14.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel14.text")); // NOI18N

        jLabel15.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel15.text")); // NOI18N

        jLabel16.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel16.text")); // NOI18N

        tasa.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.tasa.text")); // NOI18N
        ...
        jLabel17.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel17.text")); // NOI18N

        jLabel18.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel18.text")); // NOI18N
        ...
        importecuota.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.importecuota.text")); // NOI18N
        ...
        jLabel19.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel19.text")); // NOI18N
        ...
        Modo.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.Modo.text")); // NOI18N

        jLabel21.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel21.text")); // NOI18N
        ...
        plazo.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.plazo.text")); // NOI18N
        plazo.setToolTipText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.plazo.toolTipText")); // NOI18N
        ...
        jLabel22.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel22.text")); // NOI18N

        creferencia.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.creferencia.text")); // NOI18N
        ...
        incluiriva.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.incluiriva.text")); // NOI18N

        entregarneto.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.entregarneto.text")); // NOI18N
        ...
        importeaprobado.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.importeaprobado.text")); // NOI18N
        ...
        cuotaoriginal.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.cuotaoriginal.text")); // NOI18N
        ...
        jLabel4.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel4.text")); // NOI18N

        Cliente.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.Cliente.text")); // NOI18N
        ...
        Direccion.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.Direccion.text")); // NOI18N
        ...
        BuscarCliente.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.BuscarCliente.text")); // NOI18N
        ...
        jLabel35.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel35.text")); // NOI18N
        ...
        jLabel11.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel11.text")); // NOI18N
        ...
        jLabel10.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel10.text")); // NOI18N
        ...
        jLabel9.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel9.text")); // NOI18N
        ...
        gastos_administrativos.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.gastos_administrativos.text")); // NOI18N
        ...
        jLabel7.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel7.text")); // NOI18N
        ...
        descuentos.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.descuentos.text")); // NOI18N
        ...
        jLabel8.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel8.text")); // NOI18N
        ...
        montoiva.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.montoiva.text")); // NOI18N
        ...
        jLabel6.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel6.text")); // NOI18N
        ...
        idfila.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.idfila.text")); // NOI18N
        ...
        jLabel23.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel23.text")); // NOI18N
        ...
        jLabel24.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel24.text")); // NOI18N
        ...
        calcularneto.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.calcularneto.text")); // NOI18N
        ...
        auxiliar.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.auxiliar.text")); // NOI18N

        estado.setEditable(false);
        estado.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        estado.setForeground(new java.awt.Color(255, 0, 0));
        estado.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.estado.text")); // NOI18N

        GenerarCuotas.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.GenerarCuotas.text")); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel2.text")); // NOI18N

        jLabel13.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel13.text")); // NOI18N

        idControl.setEditable(false);
        idControl.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        idControl.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.idControl.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel3.text")); // NOI18N
        ...
        jLabel5.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel5.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jLabel1.text")); // NOI18N
        ...
        agregarpago.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.agregarpago.text")); // NOI18N
        ...
        eliminarpago.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.eliminarpago.text")); // NOI18N
        ...
        GuardarOperacion.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.GuardarOperacion.text")); // NOI18N
        ...
        Salir.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.Salir.text")); // NOI18N
        ...
        jMenu1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jMenu1.text")); // NOI18N

        jMenuItem1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jMenuItem1.text")); // NOI18N
        ...
        jMenuItem2.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jMenuItem2.text")); // NOI18N
        jMenu1.add(jMenuItem2);
        jMenu1.add(jSeparator2);

        jMenuItem3.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jMenuItem3.text")); // NOI18N
        ...
        jMenuItem4.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jMenuItem4.text")); // NOI18N
        ...
        jMenuItem5.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jMenuItem5.text")); // NOI18N
        ...
        jMenuItem6.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jMenuItem6.text")); // NOI18N
        jMenu1.add(jMenuItem6);
        jMenu1.add(jSeparator6);

        jMenuItem7.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jMenuItem7.text")); // NOI18N
        jMenu1.add(jMenuItem7);
        jMenu1.add(jSeparator7);

        jMenuItem8.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jMenuItem8.text")); // NOI18N
        jMenu1.add(jMenuItem8);
        jMenu1.add(jSeparator8);

        jMenuItem9.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_pb.class, "detalle_prestamos_pb.jMenuItem9.text")); // NOI18N
...
// TODO add your handling code here:
    ...
    private void importecapitalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_importecapitalActionPerformed
        ...
        System.out.println("Auxiliar IVA " + auxiva);
        System.out.println("IVA " + Config.nArancelIva);
