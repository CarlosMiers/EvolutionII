 ...
 * @author hp
 */
public class detalle_prestamos_preciosbajos extends javax.swing.JFrame {
    ...
    public detalle_prestamos_preciosbajos(String Opcion) throws ParseException {
        initComponents();
        ...
        this.cuotaoriginal.setVisible(false);
        this.estado.setVisible(false);
        this.entregarneto.setVisible(false);
        ...
        this.importeaprobado.setVisible(false);
        ...
        this.segurovida.setHorizontalAlignment(JTextField.RIGHT);
        ...
        this.acreedor.setVisible(false);
        this.nombreacreedor.setVisible(false);

        this.BuscarAcreedor.setVisible(false);
        ...
        if (Opcion == "new") {
            ...
            this.GuardarOperacion.setEnabled(false);
        } else {
            this.idControl.setText(Opcion);
            this.fechaproceso.setCalendar(c2);
    ...
    private void generarcuotas() {
        ...
        String cMonto = this.totalprestamo.getText();
        ...
        for (int i = 1; i <= nCantidad; i++) {
            ...
            if (i == 1 && Integer.valueOf(cdiferencia) > 31) {
                InteresAdicional = Math.round(nMonto * (nTasa / 100)) / 365 * ((Integer.valueOf(cdiferencia) - 30));
                double nResto = Math.round(InteresAdicional / nCantidad);
                nMontoCuota = nMontoCuota + nResto;
                nInteres = Math.round(nMonto * (nTasa / 12) / 100);
                nInteres = nInteres+InteresAdicional;
                nAmortiza = Math.round(nMontoCuota - nInteres);
                //nAmortiza = Math.round(nMontoCuota - InteresAdicional);
                nCuotaAnterior = nMontoCuota;
...
//                nInteres = InteresAdicional;
    ...
    public void consultarPagos() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                fila2[0] = rs.getInt("forma");
                fila2[1] = rs.getString("nombreformapago");
                fila2[2] = rs.getInt("banco");
                fila2[3] = rs.getString("nombrebanco");
                fila2[4] = formatoFecha.format(rs.getDate("confirmacion"));
                fila2[5] = formato.format(rs.getInt("netocobrado"));
    ...
    public void consultarTabla() throws ParseException {
        ...
        prestamo p = null;
        try {
            p = pre.buscarId(Integer.valueOf(idControl.getText()));
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "ERROR:" + e.getMessage());
        }
        if (p != null) {
            nSucursal = p.getSucursal().getCodigo();
            nAsesor = p.getOficial().getCodigo();
            nMoneda = p.getMoneda().getCodigo();
            nComprobante = p.getTipo().getCodigo();
            nDestino = p.getDestino();
            nGarantia = p.getGarantia();
            this.creferencia.setText(p.getIdprestamos());
            this.primer_vencimiento.setDate(p.getPrimer_vence());
            this.Cliente.setText(String.valueOf(p.getSocio().getCodigo()));
            this.NombreCliente.setText(p.getSocio().getNombre());
            this.Direccion.setText(p.getSocio().getDireccion());
            this.importecapital.setText(formato.format(p.getImporte()));
            this.tasa.setText(formato.format(p.getTasa()));
            this.plazo.setText(formato.format(p.getPlazo()));
            this.importecuota.setText(formato.format(p.getMonto_cuota()));
            this.montoiva.setText(formato.format(p.getIvainteres()));
            this.gastos_administrativos.setText(formato.format(p.getComision_deudor()));
            this.descuentos.setText(formato.format(p.getDeducciones()));
            this.interes.setText(formato.format(p.getInteres()));
            this.totalprestamo.setText(formato.format(p.getTotalprestamo()));
            this.neto_a_entregar.setText(formato.format(p.getMonto_entregar()));
            this.segurovida.setText(formato.format(p.getSegurovida()));
            this.comision.setText(formato.format(p.getGastos_escritura()));
            this.importeaprobado.setText(formato.format(p.getMontoaprobado()));
            this.estado.setText(p.getEstado());
            this.observaciones2.setText(p.getObservaciones());
    ...
    private void initComponents() {
        ...
        observaciones2 = new javax.swing.JTextArea();
        ...
        cuotaoriginal = new javax.swing.JFormattedTextField();
        ...
        CtaTitular.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.CtaTitular.text")); // NOI18N
        ...
        NombreTitular.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.NombreTitular.text")); // NOI18N
        NombreTitular.setBorder(null);

        NroPrestamo.setEditable(false);
        NroPrestamo.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.NroPrestamo.text")); // NOI18N
        NroPrestamo.setBorder(null);

        jLabel25.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel25.text")); // NOI18N

        jLabel26.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel26.text")); // NOI18N

        jLabel27.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel27.text")); // NOI18N

        AdItemGarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.AdItemGarante.text")); // NOI18N
        ...
        DelItemGarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.DelItemGarante.text")); // NOI18N
        ...
        codgarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.codgarante.text")); // NOI18N
        ...
        BuscarGarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.BuscarGarante.text")); // NOI18N
        ...
        nombregarante.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.nombregarante.text")); // NOI18N
        ...
        Cuenta.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.Cuenta.text")); // NOI18N

        ctaclientedesembolso.setEditable(false);
        ctaclientedesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.ctaclientedesembolso.text")); // NOI18N

        nombrecliente.setEditable(false);
        nombrecliente.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.nombrecliente.text")); // NOI18N

        nprestamodesembolso.setEditable(false);
        nprestamodesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.nprestamodesembolso.text")); // NOI18N

        jLabel29.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel29.text")); // NOI18N

        jLabel30.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel30.text")); // NOI18N

        formadesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.formadesembolso.text")); // NOI18N
        ...
        nombreformadesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.nombreformadesembolso.text")); // NOI18N

        bancodesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.bancodesembolso.text")); // NOI18N
        ...
        banconombredesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.banconombredesembolso.text")); // NOI18N

        jLabel31.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel31.text")); // NOI18N

        jLabel28.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel28.text")); // NOI18N

        nrocheque.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.nrocheque.text")); // NOI18N
        ...
        GrabarDesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.GrabarDesembolso.text")); // NOI18N
        ...
        jButton2.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jButton2.text")); // NOI18N
        ...
        jLabel32.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel32.text")); // NOI18N
        ...
        netodesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.netodesembolso.text")); // NOI18N

        jLabel33.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel33.text")); // NOI18N

        buscarfdesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.buscarfdesembolso.text")); // NOI18N
        ...
        buscarbdesembolso.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.buscarbdesembolso.text")); // NOI18N
        ...
        jLabel36.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel36.text")); // NOI18N

        rfpnroprestamo.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.rfpnroprestamo.text")); // NOI18N

        jLabel37.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel37.text")); // NOI18N

        rfpcuenta.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.rfpcuenta.text")); // NOI18N

        rfpnombrecuenta.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.rfpnombrecuenta.text")); // NOI18N
        ...
        jButton1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jButton1.text")); // NOI18N

        jButton9.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jButton9.text")); // NOI18N

        jLabel38.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel38.text")); // NOI18N

        jLabel39.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel39.text")); // NOI18N

        jTextField1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jTextField1.text")); // NOI18N

        jTextField2.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jTextField2.text")); // NOI18N

        jLabel40.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel40.text")); // NOI18N

        jTextField3.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jTextField3.text")); // NOI18N

        jLabel41.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel41.text")); // NOI18N

        jTextField4.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jTextField4.text")); // NOI18N

        jTextField5.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jTextField5.text")); // NOI18N

        jLabel42.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel42.text")); // NOI18N

        jLabel43.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel43.text")); // NOI18N

        jTextField6.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jTextField6.text")); // NOI18N
        ...
        setTitle(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.title")); // NOI18N
        setResizable(false);
        ...
        jButton3.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jButton3.text")); // NOI18N
        ...
        jButton6.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jButton6.text")); // NOI18N
        ...
        nombreacreedor.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.nombreacreedor.text")); // NOI18N
        ...
        BuscarAcreedor.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.BuscarAcreedor.text")); // NOI18N
        BuscarAcreedor.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        BuscarAcreedor.setEnabled(false);
        ...
        acreedor.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.acreedor.text")); // NOI18N
        acreedor.setEnabled(false);
        ...
        observaciones2.setEditable(false);
        observaciones2.setColumns(20);
        observaciones2.setRows(5);
        jScrollPane5.setViewportView(observaciones2);

        jLabel34.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel34.text")); // NOI18N
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(nombreacreedor, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        importecapital.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.importecapital.text")); // NOI18N
        importecapital.setToolTipText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.importecapital.toolTipText")); // NOI18N
        importecapital.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                importecapitalFocusGained(evt);
            }
        ...
        jLabel12.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel12.text")); // NOI18N

        jLabel14.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel14.text")); // NOI18N

        jLabel15.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel15.text")); // NOI18N

        jLabel16.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel16.text")); // NOI18N

        tasa.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.tasa.text")); // NOI18N
        ...
        jLabel17.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel17.text")); // NOI18N

        jLabel18.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel18.text")); // NOI18N
        ...
        importecuota.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.importecuota.text")); // NOI18N
        ...
        jLabel19.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel19.text")); // NOI18N
        ...
        Modo.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.Modo.text")); // NOI18N

        jLabel21.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel21.text")); // NOI18N
        ...
        plazo.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.plazo.text")); // NOI18N
        plazo.setToolTipText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.plazo.toolTipText")); // NOI18N
        ...
        jLabel22.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel22.text")); // NOI18N

        creferencia.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.creferencia.text")); // NOI18N
        ...
        incluiriva.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.incluiriva.text")); // NOI18N

        entregarneto.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.entregarneto.text")); // NOI18N
        entregarneto.setEnabled(false);
        ...
        importeaprobado.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.importeaprobado.text")); // NOI18N
        importeaprobado.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                importeaprobadoFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                importeaprobadoFocusLost(evt);
            }
        });
        importeaprobado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                importeaprobadoActionPerformed(evt);
            }
        });
        importeaprobado.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                importeaprobadoKeyPressed(evt);
            }
        });

        cuotaoriginal.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0"))));
        cuotaoriginal.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        cuotaoriginal.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.cuotaoriginal.text")); // NOI18N
        cuotaoriginal.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                cuotaoriginalFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                cuotaoriginalFocusLost(evt);
            }
        });
        cuotaoriginal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cuotaoriginalActionPerformed(evt);
            }
        });
        cuotaoriginal.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cuotaoriginalKeyPressed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(cuotaoriginal, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(importeaprobado, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(54, 54, 54))
        );
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jLabel19)
                            .addComponent(importecuota, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(entregarneto)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cuotaoriginal, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(importeaprobado, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        jLabel4.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel4.text")); // NOI18N

        Cliente.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.Cliente.text")); // NOI18N
        ...
        Direccion.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.Direccion.text")); // NOI18N
        ...
        BuscarCliente.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.BuscarCliente.text")); // NOI18N
        ...
        jLabel35.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel35.text")); // NOI18N
        ...
        jLabel11.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel11.text")); // NOI18N
        ...
        jLabel10.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel10.text")); // NOI18N
        ...
        jLabel9.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel9.text")); // NOI18N
        ...
        gastos_administrativos.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.gastos_administrativos.text")); // NOI18N
        ...
        jLabel7.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel7.text")); // NOI18N
        ...
        descuentos.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.descuentos.text")); // NOI18N
        ...
        jLabel8.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel8.text")); // NOI18N
        ...
        montoiva.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.montoiva.text")); // NOI18N
        ...
        jLabel6.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel6.text")); // NOI18N

        segurovida.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        segurovida.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0.00"))));
        segurovida.setDisabledTextColor(new java.awt.Color(255, 0, 0));
        segurovida.setEnabled(false);
        segurovida.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N

        idfila.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.idfila.text")); // NOI18N
        ...
        jLabel23.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel23.text")); // NOI18N
        ...
        jLabel24.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel24.text")); // NOI18N
        ...
        calcularneto.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.calcularneto.text")); // NOI18N
        ...
        auxiliar.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.auxiliar.text")); // NOI18N

        estado.setEditable(false);
        estado.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        estado.setForeground(new java.awt.Color(255, 0, 0));
        estado.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.estado.text")); // NOI18N

        GenerarCuotas.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.GenerarCuotas.text")); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel2.text")); // NOI18N

        jLabel13.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel13.text")); // NOI18N

        idControl.setEditable(false);
        idControl.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        idControl.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.idControl.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel3.text")); // NOI18N
        ...
        jLabel5.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel5.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jLabel1.text")); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(fechaproceso, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(codmoneda, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        agregarpago.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.agregarpago.text")); // NOI18N
        ...
        eliminarpago.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.eliminarpago.text")); // NOI18N
        ...
        GuardarOperacion.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.GuardarOperacion.text")); // NOI18N
        ...
        Salir.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.Salir.text")); // NOI18N
        ...
        jMenu1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jMenu1.text")); // NOI18N

        jMenuItem1.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jMenuItem1.text")); // NOI18N
        ...
        jMenuItem2.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jMenuItem2.text")); // NOI18N
        jMenu1.add(jMenuItem2);
        jMenu1.add(jSeparator2);

        jMenuItem3.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jMenuItem3.text")); // NOI18N
        ...
        jMenuItem4.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jMenuItem4.text")); // NOI18N
        ...
        jMenuItem5.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jMenuItem5.text")); // NOI18N
        ...
        jMenuItem6.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jMenuItem6.text")); // NOI18N
        jMenu1.add(jMenuItem6);
        jMenu1.add(jSeparator6);

        jMenuItem7.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jMenuItem7.text")); // NOI18N
        jMenu1.add(jMenuItem7);
        jMenu1.add(jSeparator7);

        jMenuItem8.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jMenuItem8.text")); // NOI18N
        jMenu1.add(jMenuItem8);
        jMenu1.add(jSeparator8);

        jMenuItem9.setText(org.openide.util.NbBundle.getMessage(detalle_prestamos_preciosbajos.class, "detalle_prestamos_preciosbajos.jMenuItem9.text")); // NOI18N
    ...
    private void GuardarOperacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarOperacionActionPerformed
        ...
        if (this.Modo.getText() != "new") {
            String cT = importecapital.getText();
            cT = cT.replace(".", "");

            String cT2 = importeaprobado.getText();
            cT2 = cT2.replace(".", "");

            if (Double.valueOf(cT) > Double.valueOf(cT2)) {
                JOptionPane.showMessageDialog(null, "Supera el Monto Aprobado, Verifique");
        ...
        String cSeguroVida = segurovida.getText();
        cSeguroVida = cSeguroVida.replace(".", "");
        cSeguroVida = cSeguroVida.replace(",", ".");
        ...
        if (ret == 0) {
            try {
                ...
                try {
                    ...
                    cSqlCab += "',segurovida='" + cSeguroVida + "',gastos_escritura='" + cComision;
                    ...
                    for (int i = 0; i < Items; i++) {
                        ...
                        if (this.estado.getText().equals("DESEMBOLSADO")) {
    ...
    private void importecuotaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_importecuotaFocusGained
        ...
        String cCapital = String.valueOf(this.totalprestamo.getText());
        cCapital = cCapital.replace(".", "");
        cCapital = cCapital.replace(",", ".");
        ...
        this.cuotaoriginal.setText(formato.format(Cuota_F));
    ...
    private void plazoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_plazoActionPerformed
        ...
        Thread HiloTasa = new Thread(calculartasa);
        HiloTasa.start();
// TODO add your handling code here:
    ...
    private void importecapitalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_importecapitalActionPerformed
        String cAuxiliar = this.importecapital.getText();
        cAuxiliar = cAuxiliar.replace(".", "");
        cAuxiliar = cAuxiliar.replace(",", ".");
        double nAuxiliar = Double.valueOf(cAuxiliar);
        this.gastos_administrativos.setText(formato.format(Math.round(nAuxiliar * Config.nArancelGastos / 100)));
        this.comision.setText(formato.format(Math.round(nAuxiliar * Config.nArancelComision / 100)));
        this.segurovida.setText(formato.format(Math.round(nAuxiliar * Config.nArancelSeguro / 100)));
        double auxiva = Math.round(nAuxiliar * Config.nArancelGastos / 100) + Math.round(nAuxiliar * Config.nArancelComision / 100) + Math.round(nAuxiliar * Config.nArancelSeguro / 100);
        this.montoiva.setText(formato.format(Math.round(auxiva * Config.nArancelIva / 100)));
        this.totalprestamo.setText(formato.format(nAuxiliar + Math.round(nAuxiliar * Config.nArancelGastos / 100) + Math.round(nAuxiliar * Config.nArancelComision / 100) + Math.round(nAuxiliar * Config.nArancelSeguro / 100) + Math.round(auxiva * Config.nArancelIva / 100)));
        this.neto_a_entregar.setText(formato.format(nAuxiliar));
        // TODO add your handling code here:
...
// TODO add your handling code here:
    ...
    private void GrabarDesembolsoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarDesembolsoActionPerformed
        ...
        this.estado.setText("DESEMBOLSADO");
        prestamoDAO pr1 = new prestamoDAO();
        prestamo p = null;
        try {
            p = pr1.buscarId(Integer.valueOf(this.idControl.getText()));
            p.setNumero(Integer.valueOf(this.idControl.getText().toString()));
            p.setEstado("DESEMBOLSADO");
            pr1.ActualizarPrestamoDesembolso(p);
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "ERROR:" + e.getMessage());
        }
    ...
    private void entregarnetoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_entregarnetoActionPerformed
        if (this.entregarneto.isSelected()) { // Si hemos dado clic en el jCheckBox
            String cCapital = this.totalprestamo.getText();
            cCapital = cCapital.replace(".", "");
            cCapital = cCapital.replace(",", ".");
...
// TODO add your handling code here:
    ...
    private void GenerarCuotasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GenerarCuotasActionPerformed
        //   if (this.importecuota.getText() != this.cuotaoriginal.getText()) {
        //        this.importecuota.setText(cuotaoriginal.getText());
        //    }
        this.generarcuotas();
    ...
    private void importecapitalFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_importecapitalFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_importecapitalFocusGained

    private void importeaprobadoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_importeaprobadoFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_importeaprobadoFocusGained

    private void importeaprobadoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_importeaprobadoFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_importeaprobadoFocusLost

    private void importeaprobadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_importeaprobadoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_importeaprobadoActionPerformed

    private void importeaprobadoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_importeaprobadoKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_importeaprobadoKeyPressed

    private void cuotaoriginalFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cuotaoriginalFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_cuotaoriginalFocusGained

    private void cuotaoriginalFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cuotaoriginalFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_cuotaoriginalFocusLost

    private void cuotaoriginalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cuotaoriginalActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cuotaoriginalActionPerformed

    private void cuotaoriginalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cuotaoriginalKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_cuotaoriginalKeyPressed
...
//                new detalle_descuento_cheques().setVisible(true);
    ...
    private javax.swing.JFormattedTextField cuotaoriginal;
    ...
    private javax.swing.JTextArea observaciones2;
    ...
    private class calculartasa extends Thread {
        ...
        public void run() {
            ...
            ResultSet results = null;
            try {
                results = stm.executeQuery("SELECT plazoi,porcentaje FROM config_premios WHERE comprobante=" + cTipo + " and moneda=" + cMoneda);
                while (results.next()) {
                    String cPl = results.getString("plazoi");
    ...
    private class grabarbanco extends Thread {
        ...
        public void run() {
            con = new Conexion();
            stm = con.conectar();
            String cObs  = "'DESEMBOLSO PRÉSTAMO "+NombreCliente.getText().trim()+"'";
            ...
            cSqlAgregarBanco += "detalle_forma_pago.banco,detalle_forma_pago.codmoneda,"+cObs;
            ...
            cSqlAgregarBanco += "LEFT JOIN detalle_forma_pago ";
    ...
    private class grabarcabecera extends Thread {
        ...
        public void run() {
            ...
            ResultSet results = null;
            try {
                String cSqlCab = "INSERT INTO Prestamos (idprestamos,fecha,moneda,sucursal,acreedor,oficial,socio,";
                cSqlCab += "monto_entregar,plazo,deducciones,comision_deudor,importe,monto_cuota,primer_vence,tipo,tasa,interes,ivainteres,";
                cSqlCab += "totalamortizacion,totalprestamo,asesor,gastos_escritura,segurovida,codusuario)";
                cSqlCab += "VALUES ('" + creferencia.getText() + "','" + FechaProceso + "','" + Moneda + "','" + Sucursal + "','" + acreedor.getText() + "','";
                ...
                cSqlCab += cMontoIva + "','" + cCapital + "','" + cTotal + "','" + Asesor + "','" + cComision + "','" + cSeguroVida + "','" + Config.CodUsuario + "')";
                ...
                for (int i = 0; i < Items; i++) {
                    ...
                    String cSqlDet = "INSERT INTO detalle_prestamo (nprestamo,nrocuota,dias,capital,amortiza,minteres,vence,monto,ivaxinteres)";
                    cSqlDet += "VALUES ('" + idNumero + "','" + cNrocuota + "','" + cNroDias + "','";
                    cSqlDet += cCapital + "','" + cAmortiza + "','" + cInteres + "','" + dVence + "','" + cCuota + "','" + cMontoIva + "')";
                    stm.executeUpdate(cSqlDet);
                }
                stm.close();
