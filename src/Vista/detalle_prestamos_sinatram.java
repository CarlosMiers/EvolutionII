 ...
 * @author hp
 */
public class detalle_prestamos_sinatram extends javax.swing.JFrame {
    ...
    public detalle_prestamos_sinatram(String Opcion) throws ParseException {
        initComponents();
    ...
    private void generarcuotas() {
        ...
        for (int i = 1; i <= nCantidad; i++) {
            ...
            if (Integer.parseInt(cMoneda) == 1) {
                nInteres = Math.round(nAmortiza * nTasa / 100);
                nMontoCuota=Double.valueOf(cMontoCuota)+nInteres;
            } else {
                nInteres = nAmortiza * nTasa / 100;
                nMontoCuota=Double.valueOf(cMontoCuota)+nInteres;
            }
            ...
            this.vencimientos.setDate(calendar.getTime()); //Y cargamos finalmente en el 
            nAmortiza = nAmortiza - Double.valueOf(cMontoCuota);
    ...
    private void importecuotaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_importecuotaFocusGained
        ...
        double Cuota_F = 0.00;
        if (cMoneda.equals("1")) {
            Cuota_F = Math.round((Monto + Gasto) / Plazos);
        } else {
            Cuota_F = (Monto + Gasto) / Plazos;
        }
