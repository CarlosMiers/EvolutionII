...
import DAO.ventaDAO;
import Modelo.Detalleventasxcaja;
import Modelo.caja;
 ...
 * @author hp
 */
public class detalle_ventasxcajas extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {100, 80, 300, 100, 300, 100, 100, 80, 100, 150, 300};
    ...
    private void initComponents() {
        ...
        jTBuscarCaja.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxcajas.class, "ventas.jTBuscarClientes.text")); // NOI18N
        jTBuscarCaja.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                jTBuscarCajaFocusGained(evt);
            }
        });
        ...
        AceptarCaja.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxcajas.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCaja.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxcajas.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxcajas.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxcajas.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxcajas.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Detalle de Ventas por Cajas ");
        ...
        etiquetasaldos.setText("Detalle de Ventas por Cajas ");
        ...
        buscarCaja.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                buscarCajaMouseClicked(evt);
            }
        });
    ...
    private void jTBuscarCajaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTBuscarCajaKeyPressed
        this.jTBuscarCaja.addKeyListener(new KeyAdapter() {
            public void keyReleased(final KeyEvent e) {
                ...
                repaint();
                filtroscaja(indiceColumnaTabla);
            }
        });
    ...
    private void cajaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cajaKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.jTBuscarCaja.requestFocus();
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_cajaKeyPressed

    private void cajaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cajaKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_cajaKeyReleased
    ...
    private void buscarCajaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buscarCajaMouseClicked
        jTBuscarCaja.requestFocus();

    }//GEN-LAST:event_buscarCajaMouseClicked
    ...
    private void buscarCajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarCajaActionPerformed
        if (caja.getText().isEmpty()) {
            ...
            caja.setText("0");
            nombrecaja.setText("Todas las Cajas");
            moneda.requestFocus();
        } else {
            cajaDAO cjDAO = new cajaDAO();
            caja cj = null;
            try {
                cj = cjDAO.buscarId(Integer.valueOf(this.caja.getText()));
                if (cj.getCodigo() == 0) {
    ...
    private void jTBuscarCajaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTBuscarCajaFocusGained
        caja.selectAll();
    }//GEN-LAST:event_jTBuscarCajaFocusGained
    ...
    public void filtroscaja(int nNumeroColumna) {
    ...
    private class GenerarConsultaVenta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (venta orden : DAO.DetalleVtaxCaja(FechaI, FechaF, nCaja, nCaja, nMoneda)) {
                    String Datos[] = {formatosinpunto.format(orden.getFactura()), formatoFecha.format(orden.getFecha()), orden.getCliente().getNombre(), orden.getCodprodventa(), orden.getNombreproductoventa(), formato.format(orden.getCantidadventa()), formato.format(orden.getPrecioventa()), formato.format(orden.getTotalneto()), String.valueOf(orden.getPorcentaje()), String.valueOf(orden.getCaja().getCodigo()), orden.getCaja().getNombre()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
         ...
         public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                tipo = new Detalleventasxcaja(jTable1.getValueAt(nFila, 0).toString(), jTable1.getValueAt(nFila, 1).toString(), jTable1.getValueAt(nFila, 3).toString(), jTable1.getValueAt(nFila, 4).toString(), Double.valueOf(cCantidad), Double.valueOf(cPrecio), Integer.valueOf(jTable1.getValueAt(nFila, 8).toString()), Double.valueOf(cTotal), jTable1.getValueAt(nFila, 2).toString(), Integer.valueOf(jTable1.getValueAt(nFila, 9).toString()), jTable1.getValueAt(nFila, 10).toString());
                Resultados.add(tipo);
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/detalle_ventascajas.jasper");
