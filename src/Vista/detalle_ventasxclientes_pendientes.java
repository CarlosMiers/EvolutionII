...
import DAO.ventaDAO;
import Modelo.Detalleventasxcliente;
 ...
 * @author hp
 */
public class detalle_ventasxclientes_pendientes extends javax.swing.JFrame {
     ...
     */
    public detalle_ventasxclientes_pendientes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxclientes_pendientes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCliente.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxclientes_pendientes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCliente.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxclientes_pendientes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxclientes_pendientes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxclientes_pendientes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxclientes_pendientes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Detalle de Venta por Clientes");
        ...
        etiquetasaldos.setText("Detalle de Venta por Clientes");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(nombrecliente, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(27, 27, 27))
        );
    ...
    private void jTBuscarClienteKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTBuscarClienteKeyPressed
        this.jTBuscarCliente.addKeyListener(new KeyAdapter() {
            public void keyReleased(final KeyEvent e) {
                ...
                repaint();
                filtroscliente(indiceColumnaTabla);
            }
        });
    ...
    public void filtroscliente(int nNumeroColumna) {
    ...
    private class GenerarConsultaVenta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (venta orden : DAO.DetalleVtaxClientePendiente(FechaI, FechaF, nCliente, nCliente, nMoneda)) {
                    String Datos[] = {formatosinpunto.format(orden.getFactura()), formatoFecha.format(orden.getFecha()), orden.getCliente().getNombre(), orden.getCodprodventa(), orden.getNombreproductoventa(), formato.format(orden.getCantidadventa()), formato.format(orden.getPrecioventa()), formato.format(orden.getTotalneto()), String.valueOf(orden.getPorcentaje()), String.valueOf(orden.getCliente().getCodigo()),orden.getSucursal().getNombre(),};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/detalle_ventasxcliente_pendientes.jasper");
