 ...
 * @author hp
 */
public class detalle_ventasxclientesxfecha extends javax.swing.JFrame {
     ...
     */
    public detalle_ventasxclientesxfecha() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxclientesxfecha.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCliente.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxclientesxfecha.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCliente.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxclientesxfecha.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxclientesxfecha.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxclientesxfecha.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxclientesxfecha.class, "ventas.SalirCliente.text")); // NOI18N
    ...
    private class GenerarConsultaVenta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (venta orden : DAO.DetalleVtaxCliente(FechaI, FechaF, nCliente, nCliente, nMoneda)) {
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/detalle_ventasxclientexfecha.jasper");
