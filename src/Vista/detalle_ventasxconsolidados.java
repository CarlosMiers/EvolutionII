...
import DAO.ventaDAO;
import Modelo.Detalleventasxconsolidado;
 ...
 * @author hp
 */
public class detalle_ventasxconsolidados extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltrosuc, trsfiltromoneda;
     ...
     */
    public detalle_ventasxconsolidados() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxconsolidados.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxconsolidados.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxconsolidados.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxconsolidados.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxconsolidados.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxconsolidados.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Detalle de Ventas Consolidadas");
        ...
        etiquetasaldos.setText("Detalle de Ventas Consolidadas ");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(nombresucursal, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(27, 27, 27))
        );
    ...
    private class GenerarConsultaVenta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (venta orden : DAO.DetalleVtaxSucursal(FechaI, FechaF, nSucursal, nSucursal, nMoneda)) {
                    String Datos[] = {formatosinpunto.format(orden.getFactura()), formatoFecha.format(orden.getFecha()), orden.getCliente().getNombre(), orden.getCodprodventa(), orden.getNombreproductoventa(), formato.format(orden.getCantidadventa()), formato.format(orden.getPrecioventa()), formato.format(orden.getTotalneto()), String.valueOf(orden.getPorcentaje()), String.valueOf(orden.getSucursal().getCodigo()), orden.getSucursal().getNombre()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            Detalleventasxconsolidado tipo;
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/detalle_ventasconsolidado.jasper");
