 ...
 * @author hp
 */
public class detalle_ventasxproductos extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltroproducto, trsfiltrosucursal;
     ...
     */
    public detalle_ventasxproductos() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {100, 80, 300, 100, 300, 100, 100, 80, 150, 300};
   ...
   /*   this.jTable1.getColumnModel().getColumn(8).setMaxWidth(0);
    ...
    private void initComponents() {
        ...
        jTBuscarproducto.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxproductos.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarProducto.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxproductos.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirProducto.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxproductos.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxproductos.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxproductos.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxproductos.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Detalle de Ventas por Productos ");
        ...
        etiquetasaldos.setText("Detalle de Ventas por Productos ");
    ...
    private void generarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generarActionPerformed
        if (this.producto.getText().equals("")) {
    ...
    private class GenerarConsultaVenta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (venta orden : DAO.DetalleVtaxProducto(FechaI, FechaF, producto.getText(), nSucursal)) {
                    String cNombreVendedor="SD";
                    if(orden.getVendedor().getNombre()==""){
                        cNombreVendedor=orden.getVendedor().getNombre();
                    }else{
                        cNombreVendedor="SD";
                    }
                    String Datos[] = {formatosinpunto.format(orden.getFactura()), formatoFecha.format(orden.getFecha()), orden.getCliente().getNombre(), orden.getCodprodventa(), orden.getNombreproductoventa(), formato.format(orden.getCantidadventa()), formato.format(orden.getPrecioventa()), formato.format(orden.getTotalneto()), String.valueOf(orden.getVendedor().getCodigo()),cNombreVendedor};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
         ...
         public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                if(jTable1.getValueAt(nFila, 9).toString().isEmpty()){
                    cNombreVendedor="SD";
                }else{
                    cNombreVendedor=jTable1.getValueAt(nFila, 9).toString();
                }
                
                tipo = new Detalleventaxproducto(
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/detalle_ventasproductos.jasper");
