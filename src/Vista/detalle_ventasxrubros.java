...
import DAO.rubroDAO;
import DAO.ventaDAO;
import Modelo.Detalleventasxrubro;
 ...
 * @author hp
 */
public class detalle_ventasxrubros extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTBuscarRubro.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxrubros.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarRubro.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxrubros.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirVendedor.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxrubros.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxrubros.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxrubros.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxrubros.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Detalle de Venta por Rubros");
        ...
        etiquetasaldos.setText("Detalle de Venta por Rubros");
    ...
    private class GenerarConsultaVenta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (venta orden : DAO.DetalleVtaxRubro(FechaI, FechaF, nRubro, nRubro, nMoneda)) {
                    String Datos[] = {formatosinpunto.format(orden.getFactura()),
                        formatoFecha.format(orden.getFecha()), 
                        orden.getCliente().getNombre(), 
                        orden.getCodprodventa(), 
                        ...
                        formato.format(orden.getPorcentaje()), 
                        String.valueOf(orden.getRubro().getCodigo()),
                        orden.getRubro().getNombre()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/detalle_ventasrubro.jasper");
