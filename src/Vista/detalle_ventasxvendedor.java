...
import DAO.ventaDAO;
import Modelo.Detalleventasxvendedor;
 ...
 * @author hp
 */
public class detalle_ventasxvendedor extends javax.swing.JFrame {
     ...
     */
    public detalle_ventasxvendedor() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {100, 80, 300, 100, 300, 100, 100, 80, 100, 150, 300, 150, 300};
    ...
    private void initComponents() {
        ...
        jTBuscarVendedor.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxvendedor.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarVendedor.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxvendedor.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirVendedor.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxvendedor.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxvendedor.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxvendedor.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxvendedor.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxvendedor.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxvendedor.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(detalle_ventasxvendedor.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Detalle de Ventas por Vendedores");
        ...
        etiquetasaldos.setText("Detalle de Ventas por Vendedores");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(vendedor, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(moneda, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(sucursal, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private class GenerarConsultaVenta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (venta orden : DAO.DetalleVtaxVendedor(FechaI, FechaF, nSucursal, nSucursal, nVendedor, nVendedor, nMoneda)) {
                    String Datos[] = {formatosinpunto.format(orden.getFactura()), formatoFecha.format(orden.getFecha()), orden.getCliente().getNombre(), orden.getCodprodventa(), orden.getNombreproductoventa(), formato.format(orden.getCantidadventa()), formato.format(orden.getPrecioventa()), formato.format(orden.getTotalneto()), String.valueOf(orden.getPorcentaje()), String.valueOf(orden.getSucursal().getCodigo()), orden.getSucursal().getNombre(), String.valueOf(orden.getVendedor().getCodigo()), orden.getVendedor().getNombre()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                cCantidad = jTable1.getValueAt(nFila, 5).toString();
                ...
                tipo = new Detalleventasxvendedor(jTable1.getValueAt(nFila, 0).toString(), jTable1.getValueAt(nFila, 1).toString(), jTable1.getValueAt(nFila, 3).toString(), jTable1.getValueAt(nFila, 4).toString(), Double.valueOf(cCantidad), Double.valueOf(cPrecio), Integer.valueOf(jTable1.getValueAt(nFila, 8).toString()), Double.valueOf(cTotal), jTable1.getValueAt(nFila, 2).toString(), Integer.valueOf(jTable1.getValueAt(nFila, 11).toString()), jTable1.getValueAt(nFila, 12).toString(), jTable1.getValueAt(nFila, 10).toString());
                Resultados.add(tipo);
                
                System.out.println(tipo.getFactura());
                System.out.println(tipo.getFecha());
                System.out.println(tipo.getNombreproducto());
                System.out.println(tipo.getCantidad());
                System.out.println(tipo.getPrecio());
                System.out.println(tipo.getIva());
                System.out.println(tipo.getTotal());
                System.out.println(tipo.getNombrecliente());
                System.out.println(tipo.getVendedor());
                System.out.println(tipo.getNombrevendedor());
                System.out.println(tipo.getNombresucursal());
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/detalle_ventasvendedor.jasper");
