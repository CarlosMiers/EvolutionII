 ...
 * @author hp
 */
public class extracto_clientes extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        modelolibro.addColumn("Aut.");
        int[] anchos = {100, 90, 100, 150, 200, 150, 150, 150, 10};
    ...
    private void initComponents() {
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(extracto_clientes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(extracto_clientes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(extracto_clientes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        BCuenta.setTitle("Buscar Cliente");
        ...
        jTBuscarPlan.setText(org.openide.util.NbBundle.getMessage(extracto_clientes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(extracto_clientes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(extracto_clientes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        labelMetric1.setText("Extracto de Clientes");
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(extracto_clientes.class, "libroventaconsolidado.jButton1.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(extracto_clientes.class, "libroventaconsolidado.jButton1.toolTipText")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(extracto_clientes.class, "libroventaconsolidado.jButton2.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(extracto_clientes.class, "libroventaconsolidado.jButton2.toolTipText")); // NOI18N
    ...
    private void cuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cuentaActionPerformed
        clienteDAO plaDAO = new clienteDAO();
        cliente pl = null;
        try {
            pl = plaDAO.buscarId(Integer.valueOf(this.cuenta.getText()));
            if (pl.getCodigo() != 0) {
                nombrecuenta.setText(pl.getNombre());
                ruc.setText(pl.getRuc());
    ...
    private void AceptarGirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarGirActionPerformed
        ...
        this.ruc.setText(this.tablaplan.getValueAt(nFila, 2).toString());
        this.dFechaInicial.requestFocus();
    ...
    private class GenerarConsulta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cuenta_clientes ven : DAO.ExtractoxCliente(ruc.getText(), Integer.valueOf(moneda.getText()), FechaI, FechaF)) {
                    String Datos[] = {formatoFecha.format(ven.getFecha()), ven.getDocumento(), ven.getNrorecibo(), cuenta.getText(), nombrecuenta.getText(), ven.getDescripcion(), formatea.format(ven.getCreditos()), formatea.format(ven.getDebitos()), ven.getAutorizacion()};
    ...
    private class GenerarLibro extends Thread {
        ...
        public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                String cAutorizacion = jTable1.getValueAt(nFila, 8).toString();
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/extractocliente.jasper");
    ...
    private class GrillaClientes extends Thread {
        ...
        public void run() {
            ...
            clienteDAO DAOPLA = new clienteDAO();
            try {
                for (cliente pl : DAOPLA.todosimple()) {
