 ...
 * @author hp
 */
public class extracto_funcionarios extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {90, 130, 130, 130, 100, 100};
        ...
        this.jTable1.getColumnModel().getColumn(1).setCellRenderer(TablaCentro);
    ...
    private void initComponents() {
        ...
        BFuncionario.setTitle(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.BFuncionario.title")); // NOI18N
        ...
        jTBuscarFicha.setText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.jTBuscarFicha.text")); // NOI18N
        ...
        AceptarFuncionario.setText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.AceptarFuncionario.text")); // NOI18N
        ...
        SalirFuncionario.setText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.SalirFuncionario.text")); // NOI18N
        ...
        setTitle(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.title")); // NOI18N
        ...
        etiquetasaldos.setText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.etiquetasaldos.text")); // NOI18N
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.generar.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.generar.toolTipText")); // NOI18N
        ...
        salir.setText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.salir.text")); // NOI18N
        salir.setToolTipText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.salir.toolTipText")); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.jPanel2.border.title"))); // NOI18N

        jLabel1.setText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.jLabel1.text")); // NOI18N

        funcionario.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
        funcionario.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        funcionario.setText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.funcionario.text")); // NOI18N
        funcionario.setFont(new java.awt.Font("Arial", 1, 10)); // NOI18N
        ...
        nombrefuncionario.setText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.nombrefuncionario.text")); // NOI18N
        nombrefuncionario.setEnabled(false);

        Buscar.setText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.Buscar.text")); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.jPanel4.border.title"))); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.jLabel2.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.jLabel3.text")); // NOI18N
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addComponent(funcionario, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.listar.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(extracto_funcionarios.class, "extracto_funcionarios.listar.toolTipText")); // NOI18N
    ...
    private void generarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generarActionPerformed
        if (this.funcionario.getText().equals("")) {
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        if (this.funcionario.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Ingrese el Funcionario");
            this.funcionario.requestFocus();
            return;
        }
    ...
    private class generarconsulta extends Thread {
        ...
        public void run() {
            ...
            int nBanco = Integer.valueOf(funcionario.getText());
            String cObservacion = "";
            ...
            try {
                for (credito_salario ex : exDAO.SaldoAnteriorExtracto(nBanco, FechaI)) {
                    nSaldoAnterior = ex.getCreditos() - ex.getDebitos();
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
            }
            ...
            try {
                for (credito_salario ct : exDAO.MostrarExtracto(nBanco, FechaI, FechaF)) {
                    if (ct.getObservacion() == null) {
                        cObservacion = "Sin Información";
                    } else {
                        cObservacion = ct.getObservacion();
                    }

                    String Datos[] = {formatosinpunto.format(ct.getIdcontrol()),
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            ExtractoFuncionario tipo;
            String cCredito = "0";
            String cDebito = "0";

            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                
                cCredito = jTable1.getValueAt(nFila, 4).toString();
                cCredito = cCredito.replace(".", "").replace(",", ".");

                cDebito = jTable1.getValueAt(nFila, 5).toString();
                cDebito = cDebito.replace(".", "").replace(",", ".");
                ...
                tipo = new ExtractoFuncionario(jTable1.getValueAt(nFila, 0).toString().trim(),
                        jTable1.getValueAt(nFila, 1).toString().trim(),
                        jTable1.getValueAt(nFila, 2).toString().trim(), 
                        jTable1.getValueAt(nFila, 3).toString().trim(), 
                        Double.valueOf(cCredito),
                        Double.valueOf(cDebito));
                Resultados.add(tipo);
            }
            ...
            try {
                ...
                parameters.put("nBanco", funcionario.getText());
                parameters.put("nSaldoAnterior", nSaldoAnterior);
                parameters.put("cNombreFuncionario", nombrefuncionario.getText());
                parameters.put("FechaI", FechaI);
                parameters.put("FechaF", FechaF);
                JasperReport jr = null;

                URL url = getClass().getClassLoader().getResource("Reports/extracto_funcionario.jasper");
