 ...
 * @author hp
 */
public class factura_pendiente_xemision extends javax.swing.JFrame {
     ...
     */
    public factura_pendiente_xemision() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {90, 200, 100, 100, 100, 130, 130};
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(factura_pendiente_xemision.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(factura_pendiente_xemision.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(factura_pendiente_xemision.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Saldo de Clientes por Fecha de Emisión");
        ...
        etiquetasaldoxsocio.setText("Saldos de Facturas por Fecha de Emisión");
    ...
    private class consultar extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cuenta_clientes ct : DAO.Factura_pendiente_xemision(nCliente, FechaI,FechaF)) {
                    String Datos[] = {String.valueOf(ct.getCliente().getCodigo()), ct.getCliente().getNombre(), ct.getDocumento(), formatoFecha.format(ct.getFecha()), formatoFecha.format(ct.getVencimiento()), formato.format(ct.getImporte()), formato.format(ct.getSaldo())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/factura_pendiente_xemision.jasper");
