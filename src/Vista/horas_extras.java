...
public class horas_extras extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltro, trsfiltroempleado;
    ...
    double nPorcentajeSalarioDiurno;
    double nPorcentajeSalarioNocturno;
    ...
    public horas_extras() {
        ...
        GrillaHoraExtra GrillaLlega = new GrillaHoraExtra();
    ...
    private void initComponents() {
        ...
        detalle_horas_extras = new javax.swing.JDialog();
        ...
        tipo_horario = new javax.swing.JComboBox<>();
        ...
        etiquetahorasextras = new org.edisoncor.gui.label.LabelMetric();
        ...
        detalle_horas_extras.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                detalle_horas_extrasFocusGained(evt);
            }
        });
        detalle_horas_extras.addWindowFocusListener(new java.awt.event.WindowFocusListener() {
            public void windowGainedFocus(java.awt.event.WindowEvent evt) {
                detalle_horas_extrasWindowGainedFocus(evt);
            }
            public void windowLostFocus(java.awt.event.WindowEvent evt) {
            }
        });
        detalle_horas_extras.addWindowListener(new java.awt.event.WindowAdapter() {
            public void windowActivated(java.awt.event.WindowEvent evt) {
                detalle_horas_extrasWindowActivated(evt);
            }
        });
        ...
        horas.setText("Horas");
        horas.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        horas.setName(""); // NOI18N
        ...
        tipo_horario.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Diurno", "Nocturno" }));
        tipo_horario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tipo_horarioActionPerformed(evt);
            }
        });
        tipo_horario.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tipo_horarioKeyPressed(evt);
            }
        });
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(salario, javax.swing.GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE)
                                        .addComponent(tipo_salario)))
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(tipo_horario, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tipo_horario, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel1))
        ...
        javax.swing.GroupLayout detalle_horas_extrasLayout = new javax.swing.GroupLayout(detalle_horas_extras.getContentPane());
        detalle_horas_extras.getContentPane().setLayout(detalle_horas_extrasLayout);
        detalle_horas_extrasLayout.setHorizontalGroup(
            detalle_horas_extrasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(detalle_horas_extrasLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(detalle_horas_extrasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(detalle_horas_extrasLayout.createSequentialGroup()
        ...
        detalle_horas_extrasLayout.setVerticalGroup(
            detalle_horas_extrasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, detalle_horas_extrasLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addGroup(detalle_horas_extrasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Grabar)
                    .addComponent(Salir))
                .addContainerGap())
        );
        ...
        jTBuscarEmpleado.setText(org.openide.util.NbBundle.getMessage(horas_extras.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarEmpleado.setText(org.openide.util.NbBundle.getMessage(horas_extras.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirEmpleado.setText(org.openide.util.NbBundle.getMessage(horas_extras.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetahorasextras.setBackground(new java.awt.Color(255, 255, 255));
        etiquetahorasextras.setText("Horas Extras");
        ...
        panel1Layout.setHorizontalGroup(
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                .addGap(26, 26, 26)
                .addComponent(etiquetahorasextras, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(40, 40, 40)
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(horas_extras.class, "libroventaconsolidado.jPanel2.border.title"))); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(horas_extras.class, "libroventaconsolidado.jLabel1.text")); // NOI18N

        jLabel8.setText(org.openide.util.NbBundle.getMessage(horas_extras.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
    ...
    private void ConfigurarHora() {
        ...
        nPorcentajeSalarioDiurno = config.getHoras_extras_diurnas_habiles();
        nPorcentajeSalarioNocturno = config.getHoras_extras_nocturnas();
    }
    ...
    private void CalcularxHora(String cSalario, int nTipoSalario, double nTiempo, int TipoTiempo) {
        ...
        // PRIMERO SE HALLA EL SALARIO X HORA
        switch (nTipoSalario) {
            //SI EL SALARIO ES POR HORAS
            case 1:
                salarioxhora = Math.round(Double.valueOf(cSalario) * nTiempo);
                break;
            //SI EL SALARIO ES POR DIA         
            case 2:
                salarioxhora = Math.round((Double.valueOf(cSalario) / 8) * nTiempo);
                break;
            //SI EL SALARIO ES QUINCENAL         
            case 3:
                salarioxhora = Math.round((Double.valueOf(cSalario) * 2 / 30 / 8) * nTiempo);
                break;
            //SI EL SALARIO ES MENSUAL
            case 4:
                salarioxhora = Math.round((Double.valueOf(cSalario) / 30 / 8) * nTiempo);
                break;
        }
        if (this.tipo_horario.getSelectedIndex() == 0) {
            salarioxhora = Math.round(salarioxhora + (salarioxhora * (nPorcentajeSalarioDiurno / 100)));
        } else {
            salarioxhora = Math.round((salarioxhora + (salarioxhora * (nPorcentajeSalarioNocturno / 100))) * 2);
        }
        this.importe.setText(formatea.format(salarioxhora));
    }
    ...
    private void AgregarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        idControl.setText("0");
        this.limpiar();
        horas.setSelected(true);
        detalle_horas_extras.setModal(true);
        detalle_horas_extras.setSize(520, 310);
        //Establecemos un título para el jDialog
        detalle_horas_extras.setTitle("Agregar Horas Extras");
        detalle_horas_extras.setLocationRelativeTo(null);
        detalle_horas_extras.setVisible(true);
        empleado.requestFocus();
    ...
    private void ModificarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) < 3) {
            ...
            hora_extraDAO llegaDAO = new hora_extraDAO();
            hora_extra llegada = null;
            try {
                llegada = llegaDAO.buscarId(Integer.valueOf(this.numero.getText()));
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR:" + e.getMessage());
            }
            if (llegada != null) {
                empleado.setText(String.valueOf(llegada.getFicha_empleado().getCodigo()));
                nombreempleado.setText(llegada.getFicha_empleado().getNombreempleado());
                salario.setText(formatea.format(llegada.getFicha_empleado().getSalario()));
                tipo_salario.setText(String.valueOf(llegada.getFicha_empleado().getTipo_salario()));
                fecha.setDate(llegada.getFecha());
                hora.setText(String.valueOf(llegada.getHoras()));
                importe.setText(formatea.format(llegada.getImporte()));
                tipo_horario.setSelectedIndex(llegada.getTipo_horario() - 1);;
                hora.setText(String.valueOf(llegada.getHoras()));

                if (llegada.getUnidmed().equals("Minutos")) {
                    minutos.setSelected(true);
                } else {
                    minutos.setSelected(false);
                }

                if (llegada.getUnidmed().equals("Horas")) {
                    horas.setSelected(true);
                } else {
                    horas.setSelected(false);
                }
                ...
                detalle_horas_extras.setSize(520, 310);
                //Establecemos un título para el jDialog
                detalle_horas_extras.setTitle("Modificar Horas Extras");
                detalle_horas_extras.setLocationRelativeTo(null);
                detalle_horas_extras.setVisible(true);
    ...
    private void EliminarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) == 1) {
            ...
            if (ret == 0) {
                hora_extraDAO llegaDAO = new hora_extraDAO();
                try {
                    hora_extra llegada = llegaDAO.buscarId(Integer.valueOf(num));
                    if (llegada == null) {
                        JOptionPane.showMessageDialog(null, "Registro no Existe");
                    } else {
                        llegaDAO.eliminarllegada(Integer.valueOf(num));
    ...
    private void SalirActionPerformed(ActionEvent evt) {//GEN-FIRST:event_SalirActionPerformed
        detalle_horas_extras.setVisible(false);
        // TODO add your handling code here:
    ...
    private void GrabarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (ret == 0) {
            ...
            hora_extraDAO grabar = new hora_extraDAO();
            hora_extra llegada = new hora_extra();
            ...
            llegada.setNumero(String.valueOf(this.numero.getText()));
            llegada.setFecha(Fecha);
            llegada.setFicha_empleado(ficha);
            llegada.setGiraduria(ficha.getGiraduria().getCodigo());
            llegada.setTipo_horario(this.tipo_horario.getSelectedIndex() + 1);
            llegada.setHoras(Integer.valueOf(hora.getText()));
            String cImporte = importe.getText();
            llegada.setTipo_horario(tipo_horario.getSelectedIndex());
            cImporte = cImporte.replace(".", "").replace(",", ".");
            BigDecimal nImporte = new BigDecimal(cImporte);
            llegada.setImporte(nImporte);

            if (minutos.isSelected()) {
                llegada.setUnidmed("Minutos");
            }

            if (horas.isSelected()) {
                llegada.setUnidmed("Horas");
            }

            //EMPEZAMOS A CAPTURAR DATOS NUMERICOS
            if (Integer.valueOf(this.numero.getText()) == 0) {
                try {
                    grabar.insertarllegada(llegada);
                ...
                try {
                    llegada.setNumero(String.valueOf(this.numero.getText()));
                    grabar.actualizarllegada(llegada);
                    JOptionPane.showMessageDialog(null, "Datos Agregados Correctamente");
                } catch (SQLException e) {
                    JOptionPane.showMessageDialog(null, "Error BD: " + e.getMessage());
                }
            ...
            detalle_horas_extras.setVisible(false);
            this.detalle_horas_extras.setModal(false);
            this.refrescar.doClick();
        }

    }//GEN-LAST:event_GrabarActionPerformed

    private void detalle_horas_extrasFocusGained(FocusEvent evt) {//GEN-FIRST:event_detalle_horas_extrasFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_horas_extrasFocusGained

    private void detalle_horas_extrasWindowGainedFocus(WindowEvent evt) {//GEN-FIRST:event_detalle_horas_extrasWindowGainedFocus
        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_horas_extrasWindowGainedFocus

    private void detalle_horas_extrasWindowActivated(WindowEvent evt) {//GEN-FIRST:event_detalle_horas_extrasWindowActivated

        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_horas_extrasWindowActivated
    ...
    }   // TODO     }//GEN-LAST:event_importeKeyPressed
    ...
    private void horaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_horaKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_UP) {
            this.tipo_horario.requestFocus();
        }
    }   // TODO     }//GEN-LAST:event_horaKeyPressed
    ...
    private void minutosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_minutosActionPerformed
        if (minutos.isSelected()) {
            horas.setSelected(false);
            this.CalcularxHora(salario.getText().toString(), Integer.valueOf(tipo_salario.getText()), Double.valueOf(hora.getText()), 2);
        } else {
            horas.setSelected(true);
            this.CalcularxHora(salario.getText().toString(), Integer.valueOf(tipo_salario.getText()), Double.valueOf(hora.getText()), 1);
        }
    ...
    private void tipo_horarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tipo_horarioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tipo_horarioActionPerformed

    private void tipo_horarioKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tipo_horarioKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_ENTER || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.hora.requestFocus();
        }
        if (evt.getKeyCode() == KeyEvent.VK_UP) {
    ...
    }//GEN-LAST:event_tipo_horarioKeyPressed
    ...
    private javax.swing.JDialog detalle_horas_extras;
    private javax.swing.JTextField empleado;
    private org.edisoncor.gui.label.LabelMetric etiquetahorasextras;
    ...
    private javax.swing.JComboBox<String> tipo_horario;
    private javax.swing.JTextField tipo_salario;
    // End of variables declaration//GEN-END:variables

    private class GrillaHoraExtra extends Thread {
        ...
        public void run() {
            ...
            try {
                for (hora_extra llegada : DAO.Todos(FechaI, FechaF)) {
                    String Datos[] = {String.valueOf(llegada.getNumero()), formatoFecha.format(llegada.getFecha()), llegada.getFicha_empleado().getNombreempleado(), String.valueOf(llegada.getTiempo()), formatea.format(llegada.getImporte())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/horas_extras.jasper");
