 ...
 * @author hp
 */
public class horas_extras_informes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTBuscarRubro.setText(org.openide.util.NbBundle.getMessage(horas_extras_informes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarRubro.setText(org.openide.util.NbBundle.getMessage(horas_extras_informes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirRubro.setText(org.openide.util.NbBundle.getMessage(horas_extras_informes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(horas_extras_informes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(horas_extras_informes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(horas_extras_informes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldos.setText("Informe de Horas Extras");
    ...
    private class GrillaDescuento extends Thread {
        ...
        public void run() {
            ...
            hora_extraDAO DAO = new hora_extraDAO();
            try {
                for (hora_extra llegada : DAO.TodosxSuc(FechaI, FechaF,Integer.valueOf(sucursal.getText()))) {
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/horas_extras_sucursal.jasper");
