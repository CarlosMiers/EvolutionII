 ...
 * @author hp
 */
public class informe_extracciones extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {130, 130, 130, 130, 200, 130, 200, 200, 200};
    ...
    private void initComponents() {
        ...
        wBuscarBanco = new javax.swing.JDialog();
        ...
        codbanco = new javax.swing.JFormattedTextField();
        ...
        wBuscarBanco.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        wBuscarBanco.setTitle(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.wBuscarBanco.title")); // NOI18N
        ...
        BuscarGiraduria.setText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.BuscarGiraduria.text")); // NOI18N
        ...
        jScrollPane6.setViewportView(tablabanco);

        jPanel18.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));

        AceptarGir.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.AceptarGir.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.SalirGir.text")); // NOI18N
        ...
        javax.swing.GroupLayout wBuscarBancoLayout = new javax.swing.GroupLayout(wBuscarBanco.getContentPane());
        wBuscarBanco.getContentPane().setLayout(wBuscarBancoLayout);
        wBuscarBancoLayout.setHorizontalGroup(
            wBuscarBancoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(wBuscarBancoLayout.createSequentialGroup()
                .addComponent(jPanel17, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
            .addComponent(jScrollPane6, javax.swing.GroupLayout.Alignment.TRAILING)
            .addComponent(jPanel18, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        wBuscarBancoLayout.setVerticalGroup(
            wBuscarBancoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(wBuscarBancoLayout.createSequentialGroup()
                .addComponent(jPanel17, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        setTitle(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.title")); // NOI18N
        ...
        etiquetasaldos.setText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.etiquetasaldos.text")); // NOI18N
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.generar.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.generar.toolTipText")); // NOI18N
        ...
        salir.setText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.salir.text")); // NOI18N
        salir.setToolTipText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.salir.toolTipText")); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.jPanel2.border.title"))); // NOI18N

        jLabel1.setText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.jLabel1.text")); // NOI18N

        codbanco.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
        codbanco.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        codbanco.setText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.codbanco.text")); // NOI18N
        codbanco.setFont(new java.awt.Font("Arial", 1, 10)); // NOI18N
        ...
        nombrebanco.setFont(new java.awt.Font("Arial", 1, 10)); // NOI18N
        nombrebanco.setText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.nombrebanco.text")); // NOI18N
        nombrebanco.setEnabled(false);

        Buscar.setText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.Buscar.text")); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.jPanel4.border.title"))); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.jLabel2.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.jLabel3.text")); // NOI18N
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addComponent(codbanco, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.listar.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(informe_extracciones.class, "informe_extracciones.listar.toolTipText")); // NOI18N
    ...
    private void generarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generarActionPerformed
        if (this.codbanco.getText().equals("")) {
    ...
    private void BuscarGiraduriaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BuscarGiraduriaKeyPressed
        ...
        trsfiltro2 = new TableRowSorter(tablabanco.getModel());
        tablabanco.setRowSorter(trsfiltro2);
        // TODO add your handling code here:
    ...
    private void AceptarGirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarGirActionPerformed
        ...
        this.wBuscarBanco.setVisible(false);
        wBuscarBanco.setModal(true);
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        ...
        try {
            ...
            if (ba.getCodigo() == 0) {
                GrillaBanco grillagi = new GrillaBanco();
                Thread hilogi = new Thread(grillagi);
                hilogi.start();
                wBuscarBanco.setModal(true);
                wBuscarBanco.setSize(482, 575);
                wBuscarBanco.setLocationRelativeTo(null);
                wBuscarBanco.setVisible(true);
                wBuscarBanco.setTitle("Buscar Giraduria");
                this.dFechaInicial.requestFocus();
                wBuscarBanco.setModal(false);
            } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new informe_extracciones().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField codbanco;
    ...
    private javax.swing.JDialog wBuscarBanco;
    ...
    private class generarconsulta extends Thread {
        ...
        public void run() {
            ...
            int nBanco = Integer.valueOf(codbanco.getText());
            String cTipo = "D";
            ...
            try {
                for (extraccion ct : exDAO.MostrarxFecha(nBanco, FechaI, FechaF, cTipo)) {
                    String Datos[] = {ct.getDocumento(), formatoFecha.format(ct.getFecha()), formatoFecha.format(ct.getVencimiento()), String.valueOf(ct.getBanco().getCodigo()), ct.getBanco().getNombre(), formato.format(ct.getImporte()), ct.getObservaciones(), ct.getSucursal().getNombre(), ct.getChequenro()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                tipo = new infextracciones(jTable1.getValueAt(nFila, 0).toString(), jTable1.getValueAt(nFila, 1).toString(), jTable1.getValueAt(nFila, 2).toString(), jTable1.getValueAt(nFila, 3).toString(), jTable1.getValueAt(nFila, 4).toString(), Double.valueOf(cImporte), jTable1.getValueAt(nFila, 6).toString(), jTable1.getValueAt(nFila, 8).toString());
                Resultados.add(tipo);
            }
            ...
            try {
                ...
                parameters.put("FechaF", FechaI);
                JasperReport jr = null;

                URL url = getClass().getClassLoader().getResource("Reports/informe_extracciones.jasper");
