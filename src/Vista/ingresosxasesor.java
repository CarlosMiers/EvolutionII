 ...
 * @author hp
 */
public class ingresosxasesor extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {90, 200, 90, 200, 200, 100};
    ...
    private void initComponents() {
        ...
        setTitle(org.openide.util.NbBundle.getMessage(ingresosxasesor.class, "ingresosxasesor.title")); // NOI18N
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(ingresosxasesor.class, "ingresosxasesor.generar.text")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(ingresosxasesor.class, "ingresosxasesor.listar.text")); // NOI18N
        ...
        jButton3.setText(org.openide.util.NbBundle.getMessage(ingresosxasesor.class, "ingresosxasesor.jButton3.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(ingresosxasesor.class, "ingresosxasesor.jLabel1.text")); // NOI18N

        jLabel2.setText(org.openide.util.NbBundle.getMessage(ingresosxasesor.class, "ingresosxasesor.jLabel2.text")); // NOI18N

        jLabel6.setText(org.openide.util.NbBundle.getMessage(ingresosxasesor.class, "ingresosxasesor.jLabel6.text")); // NOI18N
        ...
        BuscarMoneda.setText(org.openide.util.NbBundle.getMessage(ingresosxasesor.class, "ingresosxasesor.BuscarMoneda.text")); // NOI18N
        ...
        getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(ingresosxasesor.class, "ingresosxasesor.AccessibleContext.accessibleName")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ingresosxasesor().setVisible(true);
            }
        });
    }
    ...
    private class generarconsulta extends Thread {
        ...
        public void run() {
            ...
            cSql = "SELECT clientes.asesor,vendedores.nombre AS nombreasesor,cabecera_ventas.cliente,clientes.nombre AS nombrecliente,";
            cSql += "cabecera_ventas.moneda,detalle_ventas.codprod,productos.nombre as nombreservicio,SUM(monto) AS total,monedas.nombre as nombremoneda";
            cSql += " FROM cabecera_ventas";
            cSql += " INNER JOIN clientes";
            cSql += " ON clientes.codigo=cabecera_ventas.cliente";
            cSql += " INNER JOIN vendedores";
            cSql += " ON vendedores.codigo=clientes.asesor";
            cSql += " INNER JOIN monedas";
            cSql += " ON monedas.codigo=cabecera_ventas.moneda";
            cSql += " INNER JOIN detalle_ventas";
            cSql += " ON detalle_ventas.dreferencia=cabecera_ventas.creferencia";
            cSql += " INNER JOIN productos";
            cSql += " ON productos.codigo=detalle_ventas.codprod";
            cSql += " WHERE productos.medida=1 and cabecera_ventas.moneda=" + moneda.getText();
            cSql += " AND cabecera_ventas.fecha BETWEEN " + "'" + dFechaInicio + "'" + " AND " + "'" + dFechaFinal + "'";
            cSql += " GROUP BY clientes.asesor,clientes.codigo,productos.codigo,cabecera_ventas.moneda";
            cSql += " ORDER BY clientes.asesor";
            ...
            try {
                ...
                while (results.next()) {
                    ...
                    Object[] fila = new Object[6]; // Cantidad de columnas en la tabla
                    fila[0] = results.getString("asesor");
                    fila[1] = results.getString("nombreasesor");
                    fila[2] = results.getString("cliente");
                    fila[3] = results.getString("nombrecliente");
                    fila[4] = results.getString("nombremoneda");
                    fila[5] = formatea.format(results.getDouble("total"));
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/ingresosxasesor.jasper");
