...
public class instrumentos extends javax.swing.JFrame {
    ...
    public instrumentos() {
        ...
        this.etiquetafamilia.setText("Instrumentos");
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM instrumentos ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        etiquetafamilia.setText(org.openide.util.NbBundle.getMessage(instrumentos.class, "saldosxclientes.labelMetric1.text")); // NOI18N
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("instrumentos", "codigo=" + this.codigo.getText().trim());
        this.cargarTabla("SELECT * FROM instrumentos ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void GrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("instrumentos", "nombre", "'" + this.nombre.getText() + "'");
        } else {
            BD.actualizarRegistro("instrumentos", "nombre ='" + this.nombre.getText() + "'", "codigo= " + this.codigo.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM instrumentos ORDER BY codigo");
        this.nombre.setText("");
