 ...
 * @author hp
 */
public class inventariorubro extends javax.swing.JFrame {
    ...
    public inventariorubro() {
        ...
        this.dFechaFinal.setVisible(false);
    ...
    private void initComponents() {
        ...
        jTBuscarRubro.setText(org.openide.util.NbBundle.getMessage(inventariorubro.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarRubro.setText(org.openide.util.NbBundle.getMessage(inventariorubro.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirRubro.setText(org.openide.util.NbBundle.getMessage(inventariorubro.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(inventariorubro.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(inventariorubro.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(inventariorubro.class, "ventas.SalirCliente.text")); // NOI18N
    ...
    private class GenerarInventarioRubroxFecha extends Thread {
        ...
        public void run() {
            ...
            try {
                for (producto prod : DAO.inventarioxrubro(nSucursal, nRubro, FechaF,nTipo)) {
