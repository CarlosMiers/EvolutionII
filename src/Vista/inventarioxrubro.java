...
import Modelo.inventarioxrubroreport;
 ...
 * @author hp
 */
public class inventarioxrubro extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        modelo.addColumn("Descripción Rubro");
    ...
    private void initComponents() {
        ...
        jTBuscarRubro.setText(org.openide.util.NbBundle.getMessage(inventarioxrubro.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarRubro.setText(org.openide.util.NbBundle.getMessage(inventarioxrubro.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirRubro.setText(org.openide.util.NbBundle.getMessage(inventarioxrubro.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(inventarioxrubro.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(inventarioxrubro.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(inventarioxrubro.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Inventario por Rubros ");
        ...
        etiquetasaldos.setText("Inventario por Rubros ");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(nombrerubro, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new inventarioxrubro().setVisible(true);
            }
        });
    }
    ...
    private class GenerarInventarioxRubro extends Thread {
        ...
        public void run() {
            ...
            try {
                for (producto pro : DAO.inventarioxrubro(nSucursal, nSucursal, nRubro, nRubro)) {
                    String Datos[] = {pro.getCodigo(), pro.getNombre(), String.valueOf(pro.getRubro().getCodigo()), String.valueOf(pro.getRubro().getNombre()), formato.format(pro.getCosto()), formato.format(pro.getPrecio_maximo()), formato.format(pro.getStocks().getStock()), String.valueOf(pro.getMedida().getCodigo()), String.valueOf(pro.getMedida().getNombre())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/inventarioxrubro.jasper");
