 ...
 * @author hp
 */
public class libroventaxcaja extends javax.swing.JFrame {

    Conexion con = null;
    Statement stm = null;
    Tablas modelolibro = new Tablas();
    JScrollPane scroll = new JScrollPane();
    private TableRowSorter trsfiltrocaja;
    ObtenerFecha ODate = new ObtenerFecha();
    Tablas modelocaja = new Tablas();
    Config configuracion = new Config();    String cSql = null;

    SimpleDateFormat formatoFecha = new SimpleDateFormat("dd/MM/yyyy");
    DecimalFormat formatosinpunto = new DecimalFormat("############");
    DecimalFormat formatea = new DecimalFormat("###,###.##");

    public libroventaxcaja() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {200, 140, 350, 150, 200, 200, 150, 200, 200, 100};
    ...
    private void initComponents() {
        ...
        jTBuscarCaja.setText(org.openide.util.NbBundle.getMessage(libroventaxcaja.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCaja.setText(org.openide.util.NbBundle.getMessage(libroventaxcaja.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCaja.setText(org.openide.util.NbBundle.getMessage(libroventaxcaja.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        labelMetric1.setText("Libro IVA Venta por Caja");
        ...
        nombrecajero.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(caja, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(panelTranslucido2, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void AceptarCajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarCajaActionPerformed
        ...
        this.nombrecajero.setText(this.tablacaja.getValueAt(nFila, 1).toString());
       ...
       caja ca = null;
        try {
            ...
            if (ca.getCodigo() == 0) {
                ...
                BCaja.setTitle("Buscar Cliente");
                BCaja.setVisible(true);
                BCaja.setModal(false);
            } else {
                nombrecajero.setText(ca.getNombre());
            }
    ...
    private void listarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listarActionPerformed
        GenerarLibro GenerarReporte = new GenerarLibro();
    ...
    private class GenerarConsulta extends Thread {
        ...
        public void run() {
            int Cli = Integer.valueOf(caja.getText());
            ...
            try {
                for (venta ven : DAO.libroventaxcaja(Cli, FechaI, FechaF)) {
                    String Datos[] = {ven.getFormatofactura(), formatoFecha.format(ven.getFecha()), ven.getCliente().getNombre(), ven.getCliente().getRuc(), formatea.format(ven.getGravadas5()), formatea.format(ven.getGravadas10()), formatea.format(ven.getExentas()), formatea.format(ven.getTotalneto()), ven.getComprobante().getNombre(), String.valueOf(ven.getComprobante().getCodigo())};
    ...
    private class GenerarLibro extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                parameters.put("cNombreCajero",nombrecajero.getText());
                parameters.put("FechaInicio", FechaInicio);
                parameters.put("FechaFinal", FechaFinal);

                JasperReport jr = null;

                URL url = getClass().getClassLoader().getResource("Reports/Libro_Iva_Caja.jasper");
