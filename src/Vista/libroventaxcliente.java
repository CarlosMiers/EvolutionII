 ...
 * @author hp
 */
public class libroventaxcliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(libroventaxcliente.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(libroventaxcliente.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(libroventaxcliente.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        labelMetric1.setText("Libro IVA Ventas por Cliente");
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(libroventaxcliente.class, "libroventaconsolidado.jButton1.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(libroventaxcliente.class, "libroventaconsolidado.jButton1.toolTipText")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(libroventaxcliente.class, "libroventaconsolidado.jButton2.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(libroventaxcliente.class, "libroventaconsolidado.jButton2.toolTipText")); // NOI18N
    ...
    private class GenerarConsulta extends Thread {
        ...
        public void run() {
            int Cli = Integer.valueOf(cliente.getText());
            ...
            try {
                for (venta ven : DAO.libroventaxcliente(Cli, FechaI, FechaF)) {
    ...
    private class GenerarLibro extends Thread {
        ...
        public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                venta = new RptLibroVentaConsolidado(Double.valueOf(cIva5), Double.valueOf(cIva10), jTable1.getValueAt(nFila, 0).toString(), jTable1.getValueAt(nFila, 1).toString(), jTable1.getValueAt(nFila, 2).toString(), jTable1.getValueAt(nFila, 3).toString(), Double.valueOf(cGravada5) - Double.valueOf(cIva5), Double.valueOf(cGravada10) - Double.valueOf(cIva10), Double.valueOf(cExenta), Double.valueOf(cTotal), jTable1.getValueAt(nFila, 8).toString(),
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/Libro_Iva_Cliente.jasper");
