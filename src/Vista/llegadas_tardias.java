 ...
 *
 */
public class llegadas_tardias extends javax.swing.JFrame {
    ...
    public llegadas_tardias() {
        ...
        GrillaLlegadaTardia GrillaLlega = new GrillaLlegadaTardia();
    ...
    private void initComponents() {
        ...
        detalle_llegada_tardia = new javax.swing.JDialog();
        ...
        detalle_llegada_tardia.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                detalle_llegada_tardiaFocusGained(evt);
            }
        });
        detalle_llegada_tardia.addWindowFocusListener(new java.awt.event.WindowFocusListener() {
            public void windowGainedFocus(java.awt.event.WindowEvent evt) {
                detalle_llegada_tardiaWindowGainedFocus(evt);
            }
            public void windowLostFocus(java.awt.event.WindowEvent evt) {
            }
        });
        detalle_llegada_tardia.addWindowListener(new java.awt.event.WindowAdapter() {
            public void windowActivated(java.awt.event.WindowEvent evt) {
                detalle_llegada_tardiaWindowActivated(evt);
            }
        });
        ...
        javax.swing.GroupLayout detalle_llegada_tardiaLayout = new javax.swing.GroupLayout(detalle_llegada_tardia.getContentPane());
        detalle_llegada_tardia.getContentPane().setLayout(detalle_llegada_tardiaLayout);
        detalle_llegada_tardiaLayout.setHorizontalGroup(
            detalle_llegada_tardiaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(detalle_llegada_tardiaLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(detalle_llegada_tardiaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(detalle_llegada_tardiaLayout.createSequentialGroup()
        ...
        detalle_llegada_tardiaLayout.setVerticalGroup(
            detalle_llegada_tardiaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, detalle_llegada_tardiaLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(detalle_llegada_tardiaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Grabar)
                    .addComponent(Salir))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jTBuscarEmpleado.setText(org.openide.util.NbBundle.getMessage(llegadas_tardias.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarEmpleado.setText(org.openide.util.NbBundle.getMessage(llegadas_tardias.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirEmpleado.setText(org.openide.util.NbBundle.getMessage(llegadas_tardias.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetacredito.setText("Llegadas Tardias");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(llegadas_tardias.class, "libroventaconsolidado.jPanel2.border.title"))); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(llegadas_tardias.class, "libroventaconsolidado.jLabel1.text")); // NOI18N

        jLabel8.setText(org.openide.util.NbBundle.getMessage(llegadas_tardias.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
    ...
    private void AgregarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        ...
        detalle_llegada_tardia.setModal(true);
        detalle_llegada_tardia.setSize(520, 310);
        //Establecemos un título para el jDialog
        detalle_llegada_tardia.setTitle("Agregar Llegada Tardia");
        detalle_llegada_tardia.setLocationRelativeTo(null);
        detalle_llegada_tardia.setVisible(true);
        empleado.requestFocus();
    ...
    private void ModificarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) < 3) {
            ...
            llegada_tardiaDAO llegaDAO = new llegada_tardiaDAO();
            llegada_tardia llegada = null;
            try {
            ...
            if (llegada != null) {
                ...
                tiempo.setText(String.valueOf(llegada.getHoras()));
                ...
                detalle_llegada_tardia.setSize(520, 310);
                //Establecemos un título para el jDialog
                detalle_llegada_tardia.setTitle("Modificar Llegada Tardia");
                detalle_llegada_tardia.setLocationRelativeTo(null);
                detalle_llegada_tardia.setVisible(true);
            } else {
    ...
    private void EliminarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) == 1) {
            ...
            if (ret == 0) {
                llegada_tardiaDAO llegaDAO = new llegada_tardiaDAO();
                try {
                    llegada_tardia llegada = llegaDAO.buscarId(Integer.valueOf(num));
                    if (llegada == null) {
    ...
    private void SalirActionPerformed(ActionEvent evt) {//GEN-FIRST:event_SalirActionPerformed
        detalle_llegada_tardia.setVisible(false);
        // TODO add your handling code here:
    ...
    private void GrabarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (ret == 0) {
            ...
            llegada_tardiaDAO grabar = new llegada_tardiaDAO();
            ...
            llegada.setHoras(Integer.valueOf(tiempo.getText()));
            llegada.setUnidmed(String.valueOf(tiempo.getText()));
            ...
            detalle_llegada_tardia.setVisible(false);
            this.detalle_llegada_tardia.setModal(false);
            this.refrescar.doClick();
        }

    }//GEN-LAST:event_GrabarActionPerformed

    private void detalle_llegada_tardiaFocusGained(FocusEvent evt) {//GEN-FIRST:event_detalle_llegada_tardiaFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_llegada_tardiaFocusGained

    private void detalle_llegada_tardiaWindowGainedFocus(WindowEvent evt) {//GEN-FIRST:event_detalle_llegada_tardiaWindowGainedFocus
        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_llegada_tardiaWindowGainedFocus

    private void detalle_llegada_tardiaWindowActivated(WindowEvent evt) {//GEN-FIRST:event_detalle_llegada_tardiaWindowActivated

        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_llegada_tardiaWindowActivated
    ...
    private javax.swing.JDialog detalle_llegada_tardia;
    ...
    private class GrillaLlegadaTardia extends Thread {
        ...
        public void run() {
            ...
            try {
                for (llegada_tardia llegada : DAO.Todos(FechaI, FechaF)) {
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/llegadastardias.jasper");
