 ...
 * @author FedeXavier
 */
public class localidadesrrhh extends javax.swing.JFrame {
     ...
     */
    public localidadesrrhh() {
        initComponents();
        this.jTextField3.setVisible(false);
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM localidades ORDER BY codigo");
    }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
         if (Integer.valueOf(Config.cNivelUsuario) == 1) {
            ...
            BD.borrarRegistro("localidades", "codigo=" + this.jTextField1.getText().trim());
            this.cargarTabla("SELECT * FROM localidades ORDER BY codigo");
        } else {
    ...
    private void GrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("localidades", "nombre", "'" + this.nombre.getText() + "'");
        } else {
            BD.actualizarRegistro("localidades", "nombre ='" + this.nombre.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM localidades ORDER BY codigo");
        this.nombre.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(localidadesrrhh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
