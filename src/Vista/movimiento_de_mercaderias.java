 ...
 * @author hp
 */
public class movimiento_de_mercaderias extends javax.swing.JFrame {
     ...
     */
    public movimiento_de_mercaderias() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        modelo.addColumn("Transf.E");
        modelo.addColumn("Salidas");
        modelo.addColumn("Ventas");
        modelo.addColumn("Transf.S");
        modelo.addColumn("rubrocod");
        modelo.addColumn("Nombrerubro");

        int[] anchos = {80, 300, 100, 80, 80, 100, 100, 100, 100, 100};
    ...
    private void initComponents() {
        ...
        jTBuscarRubro.setText(org.openide.util.NbBundle.getMessage(movimiento_de_mercaderias.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarRubro.setText(org.openide.util.NbBundle.getMessage(movimiento_de_mercaderias.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirRubro.setText(org.openide.util.NbBundle.getMessage(movimiento_de_mercaderias.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(movimiento_de_mercaderias.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(movimiento_de_mercaderias.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(movimiento_de_mercaderias.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Movimientos de Mercaderias ");
        ...
        etiquetasaldos.setText("Movimientos de Mercaderias ");
    ...
    private void generarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generarActionPerformed
        ...
        GenerarMovimientoMercaderia consulta1 = new GenerarMovimientoMercaderia();
    ...
    private class GenerarMovimientoMercaderia extends Thread {
        ...
        public void run() {
            ...
            try {
                for (producto prod : DAO.movimiento_de_mercaderia(nSucursal, FechaI, FechaF)) {
                    /*System.out.println("CODIGO " + prod.getCodigo());
                    System.out.println("PRODUCTO " + prod.getNombre());
                    System.out.println("COSTO " + prod.getCosto());
                    System.out.println("PRECIO " + prod.getPrecio_minimo());
                    System.out.println("STOCK " + prod.getStock());*/

                    String Datos[] = {prod.getCodigo(), prod.getNombre(), formato.format(prod.getEntrada()), formato.format(prod.getCompras()), formato.format(prod.getTransEntrada()), formato.format(prod.getSalida()), formato.format(prod.getVentas()), formato.format(prod.getTransSalida()), String.valueOf(prod.getRubro().getCodigo()), String.valueOf(prod.getRubro().getNombre())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            movimiento_de_mercadriasreport tipo;
            String cEntrada = null;
            String cCompra = null;
            String cTransferenciaE = null;
            String cSalidas = null;
            String cVenta = null;
            String cTransferenciaS = null;
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                cEntrada = jTable1.getValueAt(nFila, 2).toString();
                cEntrada = cEntrada.replace(".", "").replace(",", ".");

                cCompra = jTable1.getValueAt(nFila, 3).toString();
                cCompra = cCompra.replace(".", "").replace(",", ".");

                cTransferenciaE = jTable1.getValueAt(nFila, 4).toString();
                cTransferenciaE = cTransferenciaE.replace(".", "").replace(",", ".");

                cSalidas = jTable1.getValueAt(nFila, 5).toString();
                cSalidas = cSalidas.replace(".", "").replace(",", ".");

                cVenta = jTable1.getValueAt(nFila, 6).toString();
                cVenta = cVenta.replace(".", "").replace(",", ".");

                cTransferenciaS = jTable1.getValueAt(nFila, 7).toString();
                cTransferenciaS = cTransferenciaS.replace(".", "").replace(",", ".");

                System.out.println(jTable1.getValueAt(nFila, 0).toString());
                System.out.println(jTable1.getValueAt(nFila, 1).toString());
                System.out.println(cEntrada);
                System.out.println(cCompra);
                System.out.println(cTransferenciaE);
                System.out.println(cSalidas);
                System.out.println(cVenta);
                System.out.println(cTransferenciaS);
                
                //tipo = new movimiento_de_mercadriasreport(jTable1.getValueAt(nFila, 0).toString(), jTable1.getValueAt(nFila, 1).toString(), Double.valueOf(cEntrada), Double.valueOf(cCompras), Double.valueOf(cTransferenciaE),Double.valueOf(cSalidas),Double.valueOf(cVentas), Double.valueOf(cTransferenciaS),Integer.valueOf(jTable1.getValueAt(nFila, 8).toString()),jTable1.getValueAt(nFila, 9).toString());
                tipo = new movimiento_de_mercadriasreport(jTable1.getValueAt(nFila, 0).toString(), jTable1.getValueAt(nFila, 1).toString(), Double.valueOf(cEntrada), Double.valueOf(cCompra), Double.valueOf(cTransferenciaE), Double.valueOf(cSalidas), Double.valueOf(cVenta), Double.valueOf(cTransferenciaS), Integer.valueOf(jTable1.getValueAt(nFila, 8).toString()), jTable1.getValueAt(nFila, 9).toString());
                Resultados.add(tipo);
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/movimiento_de_mercaderia.jasper");
