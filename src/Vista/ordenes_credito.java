 ...
 *
 */
public class ordenes_credito extends javax.swing.JFrame {
...
//this.jTable1.setShowHorizontalLines(false);
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(netoentregado, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarGiraduria.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarCasa.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCasa.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCasa.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarBanco.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarBco.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirBco.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "libroventaconsolidado.jPanel2.border.title"))); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "libroventaconsolidado.jLabel1.text")); // NOI18N

        jLabel8.setText(org.openide.util.NbBundle.getMessage(ordenes_credito.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
    ...
    private void AgregarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        ...
        detalle_orden_credito.setSize(710, 540);
    ...
    private void EliminarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        String num = jTable1.getValueAt(nFila, 1).toString();
            ...
            if (ret == 0) {
                ...
                try {
                    ...
                    if (p == null) {
                        ...
                        pl.borrarOrdenCredito(Integer.valueOf(num));
    ...
    private void GrabarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (ret == 0) {
            ...
            cMontoEntregar = cMontoEntregar.replace(".", "");
            cMontoEntregar = cMontoEntregar.replace(",", ".");
            ...
            nMonto = Double.valueOf(cMontoEntregar);
            String detalle = "[";
            for (int i = 1; i <= Integer.valueOf(this.plazo.getText()); i++) {
                ...
                //TASA ANUAL    
                nInteres = Math.round(nMonto * ((Double.valueOf(cTasa) * 12) / 12) / 100);
                //TASA MENSUAL
...
//        this.Opciones.setText(this.jTable1.getValueAt(nFila, 1).toString());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ordenes_credito().setVisible(true);
            }
        });
    }
