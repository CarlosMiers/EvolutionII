 ...
 *
 */
public class ordenes_credito_ferremax extends javax.swing.JFrame {
    ...
    public ordenes_credito_ferremax() {
        initComponents();
...
//this.jTable1.setShowHorizontalLines(false);
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(nroorden, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarGiraduria.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarCasa.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCasa.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCasa.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarBanco.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarBco.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirBco.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "libroventaconsolidado.jPanel2.border.title"))); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "libroventaconsolidado.jLabel1.text")); // NOI18N

        jLabel8.setText(org.openide.util.NbBundle.getMessage(ordenes_credito_ferremax.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
    ...
    private void AgregarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        ...
        detalle_orden_credito.setSize(661, 440);
    ...
    private void GrabarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (ret == 0) {
            ...
            String cNumeroFactura = nroorden.getText();
            ...
            if (Integer.valueOf(this.numero.getText()) == 0) {
                try {
                    grabarOCR.insertarOrdenCreditoFerremax(cr, detalle);
                } catch (SQLException e) {
                ...
                try {
                    ...
                    grabarOCR.ActualizarOrdenCreditoFerremax(cr, detalle);
                } catch (SQLException e) {
                    JOptionPane.showMessageDialog(null, "Error BD: " + e.getMessage());
                }
                JOptionPane.showMessageDialog(null, "Datos Agregados Correctamente");
...
//        this.Opciones.setText(this.jTable1.getValueAt(nFila, 1).toString());
    ...
    private void nroordenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nroordenActionPerformed
        int nCaracter = nroorden.getText().indexOf("-");
        String cNumeroFactura = nroorden.getText();
        if (nCaracter >= 0) {
            cNumeroFactura = cNumeroFactura.replace("-", "");
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {10, 120, 90, 90, 250, 100, 100,100};
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ordenes_credito_ferremax().setVisible(true);
            }
        });
    }
        ...
        public void run() {
            ...
            try {
                for (ordencredito orden : DAO.MostrarxFecha(dFechaInicio, dFechaFinal)) {
                    ...
                    String Datos[] = {orden.getIdordencredito(), String.valueOf(orden.getNumero()), formatoFecha.format(orden.getFecha()), String.valueOf(orden.getCliente().getCodigo()), orden.getCliente().getNombre(),formatea.format(orden.getImporte()), String.valueOf(orden.getPlazo()),formatea.format(orden.getMonto_cuota())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
