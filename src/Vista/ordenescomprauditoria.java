 ...
 * @author hp
 */
public class ordenescomprauditoria extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {120, 90, 90, 250, 100, 100, 100};
    ...
    private void initComponents() {
        ...
        wBuscarGiraduria.setTitle(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.wBuscarGiraduria.title")); // NOI18N
        ...
        BuscarGiraduria.setText(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.BuscarGiraduria.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.AceptarGir.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.SalirGir.text")); // NOI18N
        ...
        setTitle(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.title")); // NOI18N
        ...
        etiquetasaldos.setText(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.etiquetasaldos.text")); // NOI18N
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.generar.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.generar.toolTipText")); // NOI18N
        ...
        salir.setText(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.salir.text")); // NOI18N
        salir.setToolTipText(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.salir.toolTipText")); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.jPanel2.border.title"))); // NOI18N

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.jPanel4.border.title"))); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.jLabel2.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.jLabel3.text")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.listar.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(ordenescomprauditoria.class, "ordenescomprauditoria.listar.toolTipText")); // NOI18N
    ...
    private class GenerarConsultaOCredito extends Thread {
        ...
        public void run() {
            ...
            try {
                for (ordencompra orden : DAO.Auditar(FechaI, FechaF)) {
                    String Datos[] = {formato.format(orden.getNumero()), formatoFecha.format(orden.getFecha()), String.valueOf(orden.getCliente().getCodigo()), orden.getCliente().getNombre(), formato.format(orden.getImporte()), String.valueOf(orden.getPlazo()), formato.format(orden.getMonto_cuota())};
            ...
            if (cantFilas > 0) {
                ...
                JOptionPane.showMessageDialog(null, "Todas las Cuotas fueron generadas " );
    ...
    private class GenerarReporte extends Thread {
        public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                tipo = new OrdenCompraReporte(jTable1.getValueAt(nFila, 0).toString(), jTable1.getValueAt(nFila, 1).toString(), jTable1.getValueAt(nFila, 2).toString(), jTable1.getValueAt(nFila, 3).toString(), Double.valueOf(cImporte), jTable1.getValueAt(nFila, 5).toString(), Double.valueOf(cCuota), jTable1.getValueAt(nFila, 7).toString(), jTable1.getValueAt(nFila, 8).toString(), jTable1.getValueAt(nFila, 9).toString());
                Resultados.add(tipo);
            }
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/ocompraauditoria.jasper");
