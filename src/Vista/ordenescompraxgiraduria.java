 ...
 * @author hp
 */
public class ordenescompraxgiraduria extends javax.swing.JFrame {
     ...
     */
    public ordenescompraxgiraduria() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarCasa.setText(org.openide.util.NbBundle.getMessage(ordenescompraxgiraduria.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCasa.setText(org.openide.util.NbBundle.getMessage(ordenescompraxgiraduria.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCasa.setText(org.openide.util.NbBundle.getMessage(ordenescompraxgiraduria.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldos.setText("Ordenes de Compra Emitidas por Giraduría");
    ...
    private class GenerarConsultaOCredito extends Thread {
        ...
        public void run() {
            ...
            try {
                for (ordencompra orden : DAO.MostrarxFechaCondicional(FechaI, FechaF, nGiraduria, nGiraduria, nCliente, nCliente,nCasa,nCasa)) {
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/ordenescompraxgiraduria.jasper");
