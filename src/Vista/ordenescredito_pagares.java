...
import Modelo.PagareOrdenCredito;
 ...
 * @author hp
 */
public class ordenescredito_pagares extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Pagarés Vencidos de Ordenes de Crédito");
        ...
        etiquetasaldos.setText("Vencimientos de Págares por Ordenes de Crédito");
    ...
    private class GenerarConsultaOCredito extends Thread {
        ...
        public void run() {
            ...
            try {
                for (ordencredito orden : DAO.PagareOCR(FechaI, FechaF, nCliente, nCliente)) {
        ...
        public void run() {
            ...
            try {
                ...
                if (Integer.valueOf(socio.getText()) == 0) {
                    url = getClass().getClassLoader().getResource("Reports/ordenes_credito_pagares.jasper");
                } else {
                    url = getClass().getClassLoader().getResource("Reports/ordenes_credito_pagares2.jasper");
                }
