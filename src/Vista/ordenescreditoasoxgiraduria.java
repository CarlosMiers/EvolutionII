 ...
 * @author hp
 */
public class ordenescreditoasoxgiraduria extends javax.swing.JFrame {
     ...
     */
    public ordenescreditoasoxgiraduria() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {120, 90, 90, 250, 100, 100, 100, 100, 100, 100};
    ...
    private void initComponents() {
        ...
        jTBuscarCasa.setText(org.openide.util.NbBundle.getMessage(ordenescreditoasoxgiraduria.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCasa.setText(org.openide.util.NbBundle.getMessage(ordenescreditoasoxgiraduria.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCasa.setText(org.openide.util.NbBundle.getMessage(ordenescreditoasoxgiraduria.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldos.setText("Ordenes de Crédito por Giraduría");
    ...
    private class GenerarConsultaOCredito extends Thread {
        ...
        public void run() {
            ...
            try {
                for (ordencredito orden : DAO.MostrarxFechaCondicional(FechaI, FechaF, nGiraduria, nGiraduria, nCliente, nCliente,nCasa,nCasa)) {
                    String Datos[] = {formato.format(orden.getNumero()), formatoFecha.format(orden.getFecha()), String.valueOf(orden.getCliente().getCodigo()), orden.getCliente().getNombre(), formato.format(orden.getImporte()), String.valueOf(orden.getPlazo()), formato.format(orden.getMonto_cuota()), String.valueOf(orden.getGiraduria().getCodigo()), orden.getGiraduria().getNombre(), orden.getCasas().getNombre()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/ordenescreditoxgiraduria.jasper");
