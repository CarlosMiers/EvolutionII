...
import Modelo.OrdenCreditoReporte;
 ...
 * @author hp
 */
public class ordenescreditoauditoria extends javax.swing.JFrame {
     ...
     */
    public ordenescreditoauditoria() {
        initComponents();
    ...
    private void initComponents() {
        ...
        wBuscarGiraduria.setTitle(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.wBuscarGiraduria.title")); // NOI18N
        ...
        BuscarGiraduria.setText(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.BuscarGiraduria.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.AceptarGir.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.SalirGir.text")); // NOI18N
        ...
        setTitle(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.title")); // NOI18N
        ...
        etiquetasaldos.setText(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.etiquetasaldos.text")); // NOI18N
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.generar.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.generar.toolTipText")); // NOI18N
        ...
        salir.setText(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.salir.text")); // NOI18N
        salir.setToolTipText(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.salir.toolTipText")); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.jPanel2.border.title"))); // NOI18N

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.jPanel4.border.title"))); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.jLabel2.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.jLabel3.text")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.listar.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(ordenescreditoauditoria.class, "ordenescreditoauditoria.listar.toolTipText")); // NOI18N
    ...
    private class GenerarConsultaOCredito extends Thread {
        ...
        public void run() {
            ...
            try {
                for (ordencredito orden : DAO.Auditar(FechaI, FechaF)) {
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/ocreditoauditoria.jasper");
