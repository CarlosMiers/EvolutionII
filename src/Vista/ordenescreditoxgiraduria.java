 ...
 * @author hp
 */
public class ordenescreditoxgiraduria extends javax.swing.JFrame {
     ...
     */
    public ordenescreditoxgiraduria() {
        initComponents();
    ...
    private void initComponents() {
        ...
        wBuscarGiraduria.setTitle(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.wBuscarGiraduria.title")); // NOI18N
        ...
        BuscarGiraduria.setText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.BuscarGiraduria.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.AceptarGir.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.SalirGir.text")); // NOI18N
        ...
        setTitle(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.title")); // NOI18N
        ...
        etiquetasaldos.setText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.etiquetasaldos.text")); // NOI18N
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.generar.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.generar.toolTipText")); // NOI18N
        ...
        salir.setText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.salir.text")); // NOI18N
        salir.setToolTipText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.salir.toolTipText")); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.jPanel2.border.title"))); // NOI18N

        jLabel1.setText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.jLabel1.text")); // NOI18N
        ...
        giraduria.setText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.giraduria.text")); // NOI18N
        ...
        Buscar.setText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.Buscar.text")); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.jPanel4.border.title"))); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.jLabel2.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.jLabel3.text")); // NOI18N
        ...
        nombregiraduria.setText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.nombregiraduria.text")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.listar.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(ordenescreditoxgiraduria.class, "ordenescreditoxgiraduria.listar.toolTipText")); // NOI18N
    ...
    private class GenerarConsultaOCredito extends Thread {
        ...
        public void run() {
            ...
            try {
                for (ordencredito orden : DAO.MostrarxGiraduria(nGiraduria, FechaI, FechaF)) {
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                parameters.put("nGiraduria", giraduria.getText());
                parameters.put("FechaI", FechaI);
                parameters.put("FechaF", FechaF);
                JasperReport jr = null;

                URL url = getClass().getClassLoader().getResource("Reports/ocreditosxgiraduria.jasper");
