...
public class paises extends javax.swing.JFrame {
    ...
    public paises() {
        ...
        this.etiquetapais.setText("Países");
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM paises ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        etiquetapais = new org.edisoncor.gui.label.LabelMetric();
        ...
        etiquetapais.setText(org.openide.util.NbBundle.getMessage(paises.class, "saldosxclientes.labelMetric1.text")); // NOI18N
        ...
        panel1Layout.setHorizontalGroup(
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addComponent(etiquetapais, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        panel1Layout.setVerticalGroup(
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(etiquetapais, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("paises", "codigo=" + this.jTextField1.getText().trim());
        this.cargarTabla("SELECT * FROM paises ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("paises", "nombre", "'" + this.jTextField2.getText() + "'");
        } else {
            BD.actualizarRegistro("paises", "nombre ='" + this.jTextField2.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM paises ORDER BY codigo");
        this.jTextField2.setText("");
    ...
    private org.edisoncor.gui.label.LabelMetric etiquetapais;
