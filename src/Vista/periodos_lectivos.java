 ...
 * @author FedeXavier
 */
public class periodos_lectivos extends javax.swing.JFrame {
     ...
     */
    public periodos_lectivos() {
        initComponents();
        this.jTextField3.setVisible(false);
        this.etiquetafamilia.setText("Períodos Lectivos");
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM periodo_lectivo ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        etiquetafamilia.setText(org.openide.util.NbBundle.getMessage(periodos_lectivos.class, "saldosxclientes.labelMetric1.text")); // NOI18N
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("periodo_lectivo", "codigo=" + this.codigo.getText().trim());
        this.cargarTabla("SELECT * FROM periodo_lectivo ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void GrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("periodo_lectivo", "nombre,nomalias", "'" + this.nombre.getText()+ "'");
        } else {
            BD.actualizarRegistro("periodo_lectivo", "nombre ='" + this.nombre.getText() + "'", "codigo= " + this.codigo.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM periodo_lectivo ORDER BY codigo");
        this.nombre.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(periodos_lectivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new periodos_lectivos().setVisible(true);
            }
        });
    }
