...
public class permisos extends javax.swing.JFrame {
    ...
    Tablas modelopermiso = new Tablas();
    Tablas modeloausencia = new Tablas();
    JScrollPane scroll = new JScrollPane();
    private TableRowSorter trsfiltro, trsfiltroempleado, trsfiltropermiso, trsfiltroausencia;
    ...
    public permisos() {
        ...
        this.BuscarMotivo.setIcon(iconobuscar);
    ...
    private void initComponents() {
        ...
        detalle_permisos = new javax.swing.JDialog();
        ...
        BuscarMotivo = new javax.swing.JButton();
        ...
        detalle_permisos.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                detalle_permisosFocusGained(evt);
            }
        });
        detalle_permisos.addWindowFocusListener(new java.awt.event.WindowFocusListener() {
            public void windowGainedFocus(java.awt.event.WindowEvent evt) {
                detalle_permisosWindowGainedFocus(evt);
            }
            public void windowLostFocus(java.awt.event.WindowEvent evt) {
            }
        });
        detalle_permisos.addWindowListener(new java.awt.event.WindowAdapter() {
            public void windowActivated(java.awt.event.WindowEvent evt) {
                detalle_permisosWindowActivated(evt);
            }
        });
        ...
        motivo.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                motivoFocusGained(evt);
            }
        });
        ...
        BuscarMotivo.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        BuscarMotivo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BuscarMotivoActionPerformed(evt);
            }
        });

        nombremotivo.setEnabled(false);
        nombremotivo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                nombremotivoKeyPressed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(motivo, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(BuscarMotivo, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(nombremotivo)))
                .addGap(19, 19, 19))
        );
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jLabel6)))
                    .addComponent(BuscarMotivo, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(22, Short.MAX_VALUE))
        );

        javax.swing.GroupLayout detalle_permisosLayout = new javax.swing.GroupLayout(detalle_permisos.getContentPane());
        detalle_permisos.getContentPane().setLayout(detalle_permisosLayout);
        detalle_permisosLayout.setHorizontalGroup(
            detalle_permisosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(detalle_permisosLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(detalle_permisosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, detalle_permisosLayout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
        ...
        detalle_permisosLayout.setVerticalGroup(
            detalle_permisosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, detalle_permisosLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(detalle_permisosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Grabar)
                    .addComponent(Salir))
        ...
        jTBuscarEmpleado.setText(org.openide.util.NbBundle.getMessage(permisos.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarEmpleado.setText(org.openide.util.NbBundle.getMessage(permisos.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirEmpleado.setText(org.openide.util.NbBundle.getMessage(permisos.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarAusencia.setText(org.openide.util.NbBundle.getMessage(permisos.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarAusencia.setText(org.openide.util.NbBundle.getMessage(permisos.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirAusencia.setText(org.openide.util.NbBundle.getMessage(permisos.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetavacaciones.setText("Permisos");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(permisos.class, "libroventaconsolidado.jPanel2.border.title"))); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(permisos.class, "libroventaconsolidado.jLabel1.text")); // NOI18N

        jLabel8.setText(org.openide.util.NbBundle.getMessage(permisos.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
    ...
    private void AgregarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        idControl.setText("0");
        this.limpiar();
        detalle_permisos.setModal(true);
        detalle_permisos.setSize(500, 340);
        //Establecemos un título para el jDialog
        detalle_permisos.setTitle("Agregar Permisos");
        detalle_permisos.setLocationRelativeTo(null);
        detalle_permisos.setVisible(true);
        empleado.requestFocus();
    ...
    public void limpiar() {
        ...
        this.motivo.setText("0");
        this.nombremotivo.setText("");
    }
    ...
    private void ModificarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) == 1) {
            ...
            permisoDAO vacDAO = new permisoDAO();
            permiso vac = null;
            try {
            ...
            if (vac != null) {
                ...
                motivo.setText(String.valueOf(vac.getMotivo().getCodigo()));
                nombremotivo.setText(vac.getMotivo().getNombre());
                ...
                detalle_permisos.setSize(500, 340);
                //Establecemos un título para el jDialog
                detalle_permisos.setTitle("Modificar Permisos");
                detalle_permisos.setLocationRelativeTo(null);
                detalle_permisos.setVisible(true);
                empleado.requestFocus();
            } else {
    ...
    private void EliminarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) == 1) {
            ...
            if (ret == 0) {
                permisoDAO vacDAO = new permisoDAO();
                try {
                    permiso vac = vacDAO.buscarId(Integer.valueOf(num));
                    if (vac == null) {
                        JOptionPane.showMessageDialog(null, "Registro no Existe");
                    } else {
                        vacDAO.eliminarpermiso(Integer.valueOf(num));
    ...
    private void SalirActionPerformed(ActionEvent evt) {//GEN-FIRST:event_SalirActionPerformed
        detalle_permisos.setVisible(false);
        // TODO add your handling code here:
    ...
    private void GrabarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (ret == 0) {
            ...
            permisoDAO grabar = new permisoDAO();
            permiso vac = new permiso();

            ficha_empleadoDAO fichaDAO = new ficha_empleadoDAO();
            ficha_empleado ficha = null;

            motivo_ausenciaDAO moDAO = new motivo_ausenciaDAO();
            motivo_ausencia mo = null;
            try {
                ficha = fichaDAO.buscarId(Integer.valueOf(this.empleado.getText()));
                mo = moDAO.buscarId(Integer.valueOf(this.motivo.getText()));
            ...
            detalle_permisos.setVisible(false);
            this.detalle_permisos.setModal(false);
            this.refrescar.doClick();
        }
    }//GEN-LAST:event_GrabarActionPerformed

    private void detalle_permisosFocusGained(FocusEvent evt) {//GEN-FIRST:event_detalle_permisosFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_permisosFocusGained

    private void detalle_permisosWindowGainedFocus(WindowEvent evt) {//GEN-FIRST:event_detalle_permisosWindowGainedFocus
        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_permisosWindowGainedFocus

    private void detalle_permisosWindowActivated(WindowEvent evt) {//GEN-FIRST:event_detalle_permisosWindowActivated

        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_permisosWindowActivated
    ...
    private void AceptarAusenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarAusenciaActionPerformed
        ...
        this.motivo.setText(this.tablaausencia.getValueAt(nFila, 0).toString());
        this.nombremotivo.setText(this.tablaausencia.getValueAt(nFila, 1).toString());
    ...
    private void motivoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_motivoFocusGained
        motivo.selectAll();
    }//GEN-LAST:event_motivoFocusGained

    private void motivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_motivoActionPerformed
        BuscarMotivo.doClick();
        // TODO add your handling code here:
    ...
    private void BuscarMotivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarMotivoActionPerformed
        motivo_ausenciaDAO ausDAO = new motivo_ausenciaDAO();
        motivo_ausencia aus = null;
        try {
            aus = ausDAO.buscarId(Integer.valueOf(this.motivo.getText()));
            if (aus.getCodigo() == 0) {
                ...
                nombremotivo.setText(aus.getNombre());
                //Establecemos un título para el jDialog
            }
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "ERROR:" + e.getMessage());
        ...
        this.tiempo.requestFocus();
        // TODO add your handling code here:
    }//GEN-LAST:event_BuscarMotivoActionPerformed

    private void nombremotivoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nombremotivoKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_nombremotivoKeyPressed
    ...
    private void cargarTitulo() {
        ...
        modelo.addColumn("Motivo Permiso");

        int[] anchos = {100, 100,100,100,300, 150};
    ...
    private javax.swing.JButton BuscarMotivo;
    ...
    private javax.swing.JDialog detalle_permisos;
    ...
    private class GrillaPermisos extends Thread {
        ...
        public void run() {
            ...
            try {
                for (permiso vac : DAO.Todos(FechaI, FechaF)) {
                    System.out.println(vac.getNumero());
                    String Datos[] = {formatosinpunto.format(vac.getNumero()), formatoFecha.format(vac.getFecha()),formatoFecha.format(vac.getInicio()),formatoFecha.format(vac.getFin()),vac.getFicha_empleado().getNombreempleado(), vac.getMotivo().getNombre()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/solicitud_permiso.jasper");
