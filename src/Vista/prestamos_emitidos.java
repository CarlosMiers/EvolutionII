 ...
 * @author hp
 */
public class prestamos_emitidos extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        modelo.addColumn("Prestamo Monto");
        ...
        int[] anchos = {150, 250, 150, 150, 200, 150, 200, 200, 200, 100, 200};
    ...
    private void initComponents() {
        ...
        setTitle(org.openide.util.NbBundle.getMessage(prestamos_emitidos.class, "prestamos_emitidos.title")); // NOI18N
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(prestamos_emitidos.class, "prestamos_emitidos.generar.text")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(prestamos_emitidos.class, "prestamos_emitidos.listar.text")); // NOI18N
        ...
        jButton3.setText(org.openide.util.NbBundle.getMessage(prestamos_emitidos.class, "prestamos_emitidos.jButton3.text_1")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(prestamos_emitidos.class, "prestamos_emitidos.jLabel1.text")); // NOI18N

        jLabel2.setText(org.openide.util.NbBundle.getMessage(prestamos_emitidos.class, "prestamos_emitidos.jLabel2.text")); // NOI18N

        jLabel6.setText(org.openide.util.NbBundle.getMessage(prestamos_emitidos.class, "prestamos_emitidos.jLabel6.text")); // NOI18N
        ...
        BuscarMoneda.setText(org.openide.util.NbBundle.getMessage(prestamos_emitidos.class, "prestamos_emitidos.BuscarMoneda.text")); // NOI18N
        ...
        getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(prestamos_emitidos.class, "prestamos_emitidos.AccessibleContext.accessibleName_1")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new prestamos_emitidos().setVisible(true);
            }
        });
    }
    ...
    private class generarconsulta extends Thread {
        ...
        public void run() {
            ...
            cSql = "SELECT prestamos.socio,prestamos.fecha, ";
            cSql = cSql + "clientes.nombre as nombrecliente, ";
            cSql = cSql + "comprobantes.nombre AS Tipo, sucursales.nombre AS Sucursal,prestamos.monto_entregar, ";
            cSql = cSql + "prestamos.monto_cuota, monedas.nombre AS moneda, prestamos.tasa, prestamos.plazo, prestamos.interes ";
            cSql = cSql + "FROM prestamos ";
            cSql = cSql + "JOIN CLIENTES ";
            cSql = cSql + "ON clientes.codigo=prestamos.socio ";
            cSql = cSql + "JOIN comprobantes ";
            cSql = cSql + "ON prestamos.tipo = comprobantes.codigo ";
            cSql = cSql + "JOIN monedas ";
            cSql = cSql + "ON monedas.codigo = prestamos.moneda ";
            cSql = cSql + "JOIN sucursales ";
            cSql = cSql + "ON sucursales.codigo = prestamos.sucursal ";
            cSql = cSql + "WHERE prestamos.estado='DESEMBOLSADO' and prestamos.fecha BETWEEN " + "'" + dFechaInicio + "'" + " AND " + "'" + dFechaFinal + "'";
            cSql = cSql + "ORDER BY prestamos.tipo; ";
            ...
            try {
                ...
                while (results.next()) {
                    ...
                    fila[0] = results.getString("socio");
                    fila[1] = formatoFecha.format(results.getDate("fecha"));
                    fila[2] = results.getString("nombrecliente");
                    fila[3] = results.getString("Tipo");
                    fila[4] = results.getString("sucursal");
                    fila[5] = formatea.format(results.getDouble("monto_entregar"));
                    fila[6] = formatea.format(results.getDouble("monto_cuota"));
                    fila[7] = results.getString("Moneda");
                    fila[8] = formatea.format(results.getDouble("Tasa"));
                    fila[9] = results.getString("Plazo");
                    fila[10] = formatea.format(results.getDouble("Interes"));
