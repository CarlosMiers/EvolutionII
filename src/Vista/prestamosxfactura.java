 ...
 * @author hp
 */
public class prestamosxfactura extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        wBuscarVendedor.setTitle(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.wBuscarVendedor.title")); // NOI18N
        ...
        BuscarVendedor.setText(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.BuscarVendedor.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.AceptarGir.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.SalirGir.text")); // NOI18N
        ...
        setTitle(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.title")); // NOI18N
        ...
        etiquetasaldos.setText(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.etiquetasaldos.text")); // NOI18N
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.generar.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.generar.toolTipText")); // NOI18N
        ...
        salir.setText(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.salir.text")); // NOI18N
        salir.setToolTipText(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.salir.toolTipText")); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.jPanel2.border.title"))); // NOI18N

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.jPanel4.border.title"))); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.jLabel2.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.jLabel3.text")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.listar.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(prestamosxfactura.class, "prestamosxfactura.listar.toolTipText")); // NOI18N
    ...
    private class GenerarConsultaPrestamo extends Thread {
        ...
        public void run() {
            ...
            try {
                for (prestamo pr : DAO.ConsultaPrestamoxFecha(FechaI, FechaF)) {
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/prestamos_emitidosxfactura.jasper");
