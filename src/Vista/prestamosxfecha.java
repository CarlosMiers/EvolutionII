 ...
 * @author hp
 */
public class prestamosxfecha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        wBuscarMoneda.setTitle(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.wBuscarMoneda.title")); // NOI18N
        ...
        BuscarVendedor.setText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.BuscarVendedor.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.AceptarGir.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.SalirGir.text")); // NOI18N
        ...
        setTitle(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.title")); // NOI18N
        ...
        etiquetasaldos.setText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.etiquetasaldos.text")); // NOI18N
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.generar.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.generar.toolTipText")); // NOI18N
        ...
        salir.setText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.salir.text")); // NOI18N
        salir.setToolTipText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.salir.toolTipText")); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.jPanel2.border.title"))); // NOI18N

        jLabel1.setText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.jLabel1.text")); // NOI18N
        ...
        moneda.setText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.moneda.text")); // NOI18N
        ...
        nombremoneda.setText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.nombremoneda.text")); // NOI18N
        nombremoneda.setEnabled(false);

        Buscar.setText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.Buscar.text")); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.jPanel4.border.title"))); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.jLabel2.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.jLabel3.text")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.listar.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(prestamosxfecha.class, "prestamosxfecha.listar.toolTipText")); // NOI18N
    ...
    private class GenerarConsultaPrestamo extends Thread {
        ...
        public void run() {
            ...
            try {
                for (prestamo pr : DAO.ConsultaPrestamoxMoneda(nMoneda, FechaI, FechaF)) {
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/prestamos_emitidos.jasper");
