...
public class profesiones extends javax.swing.JFrame {
    ...
    public profesiones() {
        ...
        GrillaProfesion GrillaOC = new GrillaProfesion();
    ...
    private void initComponents() {
        ...
        labelMetric1.setText("Profesiones");
...
/*        int nFila = this.jTable1.getSelectedRow();
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        ...
        if (ret == 0) {
            ...
            try {
                profesion pro = proDAO.buscarId(Integer.valueOf(num));
                if (pro == null) {
                    JOptionPane.showMessageDialog(null, "Registro no Existe");
                } else {
                    proDAO.eliminarprofesion(Integer.valueOf(num));
        ...
        Thread HiloGrilla = new Thread(GrillaPro);
        HiloGrilla.start();
    ...
    private void GrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        profesionDAO grabar = new profesionDAO();
        profesion pro = new profesion();

        if (Integer.valueOf(codigo.getText()) > 0) {
            pro.setCodigo(Integer.valueOf(codigo.getText()));
        }    //CAPTURAMOS LOS DATOS DE LA CABECERA
        pro.setNombre(this.nombre.getText());

        if (Integer.valueOf(this.codigo.getText()) == 0) {
            try {
                grabar.insertarprofesion(pro);
            ...
            try {
                grabar.actualizarprofesion(pro);
                JOptionPane.showMessageDialog(null, "Datos Agregados Correctamente");
                this.Limpiar();
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "Error BD: " + e.getMessage());
        ...
        GrillaProfesion GrillaP = new GrillaProfesion();
    ...
    private void modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarActionPerformed
        ...
        profesion pro = null;
        try {
            pro = proDAO.buscarId(Integer.valueOf(this.codigo.getText()));
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "ERROR:" + e.getMessage());
        }
        if (pro != null) {
            codigo.setText(String.valueOf(pro.getCodigo()));
    ...
    private class GrillaProfesion extends Thread {
        ...
        public void run() {
            ...
            profesionDAO proDAO = new profesionDAO();
            try {
                for (profesion pro : proDAO.Todos()) {
