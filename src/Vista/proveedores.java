...
public class proveedores extends javax.swing.JFrame {
    ...
    public proveedores() {
        ...
        this.TitPlan();
        this.cargarTitulo();
        this.cargarTabla("select codigo,nombre,ruc,direccion,localidad,telefono,fax,email,web,timbrado,vencimiento,estado,idcta,contacto from proveedores order by codigo");
    }
    ...
    private void initComponents() {
        ...
        contaproveedor = new javax.swing.JDialog();
        ...
        javax.swing.GroupLayout contaproveedorLayout = new javax.swing.GroupLayout(contaproveedor.getContentPane());
        contaproveedor.getContentPane().setLayout(contaproveedorLayout);
        contaproveedorLayout.setHorizontalGroup(
            contaproveedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(jPanel3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        contaproveedorLayout.setVerticalGroup(
            contaproveedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(contaproveedorLayout.createSequentialGroup()
        ...
        jTBuscarPlan.setText(org.openide.util.NbBundle.getMessage(proveedores.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(proveedores.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(proveedores.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Nombre", "Código", "RUC" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String Opcion = "new";
        new detalle_proveedores(Opcion).setVisible(true);
        // TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ControlGrabado.REGISTRO_GRABADO = "";
        String Opcion = this.jTextOpciones1.getText();
        new detalle_proveedores(Opcion).setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (Integer.valueOf(Config.cNivelUsuario) == 1) {
            if (!this.jTextOpciones1.getText().isEmpty()) {
                ...
                BD.borrarRegistro("proveedores", "codigo=" + this.jTextOpciones1.getText().trim());
                this.cargarTabla("select codigo,nombre,ruc,direccion,localidad,telefono,fax,email,web,timbrado,vencimiento,estado,idcta,contacto from proveedores order by codigo");
            } else {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        proveedor pro = null;
        try {
            pro = pvDAO.buscarId(Integer.valueOf(this.codcuenta.getText()));
        ...
        if (pro != null) {
            ...
            contaproveedor.setTitle("Modificar Enlace Contable");
            contaproveedor.setModal(true);

            //(Ancho,Alto)
            contaproveedor.setSize(450, 271);
            //Establecemos un título para el jDialog
            contaproveedor.setLocationRelativeTo(null);
            contaproveedor.setVisible(true);
    ...
    private void GrabaEnlaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabaEnlaceActionPerformed
        ...
        if (ret == 0) {
            ...
            proveedorDAO grabar = new proveedorDAO();
            ...
            p.setIdcta(pl);
            try {
                grabar.EnlaceContableProveedor(p);
            } catch (SQLException ex) {
                Exceptions.printStackTrace(ex);
            }
            contaproveedor.setVisible(false);
            contaproveedor.setModal(false);
        }
    ...
    public void cargarTabla(String sql) {
        ...
        try {
            ...
            while (results.next()) {
                ...
                fila[2] = results.getString("ruc");
                fila[3] = results.getString("direccion");
                fila[4] = results.getString("telefono");
                fila[5] = results.getString("fax");
                fila[6] = results.getString("email");
                fila[7] = results.getString("contacto");
    ...
    private javax.swing.JDialog contaproveedor;
