...
import ExportaVtaDAO.cuentaVpnclienteDAO;
import ExportaVtaDAO.detalleformacobroVpnDAO;
import ExportaVtaDAO.stockVpnDAO;
import ExportaVtaDAO.ventaVpnDAO;
 ...
 * @author hp
 */
public class punto_venta_multicaja_ferremax_sucursal extends javax.swing.JFrame {
    ...
    Tablas modeloanticipo = new Tablas();
    ...
    private TableRowSorter trsfiltro, trsfiltrosuc, trsfiltrocli, trsfiltrogastos,
            trsfiltrocomprobante, trsfiltromoneda, trsfiltroproducto, trsfiltrovendedor, trsfiltroformapago, trsfiltrobanco, trsfiltrocaja, trsfiltropreventa, trsfiltropago, trsfiltroficha;
     ...
     */
    public punto_venta_multicaja_ferremax_sucursal() {
        initComponents();
        this.etiquetastock.setVisible(false);
    ...
    public void CargarTituloAnticipo() {
        modeloanticipo.addColumn("Número");
        modeloanticipo.addColumn("Emisión");
        modeloanticipo.addColumn("Nombre Funcionario");
        modeloanticipo.addColumn("Importe");

        int[] anchos = {90, 90, 150, 100};
        for (int i = 0; i < modeloanticipo.getColumnCount(); i++) {
            this.tablaanticipo.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);
        }
        ((DefaultTableCellRenderer) tablaanticipo.getTableHeader().getDefaultRenderer()).setHorizontalAlignment(JLabel.CENTER);// Este código es para centrar las cabeceras de la tabla.
        tablaanticipo.getTableHeader().setFont(new Font("Arial Black", 1, 8));
        ...
        this.tablaanticipo.getColumnModel().getColumn(0).setCellRenderer(TablaRenderer);
        this.tablaanticipo.getColumnModel().getColumn(1).setCellRenderer(TablaCenter);
        this.tablaanticipo.getColumnModel().getColumn(3).setCellRenderer(TablaRenderer);
    }
    ...
    private void GrabarVenta() {
        ...
        try {
            ...
            //GRABA LA VENTA EN LA CENTRAL
           /* try {
                Socket s = new Socket(dirWeb, puerto);
                if (s.isConnected()) {
                    System.out.println("Conexión establecida con la dirección: " + dirWeb + " a travéz del puerto: " + puerto);
                    //VENTAS VPN    
                    //SE EJECUTA EL HILO PARA GRABAR EN LA CENTRAL    
                    new GrabarVpn(v, detalle).start();

                    //CUENTA CTE VPN
                    if (Integer.valueOf(this.comprobante.getText()) == 2) {
                        new GrabarVpnCuenta(detacuota).start();
                    } else if (Integer.valueOf(this.comprobante.getText()) == 1) {
                        new GrabarVpnCobro(detalleformapago).start();
                    }
                    if (Integer.valueOf(this.comprobante.getText()) == 3 && Integer.valueOf(this.cliente.getText()) != 1) {
                        new GrabarVpnCuenta(detacuota).start();
                    }
    ...
    private void TituloGastos() {
        modelogastos.addColumn("Factura"); //0
        modelogastos.addColumn("Fecha");//1
        modelogastos.addColumn("Nombre del Proveedor");//2
        modelogastos.addColumn("Importe");//3
        modelogastos.addColumn("ref");//4
        modelogastos.addColumn("obs");//5
        ...
        this.tablagastos.getColumnModel().getColumn(0).setCellRenderer(TablaRenderer);
        this.tablagastos.getColumnModel().getColumn(1).setCellRenderer(TablaCentro);
        this.tablagastos.getColumnModel().getColumn(3).setCellRenderer(TablaRenderer);

        //recorro todas las columnas que voy a hacer invisibles
        this.tablagastos.getColumnModel().getColumn(4).setMaxWidth(0);
        this.tablagastos.getColumnModel().getColumn(4).setMinWidth(0);
        this.tablagastos.getTableHeader().getColumnModel().getColumn(4).setMaxWidth(0);
        this.tablagastos.getTableHeader().getColumnModel().getColumn(4).setMinWidth(0);

        this.tablagastos.getColumnModel().getColumn(5).setMaxWidth(0);
        this.tablagastos.getColumnModel().getColumn(5).setMinWidth(0);
        this.tablagastos.getTableHeader().getColumnModel().getColumn(5).setMaxWidth(0);
        this.tablagastos.getTableHeader().getColumnModel().getColumn(5).setMinWidth(0);
...
//      this.factura.setText(formatosinpunto.format(config.getSucursaldefecto().getFactura()));
    ...
    public void sumatoria() {
        ...
        this.totalcompleto.setText(formatea.format(sumtotalcompleto));
    ...
    private void initComponents() {
        ...
        totalcompleto = new javax.swing.JFormattedTextField();
        ...
        BAnticipos = new javax.swing.JDialog();
        jPanel68 = new javax.swing.JPanel();
        combofuncionario = new javax.swing.JComboBox();
        jTBuscarFicha = new javax.swing.JTextField();
        jScrollPane14 = new javax.swing.JScrollPane();
        tablaanticipo = new javax.swing.JTable();
        ...
        gastos_compras = new javax.swing.JDialog();
        jPanel70 = new javax.swing.JPanel();
        jLabel83 = new javax.swing.JLabel();
        ComboBuscarFactura = new javax.swing.JComboBox<>();
        FiltrarFactura = new javax.swing.JTextField();
        jPanel71 = new javax.swing.JPanel();
        jScrollPane15 = new javax.swing.JScrollPane();
        tablagastos = new javax.swing.JTable();
        jPanel72 = new javax.swing.JPanel();
        AceptarGastos = new javax.swing.JButton();
        SalirGastos = new javax.swing.JButton();
        ...
        totalcompleto.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0"))));
                ...
                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panel1Layout.createSequentialGroup()
                        ...
                        .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(panel1Layout.createSequentialGroup()
                                .addGap(10, 10, 10)
                                .addComponent(totalcompleto, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap(20, Short.MAX_VALUE))
        );
        ...
        jLabel17.setText("[F2]Cobrar [F3]Anticipos [F4]Pagos [F5]Nuevo Cliente [F6]Cancelar [F8]Productos  [F10]Cobranzas");
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarVendedor.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarVendedor.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirVendedor.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarComprobante.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarComprobante.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirComprobante.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarForma.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jLabel18.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.jLabel1.text")); // NOI18N

        codigo.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        codigo.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        codigo.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.codigo.text")); // NOI18N
        ...
        BuscarCliente.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.BuscarCliente.text")); // NOI18N
        BuscarCliente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BuscarClienteActionPerformed(evt);
            }
        ...
        nombre.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.codigo.text")); // NOI18N
        ...
        jLabel21.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.jLabel6.text")); // NOI18N
        ...
        jLabel22.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.jLabel5.text")); // NOI18N
        ...
        jLabel23.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.jLabel2.text")); // NOI18N

        ruc.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ruc.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.codigo.text")); // NOI18N
        ...
        jLabel24.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.jLabel4.text")); // NOI18N

        celular.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        celular.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.codigo.text")); // NOI18N
        ...
        habilitado.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.habilitado.text")); // NOI18N

        control.setEditable(false);
        control.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.control.text")); // NOI18N
        control.setEnabled(false);

        direccion.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        direccion.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.codigo.text")); // NOI18N
        ...
        jLabel19asdsad1.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.jLabel3.text")); // NOI18N
        ...
        GrabarCliente.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.BotonGrabar.text")); // NOI18N
        ...
        SalirCliente.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "clientes_sparta.BotonSalir.text")); // NOI18N
        ...
        textoproducto.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        etiquetastock.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        etiquetastock.setForeground(new java.awt.Color(0, 0, 255));
        etiquetastock.setText("Aguarde un Momento, buscando inventario en Sucursales ");
        ...
        AceptarProducto.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirProducto.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        fotoProducto.setToolTipText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.fotoProducto.toolTipText")); // NOI18N
        ...
        BBancos.setTitle(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "detalle_extracciones.BBancos.title")); // NOI18N
        ...
        jTBuscarbanco.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "detalle_extracciones.jTBuscarbanco.text")); // NOI18N
        ...
        Aceptar.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "detalle_extracciones.Aceptar.text")); // NOI18N
        ...
        SalirBanco.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "detalle_extracciones.SalirBanco.text")); // NOI18N
        ...
        inventario.setTitle(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas_mercaderias.inventario.title")); // NOI18N
        ...
        SalirStockSucursal.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas_mercaderias.SalirStock.text")); // NOI18N
        ...
        jLabel69.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas_mercaderias.jLabel56.text")); // NOI18N

        jLabel71.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas_mercaderias.jLabel57.text")); // NOI18N

        etiquetacodigo.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas_mercaderias.etiquetacodigo.text")); // NOI18N

        etiquetanombre.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas_mercaderias.etiquetanombre.text")); // NOI18N
        ...
        jTBuscarPago.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCobrador.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCobrador.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        BAnticipos.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        BAnticipos.setTitle("null");
        ...
        jTBuscarFicha.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        tablaanticipo.setModel(modeloanticipo);
        tablaanticipo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablaanticipoMouseClicked(evt);
            }
        });
        tablaanticipo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tablaanticipoKeyPressed(evt);
            }
        });
        jScrollPane14.setViewportView(tablaanticipo);
        ...
        AceptarFuncionario.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirFuncionario.setText(org.openide.util.NbBundle.getMessage(punto_venta_multicaja_ferremax_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        javax.swing.GroupLayout BAnticiposLayout = new javax.swing.GroupLayout(BAnticipos.getContentPane());
        BAnticipos.getContentPane().setLayout(BAnticiposLayout);
        BAnticiposLayout.setHorizontalGroup(
            BAnticiposLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane14, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 497, Short.MAX_VALUE)
            .addComponent(jPanel69, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(jPanel68, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        BAnticiposLayout.setVerticalGroup(
            BAnticiposLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(BAnticiposLayout.createSequentialGroup()
        ...
        gastos_compras.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        gastos_compras.setTitle("Pagar Gastos");

        jPanel70.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));

        jLabel83.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel83.setText("Filtrar por");

        ComboBuscarFactura.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ComboBuscarFactura.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "N° de Factura", "Nombre del Proveedor" }));

        FiltrarFactura.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                FiltrarFacturaKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                FiltrarFacturaKeyReleased(evt);
            }
        });
        ...
        jPanel70Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel70Layout.createSequentialGroup()
                ...
                .addGap(32, 32, 32)
                .addComponent(ComboBuscarFactura, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(FiltrarFactura, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(33, Short.MAX_VALUE))
        );
        jPanel70Layout.setVerticalGroup(
            ...
            .addGroup(jPanel70Layout.createSequentialGroup()
                ...
                .addGroup(jPanel70Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(FiltrarFactura, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(13, Short.MAX_VALUE))
        );

        jPanel71.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        tablagastos.setModel(modelogastos);
        ...
        jScrollPane15.setViewportView(tablagastos);
        ...
        AceptarGastos.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        AceptarGastos.setText("Aceptar");
        AceptarGastos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AceptarGastosActionPerformed(evt);
            }
        });

        SalirGastos.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        SalirGastos.setText("Salir");
        SalirGastos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SalirGastosActionPerformed(evt);
            }
        });
        ...
        jPanel72Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel72Layout.createSequentialGroup()
                .addGap(90, 90, 90)
                .addComponent(AceptarGastos, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(39, 39, 39)
                .addComponent(SalirGastos, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel72Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel72Layout.createSequentialGroup()
                ...
                .addGroup(jPanel72Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(AceptarGastos)
                    .addComponent(SalirGastos))
                .addContainerGap())
        );

        javax.swing.GroupLayout gastos_comprasLayout = new javax.swing.GroupLayout(gastos_compras.getContentPane());
        gastos_compras.getContentPane().setLayout(gastos_comprasLayout);
        gastos_comprasLayout.setHorizontalGroup(
            gastos_comprasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        gastos_comprasLayout.setVerticalGroup(
            gastos_comprasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(gastos_comprasLayout.createSequentialGroup()
    ...
    private void GrabarVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarVentaActionPerformed
        ...
        if (nCaracter >= 0) {
            ...
            JOptionPane.showMessageDialog(null, "Formato de Número Corresponde");
            this.codigoproducto.getText();
            return;
        }
 ...
 /*GrillaProd grillaprd = new GrillaProd();
    ...
    private void codigoproductoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_codigoproductoKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_F3) {
            GrillaOrdenCompra grillaant = new GrillaOrdenCompra();
            Thread hiloAnti = new Thread(grillaant);
            hiloAnti.start();
            BAnticipos.setSize(500, 575);
            BAnticipos.setLocationRelativeTo(null);
            //Cargo el Vendedor en el punto de Vent
            BAnticipos.setModal(true);
            BAnticipos.setVisible(true);
            BAnticipos.requestFocus();
        }

        if (evt.getKeyCode() == KeyEvent.VK_F4) {
            GrillaGastos grillagas = new GrillaGastos();
            Thread hiloGasto = new Thread(grillagas);
            hiloGasto.start();
            gastos_compras.setSize(500, 575);
            gastos_compras.setLocationRelativeTo(null);
            //Cargo el Vendedor en el punto de Vent
            gastos_compras.setModal(true);
            gastos_compras.setVisible(true);
            gastos_compras.requestFocus();
        }

        /*if (evt.getKeyCode() == KeyEvent.VK_F9) {
            this.limpiarOrden();
            detalle_orden_compra.setSize(448, 350);
...
//            nSupervisorCaja = 4;
    ...
    private void tablaproductoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablaproductoKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_F3) {
            this.etiquetastock.setVisible(true);
            int nsucursal = Integer.valueOf(this.sucursal.getText());
            int nFila = tablaproducto.getSelectedRow();
            String cProducto = tablaproducto.getValueAt(nFila, 0).toString();
            String cNombre = tablaproducto.getValueAt(nFila, 1).toString();
            if (nFila < 0) {
    ...
    private void jTBuscarFichaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTBuscarFichaKeyPressed
        ...
        trsfiltroficha = new TableRowSorter(tablaanticipo.getModel());
        tablaanticipo.setRowSorter(trsfiltroficha);
        // TODO add your handling code here:
    ...
    private void tablaanticipoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaanticipoMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tablaanticipoMouseClicked

    private void tablaanticipoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablaanticipoKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tablaanticipoKeyPressed
    ...
    private void AceptarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarFuncionarioActionPerformed
        int nFila = this.tablaanticipo.getSelectedRow();

        String cNumero = this.tablaanticipo.getValueAt(nFila, 0).toString();
        String cImporte = this.tablaanticipo.getValueAt(nFila, 3).toString();
        cImporte = cImporte.replace(".", "").replace(",", ".");

        String cCotizacion = "1";

        String cMonto = cImporte;
        ...
        if (ret == 0) {
            ...
            ordencompraDAO antDAO = new ordencompraDAO();
            ordencompra ant = new ordencompra();
            ant.setNumero(Integer.valueOf(cNumero));
            //ant.setCierre(1);
            try {
                usu = usuDAO.buscarId(Integer.valueOf(Config.CodUsuario));
                ca = caDAO.buscarId(Integer.valueOf(caja.getText()));
                mo = moDAO.buscarId(1);
                bco = bcoDAO.buscarId(Integer.valueOf(caja.getText()));
            } catch (SQLException ex) {
                Exceptions.printStackTrace(ex);
            }
            Date FechaProceso = ODate.de_java_a_sql(fecha.getDate());
            ...
            ap.setCotizacion(Double.valueOf(cCotizacion));
            ap.setMonto(Double.valueOf(cMonto));
            ap.setNombre("Anticipo " + this.tablaanticipo.getValueAt(nFila, 2).toString());
            ap.setBanco(bco);
            /*------------EXTRACCIONES------------------------------*/
            ...
            String idmovimiento = UUID.crearUUID();
            idmovimiento = idmovimiento.substring(1, 25);
            String cDocumento = caja.getText() + this.tablaanticipo.getValueAt(nFila, 0).toString();
            String cTipo = "C";
            String cCheque = "";
            ext.setIdmovimiento(idmovimiento);
            ext.setDocumento(cDocumento);
            ...
            ext.setCotizacion(new BigDecimal(Double.valueOf(cCotizacion)));
            ext.setImporte(new BigDecimal(Double.valueOf(cImporte)));
            ext.setObservaciones("Anticipo " + this.tablaanticipo.getValueAt(nFila, 2).toString());
            ext.setChequenro(cCheque);
            ext.setVencimiento(FechaProceso);
            ext.setMoneda(mo);
            try {
                grabar.insertarApertura(ap);
                //exDAO.insertarMovBancoFerremax(ext);
                antDAO.ActualizarPagoAnticipo(Integer.valueOf(cNumero));
                JOptionPane.showMessageDialog(null, "Datos Agregados Correctamente");
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "Error BD: " + e.getMessage());
            }
        }
        this.BAnticipos.setVisible(false);
        ...
        if (ret == 0) {
            ...
            for (int i = 1; i <= Integer.valueOf(this.plazo.getText()); i++) {
                ...
                String linea = "{iddocumento : " + iddocumento + ","
                        ...
                        + "documento : " + caja.getText() + this.cliente1.getText() + ","
                        + "fecha : " + FechaProceso + ","
            ...
            try {
                usu = usuDAO.buscarId(Integer.valueOf(Config.CodUsuario));
                caj = cajaDAO.buscarId(Integer.valueOf(caja.getText()));
                mo = moDAO.buscarId(1);
                bco = bcoDAO.buscarId(Integer.valueOf(caja.getText()));
            } catch (SQLException ex) {
                Exceptions.printStackTrace(ex);
            ...
            String idmovimiento = UUID.crearUUID();
            idmovimiento = idmovimiento.substring(1, 25);
            String cDocumento = caja.getText() + this.cliente1.getText();
            String cTipo = "C";
            String cCheque = "";
            ext.setIdmovimiento(idmovimiento);
            ext.setDocumento(cDocumento);
    ...
    private void FiltrarFacturaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_FiltrarFacturaKeyPressed
        this.ComboBuscarFactura.addKeyListener(new KeyAdapter() {
            public void keyReleased(final KeyEvent e) {
                String cadena = (FiltrarFactura.getText()).toUpperCase();
                FiltrarFactura.setText(cadena);
                int indiceColumnaTabla = 0;
                switch (ComboBuscarFactura.getSelectedIndex()) {
                    case 0:
                        indiceColumnaTabla = 0;
                        break;//por numero
                    case 1:
                ...
                repaint();
                filtrogastos(indiceColumnaTabla);
            }
        });
        trsfiltrogastos = new TableRowSorter(tablagastos.getModel());
        tablagastos.setRowSorter(trsfiltrogastos);

        // TODO add your handling code here:
    }//GEN-LAST:event_FiltrarFacturaKeyPressed

    public void filtrogastos(int nNumeroColumna) {
        trsfiltrogastos.setRowFilter(RowFilter.regexFilter(this.FiltrarFactura.getText(), nNumeroColumna));
    }


    private void FiltrarFacturaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_FiltrarFacturaKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_FiltrarFacturaKeyReleased
    ...
    private void AceptarGastosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarGastosActionPerformed
        int nFila = this.tablagastos.getSelectedRow();
        String cReferencia = this.tablagastos.getValueAt(nFila, 4).toString();
        String cNumero = this.tablagastos.getValueAt(nFila, 0).toString();
        String cImporte = this.tablagastos.getValueAt(nFila, 3).toString();
        cImporte = cImporte.replace(".", "").replace(",", ".");
        String cCotizacion = "1";
        String cMonto = cImporte;
        ...
        if (ret == 0) {
            ...
            extraccionDAO exDAO = new extraccionDAO();
            extraccion ext = new extraccion();
            gastos_comprasDAO antDAO = new gastos_comprasDAO();
            gastos_compras ant = new gastos_compras();
            ant.setCreferencia(this.tablagastos.getValueAt(nFila, 3).toString());
            //ant.setCierre(1);
            try {
                usu = usuDAO.buscarId(Integer.valueOf(Config.CodUsuario));
                ca = caDAO.buscarId(Integer.valueOf(caja.getText()));
            ...
            ap.setCotizacion(Double.valueOf(cCotizacion));
            ap.setMonto(Double.valueOf(cMonto));
            ap.setNombre(this.tablagastos.getValueAt(nFila, 5).toString());
            ap.setBanco(bco);
            /*------------EXTRACCIONES------------------------------*/
            ...
            ext.setCotizacion(new BigDecimal(Double.valueOf(cCotizacion)));
            ext.setImporte(new BigDecimal(Double.valueOf(cImporte)));
            ext.setObservaciones("Pago Factura " + this.tablagastos.getValueAt(nFila, 2).toString());
            ext.setChequenro(cCheque);
            ext.setVencimiento(FechaProceso);
            ext.setMoneda(mo);
            try {
                grabar.insertarApertura(ap);
                //exDAO.insertarMovBancoFerremax(ext);
                antDAO.ActualizarGastosCierre(cReferencia);
                JOptionPane.showMessageDialog(null, "Datos Agregados Correctamente");
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "Error BD: " + e.getMessage());
            }
        }
        this.gastos_compras.setVisible(false);
        this.FiltrarFactura.setText("");
        this.codigoproducto.requestFocus();
        // TODO add your handling code here:
    }//GEN-LAST:event_AceptarGastosActionPerformed

    private void SalirGastosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SalirGastosActionPerformed
        this.gastos_compras.setVisible(false);
        // TODO add your handling code here:
    }//GEN-LAST:event_SalirGastosActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(punto_venta_multicaja_ferremax_sucursal.class
    ...
    private javax.swing.JButton AceptarGastos;
    ...
    private javax.swing.JDialog BAnticipos;
    ...
    private javax.swing.JButton SalirGastos;
    ...
    private javax.swing.JDialog gastos_compras;
    ...
    private javax.swing.JTable tablaanticipo;
    ...
    private javax.swing.JFormattedTextField totalcompleto;
...
/*            configuracionDAO configDAO = new configuracionDAO();
    ...
    private class GrillaAnticipos extends Thread {

        public void run() {
            //Antes de Cargar el Jtable Ajustamos el ancho de las columnas con el Ancho que se nos antoje
            /*
            int cantidadRegistro = modeloanticipo.getRowCount();
            for (int i = 1; i <= cantidadRegistro; i++) {
                modeloanticipo.removeRow(0);
            }
            anticiposDAO DAOant = new anticiposDAO();
            try {
                for (anticipo prev : DAOant.MostrarxFechaActivos()) {
                    String Datos[] = {String.valueOf(formatosinpunto.format(prev.getIdcontrol())),
                        formatoFecha.format(prev.getFecha()),
                        prev.getFuncionario().getNombreempleado(),
                        formatea.format(prev.getImporte())};
                    modeloanticipo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
            }
            tablaanticipo.setRowSorter(new TableRowSorter(modeloanticipo));
            int cantFilas = tablaanticipo.getRowCount();*/
        }
    }

    private class GrillaOrdenCompra extends Thread {
        ...
        public void run() {
            ...
            ordencompraDAO DAOant = new ordencompraDAO();
            try {
                for (ordencompra prev : DAOant.MostrarxFechaActivos(FechaProceso, FechaProceso)) {
                    String Datos[] = {formatosinpunto.format(prev.getNumero()),
                        formatoFecha.format(prev.getFecha()),
                        prev.getCliente().getNombre(),
                        formatea.format(prev.getImporte())};
                    modeloanticipo.addRow(Datos);
    ...
    private class GrillaGastos extends Thread {
        ...
        public void run() {
            ...
            gastos_comprasDAO DAOant = new gastos_comprasDAO();
            try {
                for (gastos_compras prev : DAOant.MostrarDetalleGastosSinPago(FechaProceso, FechaProceso)) {
                    String Datos[] = {prev.getFormatofactura(),
                        formatoFecha.format(prev.getFechafactura()),
                        prev.getProveedor().getNombre(),
                        formatea.format(prev.getTotalneto()),
                        prev.getCreferencia(),
                        "Rubro " + prev.getConcepto().getNombre().trim() + "--"
                        + prev.getObservacion().trim()};
                    modelogastos.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
            }
    ...
    private class GrabarVpn extends Thread {

        venta cab = new venta();
        private String deta;

        public GrabarVpn(venta cabecera, String det) {
            cab = cabecera;
            deta = det;
        }
        ...
        public void run() {
            {
                ventaVpnDAO grabarVentaCentral = new ventaVpnDAO();
                try {
                    grabarVentaCentral.AgregarFacturaVentaFerremax(cab, deta,Integer.valueOf(sucursal.getText()));
                } catch (SQLException ex) {
                    Exceptions.printStackTrace(ex);
                }
    ...
    private class GrabarVpnCuenta extends Thread {

        private String cta;

        public GrabarVpnCuenta(String detallecuenta) {
            cta = detallecuenta;
        }

        public void run() {
            {
                cuentaVpnclienteDAO grabarCtaCentral = new cuentaVpnclienteDAO();
                try {
                    grabarCtaCentral.guardarCuentaVpnFerremax(cta,Integer.valueOf(sucursal.getText()));
                } catch (SQLException ex) {
                    Exceptions.printStackTrace(ex);
                }
            }
    ...
    private class GrabarVpnCobro extends Thread {

        private String efec;

        public GrabarVpnCobro(String detalleforma) {
            efec = detalleforma;
        }

        public void run() {
            {
                detalleformacobroVpnDAO cobDAO = new detalleformacobroVpnDAO();
                try {
                    cobDAO.guardarFormaPagoVpn(efec,Integer.valueOf(sucursal.getText()));
                } catch (SQLException ex) {
                    Exceptions.printStackTrace(ex);
                }
            }
        ...
        public void run() {
            {
                ...
                try {
                    if (accion == 1) {
                        cliDAO.insertarClienteVpn(cli,Integer.valueOf(sucursal.getText()));
                    } else {
                        cliDAO.actualizarClienteVpn(cli,Integer.valueOf(sucursal.getText()));
                    }
                } catch (SQLException ex) {
                    Exceptions.printStackTrace(ex);
                }
