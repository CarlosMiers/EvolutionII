 ...
 * @author hp
 */
public class puntoventa_listaprecios extends javax.swing.JFrame {
     ...
     */
    public puntoventa_listaprecios() {
        initComponents();
    ...
    private void GrabarVenta() {
        ...
        if (nombrecomprobante.getText().trim().equals("VENTA CREDITO")) {
            ...
            String cCobroTransferencia=cobrotransferencia.getText();
            String cCobroGiros = cobrogiros.getText();
            cCobroTransferencia = cCobroTransferencia.replace(".", "").replace(",", ".");
            cCobroGiros = cCobroGiros.replace(".", "").replace(",", ".");
            ...
            if (Double.valueOf(cCobroTransferencia) > 0) {
                linea = "{idmovimiento : " + referencia.getText() + ","
                        + "forma : " + "6" + ","
                        + "banco : " + "1" + ","
                        + "nrocheque : " + "XX" + ","
                        + "confirmacion: " + FechaProceso + ","
                        + "netocobrado : " + cCobroTransferencia + "},";
                detalleformapago += linea;
            }
            
            if (Double.valueOf(cCobroGiros) > 0) {
                linea = "{idmovimiento : " + referencia.getText() + ","
                        + "forma : " + "7" + ","
                        + "banco : " + "1" + ","
                        + "nrocheque : " + "XX" + ","
                        + "confirmacion: " + FechaProceso + ","
                        + "netocobrado : " + cCobroGiros + "},";
                detalleformapago += linea;
            }
        ...
        try {
            ...
            //SE SUMA UNO MAS AL NUMERO DE FACTURA EN LA SUCURSAL CORRESPONDIENTE
...
//      this.nrotimbrado.setText(String.valueOf(config.getSucursaldefecto().getNrotimbrado()));
        ...
        this.cobrotransferencia.setText("0");
        this.cobrogiros.setText("0");
    ...
    private void TituloProductos() {
        ...
        modeloproducto.addColumn("S/Recambio");
        modeloproducto.addColumn("C/Recambio");
        modeloproducto.addColumn("Mayorista");
        modeloproducto.addColumn("IVA");
        DefaultTableCellRenderer TablaRenderer = new DefaultTableCellRenderer();
        TablaRenderer.setHorizontalAlignment(SwingConstants.RIGHT); // aqui defines donde alinear 

        int[] anchos = {90, 200, 100, 100, 100, 50};
        ...
        this.tablaproducto.getColumnModel().getColumn(5).setCellRenderer(TablaRenderer);
...
//      this.factura.setText(formatosinpunto.format(config.getSucursaldefecto().getFactura()));
    ...
    private void initComponents() {
        ...
        listaprecio = new javax.swing.JComboBox<>();
        ...
        cobrotransferencia = new javax.swing.JFormattedTextField();
        jPanel42 = new javax.swing.JPanel();
        jLabel53 = new javax.swing.JLabel();
        cobrogiros = new javax.swing.JFormattedTextField();
        ...
        listaprecio.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        listaprecio.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sin Recambio", "Con Recambio", "Mayorista" }));

        jLabel49.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel49.setText("Lista Precio");
                            ...
                            .addGroup(panel2Layout.createSequentialGroup()
                                ...
                                .addGroup(panel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel2Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(listaprecio, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(62, 62, 62))))
                            .addGroup(panel2Layout.createSequentialGroup()
        ...
        jLabel52.setText("Transferencia Bancaria");

        cobrotransferencia.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0"))));
        cobrotransferencia.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        cobrotransferencia.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        cobrotransferencia.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                cobrotransferenciaFocusGained(evt);
            }
        });
        cobrotransferencia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cobrotransferenciaActionPerformed(evt);
            }
        });
        cobrotransferencia.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cobrotransferenciaKeyPressed(evt);
            }
        });
        ...
        jPanel39Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel39Layout.createSequentialGroup()
                ...
                .addComponent(cobrotransferencia, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26))
        );
        jPanel39Layout.setVerticalGroup(
            ...
            .addGroup(jPanel39Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                .addComponent(jLabel52)
                .addComponent(cobrotransferencia, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        jLabel53.setText("Giros Telefonía");

        cobrogiros.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0"))));
        cobrogiros.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        cobrogiros.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        cobrogiros.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                cobrogirosFocusGained(evt);
            }
        });
        cobrogiros.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cobrogirosActionPerformed(evt);
            }
        });
        cobrogiros.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cobrogirosKeyPressed(evt);
            }
        });
        ...
        jPanel42Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel42Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(cobrogiros, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26))
        );
        jPanel42Layout.setVerticalGroup(
            ...
            .addGroup(jPanel42Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                .addComponent(jLabel53)
                .addComponent(cobrogiros, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarVendedor.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarVendedor.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirVendedor.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarComprobante.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarComprobante.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirComprobante.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        textoproducto.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarProducto.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirProducto.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarForma.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jLabel18.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.jLabel1.text")); // NOI18N

        codigo.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        codigo.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        codigo.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.codigo.text")); // NOI18N
        ...
        BuscarCliente.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.BuscarCliente.text")); // NOI18N
        BuscarCliente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BuscarClienteActionPerformed(evt);
            }
        ...
        nombre.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.codigo.text")); // NOI18N
        ...
        jLabel21.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.jLabel6.text")); // NOI18N
        ...
        jLabel22.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.jLabel5.text")); // NOI18N
        ...
        jLabel23.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.jLabel2.text")); // NOI18N

        ruc.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ruc.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.codigo.text")); // NOI18N
        ...
        jLabel24.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.jLabel4.text")); // NOI18N

        celular.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        celular.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.codigo.text")); // NOI18N
        ...
        habilitado.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.habilitado.text")); // NOI18N

        control.setEditable(false);
        control.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.control.text")); // NOI18N
        control.setEnabled(false);

        direccion.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        direccion.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.codigo.text")); // NOI18N
        ...
        jLabel19asdsad1.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.jLabel3.text")); // NOI18N
        ...
        GrabarCliente.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.BotonGrabar.text")); // NOI18N
        ...
        SalirCliente.setText(org.openide.util.NbBundle.getMessage(puntoventa_listaprecios.class, "clientes_sparta.BotonSalir.text")); // NOI18N
    ...
    private void AceptarCobroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarCobroActionPerformed
        ...
        cCobroTransferencia=cCobroTransferencia.replace(".","");
        cCobroGiros=cCobroGiros.replace(".","");
        
        if (Double.valueOf(cPagoEfectivo) + Double.valueOf(cCobroCheque) + Double.valueOf(cCobroTarjeta)+Double.valueOf(cCobroTransferencia)+Double.valueOf(cCobroGiros) > Double.valueOf(cTotalAPagar)) {
...
//        this.botonbusquedacliente.doClick();
        ...
        if (Config.cCodProducto == "") {;
            ...
            try {
                ...
                if (p.getCodigo() == null) {
                    ...
                    if (listaprecio.getSelectedIndex() == 0) {
                        double nPrecio = p.getPrecioventa().doubleValue();
                    ...
                    } else if (listaprecio.getSelectedIndex() == 1) {
    ...
    private void AceptarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarProductoActionPerformed
        ...
        if (this.precio.getText().isEmpty()) {
            if (listaprecio.getSelectedIndex() == 0) {
                ...
                this.precio.setText(this.tablaproducto.getValueAt(nFila, 4).toString());
            }
        }
    ...
    private void cobroefectivoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cobroefectivoKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.cobrotransferencia.requestFocus();
        }
        // TODO add your handling code here:
    ...
    private void cobrotransferenciaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cobrotransferenciaFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_cobrotransferenciaFocusGained

    private void cobrotransferenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cobrotransferenciaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cobrotransferenciaActionPerformed

    private void cobrotransferenciaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cobrotransferenciaKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.cobrogiros.requestFocus();
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_cobrotransferenciaKeyPressed

    private void cobrogirosFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cobrogirosFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_cobrogirosFocusGained

    private void cobrogirosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cobrogirosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cobrogirosActionPerformed

    private void cobrogirosKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cobrogirosKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.AceptarCobro.requestFocus();
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_cobrogirosKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(puntoventa_listaprecios.class
    ...
    private javax.swing.JFormattedTextField cobrogiros;
    private javax.swing.JFormattedTextField cobrotarjeta;
    private javax.swing.JFormattedTextField cobrotransferencia;
    ...
    private javax.swing.JComboBox<String> listaprecio;
        ...
        public void run() {
            ...
            try {
                for (producto pr : DAOpro.todosbasico()) {
                    ...
                    String Datos[] = {String.valueOf(pr.getCodigo()), pr.getNombre(), formatea.format(pr.getPrecioventa()), formatea.format(pr.getPrecio_maximo()), formatea.format(pr.getPrecio_minimo()), formatea.format(nPorcentajeIVA)};
