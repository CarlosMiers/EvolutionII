 ...
 *
 */
public class rendicion_de_fondos_cuenta extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltro, trsfiltrounidad, trsfiltromoneda,
            ...
            trsfiltrorubro, trsfiltroproveedor, trsfiltroplan;
    int nProp = 0;
    ...
    public rendicion_de_fondos_cuenta() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(creferencia, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(34, 34, 34))
        );
        ...
        jTBuscarBanco.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarBanco.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirBanco.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jLabel10.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel6.text")); // NOI18N
        ...
        jLabel11.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel1.text")); // NOI18N
        ...
        jLabel13.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel2.text")); // NOI18N
        ...
        jLabel14.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel3.text")); // NOI18N
        jPanel7.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 10, -1, 20));

        jLabel17.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel5.text")); // NOI18N
        jPanel7.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 70, 20));

        jLabel19.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel8.text")); // NOI18N
        ...
        jLabel20.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel9.text")); // NOI18N
        jPanel7.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 70, 50, 20));

        jPanel10.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jPanel1.border.title"))); // NOI18N
        ...
        exentas.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.exentas.text")); // NOI18N
        ...
        gravadas10.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.exentas.text")); // NOI18N
        ...
        iva10.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.exentas.text")); // NOI18N
        ...
        gravadas5.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.exentas.text")); // NOI18N
        ...
        jLabel21.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel10.text")); // NOI18N

        jLabel22.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel11.text")); // NOI18N

        jLabel23.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel12.text")); // NOI18N

        jLabel24.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel13.text")); // NOI18N

        jLabel25.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel14.text")); // NOI18N
        ...
        Totalneto.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.exentas.text")); // NOI18N
        ...
        jLabel26.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel18.text")); // NOI18N
        ...
        jPanel11.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jPanel4.border.title"))); // NOI18N
        ...
        proveedor.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.proveedor.text")); // NOI18N
        ...
        nombreproveedor.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.nombreproveedor.text")); // NOI18N
        ...
        timbrado.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.timbrado.text")); // NOI18N
        ...
        jLabel27.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel15.text")); // NOI18N
        jPanel7.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, -1, 20));

        jLabel28.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel16.text")); // NOI18N
        jPanel7.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, -1, 20));

        jLabel29.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.jLabel17.text")); // NOI18N
        ...
        BuscarProveedor.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos.BuscarProveedor.text")); // NOI18N
        ...
        jLabel30.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos_cuenta.jLabel19.text")); // NOI18N
        jPanel7.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 40, -1, -1));
        ...
        jPanel7.add(idcta, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 40, 80, -1));
        ...
        jPanel7.add(BuscarCta, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 40, 20, 20));

        nombrecuenta.setEditable(false);
        jPanel7.add(nombrecuenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 40, 160, -1));

        nrofactura.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        nrofactura.setToolTipText("Ejemplo Formato 001-001-0000712");
        nrofactura.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                nrofacturaKeyPressed(evt);
            }
        });
        jPanel7.add(nrofactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 110, -1));

        itemgastos.getContentPane().add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 70, 790, 420));
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarComprobantes.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarComprobantes.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirComprobantes.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarProveedor.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarProveedor.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirProveedor.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        BCuenta.setTitle(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos_cuenta.BCuenta.title")); // NOI18N
        ...
        jTBuscarPlan.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos_cuenta.jTBuscarPlan.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos_cuenta.AceptarGir.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "detalle_gastos_cuenta.SalirGir.text")); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "libroventaconsolidado.jPanel2.border.title"))); // NOI18N

        jLabel4.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "libroventaconsolidado.jLabel1.text")); // NOI18N

        jLabel8.setText(org.openide.util.NbBundle.getMessage(rendicion_de_fondos_cuenta.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
    ...
    private void ModificarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) < 3) {
            ...
            if (ca != null) {
                ...
                try {
                    for (gastos_compras detasi : detDAO.MostrarDetalleGastosContable(Double.valueOf(numero.getText()))) {
                        Object Detalle[] = {
                            ...
                            detasi.getIdca().getCodigo(), //6
                            detasi.getIdca().getNombre(), //7
        ...
        if (ret == 0) {
            ...
            for (int i = 0; i <= (totalRow); i++) {
                ...
                String linea = "{fondofijo : " + numero.getText() + ","
                        ...
                        + "idcta : " + modelodetalle.getValueAt(i, 5).toString() + ","
            ...
            if (Double.valueOf(numero.getText()) == 0) {
                try {
                    grabargasto.AgregarGastosContable(c, detalle);
                ...
                try {
                    gastos_comprasDAO delDAO = new gastos_comprasDAO();
                    extraDAO.borrarExtraccion(cReferencia);
                    grabargasto.ActualizarGastosContable(c, detalle);
                    extraDAO.insertarMovBanco(ext);
...
//        this.limpiaritems();
    ...
    private void editaritemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editaritemActionPerformed
        ...
        this.idcta.setText(tabladetalle.getValueAt(nFila, 5).toString());
        this.nombrecuenta.setText(tabladetalle.getValueAt(nFila, 6).toString());
    ...
    private void GrabarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarItemActionPerformed
        ...
        fila[5] = idcta.getText();
        fila[6] = nombrecuenta.getText();
    ...
    private void ListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ListarActionPerformed
        ...
        try {
            ...
            URL url = getClass().getClassLoader().getResource("Reports/reposicion_fondo_fijo2.jasper");
    ...
    public class GuardarFondos extends Thread {
