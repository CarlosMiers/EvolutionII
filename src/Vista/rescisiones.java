...
import DAO.detalle_rescisionDAO;
import Modelo.cuenta_clientes;
import DAO.monedaDAO;
import DAO.rescisionDAO;
 ...
 *
 */
public class rescisiones extends javax.swing.JFrame {
    ...
    private void GrabarCobro() {
        ...
        rescisionDAO cobDAO = new rescisionDAO();
        rescision cob = new rescision();
...
//        this.editaritem.setEnabled(false);
    ...
    private void initComponents() {
        ...
        detalle_rescision = new javax.swing.JDialog();
        ...
        jTabbedPane1.addTab("Seleccionar Cuentas", jScrollPane2);
        ...
        jLabel10.setText("Total Rescisiones");
        ...
        boxcuotas.setText("Marcar todas las cuentas");
        ...
        javax.swing.GroupLayout detalle_rescisionLayout = new javax.swing.GroupLayout(detalle_rescision.getContentPane());
        detalle_rescision.getContentPane().setLayout(detalle_rescisionLayout);
        detalle_rescisionLayout.setHorizontalGroup(
            detalle_rescisionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        detalle_rescisionLayout.setVerticalGroup(
            detalle_rescisionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        ...
        jTBuscarCobrador.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCobrador.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCobrador.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jLabel48.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.jLabel46.text")); // NOI18N

        jLabel49.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.jLabel47.text")); // NOI18N
        ...
        jLabel50.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.jLabel48.text")); // NOI18N
        ...
        jLabel51.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.jLabel49.text")); // NOI18N

        jLabel54.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.jLabel50.text")); // NOI18N
        ...
        grabarPago.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.grabarPago.text")); // NOI18N
        ...
        salirPago.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.salirPago.text")); // NOI18N
        ...
        jTBuscarForma.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarGir1.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirGir1.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarbanco.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCasa.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCasa.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        Anular.setText("Anular Rescisión");
        ...
        Listar.setText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.Listar.text")); // NOI18N
        Listar.setToolTipText(org.openide.util.NbBundle.getMessage(rescisiones.class, "ventas.Listar.toolTipText")); // NOI18N
        ...
        labelMetric1.setText("Rescisiones");
    ...
    private void AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        ...
        detalle_rescision.setModal(true);
        detalle_rescision.setSize(1140, 700);
        detalle_rescision.setTitle("Generar Nueva Cobranza");
        detalle_rescision.setLocationRelativeTo(null);
        detalle_rescision.setVisible(true);
        fecha.requestFocus();
        this.refrescar.doClick();
    ...
    private void AnularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AnularActionPerformed
        ...
        if (Config.cNivelUsuario.equals("1")) {
            if (!this.idcontrol.getText().isEmpty()) {
                ...
                if (ret == 0) {
                    BDConexion BD = new BDConexion();
                    BD.BorrarDetalles("detalle_rescisiones", "iddetalle='" + this.idcontrol.getText().trim() + "'");
                    BD.BorrarDetalles("rescisiones", "idpagos='" + this.idcontrol.getText() + "'");
                } else {
    ...
    private void SalirCobranzaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SalirCobranzaActionPerformed
        detalle_rescision.setVisible(false);
        // TODO add your handling code here:
    ...
    private void GrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        Object[] opciones = {"   Si   ", "   No   "};
        int ret = JOptionPane.showOptionDialog(null, "Desea Confirmar la Rescisión  de las Cuotas ? ", "Confirmación", 0, 3, null, opciones, opciones[0]);
        if (ret == 0) {
            this.GrabarCobro();
        }
    ...
    private void ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) < 3) {
            ...
            if (cob != null) {
                ...
                detalle_rescisionDAO detDAO = new detalle_rescisionDAO();
                try {
                    for (detalle_rescision co : detDAO.MostrarDetalle(idcontrol.getText())) {
                ...
                detalle_rescision.setModal(true);
                detalle_rescision.setSize(1140, 700);
                detalle_rescision.setTitle("Actualizar Rescisión");
                detalle_rescision.setLocationRelativeTo(null);
                detalle_rescision.setVisible(true);
                fecha.requestFocus();
            }
    ...
    private javax.swing.JDialog detalle_rescision;
    ...
    private class GrillaCobros extends Thread {
        ...
        public void run() {
            ...
            rescisionDAO DAO = new rescisionDAO();
            try {
                for (rescision orden : DAO.MostrarxDiaCobro(dFechaInicio, dFechaFinal, 0)) {
    ...
    private class ImprimirRecibo extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/rescisiones.jasper");
