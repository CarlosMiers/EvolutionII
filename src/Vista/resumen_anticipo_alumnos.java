 ...
 * @author hp
 */
public class resumen_anticipo_alumnos extends javax.swing.JFrame {
     ...
     */
    public resumen_anticipo_alumnos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(resumen_anticipo_alumnos.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(resumen_anticipo_alumnos.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(resumen_anticipo_alumnos.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Resumen de Saldos de Anticipos");
        ...
        etiquetasaldos.setText("Resumen de Saldos Anticipos");
        ...
        nTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos", "Negativos", "Positivos" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(nTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        con = new Conexion();
        stm = con.conectar();
        int nCliente = Integer.valueOf(this.jTable1.getValueAt(nFila, 5).toString());
        try {
            Map parameters = new HashMap();
            //Ahora que hay parametros le enviamos uno con el mismo nombre del que creamos

            parameters.put("cNombreEmpresa", Config.cNombreEmpresa.trim());
            parameters.put("cliente", nCliente);
            JasperReport jr = null;

            URL url = getClass().getClassLoader().getResource("Reports/detalle_ventasxalumnos.jasper");
    ...
    private javax.swing.JComboBox<String> nTipo;
    ...
    private class GenerarConsultaVenta extends Thread {
        ...
        public void run() {
            ...
            int nTipoI = nTipo.getSelectedIndex();
            ...
            try {
                for (anticipo_alumno cs : csDAO.MostrarCuentaxFechaxAlumno(nCliente, nCliente, nTipoI)) {
                    String Datos[] = {formatosinpunto.format(cs.getIdcontrol()),
                        ...
                        String.valueOf(cs.getFuncionario().getCodigo())};
                    modelo.addRow(Datos);
                }
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            String cReporte = "";
            if (nTipoI == 0) {
                cReporte = "anticipo_alumnos.jasper";
            } else if (nTipoI == 1) {
                cReporte = "anticipo_alumnos1.jasper";
            } else {
                cReporte = "anticipo_alumnos2.jasper";
            }
            con = new Conexion();
            stm = con.conectar();
            try {
