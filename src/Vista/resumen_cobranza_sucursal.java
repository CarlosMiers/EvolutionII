 ...
 * @author hp
 */
public class resumen_cobranza_sucursal extends javax.swing.JFrame {
     ...
     */
    public resumen_cobranza_sucursal() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {50, 50, 120, 50, 150, 100, 50};
    ...
    private void initComponents() {
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_cobranza_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_cobranza_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_cobranza_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(resumen_cobranza_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(resumen_cobranza_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(resumen_cobranza_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Resumen de Ingresos por Sucursales");
        ...
        etiquetasaldos.setText("Resumen de Cobranzas");
    ...
    private class GenerarConsultaSucursal extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cobranza vta : DAO.ResumenCobranzaxSucursal(FechaI, FechaF, nSucursal, nSucursal, nMoneda)) {
                    String Datos[] = {formatosinpunto.format(vta.getNumero()), formatoFecha.format(vta.getFecha()), vta.getSucursal().getNombre(),String.valueOf(vta.getCliente().getCodigo()),vta.getCliente().getNombre(),vta.getMoneda().getNombre(),formatea.format(vta.getDetalle_forma_cobro().getNetocobrado())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
  ...
  private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/resumen_cobranza_sucursal.jasper");
