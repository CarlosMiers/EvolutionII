 ...
 * @author hp
 */
public class resumen_cobranzas extends javax.swing.JFrame {
    ...
    private void cargarTituloTabla() {
        ...
        int[] anchos = {100, 100, 100, 200, 200, 100,100};
    ...
    private class GenerarConsultaOCredito extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cobranza cobro : DAO.Resumen_cobranzas(FechaI, FechaF, nMoneda)) {
                    String Datos[] = {formato.format(cobro.getNumero()),
                        formatoFecha.format(cobro.getFecha()),
                        String.valueOf(cobro.getCliente().getCodigo()),
                        cobro.getCliente().getNombre(),
                        cobro.getMoneda().getNombre(),
                        formato.format(cobro.getTotalpago()),
                        cobro.getEstado()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
    ...
    private class GenerarReporteCobranza extends Thread {
        ...
        public void run() {
            ...
            try {
               ...
               URL url = getClass().getClassLoader().getResource("Reports/resumen_cobranzas.jasper");
