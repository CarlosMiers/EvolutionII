...
import Modelo.Resumencomprasxproveedor;
 ...
 * @author hp
 */
public class resumen_comprasxproveedor extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltroproveedor, trsfiltromoneda, trsfiltro, trsfiltro2, trsfiltrocli;
     ...
     */
    public resumen_comprasxproveedor() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        modelo.addColumn("Descripción");
        int[] anchos = {80, 300, 100, 80, 150, 100, 100, 180, 80, 120, 200};
    ...
    private void initComponents() {
        ...
        jTBuscarProveedor.setText(org.openide.util.NbBundle.getMessage(resumen_comprasxproveedor.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarProveedor.setText(org.openide.util.NbBundle.getMessage(resumen_comprasxproveedor.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirProveedor.setText(org.openide.util.NbBundle.getMessage(resumen_comprasxproveedor.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_comprasxproveedor.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_comprasxproveedor.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_comprasxproveedor.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Resumen de Compras por Proveedores");
        ...
        etiquetasaldos.setText("Resumen de Compras por Proveedores");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(nombremoneda, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(panelTranslucido2, javax.swing.GroupLayout.PREFERRED_SIZE, 610, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(14, 14, 14))
        );
    ...
    private class GenerarConsultaCompra extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cabecera_compra orden : DAO.ResumenCompraxProveedor(FechaI, FechaF, nProveedor, nProveedor, nMoneda)) {
                    String Datos[] = {orden.getCodprodcompra(), orden.getNombreproductocompra(), formato.format(orden.getCantidadcompra()), formato.format(orden.getPreciocompra()),formato.format(Math.round(orden.getPromedio().doubleValue())), formato.format(orden.getTotalneto()), String.valueOf(orden.getCodrubrocompra()), orden.getNombrerubrocompra(),formatoFecha.format(orden.getFecha()), String.valueOf(orden.getProveedor().getCodigo()), orden.getProveedor().getNombre()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
         ...
         public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/resumen_comprasxproveedor.jasper");
