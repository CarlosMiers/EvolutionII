 ...
 * @author hp
 */
public class resumen_gastosxrubro extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {100, 90, 120, 180, 180, 100};
    ...
    private void initComponents() {
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_gastosxrubro.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_gastosxrubro.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_gastosxrubro.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldos.setText("Resumen de Gastos por Rubros");
    ...
    private class GenerarConsultaCompra extends Thread {
        ...
        public void run() {
            ...
            gastos_comprasDAO DAO = new gastos_comprasDAO();
            try {
                for (gastos_compras orden : DAO.MostrarDetalleGastosxFecha(FechaI, FechaF, nMoneda)) {
                    String Datos[] = {orden.getFormatofactura(),
                        formatoFecha.format(orden.getFechafactura()),
                        orden.getProveedor().getRuc(),
                        orden.getProveedor().getNombre(),
                        orden.getConcepto().getNombre(),
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/resumen_gastosxrubro.jasper");
