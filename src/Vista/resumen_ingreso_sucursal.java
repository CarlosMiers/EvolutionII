 ...
 * @author hp
 */
public class resumen_ingreso_sucursal extends javax.swing.JFrame {
     ...
     */
    public resumen_ingreso_sucursal() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ingreso_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ingreso_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ingreso_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(resumen_ingreso_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(resumen_ingreso_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(resumen_ingreso_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldos.setText("Resumen de Ingresos");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        try {
            DAO.ResumenVentaSucursalExcel(Integer.valueOf(sucursal.getText()), Integer.valueOf(moneda.getText()), FechaI, FechaF);
    ...
    private class GenerarConsultaSucursal extends Thread {
        ...
        public void run() {
            ...
            ventaDAO DAO = new ventaDAO();
            try {
                for (venta vta : DAO.ResumenIngresoxSucursal(FechaI, FechaF, nSucursal, nMoneda)) {
                    String Datos[] = {formatosinpunto.format(vta.getFactura()), formatoFecha.format(vta.getFecha()), vta.getSucursal().getNombre(), String.valueOf(vta.getCliente().getCodigo()), vta.getCliente().getNombre(), vta.getMoneda().getNombre(), formatea.format(vta.getDetalle_forma_cobro().getNetocobrado())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                String cReporte="";
                if (Config.nMultiCaja == 8) {
                    cReporte = "resumen_ingreso_vemay.jasper";
                } else {
                    cReporte = "resumen_ingresox_sucursal.jasper";
                }
