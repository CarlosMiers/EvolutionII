 ...
 * @author hp
 */
public class resumen_operaciones_bursatiles extends javax.swing.JFrame {
     ...
     */
    public resumen_operaciones_bursatiles() {
        initComponents();
    ...
    private void initComponents() {
        ...
        etiquetasaldos.setText("Resumen de Operaciones");
        ...
        panelTranslucido1Layout.setHorizontalGroup(
            ...
            .addGroup(panelTranslucido1Layout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addComponent(etiquetasaldos, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new resumen_operaciones_bursatiles().setVisible(true);
            }
        });
    }
