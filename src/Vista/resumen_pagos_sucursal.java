 ...
 * @author hp
 */
public class resumen_pagos_sucursal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_pagos_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_pagos_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_pagos_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(resumen_pagos_sucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(resumen_pagos_sucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(resumen_pagos_sucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Resumen de Pagos por Sucursales");
        ...
        etiquetasaldos.setText("Resumen de Pagos por Sucursales");
    ...
    private class GenerarConsultaSucursal extends Thread {
        ...
        public void run() {
            ...
            try {
                for (pago pa : DAO.Resumenpagoxsucursal(FechaI, FechaF, nSucursal, nSucursal, nMoneda)) {
  ...
  private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/resumen_pagosx_sucursal.jasper");
