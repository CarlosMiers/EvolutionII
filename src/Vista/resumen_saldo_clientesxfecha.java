 ...
 * @author hp
 */
public class resumen_saldo_clientesxfecha extends javax.swing.JFrame {
     ...
     */
    public resumen_saldo_clientesxfecha() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(resumen_saldo_clientesxfecha.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(resumen_saldo_clientesxfecha.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(resumen_saldo_clientesxfecha.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldoxsocio.setText("Facturas Pendientes");
    ...
    private class consultar extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cuenta_clientes ct : DAO.MostrarSaldoxSocio(nCliente, FechaI)) {
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                //URL url = getClass().getClassLoader().getResource("Reports/resumen_saldo_clientesxfecha_detalle.jrxml");
                URL url = getClass().getClassLoader().getResource("Reports/resumen_saldo_clientesxfecha.jasper");
