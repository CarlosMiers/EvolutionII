 ...
 * @author hp
 */
public class resumen_saldos_aunafecha extends javax.swing.JFrame {
     ...
     */
    public resumen_saldos_aunafecha() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(resumen_saldos_aunafecha.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(resumen_saldos_aunafecha.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(resumen_saldos_aunafecha.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_saldos_aunafecha.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_saldos_aunafecha.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_saldos_aunafecha.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Resumen de Saldos a una Fecha");
        ...
        etiquetasaldoxsocio.setText("Resumen de Saldos a una Fecha");
    ...
    private class consultar extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cuenta_clientes ct : DAO.ResumeSaldoalaFecha(FechaI,Integer.valueOf(moneda.getText()),nCliente)) {
