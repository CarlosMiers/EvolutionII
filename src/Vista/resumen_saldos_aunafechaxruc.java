...
import Modelo.Resumen_Saldos_alafecha;
 ...
 * @author hp
 */
public class resumen_saldos_aunafechaxruc extends javax.swing.JFrame {
     ...
     */
    public resumen_saldos_aunafechaxruc() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {90, 200, 100, 100, 100, 100};
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(resumen_saldos_aunafechaxruc.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(resumen_saldos_aunafechaxruc.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(resumen_saldos_aunafechaxruc.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_saldos_aunafechaxruc.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_saldos_aunafechaxruc.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_saldos_aunafechaxruc.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Resumen de Saldos a una Fecha por RUC");
        ...
        etiquetasaldoxsocio.setText("Resumen de Saldos a una Fecha por RUC");
    ...
    private class consultar extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cuenta_clientes ct : DAO.ResumeSaldoalaFechaxRUC(FechaI,Integer.valueOf(moneda.getText()),nCliente)) {
                    String Datos[] = {String.valueOf(ct.getCliente().getCodigo()), ct.getCliente().getNombre(), ct.getCliente().getRuc(), formato.format(ct.getCreditos()),formato.format(ct.getDebitos()), formato.format(ct.getSaldofactura())};
                    modelo.addRow(Datos);
    ...
    private class GrillaBuscarCliente extends Thread {
        ...
        public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                cCredito = jTable1.getValueAt(nFila, 3).toString();
                cCredito = cCredito.replace(".", "").replace(",", ".");

                cPago = jTable1.getValueAt(nFila, 4).toString();
                cPago = cPago.replace(".", "").replace(",", ".");

                cSaldopro = jTable1.getValueAt(nFila, 5).toString();
                cSaldopro = cSaldopro.replace(".", "").replace(",", ".");

                tipo = new Resumen_Saldos_alafecha(Integer.valueOf(jTable1.getValueAt(nFila, 0).toString()), jTable1.getValueAt(nFila, 1).toString(), jTable1.getValueAt(nFila, 2).toString(), Double.valueOf(cCredito), Double.valueOf(cPago), Double.valueOf(cSaldopro));
                Resultados.add(tipo);
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/resumen_saldo_alafecha.jasper");
