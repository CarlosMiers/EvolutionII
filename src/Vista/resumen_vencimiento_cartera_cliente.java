 ...
 * @author hp
 */
public class resumen_vencimiento_cartera_cliente extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltro, trsfiltro2, trsfiltrocli, trsfiltroemisor;
     ...
     */
    public resumen_vencimiento_cartera_cliente() {
        initComponents();
        ...
        GrillaCliente grillagi = new GrillaCliente();
        ...
        GrillaEmisor grillaem = new GrillaEmisor();
        Thread hiloem = new Thread(grillaem);
        hiloem.start();
    ...
    private void initComponents() {
        ...
        AceptarEmisor = new javax.swing.JButton();
        SalirEmisor = new javax.swing.JButton();
        ...
        comboemisor.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        comboemisor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comboemisorActionPerformed(evt);
            }
        });

        JTBuscarEmisor.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        JTBuscarEmisor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JTBuscarEmisorActionPerformed(evt);
            }
        });
        ...
        jPanel19Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel19Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(JTBuscarEmisor, javax.swing.GroupLayout.PREFERRED_SIZE, 284, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jScrollPane7.setViewportView(tablaemisor);

        jPanel20.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));

        AceptarEmisor.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        AceptarEmisor.setText("Aceptar");
        AceptarEmisor.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        AceptarEmisor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AceptarEmisorActionPerformed(evt);
            }
        });

        SalirEmisor.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        SalirEmisor.setText("Salir");
        SalirEmisor.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        SalirEmisor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SalirEmisorActionPerformed(evt);
            }
        });
        ...
        jPanel20Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel20Layout.createSequentialGroup()
                .addGap(91, 91, 91)
                .addComponent(AceptarEmisor, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(85, 85, 85)
                .addComponent(SalirEmisor, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel20Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel20Layout.createSequentialGroup()
                ...
                .addGroup(jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(AceptarEmisor)
                    .addComponent(SalirEmisor))
                .addContainerGap())
        );
        ...
        setTitle("Resumen de Vencimientos por Cliente");
        ...
        etiquetasaldos.setText("Resumen de Vencimientos por Cliente");
        ...
        cliente.setFont(new java.awt.Font("Arial", 1, 10)); // NOI18N
        ...
        BuscarEmisor.setText(".....");
        BuscarEmisor.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(emisor, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(BuscarEmisor, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void JTBuscarClienteKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JTBuscarClienteKeyPressed
        ...
        trsfiltro2 = new TableRowSorter(tablacliente.getModel());
        tablacliente.setRowSorter(trsfiltro2);
        // TODO add your handling code here:
    ...
    private void clienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clienteActionPerformed
        ...
        if (cliente.getText().equals("0")) {
            cliente.setText("0");
            nombrecliente.setText("Todos los Clientes");
            moneda.requestFocus();
        } else {
            clienteDAO giDAO = new clienteDAO();
            cliente ve = null;
            try {
                ve = giDAO.buscarId(Integer.valueOf(this.cliente.getText()));
                if (ve.getCodigo() == 0) {
                    BuscarCliente.setModal(true);
                    BuscarCliente.setSize(482, 575);
                    BuscarCliente.setLocationRelativeTo(null);
                    ...
                    nombrecliente.setText(ve.getNombre());
    ...
    private void listarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listarActionPerformed
        GenerarReporteCarteraCliente GenerarReporte = new GenerarReporteCarteraCliente();
        ...
        if (emisor.getText().equals("0")) {
            ...
            try {
                ...
                if (em.getCodigo() == 0) {
                    ...
                    BEmisor.setTitle("Buscar Emisor");
                    BEmisor.setModal(false);
                    this.moneda.requestFocus();
                } else {
                    nombreemisor.setText(em.getNombre());
                    //Establecemos un título para el jDialog
                }
                moneda.requestFocus();
            } catch (SQLException e) {
    ...
    private void comboemisorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboemisorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_comboemisorActionPerformed

    private void JTBuscarEmisorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JTBuscarEmisorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JTBuscarEmisorActionPerformed
    ...
    private void AceptarEmisorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarEmisorActionPerformed
        ...
        this.moneda.requestFocus();
        // TODO add your handling code here:
    }//GEN-LAST:event_AceptarEmisorActionPerformed

    private void SalirEmisorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SalirEmisorActionPerformed
        this.BEmisor.setVisible(false);
        // TODO add your handling code here:
    }//GEN-LAST:event_SalirEmisorActionPerformed
    ...
    public void filtrogira(int nNumeroColumna) {
        trsfiltro2.setRowFilter(RowFilter.regexFilter(this.JTBuscarCliente.getText(), nNumeroColumna));
    }
    ...
    private javax.swing.JButton AceptarEmisor;
    ...
    private javax.swing.JButton SalirEmisor;
    ...
    private javax.swing.JComboBox comboemisor;
    ...
    private class ConsultaVenceEmisor extends Thread {
        ...
        public void run() {
            ...
            if (tipotitulo.getSelectedIndex() == 0) {
                try {
                    for (cartera_clientes cart : DAO.MostrarxVencimientoClientePrincipalCupones(nCliente, nMoneda, FechaI, FechaF, nEmisor)) {
                ...
                try {
                    for (cartera_clientes cart : DAO.MostrarxVencimientoClientePrincipal(nCliente, nCliente, nMoneda, nMoneda, FechaI, FechaF, nEmisor, nEmisor)) {
                        String Datos[] = {formato.format(cart.getNumero()), formatoFecha.format(cart.getFechacierre()),
                            formatoFecha.format(cart.getFechaemision()), formatoFecha.format(cart.getVencimiento()),
                            formato.format(cart.getComprador().getCodigo()),
                            formato.format(cart.getComprador().getComitente()),
                ...
                try {
                    for (cartera_clientes cart : DAO.MostrarxVencimientoClienteCupones(nCliente, nCliente, nMoneda, nMoneda, FechaI, FechaF, nEmisor, nEmisor)) {
                        String Datos[] = {formato.format(cart.getNumero()), formatoFecha.format(cart.getFechacierre()),
                            formatoFecha.format(cart.getFechaemision()), formatoFecha.format(cart.getVencimiento()),
                            formato.format(cart.getComprador().getCodigo()),
                            formato.format(cart.getComprador().getComitente()),
    ...
    private class GrillaCliente extends Thread {
        ...
        public void run() {
            ...
            clienteDAO DAOCA = new clienteDAO();
            try {
                for (cliente ca : DAOCA.todos()) {
    ...
    private class GrillaEmisor extends Thread {
        ...
        public void run() {
            ...
            emisorDAO DAOEMI = new emisorDAO();
            try {
                for (emisor em : DAOEMI.todos()) {
                    String Datos[] = {String.valueOf(em.getCodigo()), em.getNombre()};
    ...
    private class GenerarReporteCarteraCliente extends Thread {
        ...
        public void run() {
            ...
            String cReporte = "";
            if (tipotitulo.getSelectedIndex() == 0) {
                cReporte = "resumen_vencimiento_cartera_cliente00.jasper";
            } else if (tipotitulo.getSelectedIndex() == 1) {
                cReporte = "resumen_cl01.jasper";
            } else {
                cReporte = "resumen_cl02.jasper";
            }
            try {
