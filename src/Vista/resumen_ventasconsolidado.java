 ...
 * @author hp
 */
public class resumen_ventasconsolidado extends javax.swing.JFrame {
     ...
     */
    public resumen_ventasconsolidado() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasconsolidado.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasconsolidado.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasconsolidado.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Resumen de Ventas por Consolidado");
        ...
        etiquetasaldos.setText("Resumen de Venta Consolidado");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(panelTranslucido2, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void buscarMonedaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarMonedaActionPerformed
        ...
        if (moneda.getText().equals("0")) {
            moneda.setText("0");
            nombremoneda.setText("Todos las Monedas");
            moneda.requestFocus();
        } else {
    ...
    private class GenerarConsultaVenta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (venta orden : DAO.ResumenVtaConsolidado(FechaI, FechaF, nMoneda)) {
                     String Datos[] = {orden.getCodprodventa(), orden.getNombreproductoventa(), formato.format(orden.getCantidadventa()), formato.format(orden.getPrecioventa()), formato.format(orden.getPromedio()), formato.format(orden.getTotalneto()), String.valueOf(orden.getCodrubroventa()), orden.getNombrerubroventa(), formatoFecha.format(orden.getFecha()),String.valueOf(orden.getMoneda().getCodigo()), orden.getMoneda().getNombre()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
      ...
      public void run() {
            ...
            Resumenventasxconsolidado tipo;
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/resumen_ventasxconsolidado.jasper");
