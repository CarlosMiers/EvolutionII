...
import DAO.ventaDAO;
import Modelo.Resumenventasxcliente;
 ...
 * @author hp
 */
public class resumen_ventasxclientes extends javax.swing.JFrame {
     ...
     */
    public resumen_ventasxclientes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxclientes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxclientes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxclientes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxclientes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxclientes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxclientes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldos.setText("Resumen de Ventas por Clientes ");
    ...
    private class GenerarConsultaVenta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (venta orden : DAO.ResumenVtaxCliente(FechaI, FechaF, nCliente, nCliente, nMoneda)) {
                    String Datos[] = {orden.getCodprodventa(), orden.getNombreproductoventa(), formato.format(orden.getCantidadventa()), formato.format(orden.getPrecioventa()), formato.format(orden.getPromedio()), formato.format(orden.getTotalneto()), String.valueOf(orden.getCodrubroventa()), orden.getNombrerubroventa(), formatoFecha.format(orden.getFecha()), String.valueOf(orden.getCliente().getCodigo()), orden.getCliente().getNombre(),
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/resumen_ventasxcliente.jasper");
