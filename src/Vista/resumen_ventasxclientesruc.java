...
import DAO.ventaDAO;
import Modelo.Resumenventasxclienteruc;
 ...
 * @author hp
 */
public class resumen_ventasxclientesruc extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltrocli, trsfiltromoneda;
     ...
     */
    public resumen_ventasxclientesruc() {
        initComponents();
        ...
        Thread hilogi = new Thread(grillacli);
        hilogi.start();
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxclientesruc.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxclientesruc.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxclientesruc.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxclientesruc.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxclientesruc.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxclientesruc.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Resumen de Ventas por Clientes ");
        ...
        etiquetasaldos.setText("Resumen de Ventas Agrupados por Clientes ");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(ruc, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(nombremoneda, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void clienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clienteActionPerformed
        ...
        if (cliente.getText().equals("0")) {
            cliente.setText("0");
            nombrecliente.setText("Todas los Clientes");
            moneda.requestFocus();
        } else {
    ...
    private void AceptarCliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarCliActionPerformed
        ...
        this.ruc.setText(this.tablacliente.getValueAt(nFila, 2).toString());
    ...
    private class GenerarConsultaVenta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (venta orden : DAO.ResumenVtaxClienteRuc(FechaI, FechaF, ruc.getText(), nMoneda)) {
                    String Datos[] = {orden.getCodprodventa(), orden.getNombreproductoventa(), formato.format(orden.getCantidadventa()), formato.format(orden.getPrecioventa()), formato.format(orden.getPromedio()), formato.format(orden.getTotalneto()), String.valueOf(orden.getCodrubroventa()), orden.getNombrerubroventa(), formatoFecha.format(orden.getFecha()), orden.getCliente().getRuc(), orden.getCliente().getNombre()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
        ...
        public void run() {
            ...
            try {
                for (cliente cli : DAOCLIE.todos()) {
                    String Datos[] = {String.valueOf(cli.getCodigo()), cli.getNombre(),cli.getRuc()};
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                tipo = new Resumenventasxclienteruc(jTable1.getValueAt(nFila, 0).toString(), jTable1.getValueAt(nFila, 1).toString(), Double.valueOf(cCantidad), Double.valueOf(cPromedio), Double.valueOf(cPrecio), Double.valueOf(cTotal), Integer.valueOf(jTable1.getValueAt(nFila, 6).toString()), jTable1.getValueAt(nFila, 7).toString(), jTable1.getValueAt(nFila, 9).toString(), jTable1.getValueAt(nFila, 10).toString());
                Resultados.add(tipo);
            ...
            try {
                ...
                parameters.put("cCliente", ruc.getText());
                ...
                URL url = getClass().getClassLoader().getResource("Reports/resumen_ventasxclienteruc.jasper");
