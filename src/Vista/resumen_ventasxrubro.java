...
import Modelo.Resumenventasxrubro;
 ...
 * @author hp
 */
public class resumen_ventasxrubro extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
      modelo.addColumn("Código");
        ...
        int[] anchos = {80, 300, 100, 80, 150, 100, 100, 150, 80};
    ...
    private void initComponents() {
        ...
        jTBuscarRubro.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxrubro.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarRubro.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxrubro.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirRubro.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxrubro.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxrubro.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxrubro.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxrubro.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Resumen de Ventas por Rubros");
        ...
        etiquetasaldos.setText("Resumen de Ventas por Rubros");
    ...
    private void buscarRubroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarRubroActionPerformed
        if (rubro.getText().isEmpty()) {
            ...
            rubro.setText("0");
            nombrerubro.setText("Todas los Rubros");
            moneda.requestFocus();
        } else {
    ...
    private class GenerarConsultaVenta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (venta orden : DAO.ResumenVtaxRubro(FechaI, FechaF, nRubro, nRubro, nMoneda)) {
                    String Datos[] = {orden.getCodprodventa(), orden.getNombreproductoventa(), formato.format(orden.getCantidadventa()), formato.format(orden.getPrecioventa()), formato.format(orden.getPromedio()), formato.format(orden.getTotalneto()), String.valueOf(orden.getCodrubroventa()), orden.getNombrerubroventa(), formatoFecha.format(orden.getFecha())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
      ...
      public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                tipo = new Resumenventasxrubro(jTable1.getValueAt(nFila, 0).toString(), jTable1.getValueAt(nFila, 1).toString(), Double.valueOf(cCantidad), Double.valueOf(cPromedio), Double.valueOf(cPrecio), Double.valueOf(cTotal), Integer.valueOf(jTable1.getValueAt(nFila, 6).toString()), jTable1.getValueAt(nFila, 7).toString());
                Resultados.add(tipo);
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/resumen_ventasxrubro.jasper");
