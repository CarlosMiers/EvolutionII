...
import DAO.ventaDAO;
import Modelo.Resumenventasxsucursal;
 ...
 * @author hp
 */
public class resumen_ventasxsucursal extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltrosuc, trsfiltromoneda, trsfiltro, trsfiltro2, trsfiltrocli;
     ...
     */
    public resumen_ventasxsucursal() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxsucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxsucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxsucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxsucursal.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxsucursal.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(resumen_ventasxsucursal.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Resumen de Ventas por Sucursales ");
        ...
        etiquetasaldos.setText("Resumen de Ventas por Sucursales ");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(panelTranslucido1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void generarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generarActionPerformed
        ...
        try {
            for (venta orden : DAO.ResumenVtaxSucursal(FechaI, FechaF, nSucursal, nSucursal, nMoneda)) {
                String Datos[] = {orden.getCodprodventa(), orden.getNombreproductoventa(), formato.format(orden.getCantidadventa()), formato.format(orden.getPrecioventa()), formato.format(orden.getPromedio()), formato.format(orden.getTotalneto()), String.valueOf(orden.getCodrubroventa()), orden.getNombrerubroventa(), formatoFecha.format(orden.getFecha()), String.valueOf(orden.getSucursal().getCodigo()), orden.getSucursal().getNombre()};
                modelo.addRow(Datos);
            }
    ...
    private void buscarSucursalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarSucursalActionPerformed
        ...
        if (sucursal.getText().equals("0")) {
            ...
            try {
                ...
                if (suc.getCodigo() == 0) {
                    resumen_ventasxsucursal.GrillaSucursal grillasu = new resumen_ventasxsucursal.GrillaSucursal();
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/resumen_ventasxsucursal.jasper");
