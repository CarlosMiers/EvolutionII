 ...
 * @author FedeXavier
 */
public class rubro_emisores extends javax.swing.JFrame {
     ...
     */
    public rubro_emisores() {
        initComponents();
        this.jTextField3.setVisible(false);
        this.etiquetafamilia.setText("Rubro del Emisor");
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM rubro_emisor ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        etiquetafamilia.setText(org.openide.util.NbBundle.getMessage(rubro_emisores.class, "saldosxclientes.labelMetric1.text")); // NOI18N
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("rubro_emisor", "codigo=" + this.codigo.getText().trim());
        this.cargarTabla("SELECT * FROM rubro_emisor ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void GrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("rubro_emisor", "nombre", "'" + this.nombre.getText() + "'");
        } else {
            BD.actualizarRegistro("rubro_emisor", "nombre ='" + this.nombre.getText() + "'", "codigo= " + this.codigo.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM rubro_emisor ORDER BY codigo");
        this.nombre.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rubro_emisores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
