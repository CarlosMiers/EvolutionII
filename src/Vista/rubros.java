...
public class rubros extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(idcta, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTBuscarPlan.setText(org.openide.util.NbBundle.getMessage(rubros.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(rubros.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(rubros.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        panel1Layout.setHorizontalGroup(
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(labelMetric1, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jMenu1.setText("Enlace Contable");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("rubros", "codigo=" + this.jTextField1.getText().trim());
        this.cargarTabla("SELECT * FROM rubros ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("rubros", "nombre", "'" + this.jTextField2.getText() + "'");
        } else {
            BD.actualizarRegistro("rubros", "nombre ='" + this.jTextField2.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM rubros ORDER BY codigo");
        this.jTextField2.setText("");
    ...
    private void ComprasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComprasActionPerformed
        ...
        if (nFila < 0) {
            ...
            this.codcuenta.setText(this.jTable2.getValueAt(nFila, 0).toString());
            this.descripcion.setText(this.jTable2.getValueAt(nFila, 1).toString());
        }
        rubroDAO pvDAO = new rubroDAO();
        rubro pro = null;
        try {
            pro = pvDAO.buscarIdCtaCompra(Integer.valueOf(this.codcuenta.getText()));
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "ERROR:" + e.getMessage());
        }
        if (pro != null) {
            idcta.setText(pro.getIdctamercaderia());
            nombrecuenta.setText(pro.getCtacompra());
    ...
    private void GrabaEnlaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabaEnlaceActionPerformed
        ...
        if (ret == 0) {
            ...
            rubroDAO grabar = new rubroDAO();
            rubro p = new rubro();
            p.setCodigo(Integer.valueOf(this.codcuenta.getText()));;

            try {
                if (tipocta == 1) {
                    p.setIdctamercaderia(this.idcta.getText());
                    grabar.EnlaceContableCompra(p);
                } else if (tipocta == 2) {
                    p.setIdcta(this.idcta.getText());
                    grabar.EnlaceContableVenta(p);
                } else {
                    p.setIdctacosto(this.idcta.getText());
                    grabar.EnlaceContableCosto(p);
                }
    ...
    private void CostosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CostosActionPerformed
        ...
        rubro pro = null;
        try {
            pro = pvDAO.buscarIdCtaCosto(Integer.valueOf(this.codcuenta.getText()));
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "ERROR:" + e.getMessage());
        }
        if (pro != null) {
            idcta.setText(pro.getIdctacosto());
            nombrecuenta.setText(pro.getCuentacosto());
            cuentas.setTitle("Modificar Enlace Contable");
            cuentas.setModal(true);
    ...
    private void VentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VentasActionPerformed
        ...
        rubro pro = null;
        try {
            pro = pvDAO.buscarIdCtaVenta(Integer.valueOf(this.codcuenta.getText()));
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "ERROR:" + e.getMessage());
        }
        if (pro != null) {
            idcta.setText(pro.getIdcta());
            nombrecuenta.setText(pro.getCuentaventa());
            cuentas.setTitle("Modificar Enlace Contable");
            cuentas.setModal(true);
