 ...
 * @author hp
 */
public class saldocliente_detallado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(saldocliente_detallado.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(saldocliente_detallado.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(saldocliente_detallado.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldoxsocio.setText("Saldos del Cliente a  la Fecha - Detallado");
    ...
    private class consultar extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cuenta_clientes ct : DAO.MostrarSaldoxSocioDetalladoConSaldo(nCliente, FechaI)) {
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/estadocuentaclientes.jasper");
