...
import Modelo.SaldoFacturas_alafecha;
 ...
 * @author hp
 */
public class saldofacturas_alafecha extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {90, 200, 100, 100, 100, 180, 100, 100, 100, 90, 10};
        ...
        this.jTable1.getColumnModel().getColumn(3).setCellRenderer(TablaCentro);
    ...
    private void initComponents() {
        ...
        etiquetasaldoxsocio = new org.edisoncor.gui.label.LabelMetric();
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(saldofacturas_alafecha.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(saldofacturas_alafecha.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(saldofacturas_alafecha.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(saldofacturas_alafecha.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(saldofacturas_alafecha.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(saldofacturas_alafecha.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Detalle de Saldos a la Fecha");
        ...
        etiquetasaldoxsocio.setBackground(new java.awt.Color(0, 0, 0));
        etiquetasaldoxsocio.setForeground(new java.awt.Color(0, 0, 0));
        etiquetasaldoxsocio.setText("Facturas Pendientes a la Fecha");
        etiquetasaldoxsocio.setColorDeSombra(new java.awt.Color(255, 255, 255));
        ...
        panelTranslucido1Layout.setHorizontalGroup(
            ...
            .addGroup(panelTranslucido1Layout.createSequentialGroup()
                .addGap(29, 29, 29)
                .addComponent(etiquetasaldoxsocio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        tiporeporte.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Detallado por Cliente", "En Resumen" }));

        jLabel3.setText("Formato Reporte");
        ...
        jMenuItem1.setText("Exportar Excel");
    ...
    private org.edisoncor.gui.label.LabelMetric etiquetasaldoxsocio;
    ...
    private class consultar extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cuenta_clientes ct : DAO.FacturasalaFecha(FechaI, Integer.valueOf(moneda.getText()), nCliente)) {
                    String Datos[] = {String.valueOf(ct.getCliente().getCodigo()),
                        ...
                        formato.format(ct.getSaldofactura()), ct.getCliente().getRuc(), ct.getAutorizacion()};
                    modelo.addRow(Datos);
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                cCredito = jTable1.getValueAt(nFila, 6).toString();
                cCredito = cCredito.replace(".", "").replace(",", ".");

                cPago = jTable1.getValueAt(nFila, 7).toString();
                cPago = cPago.replace(".", "").replace(",", ".");

                cSaldopro = jTable1.getValueAt(nFila, 8).toString();
                cSaldopro = cSaldopro.replace(".", "").replace(",", ".");

                String cAutorizacion = jTable1.getValueAt(nFila, 10).toString();

                if (cAutorizacion.isEmpty()) {
                    cAutorizacion = "SD";
                }

                tipo = new SaldoFacturas_alafecha(Integer.valueOf(jTable1.getValueAt(nFila, 0).toString()), jTable1.getValueAt(nFila, 1).toString(), jTable1.getValueAt(nFila, 2).toString(), jTable1.getValueAt(nFila, 3).toString(), jTable1.getValueAt(nFila, 4).toString(), jTable1.getValueAt(nFila, 5).toString(), Double.valueOf(cCredito), Double.valueOf(cPago), Double.valueOf(cSaldopro), jTable1.getValueAt(nFila, 9).toString(), cAutorizacion);
                Resultados.add(tipo);
            ...
            try {
                ...
                parameters.put("Moneda", nombremoneda.getText());

                JasperReport jr = null;

                URL url = getClass().getClassLoader().getResource("Reports/detalle_saldo_alafecha_nombre.jasper");
                if (Config.nMultiCaja == 0) {
                    if (tiporeporte.getSelectedIndex() == 0) {
                        url = getClass().getClassLoader().getResource("Reports/detalle_saldo_alafechaferremax.jasper");
                    } else {
                        url = getClass().getClassLoader().getResource("Reports/detalle_saldo_alafecharuc.jasper");
                    }
                } else {
                    if (tiporeporte.getSelectedIndex() == 0) {
                        url = getClass().getClassLoader().getResource("Reports/detalle_saldo_alafecha.jasper");
                    } else {
                        url = getClass().getClassLoader().getResource("Reports/detalle_saldo_alafecharuc.jasper");
                    }
                }
