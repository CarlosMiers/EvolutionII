...
import Modelo.SaldoFacturas_obra;
 ...
 * @author hp
 */
public class saldofacturas_obra extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        modelo.addColumn("nombreobra");

        int[] anchos = {90, 200, 100, 100, 100, 180, 100, 100, 100, 90, 10,10,10};
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(saldofacturas_obra.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(saldofacturas_obra.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(saldofacturas_obra.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(saldofacturas_obra.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(saldofacturas_obra.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(saldofacturas_obra.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldoxsocio.setText("Facturas Pendientes por Obra a la Fecha");
    ...
    private class consultar extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cuenta_clientes ct : DAO.FacturasalaFechaObra(FechaI, Integer.valueOf(moneda.getText()), nCliente)) {
                    if(ct.getAsesor()==0 ){
                        cNombreObra="SIN DATOS";
                    }else{
                        cNombreObra=ct.getNombreobra();
                    }
                    ...
                    String Datos[] = {String.valueOf(ct.getCliente().getCodigo()),
                        ...
                        formato.format(ct.getSaldofactura()), ct.getCliente().getRuc(), ct.getAutorizacion(),String.valueOf(ct.getAsesor()),cNombreObra};
                    modelo.addRow(Datos);
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                tipo = new SaldoFacturas_obra(Integer.valueOf(jTable1.getValueAt(nFila, 0).toString()), jTable1.getValueAt(nFila, 1).toString(), jTable1.getValueAt(nFila, 2).toString(), jTable1.getValueAt(nFila, 3).toString(), jTable1.getValueAt(nFila, 4).toString(), jTable1.getValueAt(nFila, 5).toString(), Double.valueOf(cCredito), Double.valueOf(cPago), Double.valueOf(cSaldopro), jTable1.getValueAt(nFila, 9).toString(), cAutorizacion,Integer.valueOf(jTable1.getValueAt(nFila, 11).toString()),jTable1.getValueAt(nFila, 12).toString());
                Resultados.add(tipo);
            }
...
//                parameters.put("cNombreEmpresa", Config.cNombreEmpresa.trim());
                ...
                URL url = getClass().getClassLoader().getResource("Reports/detalle_saldo_obra.jasper");
