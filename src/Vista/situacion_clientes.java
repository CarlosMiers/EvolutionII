 ...
 * @author FedeXavier
 */
public class situacion_clientes extends javax.swing.JFrame {
     ...
     */
    public situacion_clientes() {
        initComponents();
        this.jTextField3.setVisible(false);
        this.etiquetafamilia.setText("Situación de Clientes");
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM situacion ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        etiquetafamilia.setText(org.openide.util.NbBundle.getMessage(situacion_clientes.class, "saldosxclientes.labelMetric1.text")); // NOI18N
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("situacion", "codigo=" + this.jTextField1.getText().trim());
        this.cargarTabla("SELECT * FROM situacion ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("situacion", "nombre", "'" + this.jTextField2.getText() + "'");
        } else {
            BD.actualizarRegistro("situacion", "nombre ='" + this.jTextField2.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM situacion ORDER BY codigo");
        this.jTextField2.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(situacion_clientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
