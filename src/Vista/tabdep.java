 ...
 * @author FedeXavier
 */
public class tabdep extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        etiquetafamilia.setText(org.openide.util.NbBundle.getMessage(tabdep.class, "saldosxclientes.labelMetric1.text")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tabdep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
