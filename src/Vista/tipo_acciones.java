 ...
 * @author FedeXavier
 */
public class tipo_acciones extends javax.swing.JFrame {
    ...
    public tipo_acciones() {
        ...
        this.etiquetafamilia.setText("Tipo de Acciones");
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM acciones ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        nomalias.setFont(new java.awt.Font("Corbel", 0, 14)); // NOI18N
        nomalias.setEnabled(false);
        nomalias.setSelectionColor(new java.awt.Color(0, 63, 62));
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(nomalias, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(nomalias, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        etiquetafamilia.setText(org.openide.util.NbBundle.getMessage(tipo_acciones.class, "saldosxclientes.labelMetric1.text")); // NOI18N
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        this.codigo.setText(this.jTable2.getValueAt(nFila, 0).toString());
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("acciones", "codigo=" + this.codigo.getText().trim());
        this.cargarTabla("SELECT * FROM acciones ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void GrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("acciones", "nombre,nomalias", "'" + this.nombre.getText()+  "','" + this.nomalias.getText() + "'");
        } else {
            BD.actualizarRegistro("acciones", "nombre ='" + this.nombre.getText() + "',nomalias='" + this.nomalias.getText()+"'", "codigo= " + this.codigo.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM acciones ORDER BY codigo");
        this.nombre.setText("");
        ...
        this.nomalias.setEnabled(false);
    ...
    private void jTable2FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTable2FocusGained
        ...
        this.codigo.setText(this.jTable2.getValueAt(nFila - 1, 0).toString());
        this.nombre.setText(this.jTable2.getValueAt(nFila - 1, 1).toString());
        this.nomalias.setText(this.jTable2.getValueAt(nFila - 1, 2).toString());
        // TODO add your handling code here:
    ...
    private void cargarTabla(String sql) {
        ...
        try {
            ...
            while (results.next()) {
                ...
                this.nomalias.setText(results.getString("nomalias"));
                // Se crea un array que será una de las filas de la tabla.
                Object[] fila = new Object[3]; // Hay 3 columnas en la tabla
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tipo_acciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
