 ...
 * @author FedeXavier
 */
public class tipo_documentos extends javax.swing.JFrame {
    ...
    public tipo_documentos() {
        ...
        this.etiquetafamilia.setText("Tipo Documentos");
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM tipo_documento ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        etiquetafamilia.setText(org.openide.util.NbBundle.getMessage(tipo_documentos.class, "saldosxclientes.labelMetric1.text")); // NOI18N
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("tipo_documento", "codigo=" + this.jTextField1.getText().trim());
        this.cargarTabla("SELECT * FROM tipo_documento ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("tipo_documento", "nombre", "'" + this.jTextField2.getText() + "'");
        } else {
            BD.actualizarRegistro("tipo_documento", "nombre ='" + this.jTextField2.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM tipo_documento ORDER BY codigo");
        this.jTextField2.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tipo_documentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
