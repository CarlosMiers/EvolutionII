 ...
 * @author FedeXavier
 */
public class tipo_examenes extends javax.swing.JFrame {
    ...
    public tipo_examenes() {
        ...
        this.etiquetafamilia.setText("Tipo de Examenes");
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM tipo_examen ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        etiquetafamilia.setText(org.openide.util.NbBundle.getMessage(tipo_examenes.class, "saldosxclientes.labelMetric1.text")); // NOI18N
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("tipo_examen", "codigo=" + this.codigo.getText().trim());
        this.cargarTabla("SELECT * FROM tipo_examen ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void GrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("tipo_exmanen", "codigo,nombre", "'" + this.codigo.getText()+  "','" + this.nombre.getText() + "'");
        } else {
            BD.actualizarRegistro("tipo_examen", "nombre ='" + this.nombre.getText()+"'", "codigo= '" + this.codigo.getText()+"'");
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM tipo_examen ORDER BY codigo");
        this.nombre.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tipo_examenes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tipo_examenes().setVisible(true);
            }
        });
    }
