 ...
 * @author FedeXavier
 */
public class tipo_garantias extends javax.swing.JFrame {
     ...
     */
    public tipo_garantias() {
        initComponents();
        this.jTextField3.setVisible(false);
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM garantias ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        labelMetric1.setText("Tipo de Garantías");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("garantias", "nombre", "'" + this.jTextField2.getText() + "'");
        } else {
            BD.actualizarRegistro("garantias", "nombre ='" + this.jTextField2.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM garantias ORDER BY codigo");
        this.jTextField2.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tipo_garantias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
