 ...
 * @author FedeXavier
 */
public class tipo_inmuebles extends javax.swing.JFrame {
     ...
     */
    public tipo_inmuebles() {
        initComponents();
        this.jTextField3.setVisible(false);
        this.etiquetafamilia.setText("Tipo de Inmuebles");
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM tipo_inmueble ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        etiquetafamilia.setText(org.openide.util.NbBundle.getMessage(tipo_inmuebles.class, "saldosxclientes.labelMetric1.text")); // NOI18N
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("tipo_inmueble", "codigo=" + this.jTextField1.getText().trim());
        this.cargarTabla("SELECT * FROM tipo_inmueble ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("tipo_inmueble", "nombre", "'" + this.jTextField2.getText() + "'");
        } else {
            BD.actualizarRegistro("tipo_inmueble", "nombre ='" + this.jTextField2.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM tipo_inmueble ORDER BY codigo");
        this.jTextField2.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tipo_inmuebles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
