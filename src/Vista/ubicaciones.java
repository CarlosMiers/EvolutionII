...
public class ubicaciones extends javax.swing.JFrame {
    ...
    public ubicaciones() {
        ...
        this.etiquetaubicacion.setText("Ubicaciones");
        this.setLocationRelativeTo(null); //Centramos el formulario
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM ubicaciones ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        etiquetaubicacion = new org.edisoncor.gui.label.LabelMetric();
        ...
        etiquetaubicacion.setText(org.openide.util.NbBundle.getMessage(ubicaciones.class, "saldosxclientes.labelMetric1.text")); // NOI18N
        ...
        panel1Layout.setHorizontalGroup(
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addComponent(etiquetaubicacion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        panel1Layout.setVerticalGroup(
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(etiquetaubicacion, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("ubicaciones", "codigo=" + this.jTextField1.getText().trim());
        this.cargarTabla("SELECT * FROM ubicaciones ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("ubicaciones", "nombre", "'" + this.jTextField2.getText() + "'");
        } else {
            BD.actualizarRegistro("ubicaciones", "nombre ='" + this.jTextField2.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM ubicaciones ORDER BY codigo");
        this.jTextField2.setText("");
    ...
    private org.edisoncor.gui.label.LabelMetric etiquetaubicacion;
