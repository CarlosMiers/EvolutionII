...
public class unidades extends javax.swing.JFrame {
    ...
    public unidades() {
        ...
        this.cargarTitulo();
        this.cargarTabla("SELECT * FROM unidades ORDER BY codigo");
    }
    ...
    private void initComponents() {
        ...
        labelMetric1.setText("Unidades de Médida");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BD.borrarRegistro("unidades", "codigo=" + this.jTextField1.getText().trim());
        this.cargarTabla("SELECT * FROM unidades ORDER BY codigo");
        // TODO add your handling code here:
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (cParametro.equals(cLetra)) {
            BD.insertarRegistro("unidades", "nombre", "'" + this.jTextField2.getText() + "'");
        } else {
            BD.actualizarRegistro("unidades", "nombre ='" + this.jTextField2.getText() + "'", "codigo= " + this.jTextField1.getText());
        }
        this.Limpiar();
        this.cargarTabla("SELECT * FROM unidades ORDER BY codigo");
        this.jTextField2.setText("");
