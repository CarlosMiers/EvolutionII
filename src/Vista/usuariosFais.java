 ...
 *
 */
public class usuariosFais extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltro, trsfiltrovendedor;
    ...
    public usuariosFais() {
        ...
        GrillaAsesor   GrillaAse = new GrillaAsesor();
        Thread HiloAsesor = new Thread(GrillaAse);
        HiloAsesor.start();
    ...
    private void initComponents() {
        ...
        codasesor = new javax.swing.JTextField();
        ...
        codasesor.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        codasesor.setText(" ");
        codasesor.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        codasesor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                codasesorActionPerformed(evt);
            }
        });
        codasesor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                codasesorKeyPressed(evt);
            }
        });
        ...
        operaciones.setPreferredSize(new java.awt.Dimension(105, 18));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(operaciones, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(2, 2, 2)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(nombreasesor, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(codasesor, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(buscarasesor, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(buscarasesor, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(codasesor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(nombreasesor, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTBuscarVendedor.setText(org.openide.util.NbBundle.getMessage(usuariosFais.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarVendedor.setText(org.openide.util.NbBundle.getMessage(usuariosFais.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirVendedor.setText(org.openide.util.NbBundle.getMessage(usuariosFais.class, "ventas.SalirCliente.text")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        usuario u = null;
        try {
            u = usu.buscarIdFais(Integer.valueOf(codigo.getText()));
        ...
        if (u != null) {
            ...
            codasesor.setText(String.valueOf(u.getAsesores()));
            nombreasesor.setText(u.getNombreasesor());
    ...
    private void GrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        us.setAsesores(Integer.valueOf(codasesor.getText()));
        ...
        if (Integer.valueOf(codigo.getText()) > 0) {
            ...
            try {
                ...
                grab.actualizarUsuariosFais(us);
    ...
    private void AceptarVendedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarVendedorActionPerformed
        ...
        this.codasesor.setText(this.tablavendedor.getValueAt(nFila, 0).toString());
    ...
    private void codasesorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_codasesorActionPerformed
        vendedorDAO veDAO = new vendedorDAO();
        vendedor vn = null;
        try {
            vn = veDAO.buscarId(Integer.valueOf(this.codasesor.getText()));
            if (vn.getCodigo() == 0) {
                buscarasesor.doClick();
            } else {
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_codasesorActionPerformed

    private void codasesorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_codasesorKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.Grabar.requestFocus();
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_codasesorKeyPressed
    ...
    private javax.swing.JTextField codasesor;
