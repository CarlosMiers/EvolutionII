...
public class vacaciones extends javax.swing.JFrame {
    ...
    public vacaciones() {
        ...
        this.antiguedad.setVisible(false);
        this.tablavacaciones.setShowGrid(false);
        this.tablavacaciones.setOpaque(true);
        this.tablavacaciones.setBackground(new Color(204, 204, 255));
        this.tablavacaciones.setForeground(Color.BLACK);
    ...
    private void initComponents() {
        ...
        detalle_vacaciones = new javax.swing.JDialog();
        ...
        tomadas = new javax.swing.JTextField();
        ...
        tablavacaciones = new javax.swing.JTable();

        detalle_vacaciones.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                detalle_vacacionesFocusGained(evt);
            }
        });
        detalle_vacaciones.addWindowFocusListener(new java.awt.event.WindowFocusListener() {
            public void windowGainedFocus(java.awt.event.WindowEvent evt) {
                detalle_vacacionesWindowGainedFocus(evt);
            }
            public void windowLostFocus(java.awt.event.WindowEvent evt) {
            }
        });
        detalle_vacaciones.addWindowListener(new java.awt.event.WindowAdapter() {
            public void windowActivated(java.awt.event.WindowEvent evt) {
                detalle_vacacionesWindowActivated(evt);
            }
        });
        ...
        periodo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                periodoKeyPressed(evt);
            }
        });

        tomadas.setEnabled(false);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(antiguedad, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE))))
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addComponent(hora)
                                        .addGap(68, 68, 68)
                                        .addComponent(tomadas, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGap(19, 19, 19))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(periodo, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(tomadas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(5, 5, 5)))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
        ...
        javax.swing.GroupLayout detalle_vacacionesLayout = new javax.swing.GroupLayout(detalle_vacaciones.getContentPane());
        detalle_vacaciones.getContentPane().setLayout(detalle_vacacionesLayout);
        detalle_vacacionesLayout.setHorizontalGroup(
            detalle_vacacionesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(detalle_vacacionesLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(detalle_vacacionesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, detalle_vacacionesLayout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
        ...
        detalle_vacacionesLayout.setVerticalGroup(
            detalle_vacacionesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, detalle_vacacionesLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addGroup(detalle_vacacionesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Grabar)
                    .addComponent(Salir))
                .addContainerGap())
        );
        ...
        jTBuscarEmpleado.setText(org.openide.util.NbBundle.getMessage(vacaciones.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarEmpleado.setText(org.openide.util.NbBundle.getMessage(vacaciones.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirEmpleado.setText(org.openide.util.NbBundle.getMessage(vacaciones.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetavacaciones.setText("Vacaciones");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(vacaciones.class, "libroventaconsolidado.jPanel2.border.title"))); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(vacaciones.class, "libroventaconsolidado.jLabel1.text")); // NOI18N

        jLabel8.setText(org.openide.util.NbBundle.getMessage(vacaciones.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
        ...
        tablavacaciones.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        ...
        tablavacaciones.setModel(modelo);
        tablavacaciones.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        tablavacaciones.setSelectionBackground(new java.awt.Color(51, 204, 255));
        tablavacaciones.setSelectionForeground(new java.awt.Color(0, 0, 255));
        tablavacaciones.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                tablavacacionesFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                tablavacacionesFocusLost(evt);
            }
        });
        tablavacaciones.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablavacacionesMouseClicked(evt);
            }
        });
        tablavacaciones.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                tablavacacionesPropertyChange(evt);
            }
        });
        tablavacaciones.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tablavacacionesKeyPressed(evt);
            }
        });
        jScrollPane1.setViewportView(tablavacaciones);
    ...
    private void buscarcadenaKeyPressed(KeyEvent evt) {//GEN-FIRST:event_buscarcadenaKeyPressed
        ...
        trsfiltro = new TableRowSorter(tablavacaciones.getModel());
        tablavacaciones.setRowSorter(trsfiltro);
    ...
    private void AgregarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        idControl.setText("0");
        this.limpiar();
        detalle_vacaciones.setModal(true);
        detalle_vacaciones.setSize(500, 340);
        //Establecemos un título para el jDialog
        detalle_vacaciones.setTitle("Agregar Vacaciones");
        detalle_vacaciones.setLocationRelativeTo(null);
        detalle_vacaciones.setVisible(true);
        empleado.requestFocus();
    ...
    private void tablavacacionesKeyPressed(KeyEvent evt) {//GEN-FIRST:event_tablavacacionesKeyPressed
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_tablavacacionesKeyPressed

    private void tablavacacionesMouseClicked(MouseEvent evt) {//GEN-FIRST:event_tablavacacionesMouseClicked
        int nFila = this.tablavacaciones.getSelectedRow();
        this.idControl.setText(this.tablavacaciones.getValueAt(nFila, 0).toString());
        // TODO add your handling code here:

        // TODO add your handling code here:
    }//GEN-LAST:event_tablavacacionesMouseClicked
    ...
    private void ModificarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (Integer.valueOf(Config.cNivelUsuario) == 1) {
            ...
            if (nFila < 0) {
                ...
                this.tablavacaciones.requestFocus();
                return;
            }

            this.numero.setText(this.tablavacaciones.getValueAt(nFila, 0).toString());
            ...
            if (vac != null) {
                ...
                periodo.setText(formatosinpunto.format(vac.getPeriodo()));
                ...
                detalle_vacaciones.setSize(500, 340);
                //Establecemos un título para el jDialog
                detalle_vacaciones.setTitle("Modificar Vacaciones");
                detalle_vacaciones.setLocationRelativeTo(null);
                detalle_vacaciones.setVisible(true);
                empleado.requestFocus();
            } else {
    ...
    private void tablavacacionesFocusGained(FocusEvent evt) {//GEN-FIRST:event_tablavacacionesFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_tablavacacionesFocusGained
    ...
    private void EliminarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        int nFila = tablavacaciones.getSelectedRow();
        String num = tablavacaciones.getValueAt(nFila, 0).toString();
    ...
    private void tablavacacionesFocusLost(FocusEvent evt) {//GEN-FIRST:event_tablavacacionesFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_tablavacacionesFocusLost
    ...
    private void SalirActionPerformed(ActionEvent evt) {//GEN-FIRST:event_SalirActionPerformed
        detalle_vacaciones.setVisible(false);
        // TODO add your handling code here:
    ...
    private void GrabarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        try {
            ver = grabar.Tomadas(Integer.valueOf(empleado.getText()),Integer.valueOf(periodo.getText()));
        } catch (SQLException ex) {
            Exceptions.printStackTrace(ex);
        }
        System.out.println("tomadas "+ver.getHoras());
        
        int anualidad = fecha.getCalendar().get(Calendar.YEAR);
        int diferencia = anualidad - Integer.valueOf(periodo.getText());

        if (diferencia > 2) {
            JOptionPane.showMessageDialog(null, "Ya no puede Disponer de esas Vacaciones");
            this.periodo.requestFocus();
            return;
        }
        System.out.println("TIMEPO "+tiempo.getText());
        int totaltomado=Integer.valueOf(tiempo.getText())+ver.getHoras();

        System.out.println("TOTALTOMADO "+ totaltomado);
        
        
        if (Integer.valueOf(antiguedad.getText()) <= 1 && Integer.valueOf(antiguedad.getText()) < 5) {
            if (totaltomado > 12 && dia.isSelected()) {
                JOptionPane.showMessageDialog(null, "Solo dispone de 12 Días");
                this.tiempo.requestFocus();
                return;
            }
        }
        if (totaltomado >= 5 && Integer.valueOf(antiguedad.getText()) < 10) {
            if (totaltomado >= 15 && dia.isSelected()) {
                JOptionPane.showMessageDialog(null, "Solo dispone de 12 Días");
                this.tiempo.requestFocus();
                return;
            }
        ...
        if (Integer.valueOf(antiguedad.getText()) >= 10) {
            if (totaltomado > 30 && dia.isSelected()) {
                JOptionPane.showMessageDialog(null, "Solo dispone de 30 Días");
                this.tiempo.requestFocus();
                return;
            }
        }
        ...
        try {
            ...
            if (ficha.getCodigo() != 0) {
                this.ingreso.setDate(ficha.getFecha_ingreso());
                Date fechaIn = ODate.de_java_a_sql(ingreso.getDate());
                Date fechaFi = ODate.de_java_a_sql(fecha.getDate());
                int dias = (int) ((fechaFi.getTime() - fechaIn.getTime()) / 86400000);
                double anual = Math.round(dias / 365);
        ...
        if (Integer.valueOf(this.antiguedad.getText()) < 1) {
            JOptionPane.showMessageDialog(null, "No tiene Antiguedad");
            this.empleado.requestFocus();
            return;
        }

        if (Integer.valueOf(this.periodo.getText()) <= 0) {
            JOptionPane.showMessageDialog(null, "Ingrese el Periódo");
            this.periodo.requestFocus();
            return;
        }
        ...
        if (ret == 0) {
            ...
            String cPeriodo = periodo.getText();
            cPeriodo = cPeriodo.replace(".", "");
            vac.setPeriodo(Integer.valueOf(cPeriodo));
            if (dia.isSelected()) {
                vac.setUnidmed("Días");
            }
            ...
            detalle_vacaciones.setVisible(false);
            this.detalle_vacaciones.setModal(false);
            this.refrescar.doClick();
        }
    }//GEN-LAST:event_GrabarActionPerformed

    private void detalle_vacacionesFocusGained(FocusEvent evt) {//GEN-FIRST:event_detalle_vacacionesFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_vacacionesFocusGained

    private void detalle_vacacionesWindowGainedFocus(WindowEvent evt) {//GEN-FIRST:event_detalle_vacacionesWindowGainedFocus
        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_vacacionesWindowGainedFocus

    private void detalle_vacacionesWindowActivated(WindowEvent evt) {//GEN-FIRST:event_detalle_vacacionesWindowActivated

        // TODO add your handling code here:
    }//GEN-LAST:event_detalle_vacacionesWindowActivated

    private void tablavacacionesPropertyChange(PropertyChangeEvent evt) {//GEN-FIRST:event_tablavacacionesPropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_tablavacacionesPropertyChange
    ...
    private void periodoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_periodoKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_ENTER || evt.getKeyCode() == KeyEvent.VK_DOWN) {
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_periodoKeyPressed
    ...
    private void cargarTitulo() {
        ...
        for (int i = 0; i < modelo.getColumnCount(); i++) {
            tablavacaciones.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);
        }
        ((DefaultTableCellRenderer) tablavacaciones.getTableHeader().getDefaultRenderer()).setHorizontalAlignment(JLabel.CENTER);// Este código es para centrar las cabeceras de la tabla.
        tablavacaciones.getTableHeader().setFont(new Font("Arial Black", 1, 11));

        Font font = new Font("Arial", Font.BOLD, 10);
        this.tablavacaciones.setFont(font);
        ...
        this.tablavacaciones.getColumnModel().getColumn(0).setCellRenderer(TablaRenderer);
        this.tablavacaciones.getColumnModel().getColumn(1).setCellRenderer(AlinearCentro);
        this.tablavacaciones.getColumnModel().getColumn(2).setCellRenderer(AlinearCentro);
        this.tablavacaciones.getColumnModel().getColumn(3).setCellRenderer(AlinearCentro);
        this.tablavacaciones.getColumnModel().getColumn(6).setCellRenderer(TablaRenderer);
    }
    ...
    private javax.swing.JDialog detalle_vacaciones;
    ...
    private javax.swing.JTable tablavacaciones;
    private javax.swing.JTextField tiempo;
    private javax.swing.JTextField tipo_salario;
    private javax.swing.JTextField tomadas;
        ...
        public void run() {
            ...
            try {
                for (vacacion vac : DAO.Todos(FechaI, FechaF)) {
                    String Datos[] = {formatosinpunto.format(vac.getNumero()), formatoFecha.format(vac.getFecha()), formatoFecha.format(vac.getInicio()), formatoFecha.format(vac.getFin()), vac.getFicha_empleado().getNombreempleado(), String.valueOf(vac.getHoras()), formatea.format(vac.getImporte())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
            }
            tablavacaciones.setRowSorter(new TableRowSorter(modelo));
            int cantFilas = tablavacaciones.getRowCount();
            if (cantFilas > 0) {
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                parameters.put("inicio", tablavacaciones.getValueAt(nFila, 2).toString());
                parameters.put("final", tablavacaciones.getValueAt(nFila, 3).toString());

                JasperReport jr = null;
                URL url = getClass().getClassLoader().getResource("Reports/solicitud_vacaciones.jasper");
