 ...
 * @author hp
 */
public class vacaciones_informes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTBuscarRubro.setText(org.openide.util.NbBundle.getMessage(vacaciones_informes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarRubro.setText(org.openide.util.NbBundle.getMessage(vacaciones_informes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirRubro.setText(org.openide.util.NbBundle.getMessage(vacaciones_informes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(vacaciones_informes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(vacaciones_informes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(vacaciones_informes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldos.setText("Informe de Vacaciones");
    ...
    private class GrillaDescuento extends Thread {
        ...
        public void run() {
            ...
            try {
                for (vacacion vac : DAO.TodosxSuc(FechaI, FechaF,Integer.valueOf(sucursal.getText()))) {
                    String Datos[] = {formato.format(vac.getNumero()), formatoFecha.format(vac.getFecha()),formatoFecha.format(vac.getInicio()),formatoFecha.format(vac.getFin()),vac.getFicha_empleado().getNombreempleado(), String.valueOf(vac.getHoras()), formato.format(vac.getImporte())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/vacaciones_suc.jasper");
