 ...
 * @author hp
 */
public class vencimiento_cartera_cheque extends javax.swing.JFrame {
    ...
    private TableRowSorter trsfiltrocliente, trsfiltromoneda;
     ...
     */
    public vencimiento_cartera_cheque() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        modelo.addColumn("Saldo Cheque");
        modelo.addColumn("Cuenta");
        modelo.addColumn("Nombre Cliente");
        modelo.addColumn("Comprobante");
        int[] anchos = {50, 50, 80, 50, 80, 80, 150, 100};
        ...
        this.jTable1.getColumnModel().getColumn(3).setCellRenderer(AlinearDerecho);
      ...
      private void TitCliente() {
        ...
        this.tablacliente.getColumnModel().getColumn(1).setCellRenderer(TablaRendererizquierdo);
    }
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(vencimiento_cartera_cheque.class, "ventas.jTBuscarClientes.text")); // NOI18N
        jTBuscarCliente.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                jTBuscarClienteFocusGained(evt);
            }
        });
        ...
        AceptarCliente.setText(org.openide.util.NbBundle.getMessage(vencimiento_cartera_cheque.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCliente.setText(org.openide.util.NbBundle.getMessage(vencimiento_cartera_cheque.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(org.openide.util.NbBundle.getMessage(vencimiento_cartera_cheque.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(org.openide.util.NbBundle.getMessage(vencimiento_cartera_cheque.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(org.openide.util.NbBundle.getMessage(vencimiento_cartera_cheque.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        setTitle("Vencimiento Cartera de Cheques");
        ...
        etiquetasaldos.setText("Vencimiento Cartera de Cheques");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), "Fecha de Vencimiento"));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(nombrecliente, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void clienteKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_clienteKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.jTBuscarCliente.requestFocus();
        }
    ...
    private void jTBuscarClienteFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTBuscarClienteFocusGained
        cliente.selectAll();
    }//GEN-LAST:event_jTBuscarClienteFocusGained
    ...
    public void filtrocliente(int nNumeroColumna) {
    ...
    private class GenerarConsultaProveedor extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cuenta_clientes sp : DAO.Vencimientoxcarteracheque(FechaI, FechaF, nCliente, nCliente, nMoneda)) {
                    String Datos[] = {String.valueOf(sp.getDetalle_descuento_documento().getNrodocumento()),formatoFecha.format(sp.getDetalle_descuento_documento().getCompra()), formatoFecha.format(sp.getDetalle_descuento_documento().getVencimiento()), formatea.format(sp.getImporte()), formatea.format(sp.getSaldo()), String.valueOf(sp.getCliente().getCodigo()),sp.getCliente().getNombre(),String.valueOf(sp.getComprobante().getCodigo())};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                parameters.put("nCliente", cliente.getText());
                parameters.put("nMoneda", moneda.getText());

                JasperReport jr = null;
                URL url = getClass().getClassLoader().getResource("Reports/vencimiento_cheques.jasper");
