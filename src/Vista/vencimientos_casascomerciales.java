 ...
 * @author hp
 */
public class vencimientos_casascomerciales extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        casacomercial = new javax.swing.JTextField();
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(vencimientos_casascomerciales.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(vencimientos_casascomerciales.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(vencimientos_casascomerciales.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        labelMetric1.setText("Detalle de Vencimientos por Entidad Comercial");
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(vencimientos_casascomerciales.class, "libroventaconsolidado.jButton1.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(vencimientos_casascomerciales.class, "libroventaconsolidado.jButton1.toolTipText")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(vencimientos_casascomerciales.class, "libroventaconsolidado.jButton2.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(vencimientos_casascomerciales.class, "libroventaconsolidado.jButton2.toolTipText")); // NOI18N
        ...
        jLabel1.setText("Entidad Comercial - Financiera");

        casacomercial.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        casacomercial.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                casacomercialFocusGained(evt);
            }
        });
        casacomercial.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                casacomercialActionPerformed(evt);
            }
        });
        casacomercial.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                casacomercialKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                casacomercialKeyReleased(evt);
            }
        });
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(casacomercial, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(casacomercial, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void casacomercialFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_casacomercialFocusGained
        casacomercial.selectAll();

        // TODO add your handling code here:
    }//GEN-LAST:event_casacomercialFocusGained

    private void casacomercialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_casacomercialActionPerformed
        this.buscarSucursal.doClick();
        // jTBuscarSucursal.requestFocus();
        // TODO add your handling code here:
    }//GEN-LAST:event_casacomercialActionPerformed

    private void casacomercialKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_casacomercialKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.jTBuscarSucursal.requestFocus();
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_casacomercialKeyPressed

    private void casacomercialKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_casacomercialKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_casacomercialKeyReleased
    ...
    private void buscarSucursalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarSucursalActionPerformed
        casaDAO sucDAO = new casaDAO();
        casa sucu = null;
        try {
            sucu = sucDAO.buscarId(Integer.valueOf(this.casacomercial.getText()));
            if (sucu.getCodigo() == 0) {
                ...
                BSucursal.setTitle("Buscar Entidad");
    ...
    private void AceptarSucActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarSucActionPerformed
        ...
        this.casacomercial.setText(this.tablasucursal.getValueAt(nFila, 0).toString());
    ...
    private javax.swing.JTextField casacomercial;
    ...
    private class GenerarConsulta extends Thread {
        ...
        public void run() {
            int nCasa = Integer.valueOf(casacomercial.getText());
            ...
            try {
                for (cuenta_casascomerciales ven : DAO.VencexCasas(nCasa, FechaI, FechaF)) {
    ...
    private class GrillaSucursal extends Thread {
        ...
        public void run() {
            ...
            casaDAO DAOSUC = new casaDAO();
            try {
                for (casa suc : DAOSUC.todos()) {
    ...
    private class GenerarInforme extends Thread {
        public void run() {
            ...
            try {
                ...
                parameters.put("Comercial", casacomercial.getText());
                parameters.put("FechaI", FechaInicio);
                parameters.put("FechaF", FechaFinal);
                JasperReport jr = null;
                URL url = getClass().getClassLoader().getResource("Reports/vencimiento_casascomerciales.jasper");
