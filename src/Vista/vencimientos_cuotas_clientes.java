 ...
 * @author hp
 */
public class vencimientos_cuotas_clientes extends javax.swing.JFrame {
     ...
     */
    public vencimientos_cuotas_clientes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(vencimientos_cuotas_clientes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(vencimientos_cuotas_clientes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(vencimientos_cuotas_clientes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldos.setText("Vencimiento de Cuotas x Clientes");
...
//            int nCliente = Integer.valueOf(socio.getText());
            ...
            try {
                for (cuenta_clientes orden : DAO.MostrarxFechaxCliente(FechaI, FechaF, nMoneda,nCliente,nCliente)) {
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/vencimientosxclientes.jasper");
