...
import Modelo.RptVencimientoxFechaRuc;
 ...
 * @author hp
 */
public class vencimientos_cuotas_ruc extends javax.swing.JFrame {
     ...
     */
    public vencimientos_cuotas_ruc() {
        initComponents();
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {120, 90, 90, 100, 250, 100, 100, 100, 100, 100, 150, 100,50};
    ...
    private void Inicializar() {
        ...
        this.nombrecliente.setText("Todos los Clientes");
    ...
    private void initComponents() {
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(vencimientos_cuotas_ruc.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(vencimientos_cuotas_ruc.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(vencimientos_cuotas_ruc.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        etiquetasaldos.setText("Vencimiento de Cuotas x RUC");
        ...
        jLabel1.setText("Cuenta Cliente");
        ...
        ruc.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
        ruc.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        ruc.setFont(new java.awt.Font("Arial", 1, 10)); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(ruc, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            for (nFila = 0; nFila < jTable1.getRowCount(); nFila++) {
                ...
                System.out.println(jTable1.getValueAt(nFila, 12).toString());
                tipo = new RptVencimientoxFechaRuc(jTable1.getValueAt(nFila, 0).toString(), jTable1.getValueAt(nFila, 1).toString(), jTable1.getValueAt(nFila, 2).toString(), jTable1.getValueAt(nFila, 3).toString(), jTable1.getValueAt(nFila, 4).toString(), jTable1.getValueAt(nFila, 5).toString(), Double.valueOf(cAmortiza), Double.valueOf(cMinteres), Double.valueOf(cSaldo), jTable1.getValueAt(nFila, 9).toString(), jTable1.getValueAt(nFila, 10).toString(), jTable1.getValueAt(nFila, 11).toString(),jTable1.getValueAt(nFila, 12).toString());
                Resultados.add(tipo);
            }
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/vencimientosxclientesruc.jasper");
