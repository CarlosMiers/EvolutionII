 ...
 * @author hp
 */
public class vencimientoxgiraduria extends javax.swing.JFrame {
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {130, 130, 130, 130, 200, 130, 70, 70, 120, 120, 120, 120};
    ...
    private void initComponents() {
        ...
        wBuscarGiraduria.setTitle(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.wBuscarGiraduria.title")); // NOI18N
        ...
        BuscarGiraduria.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.BuscarGiraduria.text")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.AceptarGir.text")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.SalirGir.text")); // NOI18N
        ...
        setTitle(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.title")); // NOI18N
        ...
        etiquetasaldos.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.etiquetasaldos.text")); // NOI18N
        ...
        generar.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.generar.text")); // NOI18N
        generar.setToolTipText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.generar.toolTipText")); // NOI18N
        ...
        salir.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.salir.text")); // NOI18N
        salir.setToolTipText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.salir.toolTipText")); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.jPanel2.border.title"))); // NOI18N

        jLabel1.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.jLabel1.text")); // NOI18N
        ...
        giraduria.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.giraduria.text")); // NOI18N
        ...
        nombregiraduria.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.nombregiraduria.text")); // NOI18N
        nombregiraduria.setEnabled(false);

        Buscar.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.Buscar.text")); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.jPanel4.border.title"))); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.jLabel2.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.jLabel3.text")); // NOI18N
        ...
        listar.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.listar.text")); // NOI18N
        listar.setToolTipText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.listar.toolTipText")); // NOI18N
        ...
        jMenu1.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.jMenu1.text")); // NOI18N

        jMenuItem1.setText(org.openide.util.NbBundle.getMessage(vencimientoxgiraduria.class, "vencimientoxgiraduria.jMenuItem1.text")); // NOI18N
    ...
    private class generarconsulta extends Thread {
        ...
        public void run() {
            ...
            try {
                for (cuenta_clientes ct : DAO.MostrarxGiraduria(nGiraduria, FechaI, FechaF)) {
                    String Datos[] = {ct.getDocumento(), formatoFecha.format(ct.getFecha()), formatoFecha.format(ct.getVencimiento()), String.valueOf(ct.getCliente().getCodigo()), ct.getCliente().getNombre(), ct.getComprobante().getNombre(), String.valueOf(ct.getCuota()), String.valueOf(ct.getNumerocuota()), formato.format(ct.getSaldo()), ct.getGiraduria().getNombre(), ct.getAutorizacion(), ct.getNrocuenta()};
                    modelo.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                parameters.put("Giraduria", giraduria.getText());
