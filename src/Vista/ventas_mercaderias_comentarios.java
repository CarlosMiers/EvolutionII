 ...
 *
 */
public class ventas_mercaderias_comentarios extends javax.swing.JFrame {
    ...
    Date dConfirma;
    Date dPrimeraCuota;
    private TableRowSorter trsfiltro, trsfiltrosuc, trsfiltrocli, trsfiltrocentro, trsfiltroobra,
    ...
    public ventas_mercaderias_comentarios() {
        initComponents();
...
//         ImageIcon icon = new ImageIcon(Image1.getIconHeight(). getScaledInstance(this.etiquetaimagen.getWidth(), etiquetaimagen.getHeight(), Image.SCALE_DEFAULT));
        ...
        GrillaCentro grillaCe = new GrillaCentro();
    ...
    private void initComponents() {
        ...
        itemCentro = new JDialog();
        jPanel36 = new JPanel();
        descripcioncentro = new JTextField();
        cantidadcentro = new JFormattedTextField();
        precio1 = new JFormattedTextField();
        porcentajeivacentro = new JFormattedTextField();
        totalitemcentro = new JFormattedTextField();
        importeivacentro = new JFormattedTextField();
        nombrecentro = new JTextField();
        idItemcentro = new JTextField();
        idcentro = new JTextField();
        BuscarCuenta = new JButton();
        jLabel74 = new JLabel();
        jLabel73 = new JLabel();
        jLabel75 = new JLabel();
        jLabel76 = new JLabel();
        ...
        jLabel79 = new JLabel();
        jPanel54 = new JPanel();
        GrabarItemCentro = new JButton();
        SalirCentro = new JButton();
        BCentro = new JDialog();
        jPanel55 = new JPanel();
        comboplan = new JComboBox();
        jTBuscarPlan = new JTextField();
        jScrollPane17 = new JScrollPane();
        tablacentrocosto = new JTable();
        jPanel56 = new JPanel();
        AceptarCta = new JButton();
        SalirCta = new JButton();
        detalle_centro = new JDialog();
        jPanel57 = new JPanel();
        jLabel66 = new JLabel();
        jLabel67 = new JLabel();
        jLabel68 = new JLabel();
        nrofactura1 = new JTextField();
        nombreclientecentro = new JTextField();
        totalfacturacentro = new JTextField();
        jLabel69 = new JLabel();
        comprobante1 = new JTextField();
        jLabel70 = new JLabel();
        creferencia1 = new JTextField();
        fechaemisioncentro = new JTextField();
        jPanel58 = new JPanel();
        jScrollPane18 = new JScrollPane();
        tablacentro = new JTable();
        jPanel59 = new JPanel();
        AgregarItemCentro = new JButton();
        EditarItemCentro = new JButton();
        BorrarItemCentro = new JButton();
        jButton7 = new JButton();
        totalcentro = new JFormattedTextField();
        jLabel71 = new JLabel();
        BObras = new JDialog();
        jPanel60 = new JPanel();
        combopais = new JComboBox();
        jTBuscarObra = new JTextField();
        jScrollPane20 = new JScrollPane();
        tablaobra = new JTable();
        jPanel61 = new JPanel();
        ...
        jTBuscarProducto.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarProducto.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirProducto.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jLabel12.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel12.text")); // NOI18N
        ...
        jLabel2.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel2.text")); // NOI18N
        ...
        jLabel6.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel6.text")); // NOI18N
        ...
        jLabel5.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel5.text")); // NOI18N
        jLabel5.setName("jLabel5"); // NOI18N

        vencetimbrado.setName("vencetimbrado"); // NOI18N

        jLabel7.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel7.text")); // NOI18N
        ...
        jLabel1.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel1.text")); // NOI18N
        jLabel1.setName("jLabel1"); // NOI18N

        factura.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.factura.text")); // NOI18N
                ...
                .addGroup(jPanel5Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(venceanterior, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        jLabel4.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel4.text")); // NOI18N
        ...
        jLabel9.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel9.text")); // NOI18N
        jLabel9.setName("jLabel9"); // NOI18N

        jLabel14.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel14.text")); // NOI18N
        ...
        etiquetavendedor.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.etiquetavendedor.text")); // NOI18N
        ...
        jLabel10.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel10.text")); // NOI18N
        ...
        jLabel11.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel11.text")); // NOI18N
        ...
        preventa.setFocusCycleRoot(true);
        ...
        jLabel32.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel32.text")); // NOI18N
        jLabel32.setName("jLabel32"); // NOI18N

        jLabel13.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel13.text")); // NOI18N
        jLabel13.setName("jLabel13"); // NOI18N

        caja.setHorizontalAlignment(JTextField.RIGHT);
        caja.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.caja.text")); // NOI18N
        ...
        nombrecaja.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.nombrecaja.text")); // NOI18N
        nombrecaja.setName("nombrecaja"); // NOI18N

        jLabel72.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel72.text")); // NOI18N
        jLabel72.setName("jLabel72"); // NOI18N

        obra.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.obra.text")); // NOI18N
        ...
        nombreobra.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.nombreobra.text")); // NOI18N
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(primervence, GroupLayout.PREFERRED_SIZE, 93, GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jLabel58.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel58.text")); // NOI18N
        jLabel58.setName("jLabel58"); // NOI18N

        cantidadproductos.setFont(new Font("Tahoma", 1, 11)); // NOI18N
        cantidadproductos.setHorizontalAlignment(JTextField.LEFT);
        cantidadproductos.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.cantidadproductos.text")); // NOI18N
        ...
        jTabbedPane1.addTab(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.PanelItems.TabConstraints.tabTitle"), PanelItems); // NOI18N
        ...
        NewItem.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.NewItem.text")); // NOI18N
        ...
        Upditem.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.Upditem.text")); // NOI18N
        ...
        DelItem.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.DelItem.text")); // NOI18N
        ...
        jLabel45.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel45.text")); // NOI18N
        ...
        jTabbedPane1.addTab(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jPanel37.TabConstraints.tabTitle"), jPanel37); // NOI18N
        ...
        NuevoF.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.NuevoF.text")); // NOI18N
        ...
        EditarF.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.EditarF.text")); // NOI18N
        ...
        BorrarF.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.BorrarF.text")); // NOI18N
        ...
        jLabel51.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel51.text")); // NOI18N
        ...
        jTabbedPane1.addTab(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jPanel27.TabConstraints.tabTitle"), jPanel27); // NOI18N
        ...
        nuevoitem.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.nuevoitem.text")); // NOI18N
        ...
        editaritem.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.editaritem.text")); // NOI18N
        ...
        jPanel9.setBorder(BorderFactory.createTitledBorder(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jPanel9.border.title"))); // NOI18N
        ...
        Salir.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.Salir.text")); // NOI18N
        Salir.setToolTipText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.Salir.toolTipText")); // NOI18N
        ...
        Grabar.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.Grabar.text")); // NOI18N
        Grabar.setToolTipText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.Grabar.toolTipText")); // NOI18N
        ...
        jPanel11.setBorder(BorderFactory.createTitledBorder(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jPanel11.border.title"))); // NOI18N
        ...
        jPanel12.setBorder(BorderFactory.createTitledBorder(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jPanel12.border.title"))); // NOI18N
        jPanel12.setName("jPanel12"); // NOI18N

        jLabel19.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel19.text")); // NOI18N
        jLabel19.setName("jLabel19"); // NOI18N

        jLabel21.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel21.text")); // NOI18N
        jLabel21.setName("jLabel21"); // NOI18N

        jLabel24.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel24.text")); // NOI18N
        ...
        foto.setToolTipText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.foto.toolTipText")); // NOI18N
        foto.setFONDO(false);
        ...
        jTBuscarSucursal.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarCliente.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarComprobante.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarComprobante.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirComprobante.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jLabel16.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel16.text_1")); // NOI18N
        jLabel16.setName("jLabel16"); // NOI18N

        grabaroc.setFont(new Font("Lucida Grande", 1, 13)); // NOI18N
        grabaroc.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.grabaroc.text")); // NOI18N
        ...
        saliropcion.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.saliropcion.text")); // NOI18N
        ...
        jLabel17.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel17.text")); // NOI18N
        ...
        jLabel18.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel18.text")); // NOI18N
        ...
        jLabel20.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel20.text")); // NOI18N
        ...
        jLabel22.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel22.text")); // NOI18N
        ...
        jLabel23.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel23.text")); // NOI18N
        ...
        codprod.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.codprod.text")); // NOI18N
        ...
        lblnombre.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.jLabel14.text")); // NOI18N
        lblnombre.setName("lblnombre"); // NOI18N

        BuscarProducto.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.BuscarProducto.text")); // NOI18N
        ...
        nombreproducto.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.nombreproducto.text")); // NOI18N
        nombreproducto.setEnabled(false);
        nombreproducto.setName("nombreproducto"); // NOI18N

        lblcantidad.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.jLabel15.text")); // NOI18N
        lblcantidad.setName("lblcantidad"); // NOI18N

        cantidad.setHorizontalAlignment(JTextField.RIGHT);
        cantidad.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.cantidad.text")); // NOI18N
        ...
        precio.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.preciounitario.text")); // NOI18N
        ...
        jLabel28.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.jLabel17.text")); // NOI18N
        ...
        totalitem.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.totalitem.text")); // NOI18N
        totalitem.setName("totalitem"); // NOI18N

        cModo.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.cModo.text")); // NOI18N
        ...
        porcentaje.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.preciounitario.text")); // NOI18N
        ...
        jLabel30.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel30.text")); // NOI18N
        jLabel30.setName("jLabel30"); // NOI18N

        jLabel25.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel25.text")); // NOI18N
        jLabel25.setName("jLabel25"); // NOI18N

        jLabel55.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel55.text")); // NOI18N
        ...
        comentario.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent evt) {
                comentarioKeyPressed(evt);
            }
        });
        jScrollPane19.setViewportView(comentario);

        lblnombre1.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.lblnombre1.text")); // NOI18N
            ...
            .addGroup(jPanel21Layout.createSequentialGroup()
                ...
                .addGroup(jPanel21Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel21Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(totalitem, GroupLayout.PREFERRED_SIZE, 98, GroupLayout.PREFERRED_SIZE)
                        .addGap(197, 197, 197))
                    .addGroup(jPanel21Layout.createSequentialGroup()
                        .addGroup(jPanel21Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblnombre1, GroupLayout.Alignment.TRAILING))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel21Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(nombreproducto, GroupLayout.DEFAULT_SIZE, 295, Short.MAX_VALUE)
                            .addComponent(jScrollPane19)
                            .addGroup(jPanel21Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                .addComponent(porcentaje, GroupLayout.PREFERRED_SIZE, 53, GroupLayout.PREFERRED_SIZE)
                                .addGroup(GroupLayout.Alignment.LEADING, jPanel21Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(precio, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE)
                                    .addComponent(cantidad, GroupLayout.Alignment.LEADING))))))
        ...
        jPanel21Layout.setVerticalGroup(jPanel21Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel21Layout.createSequentialGroup()
                ...
                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel21Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane19, GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .addGroup(jPanel21Layout.createSequentialGroup()
        ...
        GrabarItem.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.NuevoItem.text")); // NOI18N
        ...
        SalirItem.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.SalirItem.text")); // NOI18N
        ...
        jPanel22Layout.setVerticalGroup(jPanel22Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(GroupLayout.Alignment.TRAILING, jPanel22Layout.createSequentialGroup()
                ...
                .addGroup(jPanel22Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                    .addComponent(SalirItem, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(GrabarItem, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        );
        ...
        jTBuscarVendedor.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarVendedor.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirVendedor.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jLabel42.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel42.text")); // NOI18N
        ...
        jLabel43.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel43.text")); // NOI18N
        jLabel43.setName("jLabel43"); // NOI18N

        jLabel44.setFont(new Font("Tahoma", 1, 12)); // NOI18N
        jLabel44.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel44.text")); // NOI18N
        ...
        imprimirlotes.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.imprimirlotes.text")); // NOI18N
        ...
        SalirLotes.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.SalirLotes.text")); // NOI18N
        ...
        jLabel46.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel46.text")); // NOI18N
        jLabel46.setName("jLabel46"); // NOI18N

        jLabel47.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel47.text")); // NOI18N
        ...
        jLabel48.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel48.text")); // NOI18N
        ...
        jLabel49.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel49.text")); // NOI18N
        jLabel49.setName("jLabel49"); // NOI18N

        jLabel50.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel50.text")); // NOI18N
        ...
        cModo1.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.cModo.text")); // NOI18N
        ...
        grabarPago.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.grabarPago.text")); // NOI18N
        ...
        salirPago.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.salirPago.text")); // NOI18N
        ...
        jTBuscarForma.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarGir.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirGir.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarbanco.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCasa.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCasa.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        lblcodigo.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "detalle_facturas.jLabel19.text")); // NOI18N
        ...
        ncuotas.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.ncuotas.text")); // NOI18N
        ncuotas.setToolTipText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.ncuotas.toolTipText")); // NOI18N
        ...
        montocuota.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.montocuota.text")); // NOI18N
        ...
        jLabel15.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel15.text")); // NOI18N
        jLabel15.setName("jLabel15"); // NOI18N

        jLabel26.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel26.text")); // NOI18N
        jLabel26.setName("jLabel26"); // NOI18N

        jLabel27.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel27.text")); // NOI18N
        jLabel27.setName("jLabel27"); // NOI18N

        jLabel29.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel29.text")); // NOI18N
        jLabel29.setName("jLabel29"); // NOI18N

        jLabel31.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel31.text")); // NOI18N
        ...
        grabarFinanciacion.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.grabarFinanciacion.text")); // NOI18N
        ...
        salirFinanciacion.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.salirFinanciacion.text")); // NOI18N
        ...
        BCaja.setTitle(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.BCaja.title")); // NOI18N
        ...
        AceptarCaja.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.AceptarCaja.text")); // NOI18N
        ...
        SalirCaja.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.SalirCaja.text")); // NOI18N
        ...
        GrabarRetencion.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.GrabarRetencion.text")); // NOI18N
        ...
        SalirRetencion.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.SalirRetencion.text")); // NOI18N
        ...
        jLabel33.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel33.text")); // NOI18N
        jLabel33.setName("jLabel33"); // NOI18N

        jLabel34.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel34.text")); // NOI18N
        jLabel34.setName("jLabel34"); // NOI18N

        nroretencion.setHorizontalAlignment(JTextField.RIGHT);
        nroretencion.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.nroretencion.text")); // NOI18N
        ...
        jLabel35.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel35.text")); // NOI18N
        jLabel35.setName("jLabel35"); // NOI18N

        nrofactura.setEditable(false);
        nrofactura.setHorizontalAlignment(JTextField.RIGHT);
        nrofactura.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.sucursalret.text")); // NOI18N
        nrofactura.setName("nrofactura"); // NOI18N

        jLabel36.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel36.text")); // NOI18N
        jLabel36.setName("jLabel36"); // NOI18N

        sucursalret.setEditable(false);
        sucursalret.setHorizontalAlignment(JTextField.RIGHT);
        sucursalret.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.sucursalret.text")); // NOI18N
        sucursalret.setName("sucursalret"); // NOI18N

        nombresucursalret.setEditable(false);
        nombresucursalret.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.sucursalret.text")); // NOI18N
        nombresucursalret.setName("nombresucursalret"); // NOI18N

        jLabel37.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel37.text")); // NOI18N
        jLabel37.setName("jLabel37"); // NOI18N

        monedaret.setEditable(false);
        monedaret.setHorizontalAlignment(JTextField.RIGHT);
        monedaret.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.sucursalret.text")); // NOI18N
        monedaret.setName("monedaret"); // NOI18N

        nombremonedaret.setEditable(false);
        nombremonedaret.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.sucursalret.text")); // NOI18N
        nombremonedaret.setName("nombremonedaret"); // NOI18N

        jLabel38.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel38.text")); // NOI18N
        ...
        importe_sin_iva.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.importe_sin_iva.text")); // NOI18N
        importe_sin_iva.setName("importe_sin_iva"); // NOI18N

        jLabel39.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel39.text")); // NOI18N
        ...
        importe_iva.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.importe_sin_iva.text")); // NOI18N
        importe_iva.setName("importe_iva"); // NOI18N

        jLabel40.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel40.text")); // NOI18N
        ...
        importe_gravado_total.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.importe_sin_iva.text")); // NOI18N
        importe_gravado_total.setName("importe_gravado_total"); // NOI18N

        jLabel41.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel41.text")); // NOI18N
        ...
        porcentaje_retencion.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.importe_sin_iva.text")); // NOI18N
        ...
        jLabel52.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel52.text")); // NOI18N
        ...
        valor_retencion.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas.importe_sin_iva.text")); // NOI18N
        valor_retencion.setName("valor_retencion"); // NOI18N

        enviarcta.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.enviarcta.text")); // NOI18N
        enviarcta.setName("enviarcta"); // NOI18N

        creferenciaret.setEditable(false);
        creferenciaret.setHorizontalAlignment(JTextField.RIGHT);
        creferenciaret.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.creferenciaret.text")); // NOI18N
        creferenciaret.setName("creferenciaret"); // NOI18N

        jLabel53.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel53.text")); // NOI18N
        jLabel53.setName("jLabel53"); // NOI18N

        clienteret.setEditable(false);
        clienteret.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.clienteret.text")); // NOI18N
        clienteret.setName("clienteret"); // NOI18N

        nombreclienteret.setEditable(false);
        nombreclienteret.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.nombreclienteret.text")); // NOI18N
        ...
        preventas.setTitle(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.preventas.title")); // NOI18N
        ...
        jLabel54.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel54.text")); // NOI18N
        ...
        AceptarPreventa.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.AceptarPreventa.text")); // NOI18N
        ...
        SalirPreventa.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.SalirPreventa.text")); // NOI18N
        ...
        etiquetanombreproducto.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.etiquetanombreproducto.text")); // NOI18N
        ...
        fotoProducto.setToolTipText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.fotoProducto.toolTipText")); // NOI18N
        ...
        SalirFoto.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.SalirFoto.text")); // NOI18N
        ...
        inventario.setTitle(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.inventario.title")); // NOI18N
        ...
        SalirStock.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.SalirStock.text")); // NOI18N
        ...
        jLabel56.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel56.text")); // NOI18N
        jLabel56.setName("jLabel56"); // NOI18N

        jLabel57.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel57.text")); // NOI18N
        jLabel57.setName("jLabel57"); // NOI18N

        etiquetacodigo.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.etiquetacodigo.text")); // NOI18N
        etiquetacodigo.setName("etiquetacodigo"); // NOI18N

        etiquetanombre.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.etiquetanombre.text")); // NOI18N
        ...
        itemCentro.setName("itemCentro"); // NOI18N

        jPanel36.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
        jPanel36.setName("jPanel36"); // NOI18N

        descripcioncentro.setName("descripcioncentro"); // NOI18N
        descripcioncentro.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent evt) {
                descripcioncentroKeyPressed(evt);
            }
        });

        cantidadcentro.setFormatterFactory(new DefaultFormatterFactory(new NumberFormatter(new DecimalFormat("#,##0.00"))));
        cantidadcentro.setHorizontalAlignment(JTextField.RIGHT);
        cantidadcentro.setName("cantidadcentro"); // NOI18N
        cantidadcentro.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent evt) {
                cantidadcentroKeyPressed(evt);
            }
        });

        precio1.setFormatterFactory(new DefaultFormatterFactory(new NumberFormatter(new DecimalFormat("#,##0.00"))));
        precio1.setHorizontalAlignment(JTextField.RIGHT);
        precio1.setName("precio1"); // NOI18N
        precio1.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent evt) {
        ...
        porcentajeivacentro.setFormatterFactory(new DefaultFormatterFactory(new NumberFormatter(new DecimalFormat("#,##0.00"))));
        porcentajeivacentro.setHorizontalAlignment(JTextField.RIGHT);
        porcentajeivacentro.setName("porcentajeivacentro"); // NOI18N
        porcentajeivacentro.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent evt) {
                porcentajeivacentroFocusLost(evt);
            }
        });
        porcentajeivacentro.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent evt) {
                porcentajeivacentroKeyPressed(evt);
            }
        });

        totalitemcentro.setFormatterFactory(new DefaultFormatterFactory(new NumberFormatter(new DecimalFormat("#,##0.00"))));
        totalitemcentro.setHorizontalAlignment(JTextField.RIGHT);
        totalitemcentro.setEnabled(false);
        totalitemcentro.setName("totalitemcentro"); // NOI18N
        totalitemcentro.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent evt) {
                totalitemcentroKeyPressed(evt);
            }
        });

        importeivacentro.setFormatterFactory(new DefaultFormatterFactory(new NumberFormatter(new DecimalFormat("#,##0.00"))));
        importeivacentro.setHorizontalAlignment(JTextField.RIGHT);
        importeivacentro.setName("importeivacentro"); // NOI18N
        importeivacentro.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent evt) {
        ...
        nombrecentro.setName("nombrecentro"); // NOI18N

        idItemcentro.setEnabled(false);
        idItemcentro.setName("idItemcentro"); // NOI18N

        idcentro.setHorizontalAlignment(JTextField.RIGHT);
        idcentro.setName("idcentro"); // NOI18N
        idcentro.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                idcentroActionPerformed(evt);
            }
        });
        idcentro.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent evt) {
                idcentroKeyPressed(evt);
            }
        });

        BuscarCuenta.setCursor(new Cursor(Cursor.HAND_CURSOR));
        BuscarCuenta.setName("BuscarCuenta"); // NOI18N
        BuscarCuenta.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                BuscarCuentaActionPerformed(evt);
            }
        });

        jLabel74.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel74.text")); // NOI18N
        jLabel74.setName("jLabel74"); // NOI18N

        jLabel73.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel73.text")); // NOI18N
        jLabel73.setName("jLabel73"); // NOI18N

        jLabel75.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel75.text")); // NOI18N
        jLabel75.setName("jLabel75"); // NOI18N

        jLabel76.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel76.text")); // NOI18N
        jLabel76.setName("jLabel76"); // NOI18N

        jLabel77.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel77.text")); // NOI18N
        jLabel77.setName("jLabel77"); // NOI18N

        jLabel78.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel78.text")); // NOI18N
        jLabel78.setName("jLabel78"); // NOI18N

        jLabel79.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel79.text")); // NOI18N
        ...
        jPanel36Layout.setHorizontalGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel36Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel36Layout.createSequentialGroup()
                        .addGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            .addComponent(descripcioncentro, GroupLayout.PREFERRED_SIZE, 351, GroupLayout.PREFERRED_SIZE)
                            .addComponent(cantidadcentro, GroupLayout.PREFERRED_SIZE, 92, GroupLayout.PREFERRED_SIZE)
                            .addComponent(precio1, GroupLayout.PREFERRED_SIZE, 92, GroupLayout.PREFERRED_SIZE)
                            .addComponent(porcentajeivacentro, GroupLayout.PREFERRED_SIZE, 39, GroupLayout.PREFERRED_SIZE))
                        .addContainerGap(36, Short.MAX_VALUE))
                    .addGroup(jPanel36Layout.createSequentialGroup()
                        .addGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                            .addComponent(idcentro)
                            .addComponent(importeivacentro, GroupLayout.Alignment.LEADING)
                            .addComponent(totalitemcentro, GroupLayout.Alignment.LEADING))
                        .addGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel36Layout.createSequentialGroup()
                                .addGap(96, 96, 96)
                                .addComponent(idItemcentro, GroupLayout.PREFERRED_SIZE, 99, GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel36Layout.createSequentialGroup()
                                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(BuscarCuenta, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(nombrecentro, GroupLayout.PREFERRED_SIZE, 219, GroupLayout.PREFERRED_SIZE)))
                        .addGap(42, 42, 42))))
        );
        jPanel36Layout.setVerticalGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel36Layout.createSequentialGroup()
                ...
                .addGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel36Layout.createSequentialGroup()
                        .addComponent(descripcioncentro, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            .addComponent(cantidadcentro, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel73))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            .addComponent(precio1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel75))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            .addComponent(porcentajeivacentro, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel76))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            .addComponent(totalitemcentro, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                            .addComponent(idItemcentro, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                        .addGap(32, 32, 32))
                    .addGroup(jPanel36Layout.createSequentialGroup()
                        .addComponent(jLabel74)
                        .addGap(138, 138, 138)
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            .addComponent(importeivacentro, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel78))))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 21, Short.MAX_VALUE)
                .addGroup(jPanel36Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(nombrecentro, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel79)
                    .addComponent(idcentro, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(BuscarCuenta, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );

        jPanel54.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
        jPanel54.setName("jPanel54"); // NOI18N

        GrabarItemCentro.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.GrabarItemCentro.text")); // NOI18N
        GrabarItemCentro.setCursor(new Cursor(Cursor.HAND_CURSOR));
        GrabarItemCentro.setName("GrabarItemCentro"); // NOI18N
        GrabarItemCentro.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                GrabarItemCentroActionPerformed(evt);
            }
        });

        SalirCentro.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.SalirCentro.text")); // NOI18N
        SalirCentro.setCursor(new Cursor(Cursor.HAND_CURSOR));
        SalirCentro.setName("SalirCentro"); // NOI18N
        SalirCentro.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jPanel54Layout.setHorizontalGroup(jPanel54Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel54Layout.createSequentialGroup()
                .addGap(139, 139, 139)
                .addComponent(GrabarItemCentro, GroupLayout.PREFERRED_SIZE, 103, GroupLayout.PREFERRED_SIZE)
                .addGap(55, 55, 55)
                .addComponent(SalirCentro, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE)
                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel54Layout.setVerticalGroup(jPanel54Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel54Layout.createSequentialGroup()
                .addContainerGap()
        ...
        GroupLayout itemCentroLayout = new GroupLayout(itemCentro.getContentPane());
        itemCentro.getContentPane().setLayout(itemCentroLayout);
        itemCentroLayout.setHorizontalGroup(itemCentroLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addComponent(jPanel36, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(jPanel54, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        itemCentroLayout.setVerticalGroup(itemCentroLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        BCentro.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
        BCentro.setTitle(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.BCentro.title")); // NOI18N
        BCentro.setName("BCentro"); // NOI18N

        jPanel55.setBorder(new SoftBevelBorder(BevelBorder.RAISED));
        jPanel55.setName("jPanel55"); // NOI18N

        comboplan.setFont(new Font("Arial", 1, 14)); // NOI18N
        comboplan.setModel(new DefaultComboBoxModel(new String[] { "Buscar por Nombre", "Buscar por Código" }));
        comboplan.setCursor(new Cursor(Cursor.HAND_CURSOR));
        ...
        jTBuscarPlan.setFont(new Font("Tahoma", 1, 14)); // NOI18N
        jTBuscarPlan.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jTBuscarPlan.text")); // NOI18N
        jTBuscarPlan.setName("jTBuscarPlan"); // NOI18N
        jTBuscarPlan.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                jTBuscarPlanActionPerformed(evt);
            }
        });
        jTBuscarPlan.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent evt) {
        ...
        jPanel55Layout.setHorizontalGroup(jPanel55Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel55Layout.createSequentialGroup()
                .addComponent(comboplan, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jTBuscarPlan, GroupLayout.PREFERRED_SIZE, 284, GroupLayout.PREFERRED_SIZE)
                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel55Layout.setVerticalGroup(jPanel55Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel55Layout.createSequentialGroup()
                .addGap(19, 19, 19)
                .addGroup(jPanel55Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(comboplan, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTBuscarPlan, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addContainerGap(19, Short.MAX_VALUE))
        );
        ...
        tablacentrocosto.setName("tablacentrocosto"); // NOI18N
        tablacentrocosto.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                tablacentrocostoMouseClicked(evt);
            }
        });
        tablacentrocosto.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent evt) {
        ...
        jPanel56.setBorder(new SoftBevelBorder(BevelBorder.RAISED));
        jPanel56.setName("jPanel56"); // NOI18N

        AceptarCta.setFont(new Font("Tahoma", 1, 12)); // NOI18N
        AceptarCta.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.AceptarCta.text")); // NOI18N
        AceptarCta.setCursor(new Cursor(Cursor.HAND_CURSOR));
        AceptarCta.setName("AceptarCta"); // NOI18N
        AceptarCta.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                AceptarCtaActionPerformed(evt);
            }
        });

        SalirCta.setFont(new Font("Tahoma", 1, 12)); // NOI18N
        SalirCta.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.SalirCta.text")); // NOI18N
        SalirCta.setCursor(new Cursor(Cursor.HAND_CURSOR));
        SalirCta.setName("SalirCta"); // NOI18N
        SalirCta.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jPanel56Layout.setHorizontalGroup(jPanel56Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel56Layout.createSequentialGroup()
                .addGap(91, 91, 91)
                .addComponent(AceptarCta, GroupLayout.PREFERRED_SIZE, 111, GroupLayout.PREFERRED_SIZE)
                .addGap(85, 85, 85)
                .addComponent(SalirCta, GroupLayout.PREFERRED_SIZE, 114, GroupLayout.PREFERRED_SIZE)
                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel56Layout.setVerticalGroup(jPanel56Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        GroupLayout BCentroLayout = new GroupLayout(BCentro.getContentPane());
        BCentro.getContentPane().setLayout(BCentroLayout);
        BCentroLayout.setHorizontalGroup(BCentroLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        BCentroLayout.setVerticalGroup(BCentroLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(BCentroLayout.createSequentialGroup()
                .addComponent(jPanel55, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane17, GroupLayout.PREFERRED_SIZE, 410, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel56, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        );

        detalle_centro.setName("detalle_centro"); // NOI18N

        jPanel57.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
        jPanel57.setName("jPanel57"); // NOI18N

        jLabel66.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel66.text")); // NOI18N
        jLabel66.setName("jLabel66"); // NOI18N

        jLabel67.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel67.text")); // NOI18N
        jLabel67.setName("jLabel67"); // NOI18N

        jLabel68.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel68.text")); // NOI18N
        jLabel68.setName("jLabel68"); // NOI18N

        nrofactura1.setHorizontalAlignment(JTextField.RIGHT);
        nrofactura1.setDisabledTextColor(new Color(0, 0, 255));
        nrofactura1.setEnabled(false);
        nrofactura1.setName("nrofactura1"); // NOI18N

        nombreclientecentro.setDisabledTextColor(new Color(0, 0, 255));
        nombreclientecentro.setEnabled(false);
        nombreclientecentro.setName("nombreclientecentro"); // NOI18N

        totalfacturacentro.setHorizontalAlignment(JTextField.RIGHT);
        totalfacturacentro.setDisabledTextColor(new Color(0, 0, 255));
        totalfacturacentro.setEnabled(false);
        totalfacturacentro.setName("totalfacturacentro"); // NOI18N

        jLabel69.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel69.text")); // NOI18N
        jLabel69.setName("jLabel69"); // NOI18N

        comprobante1.setDisabledTextColor(new Color(0, 0, 255));
        comprobante1.setEnabled(false);
        comprobante1.setName("comprobante1"); // NOI18N

        jLabel70.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel70.text")); // NOI18N
        jLabel70.setName("jLabel70"); // NOI18N

        creferencia1.setEnabled(false);
        creferencia1.setName("creferencia1"); // NOI18N

        fechaemisioncentro.setHorizontalAlignment(JTextField.CENTER);
        fechaemisioncentro.setDisabledTextColor(new Color(0, 0, 255));
        fechaemisioncentro.setEnabled(false);
        fechaemisioncentro.setName("fechaemisioncentro"); // NOI18N

        GroupLayout jPanel57Layout = new GroupLayout(jPanel57);
        jPanel57.setLayout(jPanel57Layout);
        jPanel57Layout.setHorizontalGroup(jPanel57Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel57Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel57Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel67)
                    .addComponent(jLabel66))
                .addGap(18, 18, 18)
                .addGroup(jPanel57Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                    .addComponent(nrofactura1)
                    .addComponent(totalfacturacentro, GroupLayout.PREFERRED_SIZE, 94, GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                ...
                .addGroup(jPanel57Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel57Layout.createSequentialGroup()
                        .addComponent(comprobante1, GroupLayout.PREFERRED_SIZE, 201, GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(creferencia1, GroupLayout.PREFERRED_SIZE, 106, GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel57Layout.createSequentialGroup()
                        .addComponent(fechaemisioncentro, GroupLayout.PREFERRED_SIZE, 86, GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jLabel68)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(nombreclientecentro, GroupLayout.PREFERRED_SIZE, 182, GroupLayout.PREFERRED_SIZE)))
                .addGap(54, 54, 54))
        );
        jPanel57Layout.setVerticalGroup(jPanel57Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel57Layout.createSequentialGroup()
                .addGap(19, 19, 19)
                .addGroup(jPanel57Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel57Layout.createSequentialGroup()
                        .addGroup(jPanel57Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel66)
                            .addComponent(nrofactura1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel69)
                            .addComponent(fechaemisioncentro, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel68)
                            .addComponent(nombreclientecentro, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel57Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel67)
                            .addComponent(totalfacturacentro, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel70)))
                    .addGroup(jPanel57Layout.createSequentialGroup()
                        .addGap(31, 31, 31)
                        .addGroup(jPanel57Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            .addComponent(comprobante1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                            .addComponent(creferencia1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jPanel58.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
        jPanel58.setName("jPanel58"); // NOI18N

        jScrollPane18.setName("jScrollPane18"); // NOI18N

        tablacentro.setModel(modelocentro);
        tablacentro.setName("tablacentro"); // NOI18N
        jScrollPane18.setViewportView(tablacentro);

        GroupLayout jPanel58Layout = new GroupLayout(jPanel58);
        jPanel58.setLayout(jPanel58Layout);
        jPanel58Layout.setHorizontalGroup(jPanel58Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel58Layout.createSequentialGroup()
                .addComponent(jScrollPane18, GroupLayout.PREFERRED_SIZE, 690, GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        jPanel58Layout.setVerticalGroup(jPanel58Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane18, GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
        );

        jPanel59.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
        jPanel59.setName("jPanel59"); // NOI18N

        AgregarItemCentro.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.AgregarItemCentro.text")); // NOI18N
        AgregarItemCentro.setCursor(new Cursor(Cursor.HAND_CURSOR));
        AgregarItemCentro.setName("AgregarItemCentro"); // NOI18N
        AgregarItemCentro.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                AgregarItemCentroActionPerformed(evt);
            }
        });

        EditarItemCentro.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.EditarItemCentro.text")); // NOI18N
        EditarItemCentro.setCursor(new Cursor(Cursor.HAND_CURSOR));
        EditarItemCentro.setEnabled(false);
        EditarItemCentro.setName("EditarItemCentro"); // NOI18N
        EditarItemCentro.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                EditarItemCentroActionPerformed(evt);
            }
        });

        BorrarItemCentro.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.BorrarItemCentro.text")); // NOI18N
        BorrarItemCentro.setCursor(new Cursor(Cursor.HAND_CURSOR));
        BorrarItemCentro.setEnabled(false);
        BorrarItemCentro.setName("BorrarItemCentro"); // NOI18N
        BorrarItemCentro.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                BorrarItemCentroActionPerformed(evt);
            }
        });

        jButton7.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jButton7.text")); // NOI18N
        ...
        totalcentro.setFormatterFactory(new DefaultFormatterFactory(new NumberFormatter(new DecimalFormat("#0.00"))));
        totalcentro.setHorizontalAlignment(JTextField.CENTER);
        totalcentro.setDisabledTextColor(new Color(0, 0, 204));
        totalcentro.setEnabled(false);
        totalcentro.setFont(new Font("Arial", 1, 12)); // NOI18N
        totalcentro.setName("totalcentro"); // NOI18N

        jLabel71.setFont(new Font("Arial", 1, 14)); // NOI18N
        jLabel71.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jLabel71.text")); // NOI18N
        jLabel71.setName("jLabel71"); // NOI18N

        GroupLayout jPanel59Layout = new GroupLayout(jPanel59);
        jPanel59.setLayout(jPanel59Layout);
        jPanel59Layout.setHorizontalGroup(jPanel59Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel59Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(AgregarItemCentro, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(EditarItemCentro, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(BorrarItemCentro, GroupLayout.PREFERRED_SIZE, 94, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jButton7, GroupLayout.PREFERRED_SIZE, 92, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jLabel71)
                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(totalcentro, GroupLayout.PREFERRED_SIZE, 117, GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanel59Layout.setVerticalGroup(jPanel59Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel59Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel59Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(AgregarItemCentro)
                    .addComponent(EditarItemCentro)
                    .addComponent(BorrarItemCentro)
                    .addComponent(jButton7)
                    .addComponent(totalcentro, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel71))
                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        GroupLayout detalle_centroLayout = new GroupLayout(detalle_centro.getContentPane());
        detalle_centro.getContentPane().setLayout(detalle_centroLayout);
        detalle_centroLayout.setHorizontalGroup(detalle_centroLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            ...
            .addGroup(detalle_centroLayout.createSequentialGroup()
                .addGroup(detalle_centroLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                    .addComponent(jPanel58, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jPanel59, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(0, 0, Short.MAX_VALUE))
        );
        detalle_centroLayout.setVerticalGroup(detalle_centroLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(detalle_centroLayout.createSequentialGroup()
                .addComponent(jPanel57, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel58, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jPanel59, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        );

        BObras.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
        BObras.setTitle(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.BObras.title")); // NOI18N
        BObras.setName("BObras"); // NOI18N

        jPanel60.setBorder(new SoftBevelBorder(BevelBorder.RAISED));
        ...
        jTBuscarObra.setFont(new Font("Tahoma", 1, 14)); // NOI18N
        jTBuscarObra.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jTBuscarObra.text")); // NOI18N
        jTBuscarObra.setName("jTBuscarObra"); // NOI18N
        jTBuscarObra.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                jTBuscarObraActionPerformed(evt);
            }
        });
        jTBuscarObra.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent evt) {
                jTBuscarObraKeyPressed(evt);
            }
        });

        GroupLayout jPanel60Layout = new GroupLayout(jPanel60);
        jPanel60.setLayout(jPanel60Layout);
        jPanel60Layout.setHorizontalGroup(jPanel60Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel60Layout.createSequentialGroup()
                .addComponent(combopais, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jTBuscarObra, GroupLayout.PREFERRED_SIZE, 284, GroupLayout.PREFERRED_SIZE)
                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel60Layout.setVerticalGroup(jPanel60Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel60Layout.createSequentialGroup()
                .addGap(19, 19, 19)
                .addGroup(jPanel60Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(combopais, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTBuscarObra, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addContainerGap(19, Short.MAX_VALUE))
        );

        jScrollPane20.setName("jScrollPane20"); // NOI18N

        tablaobra.setModel(modeloobra);
        tablaobra.setName("tablaobra"); // NOI18N
        tablaobra.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                tablaobraMouseClicked(evt);
            }
        });
        tablaobra.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent evt) {
                tablaobraKeyPressed(evt);
            }
        });
        jScrollPane20.setViewportView(tablaobra);

        jPanel61.setBorder(new SoftBevelBorder(BevelBorder.RAISED));
        jPanel61.setName("jPanel61"); // NOI18N

        AceptarPais.setFont(new Font("Tahoma", 1, 12)); // NOI18N
        AceptarPais.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.AceptarPais.text")); // NOI18N
        ...
        SalirPais.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.SalirPais.text")); // NOI18N
        ...
        jPanel61Layout.setHorizontalGroup(jPanel61Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        jPanel61Layout.setVerticalGroup(jPanel61Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(GroupLayout.Alignment.TRAILING, jPanel61Layout.createSequentialGroup()
                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel61Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
        ...
        BObrasLayout.setHorizontalGroup(BObrasLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(BObrasLayout.createSequentialGroup()
                .addComponent(jPanel60, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
            .addComponent(jScrollPane20, GroupLayout.Alignment.TRAILING)
            .addComponent(jPanel61, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        BObrasLayout.setVerticalGroup(BObrasLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(BObrasLayout.createSequentialGroup()
                .addComponent(jPanel60, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane20, GroupLayout.PREFERRED_SIZE, 410, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel61, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        );
        ...
        etiquetaventas.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.etiquetaventas.text")); // NOI18N
        ...
        Modificar.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.Modificar.text")); // NOI18N
        ...
        Agregar.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.Agregar.text")); // NOI18N
        ...
        Eliminar.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.Eliminar.text")); // NOI18N
        Eliminar.setToolTipText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.Eliminar.toolTipText")); // NOI18N
        ...
        Listar.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.Listar.text")); // NOI18N
        Listar.setToolTipText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.Listar.toolTipText")); // NOI18N
        ...
        SalirCompleto.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.SalirCompleto.text")); // NOI18N
        SalirCompleto.setToolTipText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.SalirCompleto.toolTipText")); // NOI18N
        ...
        jPanel3.setBorder(BorderFactory.createTitledBorder(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "libroventaconsolidado.jPanel2.border.title"))); // NOI18N
        jPanel3.setName("jPanel3"); // NOI18N

        jLabel3.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "libroventaconsolidado.jLabel1.text")); // NOI18N
        jLabel3.setName("jLabel3"); // NOI18N

        dInicial.setName("dInicial"); // NOI18N

        jLabel8.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
        jLabel8.setName("jLabel8"); // NOI18N

        dFinal.setName("dFinal"); // NOI18N

        refrescar.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.refrescar.text")); // NOI18N
        ...
        jMenu1.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jMenu1.text")); // NOI18N
        ...
        jMenuItem2.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jMenuItem2.text")); // NOI18N
        ...
        jMenuItem3.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jMenuItem3.text")); // NOI18N
        ...
        jMenuItem1.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jMenuItem1.text")); // NOI18N
        ...
        jMenuItem4.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jMenuItem4.text")); // NOI18N
        ...
        jMenuItem5.setText(NbBundle.getMessage(ventas_mercaderias_comentarios.class, "ventas_mercaderias_comentarios.jMenuItem5.text")); // NOI18N
    ...
    private void TitObra() {
        modeloobra.addColumn("Código");
        modeloobra.addColumn("Nombre");

        int[] anchos = {90, 200};
        for (int i = 0; i < modeloobra.getColumnCount(); i++) {
            tablaobra.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);
        }
        ((DefaultTableCellRenderer) tablaobra.getTableHeader().getDefaultRenderer()).setHorizontalAlignment(JLabel.CENTER);// Este código es para centrar las cabeceras de la tabla.
        tablaobra.getTableHeader().setFont(new Font("Arial Black", 1, 10));

        // Hacemos Invisible la Celda de Costos de los Productos
        Font font = new Font("Arial", Font.BOLD, 9);
        this.tablaobra.setFont(font);

        DefaultTableCellRenderer TablaRenderer = new DefaultTableCellRenderer();
        TablaRenderer.setHorizontalAlignment(SwingConstants.RIGHT); // aqui defines donde alinear 
        this.tablaobra.getColumnModel().getColumn(0).setCellRenderer(TablaRenderer);
    }
...
//      this.imagen.setText("Imagen");
            ...
            if (ve != null) {
                ...
                try {
                    for (detalle_venta detvta : detDAO.MostrarDetalle(creferencia.getText())) {
                        String Detalle[] = {detvta.getCodprod().getCodigo(),
    ...
    private void ListarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_ListarActionPerformed
        ...
        if (ret == 0) {
            ...
            try {
                suc = sucDAO.buscarId(Integer.valueOf(tablaventas.getValueAt(nFila, 12).toString()));
            } catch (SQLException ex) {
                Exceptions.printStackTrace(ex);
            }
    ...
    private void GrabarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (ret == 0) {
            ...
            if (Integer.valueOf(modo.getText()) == 1) {
                try {
                    grabarventa.AgregarFacturaVentaComentario(Config.cToken, v, detalle);
                    if (Integer.valueOf(cuotas.getText()) > 0 && Double.valueOf(cFinanciado) == 0) {
                ...
                try {
                    ...
                    grabarventa.ActualizarVentaComentario(v, detalle);
                    detalle_forma_cobroDAO cobDAO = new detalle_forma_cobroDAO();
...
//                giraduria.requestFocus();
    ...
    private void editaritemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_editaritemActionPerformed
        ...
        comentario.setText(tabladetalle.getValueAt(tabladetalle.getSelectedRow(), 6).toString());
        itemventas.setModal(true);
        itemventas.setVisible(true);
        codprod.requestFocus();
        // TODO add your handling code here:
    ...
    private void descripcioncentroKeyPressed(KeyEvent evt) {//GEN-FIRST:event_descripcioncentroKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.cantidadcentro.requestFocus();
        }
    }//GEN-LAST:event_descripcioncentroKeyPressed

    private void cantidadcentroKeyPressed(KeyEvent evt) {//GEN-FIRST:event_cantidadcentroKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
    ...
    private void precio1FocusLost(FocusEvent evt) {//GEN-FIRST:event_precio1FocusLost
    ...
    private void precio1KeyPressed(KeyEvent evt) {//GEN-FIRST:event_precio1KeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
    ...
    private void porcentajeivacentroFocusLost(FocusEvent evt) {//GEN-FIRST:event_porcentajeivacentroFocusLost
    ...
    private void porcentajeivacentroKeyPressed(KeyEvent evt) {//GEN-FIRST:event_porcentajeivacentroKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
    ...
    private void totalitemcentroKeyPressed(KeyEvent evt) {//GEN-FIRST:event_totalitemcentroKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            this.importeivacentro.requestFocus();
        }
        if (evt.getKeyCode() == KeyEvent.VK_UP) {
    ...
    private void importeivacentroKeyPressed(KeyEvent evt) {//GEN-FIRST:event_importeivacentroKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
    ...
    private void idcentroActionPerformed(ActionEvent evt) {//GEN-FIRST:event_idcentroActionPerformed
        this.BuscarCuenta.doClick();
        // TODO add your handling code here:
    }//GEN-LAST:event_idcentroActionPerformed

    private void idcentroKeyPressed(KeyEvent evt) {//GEN-FIRST:event_idcentroKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
    ...
    private void BuscarCuentaActionPerformed(ActionEvent evt) {//GEN-FIRST:event_BuscarCuentaActionPerformed
        centro_costoDAO plaDAO = new centro_costoDAO();
        centro_costo pl = null;
        try {
            pl = plaDAO.buscarId(Integer.valueOf(this.idcentro.getText()));
            if (pl.getCodigo() == 0) {
    ...
    private void GrabarItemCentroActionPerformed(ActionEvent evt) {//GEN-FIRST:event_GrabarItemCentroActionPerformed
    ...
    private void SalirCentroActionPerformed(ActionEvent evt) {//GEN-FIRST:event_SalirCentroActionPerformed
        this.itemCentro.setVisible(false);
        // TODO add your handling code here:
    }//GEN-LAST:event_SalirCentroActionPerformed

    private void comboplanActionPerformed(ActionEvent evt) {//GEN-FIRST:event_comboplanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_comboplanActionPerformed

    private void jTBuscarPlanActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jTBuscarPlanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTBuscarPlanActionPerformed

    private void jTBuscarPlanKeyPressed(KeyEvent evt) {//GEN-FIRST:event_jTBuscarPlanKeyPressed
    ...
    private void tablacentrocostoMouseClicked(MouseEvent evt) {//GEN-FIRST:event_tablacentrocostoMouseClicked
        this.AceptarCta.doClick();
        // TODO add your handling code here:
    }//GEN-LAST:event_tablacentrocostoMouseClicked

    private void tablacentrocostoKeyPressed(KeyEvent evt) {//GEN-FIRST:event_tablacentrocostoKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            this.AceptarCta.doClick();
        }
    ...
    private void AceptarCtaActionPerformed(ActionEvent evt) {//GEN-FIRST:event_AceptarCtaActionPerformed
    ...
    private void SalirCtaActionPerformed(ActionEvent evt) {//GEN-FIRST:event_SalirCtaActionPerformed
        this.BCentro.setVisible(false);
        // TODO add your handling code here:
    ...
    private void AgregarItemCentroActionPerformed(ActionEvent evt) {//GEN-FIRST:event_AgregarItemCentroActionPerformed
        LimpiarCentro();
    ...
    private void EditarItemCentroActionPerformed(ActionEvent evt) {//GEN-FIRST:event_EditarItemCentroActionPerformed
    ...
    private void BorrarItemCentroActionPerformed(ActionEvent evt) {//GEN-FIRST:event_BorrarItemCentroActionPerformed
        int nFila = this.tablacentro.getSelectedRow();
        if (nFila < 0) {
            JOptionPane.showMessageDialog(null,
                    "Debe seleccionar una fila de la tabla");
    ...
    private void tablaventasKeyReleased(KeyEvent evt) {//GEN-FIRST:event_tablaventasKeyReleased
        if (evt.getKeyCode() == KeyEvent.VK_F4) {
            int nFila = this.tablaventas.getSelectedRow();
            GrillaCentroCosto GrillaP = new GrillaCentroCosto();
            Thread Hilo2 = new Thread(GrillaP);
            Hilo2.start();
            creferencia1.setText(this.tablaventas.getValueAt(nFila, 0).toString());
            nrofactura1.setText(this.tablaventas.getValueAt(nFila, 1).toString());
            fechaemisioncentro.setText(this.tablaventas.getValueAt(nFila, 2).toString());
            comprobante1.setText(this.tablaventas.getValueAt(nFila, 3).toString());
            nombreclientecentro.setText(this.tablaventas.getValueAt(nFila, 5).toString());
            totalfacturacentro.setText(this.tablaventas.getValueAt(nFila, 10).toString());
    ...
    private void comentarioKeyPressed(KeyEvent evt) {//GEN-FIRST:event_comentarioKeyPressed
        if (evt.getKeyCode() == 10 || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            //Si pulso enter o cursor abajo obtiene el foco el sgte objeto
            this.cantidad.requestFocus();
        }
    ...
    private void buscarobraActionPerformed(ActionEvent evt) {//GEN-FIRST:event_buscarobraActionPerformed
        ...
        Thread hiloobra = new Thread(grillab);
        hiloobra.start();
    ...
    private void jTBuscarObraActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jTBuscarObraActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTBuscarObraActionPerformed

    private void jTBuscarObraKeyPressed(KeyEvent evt) {//GEN-FIRST:event_jTBuscarObraKeyPressed
        this.jTBuscarObra.addKeyListener(new KeyAdapter() {
            public void keyReleased(final KeyEvent e) {
                String cadena = (jTBuscarObra.getText()).toUpperCase();
                jTBuscarObra.setText(cadena);
                int indiceColumnaTabla = 0;
                ...
                repaint();
                filtroobra(indiceColumnaTabla);
            }
        });
        trsfiltroobra = new TableRowSorter(tablaobra.getModel());
        tablaobra.setRowSorter(trsfiltroobra);
        // TODO add your handling code here:
    }//GEN-LAST:event_jTBuscarObraKeyPressed

    public void filtroobra(int nNumeroColumna) {
        trsfiltroobra.setRowFilter(RowFilter.regexFilter(this.jTBuscarObra.getText(), nNumeroColumna));
    }


    private void tablaobraMouseClicked(MouseEvent evt) {//GEN-FIRST:event_tablaobraMouseClicked
        this.AceptarPais.doClick();
        // TODO add your handling code here:
    }//GEN-LAST:event_tablaobraMouseClicked

    private void tablaobraKeyPressed(KeyEvent evt) {//GEN-FIRST:event_tablaobraKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            this.AceptarPais.doClick();
        }

        // TODO add your handling code here:
    }//GEN-LAST:event_tablaobraKeyPressed

    private void AceptarPaisActionPerformed(ActionEvent evt) {//GEN-FIRST:event_AceptarPaisActionPerformed
        int nFila = this.tablaobra.getSelectedRow();
        this.obra.setText(this.tablaobra.getValueAt(nFila, 0).toString());
        this.nombreobra.setText(this.tablaobra.getValueAt(nFila, 1).toString());

        this.BObras.setVisible(false);
        this.jTBuscarObra.setText("");
        this.cliente.requestFocus();
        // TODO add your handling code here:
    ...
    private void TituloDetalle() {
        ...
        int[] anchos = {60, 200, 50, 50, 100, 100, 100};
    ...
    JDialog BVendedor;
    JButton BorrarF;
    JButton BorrarItemCentro;
    JButton BuscarBanco;
    JButton BuscarCaja;
    JButton BuscarCuenta;
    ...
    JButton DelItem;
    JButton EditarF;
    JButton EditarItemCentro;
    JButton Eliminar;
    JTextField FiltrarPreventa;
    JButton Grabar;
    JButton GrabarItem;
    JButton GrabarItemCentro;
    ...
    JFormattedTextField cantidadcentro;
    ...
    JFormattedTextField importeivacentro;
    ...
    JTextField jTBuscarObra;
    JTextField jTBuscarPlan;
    ...
    JTextField nombrecentro;
    JTextField nombrecliente;
    JTextField nombreclientec;
    JTextField nombreclientecentro;
    ...
    JFormattedTextField porcentajeivacentro;
    JFormattedTextField precio;
    JFormattedTextField precio1;
    ...
    JTable tablaventas;
    JFormattedTextField totalcentro;
    JTextField totalfacturacentro;
    JFormattedTextField totalfinanciado;
    JFormattedTextField totalitem;
    JFormattedTextField totalitemcentro;
    ...
    private class GrillaPreventaLote extends Thread {
        ...
        public void run() {
            ...
            try {
                for (preventa prev : DAOpre.Todos()) {
    ...
    private class GrillaCentro extends Thread {
    ...
    private class GrillaObra extends Thread {
        ...
        public void run() {
            ...
            //Antes de Cargar el Jtable Ajustamos el ancho de las columnas con el Ancho que se nos antoje
            int cantidadRegistro = modeloobra.getRowCount();
            for (int i = 1; i <= cantidadRegistro; i++) {
                modeloobra.removeRow(0);
            }
            obraDAO paDAO = new obraDAO();
            try {
                for (obra ba : paDAO.todosxCliente(Integer.valueOf(cliente.getText()))) {
                    String Datos[] = {String.valueOf(ba.getCodigo()), ba.getNombre()};
                    modeloobra.addRow(Datos);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage());
            }
            tablaobra.setRowSorter(new TableRowSorter(modeloobra));
            int cantFilas = tablaobra.getRowCount();
        }
    }
