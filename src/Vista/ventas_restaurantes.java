 ...
 *
 */
public class ventas_restaurantes extends javax.swing.JFrame {
    ...
    Date dConfirma;
    Date dPrimeraCuota;
    private TableRowSorter trsfiltro, trsfiltrosuc, trsfiltrocli, trsfiltrocomprobante, trsfiltromoneda, trsfiltroproducto, trsfiltrovendedor, trsfiltroformapago, trsfiltrobanco, trsfiltrocaja;
...
//         ImageIcon icon = new ImageIcon(Image1.getIconHeight(). getScaledInstance(this.etiquetaimagen.getWidth(), etiquetaimagen.getHeight(), Image.SCALE_DEFAULT));
    ...
    private void initComponents() {
        ...
        jTBuscarProducto.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarProducto.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirProducto.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jLabel12.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel12.text")); // NOI18N
        ...
        jLabel2.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel2.text")); // NOI18N
        ...
        jLabel6.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel6.text")); // NOI18N
        ...
        jLabel5.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel5.text")); // NOI18N
        jLabel5.setName("jLabel5"); // NOI18N

        vencetimbrado.setName("vencetimbrado"); // NOI18N

        jLabel7.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel7.text")); // NOI18N
        ...
        jLabel1.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel1.text")); // NOI18N
        jLabel1.setName("jLabel1"); // NOI18N

        factura.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.factura.text")); // NOI18N
        ...
        jLabel4.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel4.text")); // NOI18N
        ...
        jLabel9.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel9.text")); // NOI18N
        jLabel9.setName("jLabel9"); // NOI18N

        jLabel14.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel14.text")); // NOI18N
        ...
        etiquetavendedor.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.etiquetavendedor.text")); // NOI18N
        ...
        jLabel10.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel10.text")); // NOI18N
        ...
        jLabel11.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel11.text")); // NOI18N
        ...
        jLabel32.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel32.text")); // NOI18N
        jLabel32.setName("jLabel32"); // NOI18N

        jLabel13.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel13.text")); // NOI18N
        jLabel13.setName("jLabel13"); // NOI18N

        caja.setHorizontalAlignment(JTextField.RIGHT);
        caja.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.caja.text")); // NOI18N
        ...
        nombrecaja.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.nombrecaja.text")); // NOI18N
        ...
        jTabbedPane1.addTab(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jPanel36.TabConstraints.tabTitle"), jPanel36); // NOI18N
        ...
        NewItem.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.NewItem.text")); // NOI18N
        ...
        Upditem.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.Upditem.text")); // NOI18N
        ...
        DelItem.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.DelItem.text")); // NOI18N
        ...
        jLabel45.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel45.text")); // NOI18N
        ...
        jTabbedPane1.addTab(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jPanel37.TabConstraints.tabTitle"), jPanel37); // NOI18N
        ...
        NuevoF.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.NuevoF.text")); // NOI18N
        ...
        EditarF.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.EditarF.text")); // NOI18N
        ...
        BorrarF.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.BorrarF.text")); // NOI18N
        ...
        jLabel51.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel51.text")); // NOI18N
        ...
        jTabbedPane1.addTab(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jPanel27.TabConstraints.tabTitle"), jPanel27); // NOI18N
        ...
        nuevoitem.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.nuevoitem.text")); // NOI18N
        ...
        editaritem.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.editaritem.text")); // NOI18N
        ...
        jPanel9.setBorder(BorderFactory.createTitledBorder(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jPanel9.border.title"))); // NOI18N
        ...
        Salir.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.Salir.text")); // NOI18N
        Salir.setToolTipText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.Salir.toolTipText")); // NOI18N
        ...
        Grabar.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.Grabar.text")); // NOI18N
        Grabar.setToolTipText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.Grabar.toolTipText")); // NOI18N
        ...
        jPanel11.setBorder(BorderFactory.createTitledBorder(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jPanel11.border.title"))); // NOI18N
        ...
        jPanel12.setBorder(BorderFactory.createTitledBorder(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jPanel12.border.title"))); // NOI18N
        jPanel12.setName("jPanel12"); // NOI18N

        jLabel19.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel19.text")); // NOI18N
        jLabel19.setName("jLabel19"); // NOI18N

        jLabel21.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel21.text")); // NOI18N
        jLabel21.setName("jLabel21"); // NOI18N

        jLabel24.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel24.text")); // NOI18N
        ...
        fotoProducto.setToolTipText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.fotoProducto.toolTipText")); // NOI18N
            ...
            .addGroup(GroupLayout.Alignment.TRAILING, detalle_ventaLayout.createSequentialGroup()
                ...
                .addGroup(detalle_ventaLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(detalle_ventaLayout.createSequentialGroup()
                        .addComponent(jPanel8, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(fotoProducto, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(detalle_ventaLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        jTBuscarSucursal.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarCliente.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCli.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCli.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarComprobante.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarComprobante.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirComprobante.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarMoneda.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarMoneda.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirMoneda.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        codprod.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.codprod.text")); // NOI18N
        ...
        lblnombre.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.jLabel14.text")); // NOI18N
        lblnombre.setName("lblnombre"); // NOI18N

        BuscarProducto.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.BuscarProducto.text")); // NOI18N
        ...
        nombreproducto.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.nombreproducto.text")); // NOI18N
        nombreproducto.setEnabled(false);
        nombreproducto.setName("nombreproducto"); // NOI18N

        lblcantidad.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.jLabel15.text")); // NOI18N
        lblcantidad.setName("lblcantidad"); // NOI18N

        cantidad.setHorizontalAlignment(JTextField.RIGHT);
        cantidad.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.cantidad.text")); // NOI18N
        ...
        precio.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.preciounitario.text")); // NOI18N
        ...
        jLabel28.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.jLabel17.text")); // NOI18N
        ...
        totalitem.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.totalitem.text")); // NOI18N
        totalitem.setName("totalitem"); // NOI18N

        cModo.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.cModo.text")); // NOI18N
        ...
        porcentaje.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.preciounitario.text")); // NOI18N
        ...
        jLabel30.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel30.text")); // NOI18N
        jLabel30.setName("jLabel30"); // NOI18N

        jLabel25.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel25.text")); // NOI18N
        jLabel25.setName("jLabel25"); // NOI18N

        jLabel54.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel54.text")); // NOI18N
        ...
        GrabarItem.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.NuevoItem.text")); // NOI18N
        ...
        SalirItem.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.SalirItem.text")); // NOI18N
        ...
        jTBuscarVendedor.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarVendedor.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirVendedor.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jLabel42.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel42.text")); // NOI18N
        ...
        jLabel43.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel43.text")); // NOI18N
        jLabel43.setName("jLabel43"); // NOI18N

        jLabel44.setFont(new Font("Tahoma", 1, 12)); // NOI18N
        jLabel44.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel44.text")); // NOI18N
        ...
        imprimirlotes.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.imprimirlotes.text")); // NOI18N
        ...
        SalirLotes.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.SalirLotes.text")); // NOI18N
        ...
        jLabel46.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel46.text")); // NOI18N
        jLabel46.setName("jLabel46"); // NOI18N

        jLabel47.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel47.text")); // NOI18N
        ...
        jLabel48.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel48.text")); // NOI18N
        ...
        jLabel49.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel49.text")); // NOI18N
        jLabel49.setName("jLabel49"); // NOI18N

        jLabel50.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel50.text")); // NOI18N
        ...
        cModo1.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.cModo.text")); // NOI18N
        ...
        grabarPago.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.grabarPago.text")); // NOI18N
        ...
        salirPago.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.salirPago.text")); // NOI18N
        ...
        jTBuscarForma.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarGir.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirGir.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarbanco.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarCasa.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirCasa.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        lblcodigo.setText(NbBundle.getMessage(ventas_restaurantes.class, "detalle_facturas.jLabel19.text")); // NOI18N
        ...
        ncuotas.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.ncuotas.text")); // NOI18N
        ncuotas.setToolTipText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.ncuotas.toolTipText")); // NOI18N
        ...
        montocuota.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.montocuota.text")); // NOI18N
        ...
        jLabel15.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel15.text")); // NOI18N
        jLabel15.setName("jLabel15"); // NOI18N

        jLabel26.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel26.text")); // NOI18N
        jLabel26.setName("jLabel26"); // NOI18N

        jLabel27.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel27.text")); // NOI18N
        jLabel27.setName("jLabel27"); // NOI18N

        jLabel29.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel29.text")); // NOI18N
        jLabel29.setName("jLabel29"); // NOI18N

        jLabel31.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel31.text")); // NOI18N
        ...
        grabarFinanciacion.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.grabarFinanciacion.text")); // NOI18N
        ...
        salirFinanciacion.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.salirFinanciacion.text")); // NOI18N
        ...
        BCaja.setTitle(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.BCaja.title")); // NOI18N
        ...
        AceptarCaja.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.AceptarCaja.text")); // NOI18N
        ...
        SalirCaja.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.SalirCaja.text")); // NOI18N
        ...
        GrabarRetencion.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.GrabarRetencion.text")); // NOI18N
        ...
        SalirRetencion.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.SalirRetencion.text")); // NOI18N
        ...
        jLabel33.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel33.text")); // NOI18N
        jLabel33.setName("jLabel33"); // NOI18N

        jLabel34.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel34.text")); // NOI18N
        jLabel34.setName("jLabel34"); // NOI18N

        nroretencion.setHorizontalAlignment(JTextField.RIGHT);
        nroretencion.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.nroretencion.text")); // NOI18N
        ...
        jLabel35.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel35.text")); // NOI18N
        jLabel35.setName("jLabel35"); // NOI18N

        nrofactura.setEditable(false);
        nrofactura.setHorizontalAlignment(JTextField.RIGHT);
        nrofactura.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.sucursalret.text")); // NOI18N
        nrofactura.setName("nrofactura"); // NOI18N

        jLabel36.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel36.text")); // NOI18N
        jLabel36.setName("jLabel36"); // NOI18N

        sucursalret.setEditable(false);
        sucursalret.setHorizontalAlignment(JTextField.RIGHT);
        sucursalret.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.sucursalret.text")); // NOI18N
        sucursalret.setName("sucursalret"); // NOI18N

        nombresucursalret.setEditable(false);
        nombresucursalret.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.sucursalret.text")); // NOI18N
        nombresucursalret.setName("nombresucursalret"); // NOI18N

        jLabel37.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel37.text")); // NOI18N
        jLabel37.setName("jLabel37"); // NOI18N

        monedaret.setEditable(false);
        monedaret.setHorizontalAlignment(JTextField.RIGHT);
        monedaret.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.sucursalret.text")); // NOI18N
        monedaret.setName("monedaret"); // NOI18N

        nombremonedaret.setEditable(false);
        nombremonedaret.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.sucursalret.text")); // NOI18N
        nombremonedaret.setName("nombremonedaret"); // NOI18N

        jLabel38.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel38.text")); // NOI18N
        ...
        importe_sin_iva.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.importe_sin_iva.text")); // NOI18N
        importe_sin_iva.setName("importe_sin_iva"); // NOI18N

        jLabel39.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel39.text")); // NOI18N
        ...
        importe_iva.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.importe_sin_iva.text")); // NOI18N
        importe_iva.setName("importe_iva"); // NOI18N

        jLabel40.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel40.text")); // NOI18N
        ...
        importe_gravado_total.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.importe_sin_iva.text")); // NOI18N
        importe_gravado_total.setName("importe_gravado_total"); // NOI18N

        jLabel41.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel41.text")); // NOI18N
        ...
        porcentaje_retencion.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.importe_sin_iva.text")); // NOI18N
        ...
        jLabel52.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel52.text")); // NOI18N
        ...
        valor_retencion.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas.importe_sin_iva.text")); // NOI18N
        valor_retencion.setName("valor_retencion"); // NOI18N

        enviarcta.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.enviarcta.text")); // NOI18N
        enviarcta.setName("enviarcta"); // NOI18N

        creferenciaret.setEditable(false);
        creferenciaret.setHorizontalAlignment(JTextField.RIGHT);
        creferenciaret.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.creferenciaret.text")); // NOI18N
        creferenciaret.setName("creferenciaret"); // NOI18N

        jLabel53.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jLabel53.text")); // NOI18N
        jLabel53.setName("jLabel53"); // NOI18N

        clienteret.setEditable(false);
        clienteret.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.clienteret.text")); // NOI18N
        clienteret.setName("clienteret"); // NOI18N

        nombreclienteret.setEditable(false);
        nombreclienteret.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.nombreclienteret.text")); // NOI18N
        ...
        etiquetaventas.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.etiquetaventas.text")); // NOI18N
        etiquetaventas.setName("etiquetaventas"); // NOI18N

        jComboBox1.setFont(new Font("Tahoma", 0, 14)); // NOI18N
        jComboBox1.setModel(new DefaultComboBoxModel(new String[] { "Factura", "Sucursal", "Nombre Cliente" }));
        ...
        panel1Layout.setHorizontalGroup(panel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(panel1Layout.createSequentialGroup()
                ...
                .addGap(40, 40, 40)
                .addComponent(jComboBox1, GroupLayout.PREFERRED_SIZE, 137, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
        ...
        Modificar.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.Modificar.text")); // NOI18N
        ...
        Agregar.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.Agregar.text")); // NOI18N
        ...
        Eliminar.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.Eliminar.text")); // NOI18N
        Eliminar.setToolTipText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.Eliminar.toolTipText")); // NOI18N
        ...
        Listar.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.Listar.text")); // NOI18N
        Listar.setToolTipText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.Listar.toolTipText")); // NOI18N
        ...
        SalirCompleto.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.SalirCompleto.text")); // NOI18N
        SalirCompleto.setToolTipText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.SalirCompleto.toolTipText")); // NOI18N
        ...
        jPanel3.setBorder(BorderFactory.createTitledBorder(NbBundle.getMessage(ventas_restaurantes.class, "libroventaconsolidado.jPanel2.border.title"))); // NOI18N
        jPanel3.setName("jPanel3"); // NOI18N

        jLabel3.setText(NbBundle.getMessage(ventas_restaurantes.class, "libroventaconsolidado.jLabel1.text")); // NOI18N
        jLabel3.setName("jLabel3"); // NOI18N

        dInicial.setName("dInicial"); // NOI18N

        jLabel8.setText(NbBundle.getMessage(ventas_restaurantes.class, "libroventaconsolidado.jLabel2.text")); // NOI18N
        jLabel8.setName("jLabel8"); // NOI18N

        dFinal.setName("dFinal"); // NOI18N

        refrescar.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.refrescar.text")); // NOI18N
        ...
        jTable1.setSelectionBackground(new Color(51, 204, 255));
        jTable1.setSelectionForeground(new Color(0, 0, 255));
        ...
        jMenu1.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jMenu1.text")); // NOI18N
        ...
        jMenuItem2.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jMenuItem2.text")); // NOI18N
        ...
        jMenuItem3.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jMenuItem3.text")); // NOI18N
        ...
        jMenuItem1.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jMenuItem1.text")); // NOI18N
        ...
        jMenuItem4.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jMenuItem4.text")); // NOI18N
        ...
        jMenuItem5.setText(NbBundle.getMessage(ventas_restaurantes.class, "ventas_restaurantes.jMenuItem5.text")); // NOI18N
...
//      this.imagen.setText("Imagen");
    ...
    private void GrabarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_GrabarActionPerformed
        ...
        if (ret == 0) {
            ...
            v.setCaja(ca);
            double grav10 = 0;
            if (nGravadas10.doubleValue() > 0) {
                grav10 = Math.round(nGravadas10.doubleValue() * 55 / 105);
                nExentas = new BigDecimal(nGravadas10.doubleValue() - grav10);
                v.setExentas(nExentas);
                v.setGravadas10(new BigDecimal(grav10));
            } else {
                v.setExentas(nExentas);
...
//                giraduria.requestFocus();
    ...
    private void calcularVencimiento(int dias) {
        Calendar calendar = Calendar.getInstance(); //Instanciamos Calendar
        calendar.setTime(primervence.getDate()); // Capturamos en el setTime el valor de la fecha ingresada
        calendar.add(Calendar.DATE, dias);  // en caso que sea Febrero 28 se aumentan a dos días                            //el vencimiento
        primervence.setDate(calendar.getTime()); //Y cargamos finalmente en el 
    }
...
//                giraduria.requestFocus();
    ...
    private void cargarTitulo() {
        ...
        int[] anchos = {3, 120, 90, 100, 100, 150, 70, 100, 100, 100, 100, 10, 1};
    ...
    private class GenerarPagare extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                JasperReport jr = null;
                URL url = getClass().getClassLoader().getResource("Reports/pagares_venta_carway.jasper");
                jr = (JasperReport) JRLoader.loadObject(url);
                JasperPrint masterPrint = null;
                //Se le incluye el parametro con el nombre parameters porque asi lo definimos
                masterPrint = JasperFillManager.fillReport(jr, parameters, stm.getConnection());
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                parameters.put("Letra", numero.Convertir(num, true, Integer.valueOf(jTable1.getValueAt(nFila, 11).toString())));
